...
export default async function AdminSettingsPage() {
  ...
  return (
    <AdminPageShell title="Settings" description="Read-only operational settings for active and paused platform systems.">
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Card className="p-5"><h2 className="font-bold text-navy">System status</h2><div className="mt-3 flex flex-wrap gap-2"><StatusPill tone="good">Active: flight metasearch</StatusPill><StatusPill tone="good">Active: auth</StatusPill><StatusPill tone="good">Active: Duffel foundation</StatusPill><StatusPill>Paused: Stripe premium</StatusPill><StatusPill>Paused: Resend alerts</StatusPill><StatusPill>Paused: OpenAI premium</StatusPill><StatusPill>Paused: Travelpayouts</StatusPill></div></Card>
      </div>
