...
export default async function AdminOperationsPage() {
  ...
  const destinations = getAdminHubDestinations("operations", role);

  return (
    <AdminPageShell title="Operations" description="Manage customer and support operations." eyebrow="Admin navigation">
