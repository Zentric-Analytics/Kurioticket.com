...
import { requireCuratedDestinationImage } from "@/data/destinationImages";
...
const getDestinationPhotoUrl = (name: string, country: string) =>
  requireCuratedDestinationImage(name, country).imageUrl;
