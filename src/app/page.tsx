...
export default function Home() {
  ...
  const trustItemsLocalized = trustItems.map((item, i) => ({ ...item, title: t.trustTitles[i], body: t.trustBodies[i] }));
  return (
    <>
      <AppHeader />
