    ...
    <>
      ...
      <main className="flex-1 bg-white">
        <section className="relative min-h-[420px] overflow-visible bg-slate-950 sm:min-h-[550px] lg:min-h-[610px]">
          ...
          <div className="page-shell absolute inset-x-0 bottom-[-96px] z-30 sm:hidden">
            <SearchTabs
        ...
        <section className="border-y border-slate-200/75 bg-[#fbfaf7] pb-7 pt-[31rem] shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] sm:border-y-0 sm:bg-transparent sm:pb-5 sm:pt-24 sm:shadow-none lg:pt-28">
