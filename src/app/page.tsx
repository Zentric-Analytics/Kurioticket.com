      ...
      <main className="flex-1 bg-white">
        ...
        <section className="page-shell pb-5">
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {[
              [t.featuresMillionsTitle || "Millions of Choices", t.featuresMillionsBody || "Flights and hotels worldwide"],
              [t.featuresFlexibleTitle || "Flexible Options", t.featuresFlexibleBody || "Choose what fits your trip"],
              [t.featuresSecureTitle || "Secure Payments", t.featuresSecureBody || "100% safe and secure"],
              [t.featuresDealsTitle || "Great Deals", t.featuresDealsBody || "Compare more before you buy"],
            ].map(([title, body]) => (
