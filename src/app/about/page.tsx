    ...
    <>
      ...
      <main className="page-shell flex-1 pt-8 pb-10 sm:pt-10 lg:pt-12">
        <section className="max-w-3xl">
          <p className="text-sm font-semibold text-teal-dark">About Curioticket</p>
          <h1 className="mt-2 text-4xl font-bold tracking-tight text-navy">About Us</h1>
          <p className="mt-4 text-sm leading-6 text-muted sm:text-base">
            Curioticket is a travel search and comparison platform that helps travelers search,
        ...
        <section className="mt-10 max-w-3xl rounded-2xl border border-border bg-white p-5 sm:p-6">
          ...
          <p className="mt-3 text-sm leading-6 text-muted sm:text-base">
            Curioticket focuses on helping travelers evaluate travel options with useful context.
