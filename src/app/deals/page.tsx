...
export default function DealsPage() {
  ...
  return <><AppHeader /><main ref={dealsPageRef} className="flex-1 bg-slate-50 pb-12" style={{ "--deals-search-inside": "0px", "--deals-search-outside": "0px" } as CSSProperties}>
    <section className="relative overflow-hidden border-b border-slate-200 bg-[#F6F9FC] pb-12 shadow-[0_18px_45px_rgba(15,23,42,0.06)] sm:overflow-visible sm:pb-0 lg:h-[390px]">
      <div className="absolute inset-0 overflow-hidden bg-slate-800"><Image src={dealsHeroImage} alt="" fill priority quality={90} sizes="100vw" className="object-cover object-[center_52%] lg:object-[center_48%]" /></div>
      <div className="h-36 sm:h-[calc(2.5rem+var(--deals-search-inside))] lg:h-auto" aria-hidden="true" />
      <div ref={dealsSearchRef} className="page-shell relative z-20 mt-8 sm:absolute sm:inset-x-0 sm:bottom-0 sm:mt-0 sm:translate-y-[38%] lg:translate-y-[56%]"><div className="mx-auto max-w-[1280px]"><Suspense fallback={<div className="min-h-80 rounded-3xl bg-white/90" />}><DealsSearchForm presentation={pathname === "/packages" ? "packages-landing" : "desktop-landing"} /></Suspense></div></div>
    </section>
