...
const copy = {
  ...
  fr: {
    ...
    subtitle:
      "Les offres en vedette sont prêtes pour la curation et les flux partenaires.",
...
export default function DealsPage() {
  ...
  return (
    <>
      ...
      <main className="flex-1 bg-gradient-to-b from-indigo-50 via-white to-violet-50/40 pt-8 pb-10 sm:pt-10 lg:pt-12">
            ...
            {deals.map(([route, amount]) => (
              ...
              >
                ...
                <LinkButton
                  ...
                  variant="secondary"
                  className="mt-4 border-indigo-200 bg-indigo-50 text-indigo-700 hover:bg-indigo-100"
                >
                  {c.cta}
                </LinkButton>
              </Card>
