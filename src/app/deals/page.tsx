...
export default function DealsPage() {
  ...
  return <><AppHeader /><main className="flex-1 bg-slate-50 pb-12">
    <section className="relative min-h-[360px] overflow-hidden border-b border-slate-200 bg-[#F6F9FC] pb-12 shadow-[0_18px_45px_rgba(15,23,42,0.06)] sm:overflow-visible sm:pb-0 lg:min-h-[400px]">
