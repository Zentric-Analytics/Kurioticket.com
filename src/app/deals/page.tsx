...
const copy = {
  ...
  fr: {
    ...
    subtitle:
      "Utilisez des itinéraires simples pour commencer à comparer les résultats des fournisseurs.",
        ...
        <section className="border-b border-slate-200 bg-white">
          <div className="page-shell py-10 sm:py-14">
            <div className="max-w-3xl">
              <h1 className="text-4xl font-black [letter-spacing:-0.025em] text-slate-950 sm:text-5xl">
                {dictionary.title}
              </h1>
              ...
              <fieldset className="min-w-0" aria-label={dictionary.modeLegend}>
                ...
                <div className="flex gap-2 overflow-x-auto pb-1 sm:flex-wrap sm:overflow-visible sm:pb-0">
                  {packageModes.map((mode) => (
                    <label
                      key={mode.value}
                      className={`shrink-0 cursor-pointer rounded-full border px-3.5 py-2 text-sm font-extrabold transition focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 ${
                        packageMode === mode.value
                          ? "border-indigo-600 bg-indigo-600 text-white shadow-sm"
                          : "border-slate-300 bg-transparent text-slate-700 hover:border-indigo-300 hover:bg-indigo-50"
                      }`}
                    >
                      <input
                        className="sr-only"
