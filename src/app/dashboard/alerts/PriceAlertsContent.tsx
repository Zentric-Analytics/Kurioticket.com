...
const tabs = [
  {
    id: "active",
    labelKey: "accountDashboard.priceAlerts.tabs.active",
    count: 0,
  },
  {
    id: "expired",
    labelKey: "accountDashboard.priceAlerts.tabs.expired",
    count: 0,
  },
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <path
          d="M26 84h68c3.6 0 5.5-4.3 3.1-7C91.4 70.7 88 62.6 88 54v-8c0-12.7-8.1-23.5-19.5-27.5A8.8 8.8 0 0 0 60 8a8.8 8.8 0 0 0-8.5 10.5C40.1 22.5 32 33.3 32 46v8c0 8.6-3.4 16.7-9.1 23-2.4 2.7-.5 7 3.1 7Z"
      ...
      <div className="page-shell min-w-0">
        ...
        <div className="mx-auto min-w-0 max-w-6xl px-4 pt-3 pb-8 sm:px-6 sm:pt-6 lg:px-8">
          ...
          >
            ...
            {isSortOpen && (
              <div
                className="absolute end-0 top-full z-10 mt-2 w-44 overflow-hidden rounded-xl border border-slate-200 bg-white py-1 shadow-lg"
                role="listbox"
                aria-label={t["accountDashboard.priceAlerts.sort.ariaLabel"]}
              >
          ...
          <div className="mt-4 grid gap-5 lg:grid-cols-[minmax(0,1fr)_22rem]">
            ...
            >
              ...
              <h2
                id="empty-alerts-title"
                className="mt-6 text-2xl font-semibold tracking-tight text-slate-950 sm:text-[1.6rem]"
              >
            ...
            <aside
              className="hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm lg:block"
              aria-label={t["accountDashboard.priceAlerts.featuresAriaLabel"]}
            >
