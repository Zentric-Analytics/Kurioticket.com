            ...
            <div className="rounded-2xl border border-[#004BB8]/10 bg-white p-3 shadow-[0_16px_40px_-30px_rgba(2,28,43,0.26)]">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <div className="min-w-0 space-y-2">
                  <div className="h-3 w-36 animate-pulse rounded-full bg-[#004BB8]/10 motion-reduce:animate-none" />
                  <div className="h-8 w-72 max-w-full animate-pulse rounded-xl bg-slate-200 motion-reduce:animate-none" />
                </div>
                <div className="h-11 w-32 animate-pulse rounded-xl bg-[#004BB8]/10 motion-reduce:animate-none" />
              </div>
        ...
        <div className="page-shell grid gap-6 py-6 lg:grid-cols-[290px_minmax(0,1fr)] xl:grid-cols-[300px_minmax(0,1fr)]">
            ...
            <div className="rounded-2xl border border-[#004BB8]/10 bg-white p-5 shadow-[0_16px_40px_-24px_rgba(2,28,43,0.28)]">
              ...
              <div className="mt-5 space-y-4">
                {filterSkeletons.map((_, index) => (
                  <div key={index} className="space-y-3 border-t border-[#004BB8]/10 pt-4 first:border-t-0 first:pt-0">
          ...
          <section className="min-w-0 space-y-4" aria-hidden="true">
            {resultSkeletons.map((_, index) => (
              <div
                key={index}
                className="rounded-2xl border border-[#004BB8]/10 bg-white p-4 shadow-[0_16px_40px_-30px_rgba(2,28,43,0.26)]"
              >
