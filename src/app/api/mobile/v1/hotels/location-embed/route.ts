...
export async function GET(request: Request) {
  ...
  const configuration = { hotelName: location.hotelName, propertyDetails: location.propertyDetails, googleMapsEmbedApiKey: key };
  ...
  const title = view === "map" ? `${location.hotelName} map` : `${location.hotelName} Street View`;
