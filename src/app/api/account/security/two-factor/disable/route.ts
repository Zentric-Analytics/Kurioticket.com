...
export async function POST(request: Request) {
  ...
  const event = await disableTwoFactorForSession({ userId: auth.userId, accountSessionId: auth.accountSession.id, assuranceLevel: auth.accountSession.assuranceLevel });
