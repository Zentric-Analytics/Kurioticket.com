...
const cityDisplayNames: Record<string, LocalizedCityNames> = {
  ...
  "Barcelona": { "en-us": "Barcelona", ar: "برشلونة", nl: "Barcelona", "es-es": "Barcelona", fr: "Barcelone", "de-de": "Barcelona", "it-it": "Barcellona", "pt-br": "Barcelona", "zh-cn": "巴塞罗那", ja: "バルセロナ", ko: "바르셀로나" },
  ...
  "Cairo": { "en-us": "Cairo", ar: "القاهرة", nl: "Caïro", "es-es": "El Cairo", fr: "Le Caire", "de-de": "Kairo", "it-it": "Il Cairo", "pt-br": "Cairo", "zh-cn": "开罗", ja: "カイロ", ko: "카이로" },
  "Cancún": { "en-us": "Cancun", ar: "كانكون", nl: "Cancun", "es-es": "Cancún", fr: "Cancún", "de-de": "Cancún", "it-it": "Cancún", "pt-br": "Cancún", "zh-cn": "坎昆", ja: "カンクン", ko: "칸쿤" },
  "Cape Town": { "en-us": "Cape Town", ar: "كيب تاون", nl: "Kaapstad", "es-es": "Ciudad del Cabo", fr: "Le Cap", "de-de": "Kapstadt", "it-it": "Città del Capo", "pt-br": "Cidade do Cabo", "zh-cn": "开普敦", ja: "ケープタウン", ko: "케이프타운" },
  "Doha": { "en-us": "Doha", ar: "الدوحة", nl: "Doha", "es-es": "Doha", fr: "Doha", "de-de": "Doha", "it-it": "Doha", "pt-br": "Doha", "zh-cn": "多哈", ja: "ドーハ", ko: "도하" },
  "Dubai": { "en-us": "Dubai", ar: "دبي", nl: "Dubai", "es-es": "Dubái", fr: "Dubaï", "de-de": "Dubai", "it-it": "Dubai", "pt-br": "Dubai", "zh-cn": "迪拜", ja: "ドバイ", ko: "두바이" },
  "Edmonton": { "en-us": "Edmonton", ar: "إدمونتون", nl: "Edmonton", "es-es": "Edmonton", fr: "Edmonton", "de-de": "Edmonton", "it-it": "Edmonton", "pt-br": "Edmonton", "zh-cn": "埃德蒙顿", ja: "エドモントン", ko: "에드먼턴" },
  ...
  "Los Angeles": { "en-us": "Los Angeles", ar: "لوس أنجلوس", nl: "Los Angeles", "es-es": "Los Ángeles", fr: "Los Angeles", "de-de": "Los Angeles", "it-it": "Los Angeles", "pt-br": "Los Angeles", "zh-cn": "洛杉矶", ja: "ロサンゼルス", ko: "로스앤젤레스" },
  ...
  "Nairobi": { "en-us": "Nairobi", ar: "نيروبي", nl: "Nairobi", "es-es": "Nairobi", fr: "Nairobi", "de-de": "Nairobi", "it-it": "Nairobi", "pt-br": "Nairóbi", "zh-cn": "内罗毕", ja: "ナイロビ", ko: "나이로비" },
  "New York": { "en-us": "New York", ar: "نيويورك", nl: "New York", "es-es": "Nueva York", fr: "New York", "de-de": "New York", "it-it": "New York", "pt-br": "Nova York", "zh-cn": "纽约", ja: "ニューヨーク", ko: "뉴욕" },
  "Paris": { "en-us": "Paris", ar: "باريس", nl: "Parijs", "es-es": "París", fr: "Paris", "de-de": "Paris", "it-it": "Parigi", "pt-br": "Paris", "zh-cn": "巴黎", ja: "パリ", ko: "파리" },
  "Puerto Vallarta": { "en-us": "Puerto Vallarta", ar: "بويرتو فالارتا", nl: "Puerto Vallarta", "es-es": "Puerto Vallarta", fr: "Puerto Vallarta", "de-de": "Puerto Vallarta", "it-it": "Puerto Vallarta", "pt-br": "Puerto Vallarta", "zh-cn": "巴亚尔塔港", ja: "プエルトバジャルタ", ko: "푸에르토바야르타" },
  "Rome": { "en-us": "Rome", ar: "روما", nl: "Rome", "es-es": "Roma", fr: "Rome", "de-de": "Rom", "it-it": "Roma", "pt-br": "Roma", "zh-cn": "罗马", ja: "ローマ", ko: "로마" },
  ...
  "Singapore": { "en-us": "Singapore", ar: "سنغافورة", nl: "Singapore", "es-es": "Singapur", fr: "Singapour", "de-de": "Singapur", "it-it": "Singapore", "pt-br": "Singapura", "zh-cn": "新加坡", ja: "シンガポール", ko: "싱가포르" },
  ...
  "Tokyo": { "en-us": "Tokyo", ar: "طوكيو", nl: "Tokio", "es-es": "Tokio", fr: "Tokyo", "de-de": "Tokio", "it-it": "Tokyo", "pt-br": "Tóquio", "zh-cn": "东京", ja: "東京", ko: "도쿄" },
  "Toronto": { "en-us": "Toronto", ar: "تورونتو", nl: "Toronto", "es-es": "Toronto", fr: "Toronto", "de-de": "Toronto", "it-it": "Toronto", "pt-br": "Toronto", "zh-cn": "多伦多", ja: "トロント", ko: "토론토" },
