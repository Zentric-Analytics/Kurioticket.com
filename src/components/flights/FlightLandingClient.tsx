...
return ( <svg
 ...
 > <rect width="64" height="64" rx="18" fill="url(#flightSearchTile)" /> <rect x="12" y="15" width="35" height="31" rx="8" fill="white" /> <rect x="17" y="21" width="17" height="3" rx="1.5" fill="#4F46E5" /> <rect x="17" y="29" width="23" height="2.5" rx="1.25" fill="#C7D2FE" /> <path
     d="M19 37H37"
     stroke="#CBD5E1"
     strokeWidth="2.5"
     strokeLinecap="round"
   /> <path
     ...
     fill="#DBEAFE"
   /> <circle cx="43" cy="40" r="10" fill="#EEF2FF" fillOpacity="0.92" /> <circle cx="43" cy="40" r="7" stroke="#312E81" strokeWidth="2.8" /> <path
     d="M48 45L54 51"
     stroke="#312E81"
     strokeWidth="3.4"
     strokeLinecap="round"
   ...
   /> <defs> <linearGradient
     ...
     > <stop stopColor="#EEF2FF" /> <stop offset="1" stopColor="#ECFEFF" /> </linearGradient> </defs> </svg>
);
}
...
return ( <svg
   ...
   fill="none"
   xmlns="http://www.w3.org/2000/svg"
 > <rect width="64" height="64" rx="18" fill="url(#flightCompareTile)" /> <rect x="11" y="17" width="30" height="15" rx="5" fill="white" /> <rect x="17" y="23" width="10" height="3" rx="1.5" fill="#7C3AED" /> <path
     d="M29 24.5H35"
     stroke="#DDD6FE"
     strokeWidth="2.5"
     strokeLinecap="round"
   /> <rect x="23" y="32" width="30" height="15" rx="5" fill="#F8FAFC" /> <rect x="29" y="38" width="10" height="3" rx="1.5" fill="#0D9488" /> <path
     d="M41 39.5H47"
     stroke="#99F6E4"
     strokeWidth="2.5"
     strokeLinecap="round"
   ...
   /> <defs> <linearGradient
       ...
       y2="59"
       gradientUnits="userSpaceOnUse"
     > <stop stopColor="#F5F3FF" /> <stop offset="1" stopColor="#EFF6FF" /> </linearGradient> </defs> </svg>
);
}
...
return ( <svg
   ...
   fill="none"
   xmlns="http://www.w3.org/2000/svg"
 > <rect width="64" height="64" rx="18" fill="url(#flightProviderTile)" /> <rect x="18" y="14" width="31" height="25" rx="7" fill="white" /> <rect x="23" y="20" width="14" height="3" rx="1.5" fill="#2563EB" /> <rect x="23" y="28" width="20" height="2.5" rx="1.25" fill="#BFDBFE" /> <path
     d="M15 34L27 30L39 34V41C39 48 34.5 52.5 27 55C19.5 52.5 15 48 15 41V34Z"
     fill="#EEF2FF"
     stroke="#312E81"
     strokeWidth="2.6"
     strokeLinejoin="round"
   /> <rect x="23" y="40" width="8" height="7" rx="1.8" fill="#14B8A6" /> <path
   ...
   /> <defs> <linearGradient
       ...
       y2="59"
       gradientUnits="userSpaceOnUse"
     > <stop stopColor="#EFF6FF" /> <stop offset="1" stopColor="#F0FDFA" /> </linearGradient> </defs> </svg>
);
}
...
> <article className="flex h-full flex-col"> <div className="relative h-40 overflow-hidden bg-slate-100"> <Image
         src={item.image}
       ...
       /> </div> <div className="flex flex-1 flex-col p-5"> <h3 className="text-lg font-bold tracking-tight text-slate-950">
{routeText.title} </h3> <p className="mt-1 text-sm font-medium text-slate-700">
{routeText.originCity} {routeConnector} {routeText.destinationCity} </p> <p className="mt-1 text-xs font-medium text-slate-500">
{item.originCode} → {item.destinationCode} </p> <p className="mt-3 line-clamp-2 text-sm leading-6 text-slate-600">
{routeText.routeNote} </p> <span className="mt-5 inline-flex min-h-10 w-fit items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-700 to-violet-600 px-4 text-sm font-semibold text-white shadow-sm shadow-indigo-700/20 transition duration-200 group-hover:from-indigo-600 group-hover:to-violet-500 group-hover:shadow-[0_10px_22px_rgba(79,70,229,0.18)] group-active:translate-y-px">
{t("flightLandingStartThisSearch")} <Plane className="h-4 w-4 shrink-0 stroke-[2.4] transition duration-200 group-hover:translate-x-0.5" /> </span> </div> </article> </Link>
);
}
...
return ( <main className="flex-1 bg-slate-50 pb-12 pt-4 sm:pt-0"> <section className="page-shell sm:hidden"> <div> <div className="w-full max-w-3xl text-left"> <h1 className="max-w-none text-[clamp(1.25rem,6.2vw,1.7rem)] font-semibold leading-[1.14] tracking-[-0.02em] text-slate-950">
{useEnglishHeroWrap ? ( <span> <span className="block whitespace-nowrap">
{englishHeroTitleFirstLine} </span> <span className="block whitespace-nowrap">
{englishHeroTitleSecondLine} </span> </span>
) : (
heroTitle
)} </h1> <p className="mt-2.5 max-w-none text-[0.94rem] font-medium leading-[1.55] text-slate-600">
{useEnglishHeroWrap ? ( <span> <span className="block whitespace-nowrap">
{englishHeroSubtitleFirstLine} </span> <span className="block whitespace-nowrap">
{englishHeroSubtitleSecondLine} </span> </span>
) : (
heroSubtitle
)} </p> </div>
