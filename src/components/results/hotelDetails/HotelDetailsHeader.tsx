...
export function HotelDetailsHeader({
  ...
  return (
    <header className="min-w-0 space-y-3 lg:border-b lg:border-border lg:pb-6">
      ...
      <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:items-start sm:justify-between lg:gap-8">
        <h1 className="min-w-0 break-words text-3xl font-bold leading-tight text-slate-950 sm:text-4xl">{name}</h1>
        <div className="shrink-0 lg:max-w-[360px]">
      ...
      {isGoogleMapsProvider ? <p className="text-sm font-normal leading-5 text-[#5E5E5E]">Hotel discovery data provided by <span translate="no" className="whitespace-nowrap not-italic text-sm font-normal text-[#5E5E5E]">Google Maps</span></p> : null}
