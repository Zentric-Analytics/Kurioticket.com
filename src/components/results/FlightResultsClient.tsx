...
export function FlightResultsClient() {
        ...
        <section className="page-shell">
          ...
          <div className="mt-8 space-y-8">
                  ...
                  {discoveryCards.slice(0, 4).map((item) => (
                    ...
                    >
                      <article className="flex h-full flex-col">
                        ...
                        <div className="bg-white px-4 py-2.5 sm:px-5 sm:py-4">
            ...
            <section>
              ...
              <div className="border border-slate-200/80 bg-white p-3 shadow-[0_10px_30px_rgba(15,23,42,0.05)] sm:p-4 lg:p-5">
                  ...
                  <div className="grid min-w-max grid-cols-4 grid-rows-2 gap-4 px-1 pt-1 sm:min-w-0 sm:w-auto sm:grid-rows-none sm:grid-cols-3 sm:px-0 sm:pt-0 sm:[grid-template-columns:repeat(3,minmax(0,1fr))] lg:grid-cols-4 lg:gap-5 lg:[grid-template-columns:repeat(4,minmax(0,1fr))] xl:gap-6">
                    {beachVacationCards.slice(0, 6).map((item) => {
                      ...
                      return (
                        ...
                        >
                          <article className="flex h-full flex-col">
                            <div className="relative aspect-[4/3] w-full overflow-hidden bg-[#004BB8]/8 sm:aspect-auto sm:h-28 lg:h-32">
                              <Image
  ...
  return (
    <main className="flex-1 bg-[#f6f8fb] pb-8">
      ...
      <div className="page-shell grid gap-4 pb-5 pt-4 sm:pt-5 lg:grid-cols-[260px_minmax(0,1fr)]">
...
function Filters({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          layout === "mobile" ? "space-y-4 bg-white" : "space-y-0 px-1 py-1",
        )}
      >
        <section>
          {layout === "desktop" ? (
