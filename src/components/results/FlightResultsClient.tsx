  ...
  return (
    <div className="mt-6 mr-auto w-full max-w-5xl space-y-3">
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-md shadow-slate-200/70">
        <div className="grid gap-0 md:grid-cols-2 xl:grid-cols-[minmax(128px,1fr)_44px_minmax(150px,1fr)_minmax(142px,0.92fr)_minmax(142px,0.92fr)_minmax(180px,1fr)_112px]">
          ...
          <SearchSelect
            ...
            icon={<Users size={15} />}
          />
          <Button type="button" className="h-12 w-full rounded-none px-5 xl:w-[112px]">
            <Search size={16} />
            Search
          </Button>
        </div>
...
function SearchField({
  ...
  return (
    <label className="flex h-12 min-w-[150px] items-center border-b border-slate-200 px-3 md:border-b-0 xl:border-r xl:border-slate-200">
    ...
    <label
      className={cn(
        ...
        variant === "text"
          ...
          : "h-12 min-w-[170px] border-b border-slate-200 px-3 md:border-b-0 xl:border-r xl:border-slate-200",
      )}
    >
      {icon ?? null}
      <span className="sr-only">{label}</span>
...
function DateField({
  ...
  return (
    <label className="flex h-12 min-w-[150px] items-center gap-2 border-b border-slate-200 px-3 md:border-b-0 xl:border-r xl:border-slate-200">
...
function SwapButton({ onSwap }: { onSwap: () => void }) {
  return (
    <Button
      type="button"
      variant="secondary"
      className="h-12 w-full rounded-none border-x-0 border-y border-slate-200 bg-white px-3 xl:w-[44px] xl:border-x xl:border-y-0"
    ...
    <aside className="relative hidden min-h-[340px] overflow-hidden rounded-2xl bg-gradient-to-br from-sky-100 via-slate-100 to-blue-100 p-3 lg:block">
      ...
      <div className="relative grid h-full grid-cols-6 grid-rows-6 gap-2">
        <div className="relative col-span-4 row-span-3 overflow-hidden rounded-[22px]">
          <Image
            src="https://images.pexels.com/photos/615060/pexels-photo-615060.jpeg?auto=compress&cs=tinysrgb&w=1200"
