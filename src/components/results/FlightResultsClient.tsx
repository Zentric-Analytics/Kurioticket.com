        ...
        <section className="page-shell">
          ...
          <div className="mt-8 space-y-8">
            <section>
              ...
              <div className="overflow-hidden border border-slate-200/80 bg-white p-4 shadow-[0_10px_30px_rgba(15,23,42,0.05)] sm:p-5 lg:p-6">
                <div className="flex max-w-full snap-x gap-4 overflow-x-auto pb-2 [scrollbar-width:none] [-ms-overflow-style:none] sm:gap-5 lg:gap-6 [&::-webkit-scrollbar]:hidden">
                  {discoveryCards.slice(0, 4).map((item) => (
                    <Link
                      key={item.id}
                      href={buildDiscoveryLink(item)}
                      aria-label={`Explore ${item.originCode} to ${item.destinationCode}`}
                      className="group min-w-[72vw] max-w-[290px] snap-start overflow-hidden rounded-[1.25rem] border border-slate-200/80 bg-white shadow-[0_8px_22px_rgba(15,23,42,0.055)] transition duration-200 hover:-translate-y-0.5 hover:border-indigo-200 hover:shadow-[0_14px_30px_rgba(15,23,42,0.085)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 sm:min-w-[280px] lg:min-w-[280px] lg:max-w-[280px] xl:min-w-[300px] xl:max-w-[300px]"
                    >
                      <article className="flex h-full flex-col">
                        <div className="relative h-40 overflow-hidden bg-slate-100 sm:h-44 lg:h-52">
                          <Image
                            ...
                            fill
                            priority={false}
                            sizes="(min-width: 1280px) 300px, (min-width: 1024px) 280px, (min-width: 640px) 280px, 72vw"
                ...
                <div className="flex max-w-full snap-x gap-4 overflow-x-auto pb-2 [scrollbar-width:none] [-ms-overflow-style:none] sm:gap-5 lg:gap-6 [&::-webkit-scrollbar]:hidden">
                  {beachVacationCards.slice(0, 6).map((item) => {
                    ...
                    return (
                      ...
                      >
                        <article className="flex h-full flex-col">
                          <div className="relative h-40 overflow-hidden bg-sky-50 sm:h-44 lg:h-52">
                            <Image
