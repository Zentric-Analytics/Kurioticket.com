...
test("Cars shortcut backdrop covers the full viewport without a giant-shadow compositing barrier", () => {
...
test("Cars quick-sheet dismissal now keeps the Hotels-style surface and backdrop mounted through exit motion", () => {
