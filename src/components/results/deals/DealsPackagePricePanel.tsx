...
export function DealsPackagePricePanel({ candidate, headingId, selected, t, onSelect }: Props) {
  return <aside className="min-w-0 border-t border-slate-200 px-4 py-4 sm:px-5 xl:self-start xl:border-s xl:border-t-0 xl:border-slate-200 xl:px-0 xl:py-3 xl:pe-1 xl:ps-5">
    <div className="grid min-w-0 gap-0 md:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] md:gap-4 lg:grid-cols-[minmax(180px,0.75fr)_minmax(300px,1.15fr)_minmax(220px,0.85fr)] xl:block">
      ...
      <div className="pt-3 md:col-span-2 md:pt-0 lg:col-span-1 xl:pt-3">
        ...
        <p className="mt-2 text-[13px] leading-5 text-slate-600">{t("deals.results.package.disclosure")}</p>
      </div>
    </div>
  </aside>;
}
