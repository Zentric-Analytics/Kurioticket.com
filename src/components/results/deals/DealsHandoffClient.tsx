...
export function DealsHandoffClient() {
  ...
  if (plan.car) steps.push({ product: "car", title: t("deals.tripPlan.car"), summary: `${plan.car.modelName} · ${plan.car.rentalCompany} · ${plan.car.pickupLocation} → ${plan.car.returnLocation} · ${plan.car.pickupDate} ${plan.car.pickupTime}–${plan.car.dropoffDate} ${plan.car.dropoffTime}`, provider: plan.car.rentalCompany, id: plan.car.id, expired: isDealsTripPlanProductExpired(plan.car.resultReceivedAt, now) || !plan.car.detailsPath, priceLabel: t("deals.handoff.carPrice"), displayPrice: price(plan.car.sourcePrice, plan.car.sourceCurrency) });
  return <>
