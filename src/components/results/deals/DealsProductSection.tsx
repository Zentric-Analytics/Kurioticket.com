...
export function DealsProductSection({ id, title, summary, icon, href, viewAll, priceNotice, status, loadingLabel, emptyLabel, errorLabel, retryLabel, onRetry, notice, children }: { id: string; title: string; summary: string; icon: ReactNode; href: string; viewAll: string; priceNotice: string; status: string; loadingLabel: string; emptyLabel: string; errorLabel?: string; retryLabel: string; onRetry: () => void; notice?: string; children?: ReactNode }) {
