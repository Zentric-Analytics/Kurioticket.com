...
const hotelResultStackClass = "w-full max-w-[720px]";
...
export function HotelResultsClient() {
  ...
  return (
    <main className="flex-1 overflow-x-clip bg-[#f6f8fb] pb-8 pt-6 sm:pt-8 lg:pt-8">
      ...
      <div className="page-shell grid gap-x-5 gap-y-3 pb-6 pt-3 sm:py-6 lg:gap-x-4 lg:gap-y-3 lg:grid-cols-[240px_minmax(0,720px)_minmax(0,1fr)] xl:grid-cols-[250px_minmax(0,720px)_minmax(0,1fr)]">
