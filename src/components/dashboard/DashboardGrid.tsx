...
function formatSessionTime(value: string, locale: string, recentlyLabel: string) {
                  ...
                  <div key={session.id} className="relative min-w-0 rounded-xl border border-slate-200 p-4 pb-16 sm:pb-4">
                    <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      <div className="min-w-0">
                        ...
                        <p className="mt-1 text-xs leading-5 text-slate-500">Last active {formatSessionTime(session.lastSeenAt, locale, t["accountDashboard.recently"])}</p>
