            ...
            <div className="mx-auto flex w-full max-w-3xl min-w-0 items-stretch gap-2.5">
              ...
              >
                <span className="flex flex-col items-center justify-center gap-1 leading-none">
                  ...
                  <span className="text-indigo-700">Filters</span>
                </span>
              </button>
