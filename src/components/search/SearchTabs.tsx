    ...
    <section className={wrapper}>
      ...
      {tab === "flights" ? (
        <>
          ...
          <form className={cn("grid grid-cols-1 gap-2 md:grid-cols-2 xl:grid-cols-[minmax(140px,1fr)_minmax(140px,1fr)_minmax(120px,1fr)_minmax(120px,1fr)_minmax(130px,1fr)_minmax(130px,1fr)_140px]", isCalendarOpen && "pb-[22rem] md:pb-[20rem]")} onSubmit={(event) => {
