import { compactFareTerms } from "./flightDetailsPresentation";
import type { FlightFareTerm, FlightProviderCondition, TripType } from "../types";
...
/** Builds the shared native-parity fare card's three decision-oriented disclosures. */
