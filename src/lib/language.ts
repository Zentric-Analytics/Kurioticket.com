...
export const uiTranslations = {
  en: {
    ...
    featuresMillionsBody: "Flights and hotels worldwide",
    featuresFlexibleTitle: "Flexible Options",
    featuresFlexibleBody: "Choose what fits your trip",
    featuresSecureTitle: "Secure Payments",
    featuresSecureBody: "100% safe and secure",
    featuresDealsTitle: "Great Deals",
    featuresDealsBody: "Compare more before you buy",
    popularDestinations: "Popular Destinations",
    viewAllDestinations: "View all destinations",
    promoFlightsTitle: "Amazing flight deals just for you",
    promoFlightsBody:
      "Unlock exclusive offers on domestic and international flights.",
    promoFlightsCta: "Explore Flight Deals",
    promoHotelsTitle: "Find your perfect hotel stay",
    promoHotelsBody:
      "From budget to luxury, find hotels that suit your style and budget.",
    promoHotelsCta: "Explore Hotel Deals",
    newsletterTitle: "Get the best travel deals in your inbox",
    newsletterBody: "Subscribe to our newsletter and never miss a deal.",
  ...
  fr: {
    ...
    heroBadge: "Plateforme de recherche de voyage fiable",
    featuresMillionsTitle: "Des millions de choix",
    featuresMillionsBody: "Vols et hôtels dans le monde entier",
    featuresFlexibleTitle: "Options flexibles",
    featuresFlexibleBody: "Choisissez ce qui convient à votre voyage",
    featuresSecureTitle: "Paiements sécurisés",
    featuresSecureBody: "100% sûr et sécurisé",
    featuresDealsTitle: "Super offres",
    featuresDealsBody: "Comparez davantage avant d’acheter",
    popularDestinations: "Destinations populaires",
    viewAllDestinations: "Voir toutes les destinations",
    promoFlightsTitle: "Des offres de vols incroyables pour vous",
    promoFlightsBody:
      "Débloquez des offres exclusives sur les vols nationaux et internationaux.",
    promoFlightsCta: "Voir les offres de vols",
    promoHotelsTitle: "Trouvez votre hôtel idéal",
    promoHotelsBody:
      "Du budget au luxe, trouvez des hôtels adaptés à votre style.",
    promoHotelsCta: "Voir les offres d’hôtels",
    newsletterTitle: "Recevez les meilleures offres de voyage",
    newsletterBody:
  ...
  es: {
    ...
    featuresMillionsBody: "Vuelos y hoteles en todo el mundo",
    featuresFlexibleTitle: "Opciones flexibles",
    featuresFlexibleBody: "Elige lo que se adapte a tu viaje",
    featuresSecureTitle: "Pagos seguros",
    featuresSecureBody: "100% seguro",
    featuresDealsTitle: "Grandes ofertas",
    featuresDealsBody: "Compara más antes de comprar",
    popularDestinations: "Destinos populares",
    viewAllDestinations: "Ver todos los destinos",
    promoFlightsTitle: "Increíbles ofertas de vuelos para ti",
    promoFlightsBody:
      "Desbloquea ofertas exclusivas en vuelos nacionales e internacionales.",
    promoFlightsCta: "Explorar ofertas de vuelos",
    promoHotelsTitle: "Encuentra tu hotel ideal",
    promoHotelsBody:
      "Desde económico hasta lujo, encuentra hoteles para tu estilo.",
    promoHotelsCta: "Explorar ofertas de hoteles",
    newsletterTitle: "Recibe las mejores ofertas de viaje",
    newsletterBody: "Suscríbete a nuestro boletín y no te pierdas ninguna oferta.",
  ...
  ar: {
    ...
    featuresMillionsBody: "رحلات وفنادق حول العالم",
    featuresFlexibleTitle: "خيارات مرنة",
    featuresFlexibleBody: "اختر ما يناسب رحلتك",
    featuresSecureTitle: "مدفوعات آمنة",
    featuresSecureBody: "آمن ومحمي 100%",
    featuresDealsTitle: "عروض رائعة",
    featuresDealsBody: "قارن أكثر قبل الشراء",
    popularDestinations: "الوجهات الشائعة",
    viewAllDestinations: "عرض جميع الوجهات",
    promoFlightsTitle: "عروض رحلات مذهلة لك",
    promoFlightsBody: "اكتشف عروضًا حصرية على الرحلات المحلية والدولية.",
    promoFlightsCta: "استكشف عروض الرحلات",
    promoHotelsTitle: "اعثر على الفندق المثالي",
    promoHotelsBody: "من الاقتصادي إلى الفاخر، اعثر على الفنادق المناسبة لك.",
    promoHotelsCta: "استكشف عروض الفنادق",
    newsletterTitle: "احصل على أفضل عروض السفر",
    newsletterBody: "اشترك في النشرة البريدية ولا تفوت أي عرض.",
...
export function normalizeLanguage(value?: string | null): LanguageCode {
  ...
  if (upper === "EN" || lower === "en" || lower === "en-us") {
    return "en-US";
  }

  if (upper === "GB" || lower === "en-gb") {
    return "en-GB";
  }

  if (upper === "FR" || lower === "fr" || lower === "fr-fr") {
    return "fr-FR";
  }

  if (upper === "ES" || lower === "es" || lower === "es-es") {
    return "es-ES";
  }

  if (upper === "AR" || lower === "ar" || lower === "ar-sa") {
    return "ar-SA";
  }
