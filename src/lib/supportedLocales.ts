...
export const supportedLocales: SupportedLocale[] = [
  ...
  { code: "fr", label: "Français", countryCode: "FR", fallbackText: "FR" },
  { code: "es", label: "Español", countryCode: "ES", fallbackText: "ES" },
  ...
  { code: "ar", label: "العربية", rtl: true, countryCode: "SA", fallbackText: "SA" },
