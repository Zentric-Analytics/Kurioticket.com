...
export const supportedLocales: SupportedLocale[] = [
  {
    ...
    localizedLabels: { "zh-cn": "英语（美国）", ja: "英語（アメリカ合衆国）" },
    direction: "ltr",
    status: "available",
    countryCode: "US",
    fallbackText: "US",
  ...
  },
  {
    ...
    label: "Spanish",
    nativeLabel: "Español",
    localizedLabels: { "zh-cn": "西班牙语", ja: "スペイン語" },
    direction: "ltr",
    status: "available",
    countryCode: "ES",
    fallbackText: "ES",
  ...
  },
  {
    ...
    localizedLabels: { "zh-cn": "法语", ja: "フランス語" },
    direction: "ltr",
    status: "available",
    countryCode: "FR",
    fallbackText: "FR",
  ...
  },
  {
    ...
    label: "German",
    nativeLabel: "Deutsch",
    localizedLabels: { "zh-cn": "德语", ja: "ドイツ語" },
    direction: "ltr",
    status: "available",
    countryCode: "DE",
    fallbackText: "DE",
  ...
  },
  {
    ...
    localizedLabels: { "zh-cn": "意大利语", ja: "イタリア語" },
    direction: "ltr",
    status: "available",
    countryCode: "IT",
    fallbackText: "IT",
  ...
  },
  {
    ...
    localizedLabels: { "zh-cn": "葡萄牙语（巴西）", ja: "ポルトガル語（ブラジル）" },
    direction: "ltr",
    status: "available",
    countryCode: "BR",
    fallbackText: "BR",
  ...
  },
  {
    ...
    localizedLabels: { "zh-cn": "荷兰语", ja: "オランダ語" },
    direction: "ltr",
    status: "available",
    countryCode: "NL",
    fallbackText: "NL",
  ...
  },
  {
    ...
    label: "Arabic",
    nativeLabel: "العربية",
    localizedLabels: { "zh-cn": "阿拉伯语", ja: "アラビア語" },
    direction: "rtl",
    status: "available",
    countryCode: "SA",
    fallbackText: "AR",
  ...
  },
  {
    ...
    nativeLabel: "中文",
    localizedLabels: { "zh-cn": "简体中文", ja: "簡体字中国語" },
    direction: "ltr",
    status: "available",
    countryCode: "CN",
    fallbackText: "CN",
  ...
  },
  {
    ...
    label: "Japanese",
    nativeLabel: "日本語",
    localizedLabels: { "zh-cn": "日语", ja: "日本語" },
    direction: "ltr",
    status: "available",
    countryCode: "JP",
    fallbackText: "JP",
