...
export function getHotelbedsApiMode():HotelbedsApiMode{return readEnum("HOTELBEDS_API_MODE",["test","live"] as const,"live");}
...
export function hasTravelProviderKeys(){return Boolean(process.env.DUFFEL_API_KEY&&process.env.HOTELBEDS_API_KEY&&process.env.HOTELBEDS_SECRET);}
