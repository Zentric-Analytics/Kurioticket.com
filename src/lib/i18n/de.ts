...
export const translations: TranslationDictionary = {
  ...
  "accountDashboard.priceAlerts.description":
    "Zeigen Sie anbieterbasierte Benachrichtigungseinträge an, die in Ihrem Kurioticket-Konto gespeichert sind.",
  "accountDashboard.priceAlerts.empty.title":
    "Noch keine Preisbenachrichtigungen.",
  "accountDashboard.priceAlerts.empty.body":
    "Speichern Sie Suchen oder Routen, um Reisen im Blick zu behalten, die Ihnen wichtig sind.",
  "accountDashboard.priceAlerts.guidance.flight.title":
    "Mit einem Flug beginnen",
  "accountDashboard.priceAlerts.guidance.flight.body":
    "Vergleichen Sie anbieterbasierte Flugoptionen, bevor Sie Reisen oder Routen speichern.",
  "accountDashboard.priceAlerts.guidance.stays.title": "Aufenthalte prüfen",
  "accountDashboard.priceAlerts.guidance.stays.body":
    "Suchen Sie Hotels mit aktuellen Anbieterdetails, bevor Sie etwas zu Ihren Plänen hinzufügen.",
  "accountDashboard.priceAlerts.guidance.organized.title":
    "Planung organisiert halten",
  "accountDashboard.priceAlerts.guidance.organized.body":
    "Ihr Konto zeigt gespeicherte Reisedatensätze ohne erfundene Aktivitäten oder statische Preise.",
  ...
  "accountDashboard.priceAlerts.error.title":
    "Ihre Benachrichtigungen konnten nicht geladen werden. Bitte versuchen Sie es erneut.",
  "accountDashboard.priceAlerts.error.body":
    "Ihre Kontodaten bleiben geschützt. Aktualisieren Sie die Seite oder kehren Sie zu Ihrem Dashboard zurück.",
