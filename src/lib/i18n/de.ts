...
export const translations: TranslationDictionary = {
  ...
  countryCurrencyDescription:
    "Wählen Sie das Land und die Währung aus, die zur Anzeige von Preisen verwendet werden. Flughafenvorschläge verwenden Ihren erkannten Standort.",
  ...
  countryCurrencyPopularCountryAndCurrency: "BELIEBTE LÄNDER UND WÄHRUNGEN",
