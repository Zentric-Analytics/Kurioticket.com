...
export const translations: TranslationDictionary = {
  ...
  "deals.guidedPreview.description": "Geführte Deals-Vorschau: Complete guided Deals preview: Hotel, Flight and Car selection and confirmation, Review, and final partner handoff.",
  "deals.guidedPreview.availableCar": "Geführte Deals-Vorschau: Car results, filters, sorting, details, and confirmation",
  "deals.guidedPreview.availableReview": "Geführte Deals-Vorschau: Trip Review with persisted opened-step progress",
  "deals.guidedPreview.availableHandoff": "Geführte Deals-Vorschau: Final booking-partner handoff for each included product",
  "deals.guidedPreview.previewOnlyTitle": "Geführte Deals-Vorschau: Internal preview limitations",
  "deals.guidedPreview.previewOnlyPublicLaunch": "Geführte Deals-Vorschau: Public activation has not occurred; normal Search remains unchanged.",
  "deals.guidedPreview.previewOnlyBooking": "Geführte Deals-Vorschau: Kurioticket does not complete booking or payment. Complete each provider step separately.",
  "deals.guided.confirmation.readError": "Geführte Deals-Vorschau: Saved preview progress could not be read. Try confirmation again.",
  "deals.guided.confirmation.saveError": "Geführte Deals-Vorschau: Preview progress could not be saved. Try confirmation again.",
  "deals.guided.crossTabUpdated": "Geführte Deals-Vorschau: This trip was updated in another tab.",
  "deals.guided.prerequisiteChanged": "Geführte Deals-Vorschau: An earlier trip choice changed in another tab. Your current saved trip is now shown.",
  "deals.guided.conflict.title": "Geführte Deals-Vorschau: Another guided preview is saved",
  "deals.guided.conflict.body": "Geführte Deals-Vorschau: This page belongs to a different guided search. Its saved progress is protected.",
  "deals.guided.conflict.restart": "Geführte Deals-Vorschau: Start this preview trip again",
  "deals.guided.conflict.restartDisclosure": "Geführte Deals-Vorschau: Starting again replaces the guided-preview progress currently saved in this browser.",
  "deals.guided.error.title": "Geführte Deals-Vorschau: We could not show this guided Deals page",
  "deals.guided.error.body": "Geführte Deals-Vorschau: No booking-partner page was opened. Try again or return safely to Deals.",
  "deals.guided.error.retry": "Geführte Deals-Vorschau: Try again",
  "deals.guided.error.returnDeals": "Geführte Deals-Vorschau: Return to Deals",
  "deals.guided.storageUnavailable.title": "Geführte Deals-Vorschau: Temporary preview storage is unavailable",
  "deals.guided.storageUnavailable.body": "Geführte Deals-Vorschau: This guided stage cannot safely save progress. Restore browser storage and reload.",
  "deals.guided.invalid.title": "Geführte Deals-Vorschau: Saved preview progress is invalid",
  "deals.guided.invalid.body": "Geführte Deals-Vorschau: Return to the first guided stage to choose fresh trip options.",
  "deals.guided.expired.title": "Geführte Deals-Vorschau: Your guided preview has expired",
  "deals.guided.expired.body": "Geführte Deals-Vorschau: Return to the first guided stage and refresh your trip options.",
