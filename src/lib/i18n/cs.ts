...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Cestující",
  "mobileDatePicker.start": "Začátek",
  "mobileDatePicker.end": "Konec",
  deals: "Cestovní balíčky",
  ...
  homeDestinationDubaiCountry: "Spojené arabské emiráty",
  homeDestinationDubaiAlt: "Dubaj, Spojené arabské emiráty",
  homeDestinationLondonCity: "Londýn",
  homeDestinationLondonCountry: "Spojené království",
  homeDestinationLondonAlt: "Londýn, Spojené království",
  homeDestinationParisCity: "Paříž",
  homeDestinationParisCountry: "Francie",
  homeDestinationParisAlt: "Paříž, Francie",
  ...
  homeDestinationNewYorkCountry: "Spojené státy",
  homeDestinationNewYorkAlt: "New York, Spojené státy",
  ...
  "deals.results.title": "Coordinated trip results (cs)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (cs)",
  "deals.results.modify": "Modify search · Coordinated trip results (cs)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (cs)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (cs)",
  "deals.results.viewCars": "View car options · Coordinated trip results (cs)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (cs)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (cs)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (cs)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (cs)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (cs)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (cs)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (cs)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (cs)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (cs)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (cs)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (cs)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (cs)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (cs)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (cs)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (cs)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (cs)",
  ...
  flightSearchDestinationPlaceholderShort: 'Kam?',
};
