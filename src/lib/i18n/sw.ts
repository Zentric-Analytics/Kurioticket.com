...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Wasafiri",
  "mobileDatePicker.start": "Mwanzo",
  "mobileDatePicker.end": "Mwisho",
  deals: "Vifurushi vya safari",
  ...
  homeDestinationDubaiCountry: "Falme za Kiarabu",
  homeDestinationDubaiAlt: "Dubai, Falme za Kiarabu",
  homeDestinationLondonCity: "London",
  homeDestinationLondonCountry: "Uingereza",
  homeDestinationLondonAlt: "London, Uingereza",
  homeDestinationParisCity: "Paris",
  homeDestinationParisCountry: "Ufaransa",
  homeDestinationParisAlt: "Paris, Ufaransa",
  ...
  homeDestinationNewYorkCountry: "Marekani",
  homeDestinationNewYorkAlt: "New York, Marekani",
  ...
  "deals.results.title": "Coordinated trip results (sw)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (sw)",
  "deals.results.modify": "Modify search · Coordinated trip results (sw)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (sw)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (sw)",
  "deals.results.viewCars": "View car options · Coordinated trip results (sw)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (sw)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (sw)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (sw)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (sw)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (sw)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (sw)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (sw)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (sw)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (sw)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (sw)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (sw)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (sw)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (sw)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (sw)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (sw)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (sw)",
  ...
  flightSearchDestinationPlaceholderShort: 'Kwenda wapi?',
};
