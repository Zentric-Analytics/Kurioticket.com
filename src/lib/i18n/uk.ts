...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Мандрівники",
  "mobileDatePicker.start": "Початок",
  "mobileDatePicker.end": "Кінець",
  deals: "Туристичні пакети",
  ...
  homeDestinationDubaiCountry: "Об’єднані Арабські Емірати",
  homeDestinationDubaiAlt: "Дубай, Об’єднані Арабські Емірати",
  homeDestinationLondonCity: "Лондон",
  homeDestinationLondonCountry: "Велика Британія",
  homeDestinationLondonAlt: "Лондон, Велика Британія",
  homeDestinationParisCity: "Париж",
  homeDestinationParisCountry: "Франція",
  homeDestinationParisAlt: "Париж, Франція",
  homeDestinationBaliCity: "Балі",
  homeDestinationBaliCountry: "Індонезія",
  homeDestinationBaliAlt: "Балі, Індонезія",
  ...
  "deals.results.title": "Узгоджені результати подорожі",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Узгоджені результати подорожі",
  "deals.results.modify": "Modify search · Узгоджені результати подорожі",
  "deals.results.viewFlights": "View all flights · Узгоджені результати подорожі",
  "deals.results.viewHotels": "View all hotels · Узгоджені результати подорожі",
  "deals.results.viewCars": "View car options · Узгоджені результати подорожі",
  "deals.results.invalidTitle": "Review your search · Узгоджені результати подорожі",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Узгоджені результати подорожі",
  "deals.results.noResults": "No matching results were found. · Узгоджені результати подорожі",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Узгоджені результати подорожі",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Узгоджені результати подорожі",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Узгоджені результати подорожі",
  "deals.error.flightOriginCode": "Airport selection is required. · Узгоджені результати подорожі",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Узгоджені результати подорожі",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Узгоджені результати подорожі",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Узгоджені результати подорожі",
  "deals.error.flightDates": "Select valid flight dates. · Узгоджені результати подорожі",
  "deals.error.hotelDestination": "Enter a hotel destination. · Узгоджені результати подорожі",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Узгоджені результати подорожі",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Узгоджені результати подорожі",
  "deals.error.hotelDates": "Select valid hotel dates. · Узгоджені результати подорожі",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Узгоджені результати подорожі",
  ...
  flightSearchDestinationPlaceholderShort: 'Куди?',
};
