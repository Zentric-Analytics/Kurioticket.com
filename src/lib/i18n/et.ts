...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Reisijad",
  "mobileDatePicker.start": "Algus",
  "mobileDatePicker.end": "Lõpp",
  deals: "Reisipaketid",
  ...
  homeDestinationDubaiCountry: "Araabia Ühendemiraadid",
  homeDestinationDubaiAlt: "Dubai, Araabia Ühendemiraadid",
  homeDestinationLondonCity: "London",
  homeDestinationLondonCountry: "Ühendkuningriik",
  homeDestinationLondonAlt: "London, Ühendkuningriik",
  homeDestinationParisCity: "Pariis",
  homeDestinationParisCountry: "Prantsusmaa",
  homeDestinationParisAlt: "Pariis, Prantsusmaa",
  homeDestinationBaliCity: "Bali",
  homeDestinationBaliCountry: "Indoneesia",
  homeDestinationBaliAlt: "Bali, Indoneesia",
  homeDestinationNewYorkCity: "New York",
  homeDestinationNewYorkCountry: "Ameerika Ühendriigid",
  homeDestinationNewYorkAlt: "New York, Ameerika Ühendriigid",
  ...
  "deals.results.title": "Coordinated trip results (et)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (et)",
  "deals.results.modify": "Modify search · Coordinated trip results (et)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (et)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (et)",
  "deals.results.viewCars": "View car options · Coordinated trip results (et)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (et)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (et)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (et)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (et)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (et)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (et)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (et)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (et)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (et)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (et)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (et)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (et)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (et)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (et)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (et)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (et)",
  ...
  flightSearchDestinationPlaceholderShort: 'Kuhu?',
};
