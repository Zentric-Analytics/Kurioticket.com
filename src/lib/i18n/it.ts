...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Viaggiatori",
  "mobileTravelerCabin.title": "Viaggiatori e cabina",
  "mobileTravelerCabin.adultDescription": "18 anni e oltre",
  "mobileTravelerCabin.childDescription": "Da 2 a 17 anni",
  "mobileTravelerCabin.infantDescription": "Meno di 2 anni",
  "mobileTravelerCabin.tip": "Suggerimento",
  "mobileTravelerCabin.baggageTip": "La franchigia bagaglio può variare in base alla compagnia aerea. Controlla i dettagli sulla pagina del fornitore.",
  "mobileDatePicker.start": "Inizio",
  "mobileDatePicker.end": "Fine",
  "deals.guided.confirmation.retry": "Riprova",
  "deals.guidedPreview.description": "Anteprima guidata delle Offerte: Complete guided Pacchetti preview: Hotel, Flight and Car selection and confirmation, Review, and final partner handoff.",
  "deals.guidedPreview.availableCar": "Anteprima guidata delle Offerte: Car results, filters, sorting, details, and confirmation",
  "deals.guidedPreview.availableReview": "Anteprima guidata delle Offerte: Trip Review with persisted opened-step progress",
  "deals.guidedPreview.availableHandoff": "Anteprima guidata delle Offerte: Final booking-partner handoff for each included product",
  "deals.guidedPreview.previewOnlyTitle": "Anteprima guidata delle Offerte: Internal preview limitations",
  "deals.guidedPreview.previewOnlyPublicLaunch": "Anteprima guidata delle Offerte: Public activation has not occurred; normal Search remains unchanged.",
  "deals.guidedPreview.previewOnlyBooking": "Anteprima guidata delle Offerte: Kurioticket does not complete booking or payment. Complete each provider step separately.",
  "deals.guided.confirmation.readError": "Anteprima guidata delle Offerte: Saved preview progress could not be read. Try confirmation again.",
  "deals.guided.confirmation.saveError": "Anteprima guidata delle Offerte: Preview progress could not be saved. Try confirmation again.",
  "deals.guided.crossTabUpdated": "Anteprima guidata delle Offerte: This trip was updated in another tab.",
  "deals.guided.prerequisiteChanged": "Anteprima guidata delle Offerte: An earlier trip choice changed in another tab. Your current saved trip is now shown.",
  "deals.guided.conflict.title": "Anteprima guidata delle Offerte: Another guided preview is saved",
  "deals.guided.conflict.body": "Anteprima guidata delle Offerte: This page belongs to a different guided search. Its saved progress is protected.",
  "deals.guided.conflict.restart": "Anteprima guidata delle Offerte: Start this preview trip again",
  "deals.guided.conflict.restartDisclosure": "Anteprima guidata delle Offerte: Starting again replaces the guided-preview progress currently saved in this browser.",
  "deals.guided.error.title": "Anteprima guidata delle Offerte: We could not show this guided Pacchetti page",
  "deals.guided.error.body": "Anteprima guidata delle Offerte: No booking-partner page was opened. Try again or return safely to Pacchetti.",
  "deals.guided.error.retry": "Anteprima guidata delle Offerte: Try again",
  "deals.guided.error.returnDeals": "Anteprima guidata delle Offerte: Return to Pacchetti",
  "deals.guided.storageUnavailable.title": "Anteprima guidata delle Offerte: Temporary preview storage is unavailable",
  "deals.guided.storageUnavailable.body": "Anteprima guidata delle Offerte: This guided stage cannot safely save progress. Restore browser storage and reload.",
  "deals.guided.invalid.title": "Anteprima guidata delle Offerte: Saved preview progress is invalid",
  "deals.guided.invalid.body": "Anteprima guidata delle Offerte: Return to the first guided stage to choose fresh trip options.",
  "deals.guided.expired.title": "Anteprima guidata delle Offerte: Your guided preview has expired",
  "deals.guided.expired.body": "Anteprima guidata delle Offerte: Return to the first guided stage and refresh your trip options.",
  "metadata.root.title.default": "Kurioticket | Trova voli economici velocemente",
  "metadata.root.description": "Confronta voli e hotel convenienti in pochi secondi con una piattaforma di decisione di viaggio più serena.",
  destinationsLoadingPage: "Caricamento della pagina delle destinazioni...",
  "brandedLoading.default.title": "Caricamento di Kurioticket...",
  "brandedLoading.default.preparingExperience": "Preparazione della tua esperienza...",
  ...
  contactMetadataTitle: "Contatta Kurioticket",
  ...
  exploreWaysTitle: "Modi per esplorare",
  exploreWaysRouteTitle: "Scoperta delle rotte",
  exploreWaysRouteText: "Inizia con una rotta di volo, poi confronta orari, scali e opzioni dei fornitori quando i risultati sono disponibili.",
  exploreWaysHotelsTitle: "Idee per destinazioni hotel",
  exploreWaysHotelsText: "Usa ricerche hotel basate sulla destinazione per confrontare opzioni di soggiorno, posizioni e termini di cancellazione.",
  exploreWaysSavedTitle: "Viaggi salvati e ricerche recenti",
  exploreWaysSavedText: "Torna alle rotte e alle ricerche già iniziate così la pianificazione resta organizzata in più sessioni.",
  exploreWaysBasicsTitle: "Basi della pianificazione di viaggio",
  exploreWaysBasicsText: "Valuta tempi, flessibilità, bagagli, necessità di alloggio e politiche dei fornitori prima di impegnarti.",
  exploreNeedsTitle: "Pianifica in base all’esigenza di viaggio",
  exploreNeedsWeekendTitle: "Weekend in città",
  exploreNeedsWeekendText: "Confronta rotte più brevi, orari semplici e posizioni degli hotel adatte a poco tempo fuori.",
  exploreNeedsInternationalTitle: "Viaggi internazionali",
  exploreNeedsInternationalText: "Controlla con attenzione gli itinerari più lunghi, inclusi tempo totale di viaggio, scali, requisiti di ingresso e termini del fornitore.",
  exploreNeedsHotelFirstTitle: "Pianificazione prima dall’hotel",
  exploreNeedsHotelFirstText: "Inizia da dove vuoi soggiornare, poi organizza voli e altri elementi del viaggio intorno a quella posizione.",
  exploreNeedsCompleteTitle: "Pianificazione completa del viaggio",
  exploreNeedsCompleteText: "Usa insieme voli, hotel, viaggi salvati e ricerche recenti per mantenere chiaro il quadro completo del viaggio.",
  exploreChecklistTitle: "Prima di prenotare",
  exploreChecklistTime: "Confronta tempo totale di viaggio e scali",
  exploreChecklistBaggage: "Controlla bagagli e flessibilità",
  exploreChecklistHotel: "Verifica posizione dell’hotel e regole di cancellazione",
  exploreChecklistProvider: "Conferma prezzo finale e disponibilità con il fornitore",
  exploreChecklistSave: "Salva rotte o ricerche per dopo",
  explorePrimaryCta: "Cerca voli",
  exploreSecondaryCta: "Cerca hotel",
  exploreSavedCta: "Vedi viaggi salvati",
  twoFactorLoadingChallenge: "Caricamento della verifica a due fattori…",
  twoFactorEyebrow: "Autenticazione a due fattori",
  twoFactorTitle: "Inserisci il codice dell’app di autenticazione",
  twoFactorSubtitle: "Usa il codice a 6 cifre della tua app di autenticazione oppure inserisci un codice di recupero salvato per completare l’accesso.",
  twoFactorCodeLabel: "Codice di autenticazione o di recupero",
  twoFactorHelperText: "Apri la tua app di autenticazione e inserisci il codice attuale a 6 cifre, oppure usa un codice di recupero.",
  twoFactorInvalidCode: "Il codice non è valido o è già stato utilizzato.",
  twoFactorVerifying: "Verifica…",
  twoFactorSubmit: "Verifica e continua",
  twoFactorBackToLogin: "Indietro / esci",
  loginDivider: "OPPURE",
  ...
  "guides.metadata.best-time-to-book-flights.title": "Momento migliore per prenotare voli",
  "guides.metadata.best-time-to-book-flights.description": "Scopri quando prenotare voli, confrontare i tempi delle tariffe ed evitare di pagare troppo per il tuo prossimo viaggio.",
  "guides.metadata.how-to-avoid-risky-layovers.title": "Come evitare scali rischiosi",
  "guides.metadata.how-to-avoid-risky-layovers.description": "Scopri come confrontare tempi di scalo, cambi di aeroporto e rischi di coincidenza prima di prenotare.",
  "guides.metadata.how-to-compare-baggage-inclusive-fares.title": "Come confrontare tariffe con bagaglio incluso",
  "guides.metadata.how-to-compare-baggage-inclusive-fares.description": "Scopri come confrontare tariffe con bagaglio incluso affinché il biglietto più economico non diventi più costoso in seguito.",
  "guides.articleEyebrow": "Articolo di pianificazione del viaggio",
  "guides.articleBody": "Usa questa guida per organizzare i dettagli del viaggio, confrontare gli aspetti da considerare e continuare con gli strumenti di ricerca voli e hotel di Kurioticket.",
  ...
  mobileInfoLegalHeading: "Info e aspetti legali",
  mobileExploreHeading: "Esplora",
  ...
  verifyEmailInvalidCode: "Il codice di verifica non è valido o è scaduto.",
  verifyEmailSubmit: "Verifica e-mail",
  verifyEmailSending: "Invio in corso...",
  verifyEmailSendNewCode: "Invia un nuovo codice",
  verifyEmailResendSuccess: "Se questa e-mail richiede la verifica, è stato inviato un nuovo codice.",
  verifyEmailAlreadyVerified: "Già verificata?",
  verifyEmailLoginLink: "Accedi",
  verifyEmailResend: "Invia di nuovo il codice",
  verifyEmailSuccess: "E-mail verificata con successo.",
  verifyEmailVerifying: "Verifica in corso...",
  ...
  "accountMenu.recentSearches.label": "Ricerche recenti",
  ...
  "accountDashboard.priceAlerts.title": "Avvisi di prezzo",
  "accountDashboard.priceAlerts.description": "Monitora i prezzi e ricevi una notifica quando le tariffe cambiano.",
  ...
  "accountDashboard.priceAlerts.empty.title": "Non ci sono ancora avvisi di prezzo.",
  "accountDashboard.priceAlerts.empty.body": "Crea un avviso da una ricerca voli per monitorare le variazioni delle tariffe e ricevere notifiche.",
  ...
  "accountDashboard.priceAlerts.filtersAriaLabel": "Filtri degli avvisi di prezzo",
  "accountDashboard.priceAlerts.featuresAriaLabel": "Funzioni degli avvisi di prezzo",
  "accountDashboard.priceAlerts.tabs.active": "Attivi",
  "accountDashboard.priceAlerts.tabs.triggered": "Scaduti",
  "accountDashboard.priceAlerts.tabs.all": "Tutti",
  "accountDashboard.priceAlerts.sort.label": "Ordina per",
  "accountDashboard.priceAlerts.sort.ariaLabel": "Ordina avvisi di prezzo",
  "accountDashboard.priceAlerts.sort.newest": "Più recenti",
  ...
  "accountDashboard.priceAlerts.features.trends.body": "Scopri come cambiano nel tempo le tariffe monitorate.",
  "accountDashboard.priceAlerts.features.management.title": "Gestione semplice",
  ...
  countryCurrencyDescription: "Scegli il paese e la valuta usati per prezzi e preferenze regionali.",
  ...
  "accountDashboard.trips.summary": "{{total}} viaggi totali. {{upcoming}} imminenti, {{past}} passati, {{cancelled}} cancellati.",
  "accountDashboard.trips.state.loading": "Caricamento dei tuoi viaggi...",
  "accountDashboard.trips.state.unauthenticated.title": "Accedi per vedere i tuoi viaggi",
  "accountDashboard.trips.state.unauthenticated.body": "I tuoi viaggi sono collegati al tuo account. Accedi, poi torna qui per gestire prenotazioni imminenti, passate e cancellate.",
  "accountDashboard.trips.state.error.title": "Impossibile caricare i viaggi",
  "accountDashboard.trips.state.error.body": "Non siamo riusciti a caricare i tuoi viaggi. Riprova.",
  "accountDashboard.trips.state.error.retry": "Riprova",
  "accountDashboard.trips.state.error.retryAriaLabel": "Riprova a caricare i viaggi",
  "accountDashboard.trips.lookup.unauthenticated": "Accedi per cercare una prenotazione.",
  "accountDashboard.trips.lookup.error": "Non siamo riusciti a cercare quella prenotazione. Riprova.",
  "accountDashboard.trips.lookup.found": "Prenotazione trovata.",
  "accountDashboard.trips.card.bookingReference": "Riferimento prenotazione",
  "accountDashboard.trips.card.departure": "Partenza",
  "accountDashboard.trips.card.return": "Ritorno",
  "accountDashboard.trips.card.passengers": "Passeggeri",
  "accountDashboard.trips.card.total": "Totale",
  "accountDashboard.trips.card.viewDetails": "Vedi dettagli",
  "accountDashboard.trips.card.unknownDestination": "Destinazione sconosciuta",
  "accountDashboard.trips.status.upcoming": "Imminenti",
  ...
  "accountDashboard.preferences.customization.title": "Preferenze di personalizzazione",
  "accountDashboard.preferences.customization.description": "Scegli come Kurioticket personalizza la tua esperienza.",
  "accountDashboard.preferences.customization.languageRegion.title": "Lingua e regione",
  "accountDashboard.preferences.customization.languageRegion.description": "Imposta lingua, valuta e regione predefinite.",
  "accountDashboard.preferences.customization.preferredLanguage": "Lingua preferita",
  "accountDashboard.preferences.customization.selectPreferredLanguage": "Seleziona lingua preferita",
  "accountDashboard.preferences.customization.currency": "Valuta",
  "accountDashboard.preferences.customization.selectCurrency": "Seleziona valuta",
  "accountDashboard.preferences.customization.region": "Regione",
  "accountDashboard.preferences.customization.selectRegion": "Seleziona regione",
  "accountDashboard.preferences.customization.personalization.title": "Personalizzazione",
  "accountDashboard.preferences.customization.personalization.description": "Controlla come Kurioticket personalizza i tuoi consigli.",
  "accountDashboard.preferences.customization.personalizeSearches": "Usa le mie ricerche per personalizzare i consigli",
  "accountDashboard.preferences.customization.personalizedTravelPacchetti": "Mostra offerte di viaggio personalizzate",
  "accountDashboard.preferences.customization.rememberRecentSearches": "Ricorda le mie ricerche recenti",
  "accountDashboard.preferences.customization.communicationStyle.title": "Stile di comunicazione",
  "accountDashboard.preferences.customization.communicationStyle.description": "Scegli come vuoi che Kurioticket comunichi con te.",
  "accountDashboard.preferences.customization.emailUpdates": "Aggiornamenti via e-mail",
  "accountDashboard.preferences.customization.priceAlertEmails": "E-mail sugli avvisi di prezzo",
  "accountDashboard.preferences.customization.travelInspirationEmails": "E-mail di ispirazione per i viaggi",
  "accountDashboard.preferences.customization.language.english": "Inglese",
  "accountDashboard.preferences.customization.language.spanish": "Spagnolo",
  "accountDashboard.preferences.customization.language.french": "Francese",
  "accountDashboard.preferences.customization.language.german": "Tedesco",
  "accountDashboard.preferences.customization.language.portuguese": "Portoghese",
  "accountDashboard.preferences.customization.language.dutch": "Olandese",
  "accountDashboard.preferences.customization.currency.usd": "Dollaro statunitense (USD)",
  "accountDashboard.preferences.customization.currency.eur": "Euro (EUR)",
  "accountDashboard.preferences.customization.currency.gbp": "Sterlina britannica (GBP)",
  "accountDashboard.preferences.customization.currency.cad": "Dollaro canadese (CAD)",
  "accountDashboard.preferences.customization.currency.aud": "Dollaro australiano (AUD)",
  "accountDashboard.preferences.customization.region.unitedStates": "Stati Uniti",
  "accountDashboard.preferences.customization.region.canada": "Canada",
  "accountDashboard.preferences.customization.region.unitedKingdom": "Regno Unito",
  ...
  "accountDashboard.preferences.booking.title": "Preferenze di prenotazione",
  "accountDashboard.preferences.booking.description": "Imposta le tue preferenze di viaggio predefinite per prenotazioni più rapide e pertinenti.",
  "accountDashboard.preferences.booking.airports.title": "Aeroporti",
  "accountDashboard.preferences.booking.airports.description": "Scegli gli aeroporti da cui preferisci partire.",
  "accountDashboard.preferences.booking.homeAirport": "Aeroporto di partenza",
  "accountDashboard.preferences.booking.searchAirport": "Cerca aeroporto",
  "accountDashboard.preferences.booking.secondaryAirports": "Aeroporti secondari",
  "accountDashboard.preferences.booking.addAlternativeAirports": "Aggiungi aeroporti alternativi",
  "accountDashboard.preferences.booking.airlines.title": "Compagnie aeree",
  "accountDashboard.preferences.booking.airlines.description": "Scegli le compagnie aeree che preferisci o vuoi evitare.",
  "accountDashboard.preferences.booking.preferredAirlines": "Compagnie aeree preferite",
  "accountDashboard.preferences.booking.searchAirlines": "Cerca compagnie aeree",
  "accountDashboard.preferences.booking.avoidAirlines": "Evita compagnie aeree",
  "accountDashboard.preferences.booking.stays.title": "Soggiorni",
  "accountDashboard.preferences.booking.stays.description": "Imposta le preferenze di alloggio per le prenotazioni hotel.",
  "accountDashboard.preferences.booking.preferredHotelChains": "Catene alberghiere preferite",
  "accountDashboard.preferences.booking.searchHotelChains": "Cerca catene alberghiere",
  "accountDashboard.preferences.booking.avoidHotelChains": "Evita catene alberghiere",
  "accountDashboard.preferences.cancel": "Annulla",
  "accountDashboard.preferences.savePreferences": "Salva preferenze",
  "account.pendingDeletion.eyebrow": "Bentornato",
  "account.pendingDeletion.title": "L’eliminazione del tuo account è in sospeso.",
  "account.pendingDeletion.scheduledPrefix": "Il tuo account è programmato per l’eliminazione permanente il",
  "account.pendingDeletion.reactivateNotice": "Puoi riattivare il tuo account prima di questa data. Fino ad allora, la normale navigazione nella dashboard è limitata.",
  "account.pendingDeletion.helperBefore": "Bentornato. Facendo clic su Riattiva account, l’eliminazione viene annullata prima del",
  "account.pendingDeletion.helperAfter": "e viene ripristinato il normale accesso all’app.",
  "account.pendingDeletion.error.reactivate": "Impossibile riattivare l’account.",
  "account.pendingDeletion.error.expired": "La finestra di riattivazione di 7 giorni è scaduta. Contatta l’assistenza.",
  "account.pendingDeletion.action.reactivating": "Riattivazione…",
  "account.pendingDeletion.action.reactivate": "Riattiva account",
  "account.pendingDeletion.action.logout": "Esci",
  ...
  "accountDashboard.personalDetails.description": "Gestisci le informazioni che Kurioticket usa per il tuo account.",
  ...
  "accountDashboard.personalDetails.section.basicInformation": "Informazioni di base",
  ...
  "accountDashboard.personalDetails.section.address": "Indirizzo",
  ...
  "accountDashboard.personalDetails.emailVerified": "Verificato",
  "accountDashboard.personalDetails.changeEmail": "Cambia e-mail",
  "accountDashboard.personalDetails.emailHelper": "Questa e-mail viene usata per l’accesso e le conferme di prenotazione. Le modifiche richiedono la verifica.",
  "accountDashboard.personalDetails.phoneHelper": "Useremo questo numero per gli aggiornamenti sulle prenotazioni.",
  ...
  "accountDashboard.personalDetails.addressDescription": "Usato per fatturazione, registri di prenotazione e comunicazioni di viaggio.",
  "accountDashboard.personalDetails.countryRegion": "Paese/regione",
  "accountDashboard.personalDetails.selectOne": "Seleziona un’opzione",
  "accountDashboard.personalDetails.streetAddress": "Indirizzo",
  "accountDashboard.personalDetails.apartmentSuite": "Appartamento, suite, unità, edificio",
  "accountDashboard.personalDetails.townCity": "Paese / città",
  "accountDashboard.personalDetails.stateProvinceRegion": "Stato / provincia / regione",
  "accountDashboard.personalDetails.postcodeZip": "Codice postale",
  ...
  forgotPasswordMetadataTitle: "Password dimenticata",
  ...
  homepageFaqViewAll: "Vedi tutte le domande frequenti",
  ...
  "deals.loadingPage": "Caricamento pagina...",
  "deals.decreaseCountAria": "Diminuisci {{label}}",
  "deals.increaseCountAria": "Aumenta {{label}}",
  ...
  "deals.destination.tokyo.imageAlt": "Skyline di Tokyo con fitti grattacieli di giorno",
  "deals.destination.london.city": "Londra",
  "deals.destination.london.country": "Regno Unito",
  "deals.destination.london.imageAlt": "Tower Bridge e Tamigi a Londra sotto un cielo azzurro",
  "deals.destination.paris.city": "Parigi",
  "deals.destination.paris.country": "Francia",
  "deals.destination.paris.imageAlt": "Torre Eiffel e Senna a Parigi all’ora dorata",
  "deals.destination.dubai.city": "Dubai",
  "deals.destination.dubai.country": "Emirati Arabi Uniti",
  "deals.destination.dubai.imageAlt": "Skyline di Dubai con il Burj Khalifa sopra i grattacieli",
  "deals.destination.cancun.city": "Cancun",
  "deals.destination.cancun.country": "Messico",
  "deals.destination.cancun.imageAlt": "Spiaggia di Cancún con sabbia bianca e acqua turchese",
  "deals.destination.rome.city": "Roma",
  "deals.destination.rome.country": "Italia",
  "deals.destination.rome.imageAlt": "Il Colosseo a Roma sotto un cielo azzurro limpido",
  ...
  "legal.index.heroLabel": "Informazioni legali",
  "legal.index.heroTitle": "Centro legale",
  "legal.index.heroDescription": "Le risorse legali di Kurioticket spiegano come funzionano le nostre pratiche per ricerca viaggi, account, privacy, reindirizzamenti ai fornitori e conformità.",
  "legal.index.compliance.eyebrow": "AZIENDA E CONFORMITÀ",
  "legal.index.compliance.sellerOfTravel": "Venditore di viaggi della California",
  "legal.index.compliance.registrationNumberLabel": "N. registrazione",
  "legal.index.compliance.registrationExpires": "Scadenza registrazione",
  "legal.index.compliance.registrationExpiresDate": "5 giugno 2027",
  "legal.index.compliance.publicNotice": "La registrazione come venditore di viaggi non costituisce approvazione da parte dello Stato della California.",
  "legal.index.contacts.support": "Supporto",
  "legal.index.contacts.legal": "Legale",
  "legal.index.contacts.privacy": "Privacy",
  "legal.index.resourcesEyebrow": "Risorse ufficiali",
  "legal.index.resourcesTitle": "Documenti legali",
  "legal.index.documentsCountLabel": "informative e avvisi disponibili",
  "legal.index.documents.privacyChoices.title": "Scelte sulla privacy",
  "legal.index.documents.privacyChoices.summary": "Informazioni localizzate per questo documento legale di Kurioticket.",
  "legal.index.documents.californiaSellerOfTravelNotice.title": "Avviso California Seller of Travel",
  "legal.index.documents.californiaSellerOfTravelNotice.summary": "Informazioni localizzate per questo documento legale di Kurioticket.",
  "legal.index.documents.legalNoticeCompanyInformation.title": "Avviso legale e informazioni aziendali",
  "legal.index.documents.legalNoticeCompanyInformation.summary": "Informazioni localizzate per questo documento legale di Kurioticket.",
  "legal.index.documents.securityStatement.title": "Dichiarazione sulla sicurezza",
  "legal.index.documents.securityStatement.summary": "Informazioni localizzate per questo documento legale di Kurioticket.",
  "legal.index.documents.accessibilityStatement.title": "Dichiarazione di accessibilità",
  "legal.index.documents.accessibilityStatement.summary": "Informazioni localizzate per questo documento legale di Kurioticket.",
  ...
  "legal.partnerRedirectDisclaimer.developerNote":
    "Questi documenti legali sono bozze provvisorie per una startup e devono essere revisionati da un consulente legale qualificato prima di un lancio pubblico su larga scala.",
  "legal.californiaSellerOfTravelNotice.title": "Avviso California Seller of Travel",
  "legal.californiaSellerOfTravelNotice.summary": "Avviso di registrazione California Seller of Travel per la piattaforma di ricerca e reindirizzamento viaggi di Kurioticket.",
  "legal.californiaSellerOfTravelNotice.lastUpdatedDate": "June 28, 2026",
  "legal.californiaSellerOfTravelNotice.tableOfContents": "INDICE",
  "legal.californiaSellerOfTravelNotice.sections.registration.title": "Informazioni di registrazione",
  "legal.californiaSellerOfTravelNotice.sections.registration.paragraph1": "Kurioticket LLC è registrata come California Seller of Travel con numero di registrazione 2151995-40.",
  "legal.californiaSellerOfTravelNotice.sections.registration.paragraph2": "Registrazione valida dal June 27, 2026. La registrazione scade il June 30, 2027.",
  "legal.californiaSellerOfTravelNotice.sections.registration.paragraph3": "La registrazione come venditore di viaggi non costituisce approvazione da parte dello Stato della California.",
  "legal.californiaSellerOfTravelNotice.sections.platform-model.title": "Modello di ricerca e reindirizzamento",
  "legal.californiaSellerOfTravelNotice.sections.platform-model.paragraph1": "Kurioticket LLC gestisce una piattaforma di ricerca, confronto e reindirizzamento viaggi per flights, hotels, and rental cars. Kurioticket aiuta gli utenti a confrontare opzioni di viaggio e a passare a fornitori terzi per le fasi finali della prenotazione.",
  "legal.californiaSellerOfTravelNotice.sections.platform-model.paragraph2": "Kurioticket non è una compagnia aerea, un hotel, un'agenzia di viaggi online, un'agenzia di viaggi, un elaboratore di pagamenti per acquisti di viaggio né un emittente di biglietti.",
  "legal.californiaSellerOfTravelNotice.sections.provider-responsibilities.title": "Responsabilità dei fornitori terzi",
  "legal.californiaSellerOfTravelNotice.sections.provider-responsibilities.paragraph1": "I fornitori terzi gestiscono la prenotazione finale, il pagamento, la conferma, la cancellazione, i rimborsi, le modifiche, il bagaglio, il check-in e il supporto alla prenotazione dopo il passaggio da Kurioticket al sito del fornitore.",
  "legal.californiaSellerOfTravelNotice.sections.provider-responsibilities.paragraph2": "Prima di acquistare, verifica sul sito del fornitore terzo il prezzo finale, la disponibilità, le regole tariffarie, le condizioni della camera o del veicolo, le politiche di cancellazione, le politiche di rimborso, le regole sui bagagli, i requisiti di check-in e i termini del servizio clienti.",
  "legal.californiaSellerOfTravelNotice.sections.contact.title": "Contatto",
  ...
  "legal.californiaSellerOfTravelNotice.sections.contact.paragraph2": "Per il supporto della piattaforma contatta support@kurioticket.com. Per questioni legali contatta legal@kurioticket.com. Per questioni di privacy contatta privacy@kurioticket.com.",
  "legal.californiaSellerOfTravelNotice.developerNote": "Queste bozze di documenti legali sono materiali iniziali di lavoro e dovrebbero essere esaminate da un consulente legale qualificato prima di un lancio pubblico su larga scala.",
  footerAboutKurioticket: "Informazioni su Kurioticket",
  footerAboutUs: "Chi siamo",
  footerHowItWorks: "Come funziona Kurioticket",
  footerAbout:
    "Cerca voli e hotel gratuitamente, confronta i prezzi di partner affidabili e prendi decisioni di viaggio con più serenità.",
  footerMeta: "Kurioticket è una piattaforma di metaricerca viaggi.",
  ...
  selectDateAriaPrefix: "Seleziona data",
  ...
  "hotelDestinationKind.city": "Città",
  "hotelDestinationKind.district": "Area",
  "hotelDestinationKind.landmark": "Punto di interesse",
  "hotelDestinationKind.airport-area": "Zona aeroporto",
  ...
  "hotelGuests.adultDescription": "Dai 18 anni",
  "hotelGuests.childDescription": "Da 0 a 17 anni",
  "hotelGuests.roomDescription": "Camere separate",
  ...
  filterBy: "Filtra per",
  "hotelResults.openFilters": "Apri filtri",
  "hotelResults.selectDateAriaPrefix": "Seleziona",
  "hotelResults.searchingHotelPartners": "Ricerca partner hotel in corso...",
  ...
  "hotelResults.unableToSearchHotels": "Impossibile cercare hotel.",
  "hotelResults.unableToOpenProvider": "Impossibile aprire il provider al momento. Riprova.",
  "hotelResults.limitedProviderChecks": "Alcune verifiche dei partner potrebbero essere limitate per questa ricerca hotel. Controlla disponibilità finale, tasse, commissioni e regole di cancellazione con il partner prima di prenotare.",
  "hotelResults.noStaysMatchFiltersTitle": "Nessun soggiorno corrisponde a questi filtri",
  "hotelResults.noStaysMatchFiltersBody": "Prova ad aumentare la fascia di prezzo, abbassare la categoria o cancellare i filtri hotel selezionati per vedere più opzioni disponibili.",
  "hotelResults.noStaysMatchFiltersInline": "Nessun soggiorno corrisponde a questi filtri. Amplia i filtri per vedere più opzioni disponibili.",
  "hotelResults.resetFilters": "Reimposta filtri",
  "hotelResults.foundPlacesToStay": "Abbiamo trovato {{count}} sistemazioni per te",
  "hotelResults.summaryAria": "Riepilogo risultati hotel",
  "hotelResults.cheapest": "PIÙ ECONOMICO",
  "hotelResults.lowestTotalPrice": "Prezzo totale più basso",
  "hotelResults.bestValue": "MIGLIOR RAPPORTO QUALITÀ-PREZZO",
  "hotelResults.bestBalance": "Miglior equilibrio",
  "hotelResults.topRated": "PIÙ VOTATO",
  "hotelResults.highestRating": "Valutazione più alta",
  "hotelResults.valueScore": "punteggio {{score}}/100",
  "hotelResults.recommended": "Consigliato",
  "hotelResults.starSingular": "{{count}} stella",
  "hotelResults.starPlural": "{{count}} stelle",
  "hotelResults.activeHotelFilters": "Filtri hotel attivi",
  "hotelResults.removeFilter": "Rimuovi filtro {{label}}",
  "hotelResults.filterBy": "Filtra per",
  "hotelResults.budgetPrice": "Budget / Prezzo",
  "hotelResults.totalUpTo": "Totale fino a",
  "hotelResults.popularFilters": "Filtri popolari",
  "hotelResults.starRating": "Categoria",
  "hotelResults.fromRating": "Da",
  "hotelResults.locationArea": "Posizione / Area",
  "hotelResults.propertyType": "Tipo di struttura",
  "hotelResults.roomType": "Tipo di camera",
  "hotelResults.bedType": "Tipo di letto",
  "hotelResults.meals": "Pasti",
  "hotelResults.cancellationPolicy": "Politica di cancellazione",
  "hotelResults.facilities": "Servizi",
  "hotelResults.showLess": "Mostra meno",
  "hotelResults.showMore": "Mostra altro ({{count}})",
  "hotelResults.upToPrice": "Fino a {{price}}",
  "hotelResults.starsAndUp": "{{rating}}+ stelle",
  "hotelResults.nonRefundable": "Non rimborsabile",
  "hotelResults.payAtProperty": "Paga in struttura",
  "hotelResults.payLater": "Paga più tardi",
  "hotelResults.noPrepayment": "Nessun pagamento anticipato",
  "hotelResults.refundable": "Rimborsabile",
  "hotelResults.hotelImageAlt": "Opzione di soggiorno {{name}}{{location}}",
  "hotelResults.nearLocation": "vicino a {{location}}",
  "hotelResults.imageUnavailable": "Immagine non disponibile",
  "hotelResults.starHotelAria": "Hotel {{rating}} stelle",
  "hotelResults.estimatedStayTotal": "totale soggiorno stimato",
  "hotelResults.pricePerNight": "{{price}} per notte",
  "hotelResults.viewHotel": "Vedi hotel",
  "hotelResults.filter.freeWifi": "Wi-Fi gratuito",
  "hotelResults.filter.breakfastIncludedAvailable": "Colazione inclusa/disponibile",
  "hotelResults.filter.freeCancellation": "Cancellazione gratuita",
  "hotelResults.filter.parking": "Parcheggio",
  "hotelResults.filter.pool": "Piscina",
  "hotelResults.filter.airportShuttle": "Navetta aeroportuale",
  "hotelResults.filter.bedAndBreakfast": "Pernottamento e colazione",
  "hotelResults.filter.roomOnly": "Solo camera",
  "hotelResults.filter.halfBoard": "Mezza pensione",
  "hotelResults.filter.fullBoard": "Pensione completa",
  "hotelResults.filter.allInclusive": "Tutto incluso",
  "hotelResults.filter.flexibleCancellation": "Cancellazione flessibile",
  "hotelResults.filter.cancellationPolicyAvailable": "Politica di cancellazione disponibile",
  "hotelResults.filter.spa": "Centro benessere",
  "hotelResults.filter.fitnessCenter": "Centro fitness",
  "hotelResults.filter.workspace": "Spazio di lavoro",
  "hotelResults.filter.quietRooms": "Camere silenziose",
  "hotelResults.filter.frontDesk24": "Reception 24 ore su 24",
  "hotelResults.filter.lateCheckIn": "Check-in tardivo",
  "hotelResults.filter.hotel": "Struttura alberghiera",
  "hotelResults.filter.apartment": "Appartamento",
  "hotelResults.filter.resort": "Villaggio turistico",
  "hotelResults.filter.suites": "Suite",
  "hotelResults.filter.inn": "Locanda",
  "hotelResults.filter.hostel": "Ostello",
  "hotelResults.filter.villa": "Villetta",
  "hotelResults.filter.cityCentre": "Centro città",
  "hotelResults.filter.airportArea": "Zona aeroporto",
  "hotelResults.filter.businessDistrict": "Quartiere business",
  "hotelResults.filter.nearAttractions": "Vicino alle attrazioni",
  "hotelResults.filter.residentialArea": "Zona residenziale",
  "hotelResults.filter.singleRoom": "Camera singola",
  "hotelResults.filter.doubleRoom": "Camera doppia",
  "hotelResults.filter.twinRoom": "Camera con letti singoli",
  "hotelResults.filter.familyRoom": "Camera familiare",
  "hotelResults.filter.standardRoom": "Camera standard",
  "hotelResults.filter.deluxeRoom": "Camera deluxe",
  "hotelResults.filter.studio": "Monolocale",
  "hotelResults.filter.twinBeds": "Letti singoli",
  "hotelResults.filter.doubleBed": "Letto matrimoniale",
  "hotelResults.filter.queenBed": "Letto queen size",
  "hotelResults.filter.kingBed": "Letto king size",
  ...
  flightSearchAgainCurrentPrices: "Questo preventivo del volo non è più disponibile. Cerca di nuovo per vedere i prezzi attuali.",
  ...
  layoverTemplate: "Scalo a {{airport}} · {{duration}} · {{connection}}",
  flightNumberLabel: "Volo",
  layoverIn: "Scalo a",
  layoverSummaryTemplate: "Scalo: {{airport}} {{duration}}",
  ...
  flightLandingRouteTemplate: "Da {{origin}} a {{destination}}",
...
flightLandingRouteAriaLabel: "Cerca voli da {{origin}} a {{destination}}",
  ...
  "carsSearch.error.pickupLocationRequired": "Inserisci un luogo di ritiro.",
  "carsSearch.error.pickupDateRequired": "Seleziona una data di ritiro.",
  "carsSearch.error.pickupDatePast": "La data di ritiro non può essere nel passato.",
  "carsSearch.error.pickupTimeRequired": "Seleziona un orario di ritiro.",
  "carsSearch.error.dropoffDateRequired": "Seleziona una data di riconsegna.",
  "carsSearch.error.dropoffDatePast": "La data di riconsegna non può essere nel passato.",
  "carsSearch.error.dropoffTimeRequired": "Seleziona un orario di riconsegna.",
  "carsSearch.error.driverAgeInvalid": "Seleziona Qualsiasi età 18–70 o un’età del conducente da 18 a 70 anni.",
  "carsSearch.error.dropoffLocationRequired": "Inserisci un luogo di riconsegna.",
  "carsSearch.error.dropoffBeforePickup": "La data di riconsegna non può essere precedente alla data di ritiro.",
  "carsSearch.error.sameDayDropoffAfterPickup": "Per le riconsegne nello stesso giorno, l’orario di riconsegna deve essere successivo all’orario di ritiro.",
  ...
  "carsResults.pickupLocationLabel": "Luogo di ritiro",
  "carsResults.returnLocationLabel": "Luogo di riconsegna",
  "carsResults.rentalDatesLabel": "Date di noleggio",
  "carsResults.pickupReturnTimeLabel": "Orario di ritiro / riconsegna",
  "carsResults.driverAgeLabel": "Età del conducente",
  ...
  "accountDashboard.hub.emailPreferences": "Preferenze email",
  ...
  "accountDashboard.mobile.manageAccount": "Gestisci account",
  "hotelResults.filter.doubleBusiness": "Camera business doppia",
  "hotelResults.filter.deluxeKingRoom": "Camera deluxe con letto king",
  "hotelResults.filter.luxuryKing": "Camera king di lusso",
  "hotelResults.filter.singleStandard": "Camera singola standard",
  "hotelResults.filter.superiorDoubleRoom": "Camera doppia superior",
  "hotelResults.filter.superiorRoom": "Camera superior",
  "flightLandingCity.Cairo": "Il Cairo",
  "flightLandingCity.Addis Ababa": "Addis Abeba",
  "flightLandingImageAlt.Johannesburg skyline at golden hour": "Skyline di Johannesburg all’ora dorata",
  "flightLandingImageAlt.Cairo skyline with the Pyramids of Giza": "Skyline del Cairo con le piramidi di Giza",
  "flightLandingImageAlt.Addis Ababa cityscape in the Ethiopian highlands": "Paesaggio urbano di Addis Abeba sugli altopiani etiopi",

  // Hotels landing static render-path localization coverage.
  "hotelsHeroImageAlt": "Facchino d’hotel che accoglie un ospite con bagagli in una lobby premium",
  "hotelDestination.London.imageAlt": "Tower Bridge e Tamigi a Londra sotto un cielo azzurro",
  "hotelDestination.Paris.imageAlt": "Torre Eiffel e Senna a Parigi all’ora dorata",
  "hotelDestination.Rome.imageAlt": "Il Colosseo a Roma sotto un cielo azzurro limpido",
  "hotelDestination.Dubai.imageAlt": "Skyline di Dubai con il Burj Khalifa sopra i grattacieli",
  "hotelDestination.Singapore.imageAlt": "Skyline di Marina Bay a Singapore al crepuscolo",
  "hotelDestination.Barcelona.imageAlt": "Panorama urbano di Barcellona con la Sagrada Família di giorno",
  "hotelDestination.Toronto.imageAlt": "Skyline di Toronto con la CN Tower accanto al lago Ontario",
  "hotelDestination.Amsterdam.imageAlt": "Case sui canali e ponte di Amsterdam lungo l’acqua",
  "hotelDestination.Bangkok.imageAlt": "Skyline di Bangkok e fiume Chao Phraya al tramonto",
  "hotelDestination.Cancun.imageAlt": "Spiaggia di Cancún con sabbia bianca e acqua turchese",
  "hotelDestination.Istanbul.imageAlt": "Lungomare di Istanbul con cupole e minareti all’ora dorata",
  "hotelDestination.Tokyo.imageAlt": "Skyline di Tokyo con fitti grattacieli di giorno",
  "hotelDestination.New York.imageAlt": "Skyline di New York con One World Trade Center e waterfront",
  "newsletter.accountEmailLine": "Iscriviti con l’e-mail del tuo account: {{email}}.",
  "newsletter.manageEmailPreferences": "Gestisci le preferenze e-mail",
  emailPreferencesMetadataTitle: "Preferenze e-mail",
  "emailUpdates.eyebrow": "AGGIORNAMENTI KURIOTICKET",
  "emailUpdates.title": "Gestisci aggiornamenti e-mail",
  "emailUpdates.description": "Scegli se Kurioticket può inviare aggiornamenti di viaggio e novità sul prodotto a questo indirizzo e-mail.",
  "emailUpdates.emailLabel": "E-MAIL",
  "emailUpdates.subscribedStatus": "Hai effettuato l’iscrizione.",
  "emailUpdates.subscribedButton": "Iscritto",
  "emailUpdates.stopUpdates": "Interrompi aggiornamenti",
  "emailUpdates.loadingStatus": "Caricamento…",
  "emailUpdates.unsubscribedStatus": "Non hai effettuato l’iscrizione.",
  "emailUpdates.notFoundStatus": "Nessuna iscrizione trovata.",
  "emailUpdates.subscribeButton": "Iscriviti",
  "emailUpdates.restartUpdates": "Riavvia aggiornamenti",
  "emailUpdates.updatesStopped": "Aggiornamenti interrotti",
  "emailUpdates.notAvailable": "Non disponibile",
  "emailUpdates.invalidLink": "Questo link alle preferenze non è valido o è scaduto.",
  "emailUpdates.loadError": "Non è stato possibile caricare queste preferenze in questo momento.",
  "emailUpdates.updateError": "Non è stato possibile aggiornare questa preferenza in questo momento.",
  "emailUpdates.preferenceUpdated": "Preferenza aggiornata.",
  ...
  "legal.legalNoticeCompanyInformation.title": "Avviso legale e informazioni aziendali",
  "legal.legalNoticeCompanyInformation.summary": "Informazioni su azienda, contatti, ambito del prodotto e confini dei fornitori per Kurioticket.",
  "legal.legalNoticeCompanyInformation.lastUpdatedDate": "28 giugno 2026",
  "legal.legalNoticeCompanyInformation.tableOfContents": "INDICE",
  "legal.legalNoticeCompanyInformation.sections.company-information.title": "Informazioni aziendali",
  "legal.legalNoticeCompanyInformation.sections.company-information.paragraph1": "Kurioticket LLC, 801 Tupper St, Suite 812, Santa Rosa, CA 95404. Telefono: 346-383-0325. Supporto: support@kurioticket.com. Legale: legal@kurioticket.com. Privacy: privacy@kurioticket.com.",
  "legal.legalNoticeCompanyInformation.sections.company-information.paragraph2": "Nome legale: Kurioticket LLC. Indirizzo: 801 Tupper St, Suite 812, Santa Rosa, CA 95404. Telefono aziendale: 346-383-0325.",
  "legal.legalNoticeCompanyInformation.sections.contacts.title": "Indirizzi e-mail di contatto",
  "legal.legalNoticeCompanyInformation.sections.contacts.paragraph1": "Supporto: support@kurioticket.com. Legale: legal@kurioticket.com. Privacy: privacy@kurioticket.com.",
  "legal.legalNoticeCompanyInformation.sections.product-scope.title": "Ambito del prodotto e modello di business",
  "legal.legalNoticeCompanyInformation.sections.product-scope.paragraph1": "L’ambito del prodotto di Kurioticket include voli, hotel, auto e offerte.",
  "legal.legalNoticeCompanyInformation.sections.product-scope.paragraph2": "Modello di business: piattaforma di ricerca, confronto e reindirizzamento viaggi. Kurioticket aiuta gli utenti a cercare, confrontare e proseguire verso fornitori di viaggio esterni.",
  "legal.legalNoticeCompanyInformation.sections.provider-payment-boundary.title": "Confine tra fornitore e pagamento",
  "legal.legalNoticeCompanyInformation.sections.provider-payment-boundary.paragraph1": "Kurioticket non elabora pagamenti di viaggio finali e non emette documenti di viaggio finali; i fornitori esterni gestiscono prenotazione finale, pagamento, conferma, cancellazione, rimborsi, modifiche, bagagli, check-in e supporto alle prenotazioni.",
  "legal.legalNoticeCompanyInformation.sections.provider-payment-boundary.paragraph2": "Il fornitore esterno che accetta il pagamento è responsabile dei termini finali di prenotazione, del prezzo finale, dell’elaborazione del pagamento, della conferma, della cancellazione, dei rimborsi, delle modifiche, dei bagagli, del check-in e del supporto alle prenotazioni.",
  "legal.legalNoticeCompanyInformation.sections.california-registration.title": "Riferimento al California Seller of Travel",
  "legal.legalNoticeCompanyInformation.sections.california-registration.paragraph1": "California Seller of Travel Registration No. 2172630-70. La registrazione come venditore di viaggi non costituisce approvazione da parte dello Stato della California.",
  ...
  "deals.results.title": "Risultati di viaggio coordinati",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Risultati di viaggio coordinati",
  "deals.results.modify": "Modify search · Risultati di viaggio coordinati",
  "deals.results.viewFlights": "View all flights · Risultati di viaggio coordinati",
  "deals.results.viewHotels": "View all hotels · Risultati di viaggio coordinati",
  "deals.results.viewCars": "View car options · Risultati di viaggio coordinati",
  "deals.results.invalidTitle": "Review your search · Risultati di viaggio coordinati",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Risultati di viaggio coordinati",
  "deals.results.noResults": "No matching results were found. · Risultati di viaggio coordinati",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Risultati di viaggio coordinati",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Risultati di viaggio coordinati",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Risultati di viaggio coordinati",
  "deals.error.flightOriginCode": "Airport selection is required. · Risultati di viaggio coordinati",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Risultati di viaggio coordinati",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Risultati di viaggio coordinati",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Risultati di viaggio coordinati",
  "deals.error.flightDates": "Select valid flight dates. · Risultati di viaggio coordinati",
  "deals.error.hotelDestination": "Enter a hotel destination. · Risultati di viaggio coordinati",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Risultati di viaggio coordinati",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Risultati di viaggio coordinati",
  "deals.error.hotelDates": "Select valid hotel dates. · Risultati di viaggio coordinati",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Risultati di viaggio coordinati",
  "deals.productSelector.instruction": "Choose at least two products",
  "deals.productSelector.minimumTwo": "Pacchetti requires at least two products.",
  ...
  "deals.guided.handoffPending.returnDeals": "Return to Pacchetti",
  ...
  "deals.guided.handoffPending.missingBody": "Return to Pacchetti and confirm your trip options again.",
  ...
  "deals.guided.handoffInvalid.body": "For your safety, no booking partner was opened. Return to Pacchetti and try again.",
  "deals.guided.handoffInvalid.returnDeals": "Return to Pacchetti",
  ...
  "deals.guided.handoff.storageReadFailedBody": "Non è stato possibile ricontrollare il viaggio salvato, quindi questo passaggio non è stato aperto. Riprova.",
  ...
  "deals.guided.handoff.returnDeals": "Return to Pacchetti",
  "deals.guided.handoff.missingTitle": "We could not load this guided trip",
  "deals.guided.handoff.missingBody": "Return to Pacchetti and confirm your trip options again.",
  ...
  "accountDashboard.preferences.booking.sections.flightDefaults.description": "Imposta le tue preferenze di viaggio predefinite per prenotazioni più rapide e pertinenti.",
  "accountDashboard.preferences.customization.status.savingShort": "Saving...",
  "accountDashboard.preferences.email.resetShort": "Reimposta",
  "accountDashboard.preferences.email.savePreferences": "Salva preferenze",
  "accountDashboard.preferences.email.savingPreferences": "Saving...",
  "accountDashboard.preferences.email.savingShort": "Saving...",
  "accountDashboard.preferences.email.title": "Preferenze email",
  "accountMenu.savedRecent.label": "Viaggi salvati",
  "carDetails.cancellation": "Cancellazione",
  "carDetails.freeCancellation": "Cancellazione gratuita",
  "carDetails.nonRefundable": "Non rimborsabile",
  "carDetails.return": "Ritorno",
  "carDetails.unlimitedMileage": "Chilometraggio illimitato",
  "carsResults.lowestTotal": "Prezzo totale più basso",
  "carsResults.passengers": "Passeggeri",
  "carsResults.recommended": "Consigliato",
  "carsResults.sortBy": "Ordina per",
  "carsResults.topRated": "PIÙ VOTATO",
  "carsSearch.returnLocationLabel": "Luogo di riconsegna",
  "carsSearch.type.airport": "Aeroporto",
  "carsSearch.type.area": "Posizione / Area",
  "carsSearch.type.city": "Città",
  "deals.guided.hotelDetails.roomInformation": "Room",
  "homeRegionalRoutesTitle": "Scopri destinazioni dalla tua regione",
};
