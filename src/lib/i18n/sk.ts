...
export const translations: TranslationDictionary = {
  ...
  homeDestinationLondonCountry: "Spojené kráľovstvo",
  homeDestinationLondonAlt: "Londýn, Spojené kráľovstvo",
  homeDestinationParisCity: "Paríž",
  homeDestinationParisCountry: "Francúzsko",
  homeDestinationParisAlt: "Paríž, Francúzsko",
  ...
  homeDestinationNewYorkCountry: "Spojené štáty",
  homeDestinationNewYorkAlt: "New York, Spojené štáty",
  ...
  "deals.results.title": "Coordinated trip results (sk)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (sk)",
  "deals.results.modify": "Modify search · Coordinated trip results (sk)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (sk)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (sk)",
  "deals.results.viewCars": "View car options · Coordinated trip results (sk)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (sk)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (sk)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (sk)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (sk)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (sk)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (sk)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (sk)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (sk)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (sk)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (sk)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (sk)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (sk)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (sk)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (sk)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (sk)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (sk)",
