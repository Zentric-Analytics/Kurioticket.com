...
export const translations: TranslationDictionary = {
  ...
  homeDestinationDubaiCountry: "De forente arabiske emirater",
  homeDestinationDubaiAlt: "Dubai, De forente arabiske emirater",
  homeDestinationLondonCity: "London",
  homeDestinationLondonCountry: "Storbritannia",
  homeDestinationLondonAlt: "London, Storbritannia",
  homeDestinationParisCity: "Paris",
  homeDestinationParisCountry: "Frankrike",
  homeDestinationParisAlt: "Paris, Frankrike",
  ...
  homeDestinationNewYorkCountry: "USA",
  homeDestinationNewYorkAlt: "New York, USA",
  ...
  "deals.results.title": "Coordinated trip results (no)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (no)",
  "deals.results.modify": "Modify search · Coordinated trip results (no)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (no)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (no)",
  "deals.results.viewCars": "View car options · Coordinated trip results (no)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (no)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (no)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (no)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (no)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (no)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (no)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (no)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (no)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (no)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (no)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (no)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (no)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (no)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (no)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (no)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (no)",
  ...
  flightSearchDestinationPlaceholderShort: 'Hvor?',
};
