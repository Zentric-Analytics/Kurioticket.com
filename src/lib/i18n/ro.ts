...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Călători",
  "mobileDatePicker.start": "Început",
  "mobileDatePicker.end": "Sfârșit",
  deals: "Pachete turistice",
  ...
  homeDestinationDubaiCountry: "Emiratele Arabe Unite",
  homeDestinationDubaiAlt: "Dubai, Emiratele Arabe Unite",
  homeDestinationLondonCity: "Londra",
  homeDestinationLondonCountry: "Regatul Unit",
  homeDestinationLondonAlt: "Londra, Regatul Unit",
  homeDestinationParisCity: "Paris",
  homeDestinationParisCountry: "Franța",
  homeDestinationParisAlt: "Paris, Franța",
  homeDestinationBaliCity: "Bali",
  homeDestinationBaliCountry: "Indonezia",
  homeDestinationBaliAlt: "Bali, Indonezia",
  homeDestinationNewYorkCity: "New York",
  homeDestinationNewYorkCountry: "Statele Unite",
  homeDestinationNewYorkAlt: "New York, Statele Unite",
  ...
  "deals.results.title": "Coordinated trip results (ro)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (ro)",
  "deals.results.modify": "Modify search · Coordinated trip results (ro)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (ro)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (ro)",
  "deals.results.viewCars": "View car options · Coordinated trip results (ro)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (ro)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (ro)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (ro)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (ro)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (ro)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (ro)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (ro)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (ro)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (ro)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (ro)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (ro)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (ro)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (ro)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (ro)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (ro)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (ro)",
  ...
  flightSearchDestinationPlaceholderShort: 'Unde?',
};
