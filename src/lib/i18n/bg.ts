...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Пътуващи",
  "mobileDatePicker.start": "Начало",
  "mobileDatePicker.end": "Край",
  deals: "Туристически пакети",
  ...
  homeDestinationDubaiCountry: "Обединени арабски емирства",
  homeDestinationDubaiAlt: "Дубай, Обединени арабски емирства",
  homeDestinationLondonCity: "Лондон",
  homeDestinationLondonCountry: "Обединено кралство",
  homeDestinationLondonAlt: "Лондон, Обединено кралство",
  ...
  homeDestinationNewYorkCity: "Ню Йорк",
  homeDestinationNewYorkCountry: "Съединени щати",
  homeDestinationNewYorkAlt: "Ню Йорк, Съединени щати",
  ...
  "deals.results.title": "Coordinated trip results (bg)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (bg)",
  "deals.results.modify": "Modify search · Coordinated trip results (bg)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (bg)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (bg)",
  "deals.results.viewCars": "View car options · Coordinated trip results (bg)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (bg)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (bg)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (bg)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (bg)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (bg)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (bg)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (bg)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (bg)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (bg)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (bg)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (bg)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (bg)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (bg)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (bg)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (bg)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (bg)",
  ...
  flightSearchDestinationPlaceholderShort: 'До?',
};
