...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Matkustajat",
  "mobileDatePicker.start": "Alku",
  "mobileDatePicker.end": "Loppu",
  deals: "Matkapaketit",
  ...
  homeDestinationDubaiCountry: "Yhdistyneet arabiemiirikunnat",
  homeDestinationDubaiAlt: "Dubai, Yhdistyneet arabiemiirikunnat",
  homeDestinationLondonCity: "Lontoo",
  homeDestinationLondonCountry: "Yhdistynyt kuningaskunta",
  homeDestinationLondonAlt: "Lontoo, Yhdistynyt kuningaskunta",
  homeDestinationParisCity: "Pariisi",
  homeDestinationParisCountry: "Ranska",
  homeDestinationParisAlt: "Pariisi, Ranska",
  homeDestinationBaliCity: "Bali",
  homeDestinationBaliCountry: "Indonesian",
  homeDestinationBaliAlt: "Bali, Indonesia",
  homeDestinationNewYorkCity: "New York",
  homeDestinationNewYorkCountry: "Yhdysvallat",
  homeDestinationNewYorkAlt: "New York, Yhdysvallat",
  ...
  "deals.results.title": "Coordinated trip results (fi)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (fi)",
  "deals.results.modify": "Modify search · Coordinated trip results (fi)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (fi)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (fi)",
  "deals.results.viewCars": "View car options · Coordinated trip results (fi)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (fi)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (fi)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (fi)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (fi)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (fi)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (fi)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (fi)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (fi)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (fi)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (fi)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (fi)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (fi)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (fi)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (fi)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (fi)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (fi)",
  ...
  flightSearchDestinationPlaceholderShort: 'Minne?',
};
