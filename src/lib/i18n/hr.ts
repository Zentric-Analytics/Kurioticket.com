...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Putnici",
  ...
  homeDestinationNewYorkAlt: "New York, Sjedinjene Američke Države",
  ...
  "deals.results.title": "Coordinated trip results (hr)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (hr)",
  "deals.results.modify": "Modify search · Coordinated trip results (hr)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (hr)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (hr)",
  "deals.results.viewCars": "View car options · Coordinated trip results (hr)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (hr)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (hr)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (hr)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (hr)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (hr)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (hr)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (hr)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (hr)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (hr)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (hr)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (hr)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (hr)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (hr)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (hr)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (hr)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (hr)",
  ...
  flightSearchDestinationPlaceholderShort: 'Kamo?',
};
