...
export const translations: TranslationDictionary = {
  ...
  "mobileTravelerCabin.adultDescription": "18 yaş ve üzeri",
  "mobileTravelerCabin.childDescription": "2-17 yaş",
  "mobileTravelerCabin.infantDescription": "2 yaş altı",
  "mobileTravelerCabin.tip": "İpucu",
  "mobileTravelerCabin.baggageTip": "Bagaj hakkı havayoluna göre değişebilir. Ayrıntıları sağlayıcı sayfasından kontrol edin.",
  "mobileDatePicker.start": "Başlangıç",
  "mobileDatePicker.end": "Bitiş",
  "deals.guided.confirmation.retry": "Tekrar dene",
  "deals.guidedPreview.description": "Rehberli Fırsatlar önizlemesi: Complete guided Tatil Paketleri preview: Hotel, Flight and Car selection and confirmation, Review, and final partner handoff.",
  "deals.guidedPreview.availableCar": "Rehberli Fırsatlar önizlemesi: Car results, filters, sorting, details, and confirmation",
  "deals.guidedPreview.availableReview": "Rehberli Fırsatlar önizlemesi: Trip Review with persisted opened-step progress",
  "deals.guidedPreview.availableHandoff": "Rehberli Fırsatlar önizlemesi: Final booking-partner handoff for each included product",
  "deals.guidedPreview.previewOnlyTitle": "Rehberli Fırsatlar önizlemesi: Internal preview limitations",
  "deals.guidedPreview.previewOnlyPublicLaunch": "Rehberli Fırsatlar önizlemesi: Public activation has not occurred; normal Search remains unchanged.",
  "deals.guidedPreview.previewOnlyBooking": "Rehberli Fırsatlar önizlemesi: Kurioticket does not complete booking or payment. Complete each provider step separately.",
  "deals.guided.confirmation.readError": "Rehberli Fırsatlar önizlemesi: Saved preview progress could not be read. Try confirmation again.",
  "deals.guided.confirmation.saveError": "Rehberli Fırsatlar önizlemesi: Preview progress could not be saved. Try confirmation again.",
  "deals.guided.crossTabUpdated": "Rehberli Fırsatlar önizlemesi: This trip was updated in another tab.",
  "deals.guided.prerequisiteChanged": "Rehberli Fırsatlar önizlemesi: An earlier trip choice changed in another tab. Your current saved trip is now shown.",
  "deals.guided.conflict.title": "Rehberli Fırsatlar önizlemesi: Another guided preview is saved",
  "deals.guided.conflict.body": "Rehberli Fırsatlar önizlemesi: This page belongs to a different guided search. Its saved progress is protected.",
  "deals.guided.conflict.restart": "Rehberli Fırsatlar önizlemesi: Start this preview trip again",
  "deals.guided.conflict.restartDisclosure": "Rehberli Fırsatlar önizlemesi: Starting again replaces the guided-preview progress currently saved in this browser.",
  "deals.guided.error.title": "Rehberli Fırsatlar önizlemesi: We could not show this guided Tatil Paketleri page",
  "deals.guided.error.body": "Rehberli Fırsatlar önizlemesi: No booking-partner page was opened. Try again or return safely to Tatil Paketleri.",
  "deals.guided.error.retry": "Rehberli Fırsatlar önizlemesi: Try again",
  "deals.guided.error.returnDeals": "Rehberli Fırsatlar önizlemesi: Return to Tatil Paketleri",
  "deals.guided.storageUnavailable.title": "Rehberli Fırsatlar önizlemesi: Temporary preview storage is unavailable",
  "deals.guided.storageUnavailable.body": "Rehberli Fırsatlar önizlemesi: This guided stage cannot safely save progress. Restore browser storage and reload.",
  "deals.guided.invalid.title": "Rehberli Fırsatlar önizlemesi: Saved preview progress is invalid",
  "deals.guided.invalid.body": "Rehberli Fırsatlar önizlemesi: Return to the first guided stage to choose fresh trip options.",
  "deals.guided.expired.title": "Rehberli Fırsatlar önizlemesi: Your guided preview has expired",
  "deals.guided.expired.body": "Rehberli Fırsatlar önizlemesi: Return to the first guided stage and refresh your trip options.",
  ...
  "brandedLoading.default.title": "Kurioticket yükleniyor...",
  "brandedLoading.default.preparingExperience": "Deneyiminiz hazırlanıyor...",
  ...
  exploreWaysTitle: "Keşfetme yolları",
  exploreWaysRouteTitle: "Rota keşfi",
  exploreWaysRouteText: "Bir uçuş rotasıyla başlayın, ardından sonuçlar mevcut olduğunda saatleri, aktarmaları ve sağlayıcı seçeneklerini karşılaştırın.",
  exploreWaysHotelsTitle: "Otel destinasyonu fikirleri",
  exploreWaysHotelsText: "Konaklama seçeneklerini, konumları ve iptal koşullarını karşılaştırmak için destinasyon odaklı otel aramalarını kullanın.",
  exploreWaysSavedTitle: "Kaydedilen seyahatler ve son aramalar",
  exploreWaysSavedText: "Planlama birden fazla oturumda düzenli kalsın diye başladığınız rotalara ve aramalara geri dönün.",
  exploreWaysBasicsTitle: "Seyahat planlama temelleri",
  exploreWaysBasicsText: "Karar vermeden önce zamanlama, esneklik, bagaj, konaklama ihtiyaçları ve sağlayıcı politikalarını düşünün.",
  exploreNeedsTitle: "Seyahat ihtiyacına göre planlayın",
  exploreNeedsWeekendTitle: "Hafta sonu şehir kaçamakları",
  exploreNeedsWeekendText: "Kısıtlı zamana uyan daha kısa rotaları, basit saatleri ve otel konumlarını karşılaştırın.",
  exploreNeedsInternationalTitle: "Uluslararası seyahatler",
  exploreNeedsInternationalText: "Toplam seyahat süresi, aktarmalar, giriş gereksinimleri ve sağlayıcı koşulları dahil uzun güzergâhları dikkatle inceleyin.",
  exploreNeedsHotelFirstTitle: "Önce otel planlama",
  exploreNeedsHotelFirstText: "Kalmak istediğiniz yerden başlayın, ardından uçuşları ve diğer seyahat parçalarını o konuma göre düzenleyin.",
  exploreNeedsCompleteTitle: "Tam seyahat planlama",
  exploreNeedsCompleteText: "Tüm seyahat görünümünü net tutmak için uçuşları, otelleri, kaydedilen seyahatleri ve son aramaları birlikte kullanın.",
  exploreChecklistTitle: "Rezervasyondan önce",
  exploreChecklistTime: "Toplam seyahat süresini ve aktarmaları karşılaştırın",
  exploreChecklistBaggage: "Bagajı ve esnekliği gözden geçirin",
  exploreChecklistHotel: "Otel konumunu ve iptal kurallarını kontrol edin",
  exploreChecklistProvider: "Son fiyatı ve müsaitliği sağlayıcıyla doğrulayın",
  exploreChecklistSave: "Rotaları veya aramaları sonrası için kaydedin",
  explorePrimaryCta: "Uçuş ara",
  exploreSecondaryCta: "Otel ara",
  exploreSavedCta: "Kaydedilen seyahatleri görüntüle",
  ...
  loginProcessing: "Bilgileriniz kontrol ediliyor ve doğrulama kodu gönderiliyor…",
  loginResendSuccess: "Bu hesap giriş yapabiliyorsa yeni bir kod gönderdik.",
  loginEnterCode: "6 haneli giriş kodunu girin.",
  loginVerifiedRedirecting: "Doğrulandı. Yönlendiriliyor…",
  loginStartOverError: "Yeni bir kod göndermeden önce bilgilerinizi kontrol edebilmemiz için baştan başlayın.",
  loginSendingNewCode: "Yeni bir doğrulama kodu gönderiliyor…",
  loginUnableSendNewCode: "Şu anda yeni bir kod gönderilemiyor. Lütfen tekrar deneyin.",
  loginErrorAccountUnavailable: "Bu hesap kullanılamıyor. Lütfen destek ekibiyle iletişime geçin.",
  loginUnableSendLoginCode: "Şu anda giriş kodu gönderilemiyor. Lütfen tekrar deneyin.",
  signupVerificationRequiredRedirecting: "Doğrulama gerekli. Yönlendiriliyor...",
  signupErrorUnableCreate: "Hesabınızı oluşturamadık. Lütfen tekrar deneyin.",
  signupErrorRateLimited: "Çok fazla kayıt denemesi yapıldı. Lütfen bekleyip tekrar deneyin.",
  signupErrorDuplicateEmail: "Bu e-posta ile zaten bir hesap var.",
  signupErrorUnableSendVerification: "Şu anda doğrulama kodu gönderilemiyor. Lütfen tekrar deneyin.",
  ...
  "carsSearch.error.pickupLocationRequired": "Bir alış konumu girin.",
  "carsSearch.error.pickupDateRequired": "Bir alış tarihi seçin.",
  "carsSearch.error.pickupDatePast": "Alış tarihi geçmişte olamaz.",
  "carsSearch.error.pickupTimeRequired": "Bir alış saati seçin.",
  "carsSearch.error.dropoffDateRequired": "Bir bırakma tarihi seçin.",
  "carsSearch.error.dropoffDatePast": "Bırakma tarihi geçmişte olamaz.",
  "carsSearch.error.dropoffTimeRequired": "Bir bırakma saati seçin.",
  "carsSearch.error.driverAgeInvalid": "18–70 herhangi yaş veya 18 ile 70 arasında bir sürücü yaşı seçin.",
  "carsSearch.error.dropoffLocationRequired": "Bir bırakma konumu girin.",
  "carsSearch.error.dropoffBeforePickup": "Bırakma tarihi alış tarihinden önce olamaz.",
  "carsSearch.error.sameDayDropoffAfterPickup": "Aynı gün iadelerde bırakma saati alış saatinden sonra olmalıdır.",
  carsSearchPreparing: "Araç araması hazırlanıyor...",
  searchingCars: "Araçlar aranıyor...",
  ...
  "carsResults.pickupLocationLabel": "Alış konumu",
  "carsResults.returnLocationLabel": "İade konumu",
  "carsResults.rentalDatesLabel": "Kiralama tarihleri",
  "carsResults.pickupReturnTimeLabel": "Alış / iade saati",
  "carsResults.driverAgeLabel": "Sürücü yaşı",
  ...
  "accountDashboard.preferences.customization.personalizedTravelTatil Paketleri": "Kişiselleştirilmiş seyahat fırsatlarını göster",
  ...
  "accountDashboard.trips.summary": "{{total}} viajes en total. {{upcoming}} próximos, {{past}} pasados, {{cancelled}} cancelados.",
  "accountDashboard.trips.state.loading": "Cargando tus viajes...",
  "accountDashboard.trips.state.unauthenticated.title": "Inicia sesión para ver tus viajes",
  "accountDashboard.trips.state.unauthenticated.body": "Tus viajes están conectados a tu cuenta. Inicia sesión y vuelve aquí para gestionar reservas próximas, pasadas y canceladas.",
  "accountDashboard.trips.state.error.title": "No se pueden cargar los viajes",
  "accountDashboard.trips.state.error.body": "No pudimos cargar tus viajes. Inténtalo de nuevo.",
  "accountDashboard.trips.state.error.retry": "Reintentar",
  "accountDashboard.trips.state.error.retryAriaLabel": "Volver a cargar viajes",
  "accountDashboard.trips.lookup.unauthenticated": "Inicia sesión para buscar una reserva.",
  "accountDashboard.trips.lookup.error": "No pudimos buscar esa reserva. Inténtalo de nuevo.",
  "accountDashboard.trips.lookup.found": "Reserva encontrada.",
  "accountDashboard.trips.card.bookingReference": "Referencia de reserva",
  "accountDashboard.trips.card.departure": "Salida",
  "accountDashboard.trips.card.return": "Regreso",
  "accountDashboard.trips.card.passengers": "Pasajeros",
  "accountDashboard.trips.card.total": "Total",
  "accountDashboard.trips.card.viewDetails": "Ver detalles",
  "accountDashboard.trips.card.unknownDestination": "Destino desconocido",
  "accountDashboard.trips.status.upcoming": "Próximos",
  ...
  verifyLoginTitle: "Girişinizi doğrulayın",
  verifyLoginInstructions: "E-postanıza gönderdiğimiz 6 haneli kodu girin. Kodların süresi 10 dakika sonra dolar.",
  verifyLoginCodeLabel: "Giriş kodu",
  verifyLoginSubmit: "Girişi doğrula",
  verifyLoginNeedNewCode: "Yeni bir koda mı ihtiyacınız var? Güvenli şekilde yeniden gönderebilmemiz için parolanızı girin.",
  verifyLoginPasswordLabel: "Yeniden gönderim için parola",
  verifyLoginNeedStartOver: "Baştan başlamak mı gerekiyor?",
  ...
  forgotPasswordInvalidEmail: "Geçerli bir e-posta adresi girin.",
  forgotPasswordUnableRequest: "Şu anda parola sıfırlama isteği gönderilemiyor.",
  ...
  "legal.californiaSellerOfTravelNotice.title": "Kaliforniya Seyahat Satıcısı Bildirimi",
  "legal.californiaSellerOfTravelNotice.summary": "Kurioticket’in seyahat arama ve yönlendirme platformu için California Seller of Travel kayıt bildirimi.",
  "legal.californiaSellerOfTravelNotice.lastUpdatedDate": "28 Haziran 2026",
  "legal.californiaSellerOfTravelNotice.tableOfContents": "İÇİNDEKİLER",
  "legal.californiaSellerOfTravelNotice.sections.registration.title": "Kayıt Bilgileri",
  "legal.californiaSellerOfTravelNotice.sections.registration.paragraph1": "Kurioticket LLC, 2172630-70 kayıt numarasıyla California Seller of Travel olarak kayıtlıdır.",
  "legal.californiaSellerOfTravelNotice.sections.registration.paragraph2": "Kayıt June 06, 2026 tarihinden itibaren geçerlidir. Kayıt June 05, 2027 tarihinde sona erer.",
  "legal.californiaSellerOfTravelNotice.sections.registration.paragraph3": "Seyahat satıcısı olarak kayıtlı olmak, Kaliforniya Eyaleti tarafından onaylandığı anlamına gelmez.",
  "legal.californiaSellerOfTravelNotice.sections.platform-model.title": "Arama ve Yönlendirme Modeli",
  "legal.californiaSellerOfTravelNotice.sections.platform-model.paragraph1": "Kurioticket LLC; uçuşlar, oteller, kiralık araçlar ve fırsatlar için seyahat arama, karşılaştırma ve yönlendirme platformu işletir. Kurioticket, kullanıcıların seyahat seçeneklerini karşılaştırmasına ve son rezervasyon adımları için harici sağlayıcılara ilerlemesine yardımcı olur.",
  "legal.californiaSellerOfTravelNotice.sections.platform-model.paragraph2": "Kurioticket nihai seyahat ödemelerini işlemez veya nihai seyahat belgeleri düzenlemez; harici sağlayıcılar nihai rezervasyon, ödeme, onay, iptal, iade, değişiklik, bagaj, check-in ve rezervasyon desteğini yürütür.",
  "legal.californiaSellerOfTravelNotice.sections.provider-responsibilities.title": "Harici Sağlayıcı Sorumlulukları",
  "legal.californiaSellerOfTravelNotice.sections.provider-responsibilities.paragraph1": "Kurioticket’ten sağlayıcının sitesine geçtikten sonra nihai rezervasyon, ödeme, onay, iptal, iade, değişiklik, bagaj, check-in ve rezervasyon desteğini harici sağlayıcılar yürütür.",
  "legal.californiaSellerOfTravelNotice.sections.provider-responsibilities.paragraph2": "Herhangi bir satın alma işlemini tamamlamadan önce nihai fiyatı, müsaitliği, ücret kurallarını, oda veya araç koşullarını, iptal politikasını, iade politikasını, bagaj kurallarını, check-in gerekliliklerini ve müşteri desteği koşullarını harici sağlayıcıyla inceleyin.",
  "legal.californiaSellerOfTravelNotice.sections.contact.title": "İletişim",
  "legal.californiaSellerOfTravelNotice.sections.contact.paragraph1": "Kurioticket LLC, 801 Tupper St, Suite 812, Santa Rosa, CA 95404. Phone: 346-383-0325. Support: support@kurioticket.com. Legal: legal@kurioticket.com. Privacy: privacy@kurioticket.com.",
  "legal.californiaSellerOfTravelNotice.sections.contact.paragraph2": "Platform desteği için support@kurioticket.com ile iletişime geçin. Hukuki sorular için legal@kurioticket.com ile iletişime geçin. Gizlilik soruları için privacy@kurioticket.com ile iletişime geçin.",
  "legal.californiaSellerOfTravelNotice.developerNote": "Bu yasal taslaklar başlangıç aşaması için yer tutucudur ve geniş ölçekli kamuya açık lansmandan önce nitelikli hukuk danışmanı tarafından incelenmelidir.",
  ...
  "legal.partnerRedirectDisclaimer.title": "İş Ortağı Yönlendirme Sorumluluk Reddi",
  "legal.partnerRedirectDisclaimer.summary": "Kurioticket kullanıcıları havayollarına, otellere, satış ortaklarına veya seyahat sağlayıcılarına yönlendirdiğinde ne olduğunu açıklar.",
  "legal.partnerRedirectDisclaimer.lastUpdatedDate": "11 Mayıs 2026",
  "legal.partnerRedirectDisclaimer.tableOfContents": "İÇİNDEKİLER",
  "legal.partnerRedirectDisclaimer.lastUpdated": "Son güncelleme: 11 Mayıs 2026",
  "legal.partnerRedirectDisclaimer.sections.redirect.title": "Güvenli Yönlendirmeler",
  "legal.partnerRedirectDisclaimer.sections.redirect.paragraph1": "Harici bir sağlayıcıya devam ettiğinizde Kurioticket sizi bir havayoluna, otele, satış ortağına veya seyahat sağlayıcısına yönlendirir. Analitik, destek, kötüye kullanım önleme ve satış ortaklığı takibi için sağlayıcı, rota, fiyat, zaman damgası, kullanıcı türü ve kaynak sayfa gibi yönlendirme meta verilerini kaydedebiliriz.",
  "legal.partnerRedirectDisclaimer.sections.redirect.paragraph2": "Kurioticket havayolu web sitelerini otomatik doldurmaz, havayolu web sitelerini kazımaz veya sizin adınıza iş ortağı satın alımlarını tamamlamaz.",
  "legal.partnerRedirectDisclaimer.sections.external-terms.title": "Harici Şartlar",
  "legal.partnerRedirectDisclaimer.sections.external-terms.paragraph1": "Harici iş ortağı siteleri kendi şartlarına, gizlilik politikalarına, iade politikalarına, çerezlerine, erişilebilirlik uygulamalarına ve müşteri destek süreçlerine tabidir.",
  "legal.partnerRedirectDisclaimer.developerNote": "Bu yasal taslaklar startup aşaması için yer tutucudur ve büyük ölçekli genel lansmandan önce nitelikli hukuk danışmanları tarafından incelenmelidir.",
  ...
  "legal.affiliateDisclosure.lastUpdated": "Son güncelleme: 11 Mayıs 2026",
  "legal.affiliateDisclosure.tableOfContents": "İÇİNDEKİLER",
  "legal.affiliateDisclosure.sections.model.title": "Satış Ortaklığı Modeli",
  "legal.affiliateDisclosure.sections.model.paragraph1": "Kurioticket, hizmet ücreti olmadan ücretsiz uçuş ve otel araması sunar. Kullanıcılar havayolu, otel veya seyahat ortağı bağlantıları üzerinden tıkladığında, rezervasyon yaptığında veya satın aldığında satış ortaklığı komisyonu kazanabiliriz.",
  "legal.affiliateDisclosure.sections.model.paragraph2": "Kurioticket, kullanıcılar sağlayıcı bağlantıları üzerinden tıkladığında veya rezervasyon yaptığında iş ortaklarından ödeme alabilir. Bu, hizmetin işletilmesine ve iyileştirilmesine yardımcı olur.",
  "legal.affiliateDisclosure.sections.ranking.title": "Sıralama Bütünlüğü",
  "legal.affiliateDisclosure.sections.ranking.paragraph1": "Kurioticket, sonuçları fiyat, süre, aktarmalar, güven, konfor ve stres azaltma gibi kullanıcı değeri sinyallerine göre sıralamayı amaçlar. Satış ortaklığı ilişkileri sahte aciliyet, gizli ücretler veya yanıltıcı öneriler oluşturmamalıdır.",
  "legal.affiliateDisclosure.developerNote": "Bu yasal taslaklar başlangıç aşaması yer tutucularıdır ve büyük ölçekli kamu lansmanından önce nitelikli hukuk danışmanı tarafından incelenmelidir.",
  ...
  "hotelResults.payAtProperty": "Tesiste öde",
  "hotelResults.payLater": "Sonra öde",
  "hotelResults.noPrepayment": "Ön ödeme yok",
  "hotelResults.refundable": "İade edilebilir",
  ...
  "deals.loadingPage": "Sayfa yükleniyor...",
  "deals.decreaseCountAria": "{{label}} değerini azalt",
  "deals.increaseCountAria": "{{label}} değerini artır",
  ...
  "deals.destination.tokyo.imageAlt": "Gün ışığında yoğun yüksek binalarla Tokyo silüeti",
  "deals.destination.london.city": "Londra",
  "deals.destination.london.country": "Birleşik Krallık",
  "deals.destination.london.imageAlt": "Mavi gökyüzü altında Londra Tower Bridge ve Thames Nehri",
  "deals.destination.paris.city": "Paris",
  "deals.destination.paris.country": "Fransa",
  "deals.destination.paris.imageAlt": "Altın saatte Paris’te Eyfel Kulesi ve Sen Nehri",
  "deals.destination.dubai.city": "Dubai",
  "deals.destination.dubai.country": "Birleşik Arap Emirlikleri",
  "deals.destination.dubai.imageAlt": "Burj Khalifa’nın gökdelenlerin üzerinde yükseldiği Dubai silüeti",
  "deals.destination.cancun.city": "Cancun",
  "deals.destination.cancun.country": "Meksika",
  "deals.destination.cancun.imageAlt": "Beyaz kumlu ve turkuaz sulu Cancun plajı",
  "deals.destination.rome.city": "Roma",
  "deals.destination.rome.country": "İtalya",
  "deals.destination.rome.imageAlt": "Açık mavi gökyüzü altında Roma’daki Kolezyum",
  ...
  resetPasswordCreateTitle: "Yeni bir şifre oluştur",
  resetPasswordSubtitle: "Yeni şifrenizi aşağıya girin.",
  resetPasswordInvalidLink: "Bu sıfırlama bağlantısı geçersiz veya süresi dolmuş. Lütfen yeni bir şifre sıfırlama e-postası isteyin.",
  resetPasswordRequestNew: "Yeni sıfırlama e-postası iste",
  resetPasswordNewPasswordLabel: "Yeni şifre",
  resetPasswordConfirmPasswordLabel: "Yeni şifreyi onayla",
  resetPasswordValidationError: "Geçerli bir şifre girin ve iki şifre alanının eşleştiğinden emin olun.",
  resetPasswordUnable: "Şifre şu anda sıfırlanamıyor.",
  resetPasswordSuccessMessage: "Şifre başarıyla sıfırlandı. Girişe yönlendiriliyor...",
  resetPasswordResetting: "Sıfırlanıyor...",
  resetPasswordSubmit: "Şifreyi sıfırla",
  "legal.legalNoticeCompanyInformation.title": "Yasal Bildirim ve Şirket Bilgileri",
  "legal.legalNoticeCompanyInformation.summary": "Kurioticket için şirket, iletişim, ürün kapsamı ve sağlayıcı sınırı bilgileri.",
  "legal.legalNoticeCompanyInformation.lastUpdatedDate": "28 Haziran 2026",
  "legal.legalNoticeCompanyInformation.tableOfContents": "İçindekiler",
  "legal.legalNoticeCompanyInformation.sections.company-information.title": "Şirket bilgileri",
  "legal.legalNoticeCompanyInformation.sections.company-information.paragraph1": "Kurioticket LLC, 801 Tupper St, Suite 812, Santa Rosa, CA 95404. Telefon: 346-383-0325. Destek: support@kurioticket.com. Hukuk: legal@kurioticket.com. Gizlilik: privacy@kurioticket.com.",
  "legal.legalNoticeCompanyInformation.sections.company-information.paragraph2": "Yasal ad: Kurioticket LLC. Adres: 801 Tupper St, Suite 812, Santa Rosa, CA 95404. İş telefonu: 346-383-0325.",
  "legal.legalNoticeCompanyInformation.sections.contacts.title": "İletişim e-posta adresleri",
  "legal.legalNoticeCompanyInformation.sections.contacts.paragraph1": "Destek: support@kurioticket.com. Hukuk: legal@kurioticket.com. Gizlilik: privacy@kurioticket.com.",
  "legal.legalNoticeCompanyInformation.sections.product-scope.title": "Ürün kapsamı ve iş modeli",
  "legal.legalNoticeCompanyInformation.sections.product-scope.paragraph1": "Kurioticket ürün kapsamı uçuşları, otelleri, araçları ve fırsatları içerir.",
  "legal.legalNoticeCompanyInformation.sections.product-scope.paragraph2": "İş modeli: seyahat arama, karşılaştırma ve yönlendirme platformu. Kurioticket kullanıcıların arama yapmasına, karşılaştırmasına ve harici seyahat sağlayıcılarına ilerlemesine yardımcı olur.",
  "legal.legalNoticeCompanyInformation.sections.provider-payment-boundary.title": "Sağlayıcı ve ödeme sınırı",
  "legal.legalNoticeCompanyInformation.sections.provider-payment-boundary.paragraph1": "Kurioticket nihai seyahat ödemelerini işlemez ve nihai seyahat belgeleri düzenlemez; harici sağlayıcılar nihai rezervasyon, ödeme, onay, iptal, iadeler, değişiklikler, bagaj, check-in ve rezervasyon desteğini yönetir.",
  "legal.legalNoticeCompanyInformation.sections.provider-payment-boundary.paragraph2": "Ödemeyi alan harici sağlayıcı nihai rezervasyon koşullarından, nihai fiyattan, ödeme işlemeden, onaydan, iptalden, iadelerden, değişikliklerden, bagajdan, check-in'den ve rezervasyon desteğinden sorumludur.",
  "legal.legalNoticeCompanyInformation.sections.california-registration.title": "California Seller of Travel referansı",
  "legal.legalNoticeCompanyInformation.sections.california-registration.paragraph1": "California Seller of Travel Registration No. 2172630-70. Seyahat satıcısı olarak kayıt, Kaliforniya Eyaleti tarafından onay anlamına gelmez.",
  "legal.legalNoticeCompanyInformation.sections.california-registration.paragraph2": "Kayıt June 6, 2026 tarihinden itibaren geçerlidir. Kayıt June 5, 2027 tarihinde sona erer.",
  "legal.legalNoticeCompanyInformation.developerNote": "Bu yasal taslaklar başlangıç aşaması için geçici materyallerdir ve geniş ölçekli kamuya açık lansmandan önce nitelikli hukuk danışmanları tarafından incelenmelidir.",
  ...
  "flightResults.duration.minutesOnly": "{{minutes}} dk",
  ...
  "deals.results.title": "Koordineli seyahat sonuçları",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Koordineli seyahat sonuçları",
  "deals.results.modify": "Modify search · Koordineli seyahat sonuçları",
  "deals.results.viewFlights": "View all flights · Koordineli seyahat sonuçları",
  "deals.results.viewHotels": "View all hotels · Koordineli seyahat sonuçları",
  "deals.results.viewCars": "View car options · Koordineli seyahat sonuçları",
  "deals.results.invalidTitle": "Review your search · Koordineli seyahat sonuçları",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Koordineli seyahat sonuçları",
  "deals.results.noResults": "No matching results were found. · Koordineli seyahat sonuçları",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Koordineli seyahat sonuçları",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Koordineli seyahat sonuçları",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Koordineli seyahat sonuçları",
  "deals.error.flightOriginCode": "Airport selection is required. · Koordineli seyahat sonuçları",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Koordineli seyahat sonuçları",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Koordineli seyahat sonuçları",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Koordineli seyahat sonuçları",
  "deals.error.flightDates": "Select valid flight dates. · Koordineli seyahat sonuçları",
  "deals.error.hotelDestination": "Enter a hotel destination. · Koordineli seyahat sonuçları",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Koordineli seyahat sonuçları",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Koordineli seyahat sonuçları",
  "deals.error.hotelDates": "Select valid hotel dates. · Koordineli seyahat sonuçları",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Koordineli seyahat sonuçları",
  "deals.productSelector.instruction": "Choose at least two products",
  "deals.productSelector.minimumTwo": "Tatil Paketleri requires at least two products.",
  ...
  "deals.guided.handoffPending.returnDeals": "Return to Tatil Paketleri",
  ...
  "deals.guided.handoffPending.missingBody": "Return to Tatil Paketleri and confirm your trip options again.",
  ...
  "deals.guided.handoffInvalid.body": "For your safety, no booking partner was opened. Return to Tatil Paketleri and try again.",
  "deals.guided.handoffInvalid.returnDeals": "Return to Tatil Paketleri",
  ...
  "deals.guided.handoff.storageReadFailedBody": "Kaydedilen seyahatinizi yeniden kontrol edemedik, bu nedenle bu adım açılmadı. Tekrar deneyin.",
  ...
  "deals.guided.handoff.returnDeals": "Return to Tatil Paketleri",
  "deals.guided.handoff.missingTitle": "We could not load this guided trip",
  "deals.guided.handoff.missingBody": "Return to Tatil Paketleri and confirm your trip options again.",
  ...
  flightSearchDestinationPlaceholderShort: 'Nereye?',
  "accountDashboard.recently": "Yakın zamanda",
  // Reused from existing locale glossary entries with identical canonical meaning.
  "accountDashboard.mobile.manageAccount": "Hesabı yönet",
  "accountDashboard.preferences.booking.actions.saving": "Saving...",
  "accountDashboard.preferences.booking.sections.flightDefaults.description": "Daha hızlı ve daha alakalı rezervasyonlar için varsayılan seyahat tercihlerinizi ayarlayın.",
  "accountDashboard.preferences.customization.status.savingShort": "Saving...",
  "accountDashboard.preferences.email.resetShort": "Sıfırla",
  "accountDashboard.preferences.email.savePreferences": "Tercihleri kaydet",
  "accountDashboard.preferences.email.savingPreferences": "Saving...",
  "accountDashboard.preferences.email.savingShort": "Saving...",
  "accountDashboard.preferences.email.title": "E-posta tercihleri",
  "accountDashboard.preferences.personalDetails.title": "Kişisel bilgiler",
  "accountDashboard.preferences.title": "Tercihler",
  "accountDashboard.preferences.travel.title": "Rezervasyon tercihleri",
  "accountDashboard.support.contact.title": "Destekle iletişime geç",
  "accountDashboard.support.title": "Destek",
  "accountMenu.savedRecent.label": "Kaydedilen seyahatler",
  "cancel": "İptal",
  "carDetails.cancellation": "İptal",
  "carDetails.freeCancellation": "Ücretsiz iptal",
  "carDetails.nonRefundable": "İade edilemez",
  "carDetails.return": "Regreso",
  "carDetails.unlimitedMileage": "Sınırsız kilometre",
  "carsResults.lowestTotal": "En düşük toplam fiyat",
  "carsResults.passengers": "Pasajeros",
  "carsResults.recommended": "Önerilen",
  "carsResults.sortBy": "Sırala",
  "carsResults.topRated": "EN YÜKSEK PUANLI",
  "carsSearch.returnLocationLabel": "İADE KONUMU",
  "carsSearch.type.airport": "Havalimanı",
  "carsSearch.type.area": "Bölge",
  "carsSearch.type.city": "Şehir",
  "deals.guided.hotelDetails.roomInformation": "Room",
  "editSearch": "Aramayı düzenle",
  "fromPrice": "Nereden",
  "homeRegionalRoutesTitle": "Bölgenizden destinasyonları keşfedin",
  "loginVerifying": "Doğrulanıyor…",
  "nextMonth": "Sonraki ay",
  "onboarding.preferredAirlines": "Tercih edilen havayolları",
  "previousMonth": "Önceki ay",
  "price": "Fiyat",
  "recentSearches.clearAll": "Tümünü temizle",
  "recentSearches.removeAria": "Son aramayı kaldır",
  "recentSearches.title": "Son aramalar",
  "searchCars": "Araç ara",
  "verifyEmailCodeLabel": "Doğrulama kodu",
  "verifyEmailInstructions": "E-postanıza gönderdiğimiz 6 haneli kodu girin. Kodların süresi 10 dakika sonra dolar.",
};
