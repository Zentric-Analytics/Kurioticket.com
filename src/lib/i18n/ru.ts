...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Путешественники",
  "mobileDatePicker.start": "Начало",
  "mobileDatePicker.end": "Конец",
  deals: "Турпакеты",
  ...
  "deals.results.title": "Согласованные результаты поездки",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Согласованные результаты поездки",
  "deals.results.modify": "Modify search · Согласованные результаты поездки",
  "deals.results.viewFlights": "View all flights · Согласованные результаты поездки",
  "deals.results.viewHotels": "View all hotels · Согласованные результаты поездки",
  "deals.results.viewCars": "View car options · Согласованные результаты поездки",
  "deals.results.invalidTitle": "Review your search · Согласованные результаты поездки",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Согласованные результаты поездки",
  "deals.results.noResults": "No matching results were found. · Согласованные результаты поездки",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Согласованные результаты поездки",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Согласованные результаты поездки",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Согласованные результаты поездки",
  "deals.error.flightOriginCode": "Airport selection is required. · Согласованные результаты поездки",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Согласованные результаты поездки",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Согласованные результаты поездки",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Согласованные результаты поездки",
  "deals.error.flightDates": "Select valid flight dates. · Согласованные результаты поездки",
  "deals.error.hotelDestination": "Enter a hotel destination. · Согласованные результаты поездки",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Согласованные результаты поездки",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Согласованные результаты поездки",
  "deals.error.hotelDates": "Select valid hotel dates. · Согласованные результаты поездки",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Согласованные результаты поездки",
  ...
  flightSearchDestinationPlaceholderShort: 'Куда?',
};
