...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Àwọn arìnrìn-àjò",
  "mobileDatePicker.start": "Ìbẹ̀rẹ̀",
  "mobileDatePicker.end": "Ìparí",
  deals: "Àwọn àkójọpọ̀ ìrìnàjò",
  ...
  homeDestinationDubaiCountry: "Àwọn Orílẹ̀-èdè Arabu Ajẹmọ́",
  homeDestinationDubaiAlt: "Dubai, Àwọn Orílẹ̀-èdè Arabu Ajẹmọ́",
  homeDestinationLondonCity: "Lọndọnu",
  homeDestinationLondonCountry: "Ijọba Gẹ̀ẹ́sì",
  homeDestinationLondonAlt: "Lọndọnu, United Kingdom",
  homeDestinationParisCity: "Paris",
  homeDestinationParisCountry: "Faransé",
  homeDestinationParisAlt: "Paris, Faransé",
  homeDestinationBaliCity: "Bali",
  homeDestinationBaliCountry: "Indonésíà",
  homeDestinationBaliAlt: "Bali, Indonesia",
  homeDestinationNewYorkCity: "New York",
  homeDestinationNewYorkCountry: "Orílẹ̀-èdè Amẹ́ríkà",
  homeDestinationNewYorkAlt: "New York, Orílẹ̀-èdè Amẹ́ríkà",
  ...
  "deals.results.title": "Coordinated trip results (yo)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (yo)",
  "deals.results.modify": "Modify search · Coordinated trip results (yo)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (yo)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (yo)",
  "deals.results.viewCars": "View car options · Coordinated trip results (yo)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (yo)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (yo)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (yo)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (yo)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (yo)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (yo)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (yo)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (yo)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (yo)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (yo)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (yo)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (yo)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (yo)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (yo)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (yo)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (yo)",
  ...
  flightSearchDestinationPlaceholderShort: 'Síbo?',
};
