...
export const translations: TranslationDictionary = {
  ...
  homeDestinationDubaiCountry: "Emiriah Arab Bersatu",
  homeDestinationDubaiAlt: "Dubai, Emiriah Arab Bersatu",
  homeDestinationLondonCity: "London",
  homeDestinationLondonCountry: "United Kingdom (UK)",
  homeDestinationLondonAlt: "London, United Kingdom",
  homeDestinationParisCity: "Paris",
  homeDestinationParisCountry: "Perancis",
  homeDestinationParisAlt: "Paris, Perancis",
  ...
  homeDestinationNewYorkCountry: "Amerika Syarikat",
  homeDestinationNewYorkAlt: "New York, Amerika Syarikat",
  ...
  "deals.results.title": "Coordinated trip results (ms)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (ms)",
  "deals.results.modify": "Modify search · Coordinated trip results (ms)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (ms)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (ms)",
  "deals.results.viewCars": "View car options · Coordinated trip results (ms)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (ms)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (ms)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (ms)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (ms)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (ms)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (ms)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (ms)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (ms)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (ms)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (ms)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (ms)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (ms)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (ms)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (ms)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (ms)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (ms)",
};
