...
export const translations: TranslationDictionary = {
  ...
  "deals.guidedPreview.availableReview": "Trip Review with persisted opened-step progress",
  "deals.guidedPreview.availableHandoff": "Final booking-partner handoff for each included product",
  "deals.guidedPreview.previewOnlyTitle": "Preview limitations",
  "deals.guidedPreview.previewOnlyPublicLaunch": "Public activation has not occurred; normal Search remains unchanged.",
  "deals.guidedPreview.previewOnlyBooking": "Kurioticket does not complete booking or payment. Complete each provider step separately.",
  "deals.guided.confirmation.readError": "Saved preview progress could not be read. Try confirmation again.",
  "deals.guided.confirmation.saveError": "Preview progress could not be saved. Try confirmation again.",
  "deals.guided.crossTabUpdated": "This trip was updated in another tab.",
  "deals.guided.prerequisiteChanged": "An earlier trip choice changed in another tab. Your current saved trip is now shown.",
  "deals.guided.conflict.title": "Another guided preview is saved",
  "deals.guided.conflict.body": "This page belongs to a different guided search. To protect its progress, no trip choices or booking-partner actions are available here.",
  "deals.guided.conflict.restart": "Start this preview trip again",
  "deals.guided.conflict.restartDisclosure": "Starting again replaces the guided-preview progress currently saved in this browser.",
  "deals.guided.storageUnavailable.title": "Temporary preview storage is unavailable",
  "deals.guided.storageUnavailable.body": "This guided stage cannot safely save progress. Restore browser storage, then reload and try again.",
  "deals.guided.invalid.title": "Saved preview progress is invalid",
  "deals.guided.invalid.body": "Return to the first guided stage to choose fresh trip options.",
  "deals.guided.expired.title": "Your guided preview has expired",
  "deals.guided.expired.body": "Return to the first guided stage and refresh your trip options.",
  "deals.guided.error.title": "We could not show this guided Deals page",
  "deals.guided.error.body": "Your booking-partner pages were not opened. Try this page again or return safely to Deals.",
  ...
  "deals.guidedPreview.description": "Explore the complete internal preview: Hotel, Flight, and Car results, details, and confirmation, followed by Review and the final booking-partner handoff.",
  "deals.guidedPreview.availableTitle": "Available now",
  "deals.guidedPreview.availableHotel": "Hotel results, room selection, details, and confirmation",
  "deals.guidedPreview.availableFlight": "Flight results, filters, sorting, details, and confirmation",
  "deals.guidedPreview.availableCar": "Car results, filters, sorting, details, and confirmation",
  "deals.guidedPreview.inProgressTitle": "Still in progress",
  "deals.guidedPreview.inProgressCar": "Car details and confirmation",
  "deals.guidedPreview.inProgressReview": "Review and final handoff",
  "deals.guidedPreview.normalSearchNote": "This internal preview does not publicly activate guided Deals. Normal Search still opens the standard Deals results.",
  "deals.guidedPreview.action": "Preview guided journey",
  "deals.guidedPreview.accessibleName": "Internal preview of the guided Deals journey",
  ...
  "deals.guided.flightResults.viewDetailsAria": "View flight details for {{airline}}, {{origin}} to {{destination}}",
  ...
  "deals.guided.flightResults.emptyBody": "Try modifying your search or retrying flights to check availability again.",
  "deals.guided.flightResults.errorTitle": "Unable to load flight results",
  "deals.guided.flightResults.errorBody": "Retry flights to check availability again without changing your guided trip plan.",
  "deals.guided.flightResults.retry": "Retry Flights",
  "deals.guided.flightDetails.pendingTitle": "Your selected flight is ready for review",
  "deals.guided.flightDetails.pendingBody": "Flight details and fare confirmation will appear on this step.",
  "deals.guided.flightDetails.confirmCars": "Choose this flight and continue to cars",
  "deals.guided.flightDetails.confirmReview": "Choose this flight and review trip",
  "deals.guided.flightDetails.confirmCarsA11y": "Choose {airline} flight from {origin} to {destination} and continue to cars",
  ...
  "deals.guided.carResults.pendingBody": "Car options will appear on this step.",
  ...
  "deals.guided.carResults.errorBody": "Please retry the car search. Your confirmed trip selections are unchanged.",
  "deals.guided.carResults.emptyTitle": "No cars are available",
  "deals.guided.carResults.emptyBody": "No car inventory is currently available for this search. You can retry or modify your search.",
  "deals.guided.carResults.retry": "Retry Cars",
  "deals.guided.carResults.actionLabel": "View car details",
  "deals.guided.carResults.actionAriaLabel": "View details for {model} from {company}",
  "deals.guided.carDetails.pendingTitle": "Your selected car is ready for review",
  "deals.guided.carDetails.pendingBody": "Car details and rental confirmation will appear on this step.",
  "deals.guided.carDetails.loading": "Loading car details…",
  "deals.guided.carDetails.errorTitle": "We could not load this car",
  "deals.guided.carDetails.errorBody": "Car details are temporarily unavailable. Your confirmed trip options have not changed.",
  "deals.guided.carDetails.unavailableTitle": "This car is no longer available",
  "deals.guided.carDetails.unavailableBody": "Return to Car results or retry the search for this vehicle.",
  "deals.guided.carDetails.retry": "Retry car details",
  "deals.guided.carDetails.confirmReview": "Confirm car and review trip",
  "deals.guided.carDetails.confirmReviewA11y": "Confirm {model} from {company} and review trip",
  "deals.guided.carDetails.saving": "Saving car…",
  "deals.guided.carDetails.saveError": "We could not save this car. Your confirmed Hotel and Flight selections have not changed. Try again.",
  "deals.guided.carDetails.unavailableConfirm": "Car confirmation is unavailable until the selected vehicle has loaded.",
  "deals.guided.carDetails.confirmed": "Car confirmed. Review your trip.",
  "deals.guided.review.pendingTitle": "Your trip selections are ready for review",
  "deals.guided.review.pendingBody": "Your complete trip summary will appear on this step.",
  ...
  "deals.guided.hotelDetails.continueFlights": "Choose this room and continue to flights",
  "deals.guided.hotelDetails.continueCars": "Choose this room and continue to cars",
  "deals.guided.hotelDetails.roomUnavailable": "This room cannot be added to your Trip Plan because a current live room rate is unavailable.",
  "deals.guided.hotelDetails.saveError": "We could not save this room to your guided Trip Plan. Please try again.",
  ...
  "deals.guided.handoff.storageReadFailedBody": "We could not recheck your saved trip, so this step was not opened. Try again.",
