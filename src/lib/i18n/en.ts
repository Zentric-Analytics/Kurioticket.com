...
export const translations: TranslationDictionary = {
  ...
  "deals.handoff.title": "Continue with your providers",
  "deals.handoff.explanation": "Your selected options are completed separately. Each provider confirms the final price, availability, payment and booking.",
