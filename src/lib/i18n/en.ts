...
export const translations: TranslationDictionary = {
  ...
  "deals.results.tripOptionsTitle": "Trip options for your search",
  "deals.results.tripOptionsExplanation": "Compare recommended options for each part of your trip. Final prices, availability and booking are confirmed by the travel provider.",
  ...
  "deals.results.previewCount": "{{visible}} recommended previews from {{total}} returned options",
  "deals.results.returnedOptions": "{{total}} options returned",
  "deals.results.openCompleteResults": "Open the complete results to use filters and compare more options.",
  ...
  "deals.results.providedBy": "Provided by {{provider}}",
  ...
  "deals.results.flight.recommended.reason": "Selected for its value score in these results.",
  "deals.results.flight.lowest.badge": "Lowest price in these results",
  "deals.results.flight.lowest.reason": "The lowest positive provider price among the returned options.",
  "deals.results.flight.shortest.badge": "Shortest journey in these results",
  "deals.results.flight.shortest.reason": "The shortest valid journey duration among the returned options.",
  "deals.results.hotel.recommended.badge": "Recommended stay",
  "deals.results.hotel.recommended.reason": "Selected for its value score in these results.",
  "deals.results.hotel.lowest.badge": "Lowest total in these results",
  "deals.results.hotel.lowest.reason": "The lowest bookable total among the returned stays.",
  ...
  "deals.results.preview.more.reason": "Another returned option to help broaden your comparison.",
