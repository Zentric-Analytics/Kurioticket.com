...
export const translations: TranslationDictionary = {
  ...
  "deals.tripPlan.disclosure": "Each item is booked separately with its provider.",
  "deals.tripPlan.estimatedTotal": "Estimated trip total",
  "deals.tripPlan.changeOption": "Change trip option",
  "deals.tripPlan.reviewSteps": "Review separate booking steps",
  ...
  "deals.handoff.title": "Review separate provider booking steps",
  ...
  "deals.handoff.tripSummary": "Separate booking summary",
  "deals.handoff.providerSteps": "Separate provider booking steps",
  ...
  "deals.results.package.intro": "Kurioticket combines separately sourced flights, stays and cars into these options. You’ll review and book each item separately with its provider.",
  ...
  "deals.results.package.providerCount": "Provider sources: {{count}}",
  "deals.results.package.disclosure": "This is not one package booking. Prices and availability are confirmed separately by each provider.",
  "deals.results.package.bookingModel": "Mix-and-match trip option. Its included items are booked separately with their providers.",
