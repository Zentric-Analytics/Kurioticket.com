...
export const translations: TranslationDictionary = {
  ...
  "accountDashboard.priceAlerts.description": "View provider-backed alert records saved to your Kurioticket account.",
  "accountDashboard.priceAlerts.empty.title": "No price alerts yet.",
  "accountDashboard.priceAlerts.empty.body": "Save searches or routes to keep track of trips you care about.",
  ...
  loginCodeInstructions:
    "Enter the 6-digit code sent to {{email}}. Codes expire after 10 minutes.",
