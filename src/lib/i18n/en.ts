...
export const translations: TranslationDictionary = {
  ...
  "deals.results.tripOptionsExplanation": "Compare options for each part of your trip. Prices and availability remain product-specific, and each booking is completed separately.",
