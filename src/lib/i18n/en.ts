...
export const translations: TranslationDictionary = {
  ...
  "deals.guidedPreview.description": "Explore the Hotel, Flight, and Car experiences built so far. Hotel and Flight details and confirmation are available. Car details, Review, and final handoff are still in progress.",
  ...
  "deals.guidedPreview.availableCar": "Car results, filters, and sorting",
