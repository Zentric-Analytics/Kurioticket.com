...
export const translations: TranslationDictionary = {
  ...
  "accountDashboard.preferences.email.subtitle": "Choose which Kurioticket emails you want to receive. We’ll still send critical account, security, and support messages when needed.",
  "accountDashboard.preferences.email.settingsTitle": "Email settings",
  "accountDashboard.preferences.email.settingsDescription": "Manage optional updates and review the required messages that keep your account running safely.",
  ...
  "accountDashboard.preferences.email.sections.requiredEmails.title": "Required emails",
  ...
  "accountDashboard.preferences.email.rows.securityAlerts.title": "Security alerts",
  "accountDashboard.preferences.email.rows.securityAlerts.description": "Important sign-in, password, and account protection messages.",
  "accountDashboard.preferences.email.rows.supportReplies.title": "Support replies",
  "accountDashboard.preferences.email.rows.supportReplies.description": "Replies to support requests and account help conversations.",
  "accountDashboard.preferences.email.rows.billingReceipts.title": "Billing receipts",
  "accountDashboard.preferences.email.rows.billingReceipts.description": "Subscription, receipt, and billing-related messages when applicable.",
  "accountDashboard.preferences.email.alwaysOn": "Always on",
  ...
  "accountDashboard.preferences.email.trustNote": "We respect your inbox. You can update these preferences anytime.",
  "accountDashboard.preferences.email.previewSaveStatus": "Email preference saving will be connected soon. Your choices are shown here for preview only.",
