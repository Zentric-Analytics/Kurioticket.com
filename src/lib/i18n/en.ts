...
export const translations: TranslationDictionary = {
  ...
  "deals.tripPlan.title": "Your trip plan",
  ...
  "deals.tripPlan.disclosure": "Choosing an option does not book it. These options are completed separately with their providers.",
  ...
  "deals.handoff.title": "Complete your trip with each provider",
  "deals.handoff.explanation": "Review each selected item separately. Final price, availability, payment and booking are confirmed on the relevant details page.",
  ...
  "deals.handoff.openFlight": "Open Flight details",
  "deals.handoff.openStay": "Open Hotel details",
  ...
  "deals.handoff.tripSummary": "Trip summary",
  "deals.handoff.providerSteps": "Provider review steps",
  "deals.handoff.stepCount": "Step {{position}} of {{total}}",
  "deals.handoff.progress": "{{opened}} of {{total}} provider pages opened",
  "deals.handoff.allPagesOpened": "All provider pages opened",
  "deals.handoff.estimatedCombinedTotal": "Estimated combined total",
  "deals.handoff.combinedEstimateUnavailable": "Combined estimate unavailable",
  "deals.handoff.estimateDisclosure": "This combined amount is an estimate. Individual provider prices are authoritative and final prices can change.",
  "deals.handoff.openingDoesNotBook": "Opening a provider page marks it as reviewed here. It does not confirm a booking.",
  ...
  "deals.handoff.goToNextStep": "Go to next step",
  ...
  "deals.handoff.reviewStayAgain": "Review Hotel details again",
  ...
  "deals.handoff.openedAnnouncement": "{{product}} details opened in a new tab. {{opened}} of {{total}} provider pages opened.",
  ...
  "deals.results.package.title": "Combined trip options",
  "deals.results.package.intro": "Each option includes everything in your search. Compare complete combinations, then continue separately with each provider.",
  "deals.results.package.loading": "Building complete trip options…",
  ...
  "deals.results.package.unavailableTitle": "A complete live trip is not available for this search",
  ...
  "deals.results.package.hotelEmpty": "Hotels returned no results.",
  ...
  "deals.results.package.hotelUnavailable": "The returned hotels do not have a live price and a safe, bookable details action.",
  ...
  "deals.results.package.price.hotel": "Hotel stay total",
  "deals.results.package.price.car": "Car rental total",
  "deals.results.package.providerPrice": "Provider price",
  "deals.results.package.notProvided": "Not provided",
  "deals.results.package.estimatedTotal": "Estimated combined total",
  "deals.results.package.providerCount": "Assembled from {{count}} providers",
  "deals.results.package.disclosure": "Estimated combined price from the provider results shown. You will book each item separately with its provider; final prices and availability may change.",
  "deals.results.package.choose": "Choose this trip",
  "deals.results.package.selected": "Trip selected",
  "deals.results.package.selectedAnnouncement": "Complete trip option added to your trip plan.",
  ...
  "deals.results.package.lowest-total.badge": "Lowest combined total",
  ...
  "deals.results.editor.clearMultiple": "Updating this search will clear your selected package options.",
  "deals.handoff.carPrice": "Selected car total",
  "deals.handoff.openCarDetails": "Open car details",
  "deals.handoff.reviewCarAgain": "Review selected car again",
