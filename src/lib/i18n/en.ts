...
export const translations: TranslationDictionary = {
  ...
  "accountDashboard.trips.subtitle": "View and manage your upcoming, past, and cancelled trips in one place.",
  ...
  "accountDashboard.trips.current.empty.title": "No upcoming trips yet",
  "accountDashboard.trips.current.empty.body": "When you book a flight, hotel, or travel package, your upcoming trips will appear here.",
  "accountDashboard.trips.current.empty.searchFlights": "Search flights",
  "accountDashboard.trips.current.empty.exploreHotels": "Explore hotels",
  ...
  "accountDashboard.trips.history.tabs.upcoming": "Upcoming",
  "accountDashboard.trips.history.tabs.past": "Past",
  "accountDashboard.trips.history.tabs.cancelled": "Cancelled",
  "accountDashboard.trips.history.empty.past.title": "No past trips yet",
  "accountDashboard.trips.history.empty.past.body": "Completed trips and booking history will appear here after you travel.",
  "accountDashboard.trips.history.empty.past.cta": "Start planning a trip",
  "accountDashboard.trips.history.empty.cancelled.title": "No cancelled trips",
  "accountDashboard.trips.history.empty.cancelled.body": "Trips you cancel will appear here for reference.",
  "accountDashboard.trips.history.empty.cancelled.cta": "Contact support",
