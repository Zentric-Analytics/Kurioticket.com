...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Keliautojai",
  "mobileDatePicker.start": "Pradžia",
  "mobileDatePicker.end": "Pabaiga",
  deals: "Kelionių paketai",
  ...
  fromPrice: "Nuo",
  homeDestinationDubaiCity: "Dubajus",
  homeDestinationDubaiCountry: "Jungtiniai Arabų Emyratai",
  homeDestinationDubaiAlt: "Dubajus, Jungtiniai Arabų Emyratai",
  homeDestinationLondonCity: "Londonas",
  homeDestinationLondonCountry: "Jungtinė Karalystė",
  homeDestinationLondonAlt: "Londonas, Jungtinė Karalystė",
  homeDestinationParisCity: "Paryžius",
  homeDestinationParisCountry: "Prancūzija",
  homeDestinationParisAlt: "Paryžius, Prancūzija",
  homeDestinationBaliCity: "Balis",
  homeDestinationBaliCountry: "Indonezija",
  homeDestinationBaliAlt: "Balis, Indonezija",
  homeDestinationNewYorkCity: "Niujorkas",
  homeDestinationNewYorkCountry: "Jungtinės Valstijos",
  homeDestinationNewYorkAlt: "Niujorkas, Jungtinės Valstijos",
  ...
  "deals.results.title": "Coordinated trip results (lt)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (lt)",
  "deals.results.modify": "Modify search · Coordinated trip results (lt)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (lt)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (lt)",
  "deals.results.viewCars": "View car options · Coordinated trip results (lt)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (lt)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (lt)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (lt)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (lt)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (lt)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (lt)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (lt)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (lt)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (lt)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (lt)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (lt)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (lt)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (lt)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (lt)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (lt)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (lt)",
  ...
  flightSearchDestinationPlaceholderShort: 'Kur?',
};
