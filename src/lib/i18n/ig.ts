...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Ndị njem",
  "mobileDatePicker.start": "Mbido",
  "mobileDatePicker.end": "Ọgwụgwụ",
  deals: "Ngwugwu njem",
  ...
  homeDestinationDubaiCountry: "United Arab Emirates",
  homeDestinationDubaiAlt: "Dubai, United Arab Emirates",
  homeDestinationLondonCity: "London",
  homeDestinationLondonCountry: "Alaeze Obodo Britain",
  homeDestinationLondonAlt: "London, United Kingdom",
  homeDestinationParisCity: "Paris",
  homeDestinationParisCountry: "Furansị",
  homeDestinationParisAlt: "Paris, France",
  homeDestinationBaliCity: "Bali",
  homeDestinationBaliCountry: "Indonisia",
  homeDestinationBaliAlt: "Bali, Indonesia",
  homeDestinationNewYorkCity: "New York",
  homeDestinationNewYorkCountry: "Amerịka",
  homeDestinationNewYorkAlt: "New York, United States",
  ...
  "deals.results.title": "Coordinated trip results (ig)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (ig)",
  "deals.results.modify": "Modify search · Coordinated trip results (ig)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (ig)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (ig)",
  "deals.results.viewCars": "View car options · Coordinated trip results (ig)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (ig)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (ig)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (ig)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (ig)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (ig)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (ig)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (ig)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (ig)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (ig)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (ig)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (ig)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (ig)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (ig)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (ig)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (ig)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (ig)",
  ...
  flightSearchDestinationPlaceholderShort: 'Ebee?',
};
