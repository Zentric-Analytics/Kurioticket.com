...
export const translations: TranslationDictionary = {
  ...en,
  "deals.guidedPreview.description": "Pratinjau Deals terpandu: Complete guided Deals preview: Hotel, Flight and Car selection and confirmation, Review, and final partner handoff.",
  "deals.guidedPreview.availableCar": "Pratinjau Deals terpandu: Car results, filters, sorting, details, and confirmation",
  "deals.guidedPreview.availableReview": "Pratinjau Deals terpandu: Trip Review with persisted opened-step progress",
  "deals.guidedPreview.availableHandoff": "Pratinjau Deals terpandu: Final booking-partner handoff for each included product",
  "deals.guidedPreview.previewOnlyTitle": "Pratinjau Deals terpandu: Internal preview limitations",
  "deals.guidedPreview.previewOnlyPublicLaunch": "Pratinjau Deals terpandu: Public activation has not occurred; normal Search remains unchanged.",
  "deals.guidedPreview.previewOnlyBooking": "Pratinjau Deals terpandu: Kurioticket does not complete booking or payment. Complete each provider step separately.",
  "deals.guided.confirmation.readError": "Pratinjau Deals terpandu: Saved preview progress could not be read. Try confirmation again.",
  "deals.guided.confirmation.saveError": "Pratinjau Deals terpandu: Preview progress could not be saved. Try confirmation again.",
  "deals.guided.crossTabUpdated": "Pratinjau Deals terpandu: This trip was updated in another tab.",
  "deals.guided.prerequisiteChanged": "Pratinjau Deals terpandu: An earlier trip choice changed in another tab. Your current saved trip is now shown.",
  "deals.guided.conflict.title": "Pratinjau Deals terpandu: Another guided preview is saved",
  "deals.guided.conflict.body": "Pratinjau Deals terpandu: This page belongs to a different guided search. Its saved progress is protected.",
  "deals.guided.conflict.restart": "Pratinjau Deals terpandu: Start this preview trip again",
  "deals.guided.conflict.restartDisclosure": "Pratinjau Deals terpandu: Starting again replaces the guided-preview progress currently saved in this browser.",
  "deals.guided.error.title": "Pratinjau Deals terpandu: We could not show this guided Deals page",
  "deals.guided.error.body": "Pratinjau Deals terpandu: No booking-partner page was opened. Try again or return safely to Deals.",
  "deals.guided.error.retry": "Pratinjau Deals terpandu: Try again",
  "deals.guided.error.returnDeals": "Pratinjau Deals terpandu: Return to Deals",
  "deals.guided.storageUnavailable.title": "Pratinjau Deals terpandu: Temporary preview storage is unavailable",
  "deals.guided.storageUnavailable.body": "Pratinjau Deals terpandu: This guided stage cannot safely save progress. Restore browser storage and reload.",
  "deals.guided.invalid.title": "Pratinjau Deals terpandu: Saved preview progress is invalid",
  "deals.guided.invalid.body": "Pratinjau Deals terpandu: Return to the first guided stage to choose fresh trip options.",
  "deals.guided.expired.title": "Pratinjau Deals terpandu: Your guided preview has expired",
  "deals.guided.expired.body": "Pratinjau Deals terpandu: Return to the first guided stage and refresh your trip options.",
