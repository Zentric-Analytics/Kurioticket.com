...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Matafiya",
  "mobileDatePicker.start": "Farawa",
  "mobileDatePicker.end": "Ƙarshe",
  deals: "Kunshin tafiya",
  ...
  homeDestinationDubaiCountry: "Haɗaɗɗun Daular Larabawa",
  homeDestinationDubaiAlt: "Dubai, Haɗaɗɗun Daular Larabawa",
  homeDestinationLondonCity: "Landan",
  homeDestinationLondonCountry: "Birtaniya",
  homeDestinationLondonAlt: "Landan, Birtaniya",
  homeDestinationParisCity: "Paris",
  homeDestinationParisCountry: "Faransa",
  homeDestinationParisAlt: "Paris, Faransa",
  homeDestinationBaliCity: "Bali",
  homeDestinationBaliCountry: "Indonesiya",
  homeDestinationBaliAlt: "Bali, Indonesia",
  homeDestinationNewYorkCity: "New York",
  homeDestinationNewYorkCountry: "Amurka",
  homeDestinationNewYorkAlt: "New York, Amurka",
  ...
  "deals.results.title": "Coordinated trip results (ha)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (ha)",
  "deals.results.modify": "Modify search · Coordinated trip results (ha)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (ha)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (ha)",
  "deals.results.viewCars": "View car options · Coordinated trip results (ha)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (ha)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (ha)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (ha)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (ha)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (ha)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (ha)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (ha)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (ha)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (ha)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (ha)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (ha)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (ha)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (ha)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (ha)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (ha)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (ha)",
  ...
  flightSearchDestinationPlaceholderShort: 'Ina?',
};
