...
export const translations: TranslationDictionary = {
  ...
  "legal.terms.sections.acceptable-use.paragraph1": "Você não pode abusar dos sistemas de pesquisa, alertas, suporte, conta ou redirecionamento para provedores; fazer engenharia reversa de integrações com provedores; tentar contornar limites de uso; ou usar o Kurioticket para atividades fraudulentas, ilegais ou prejudiciais.",
  "legal.terms.sections.acceptable-use.paragraph2": "Podemos suspender o acesso se a atividade ameaçar a confiabilidade da plataforma, os relacionamentos com provedores, a segurança do serviço ou a segurança dos usuários.",
  ...
  "legal.terms.sections.partner-services.paragraph2": "Os termos do parceiro se aplicam quando você sai do Kurioticket ou conclui uma transação com um parceiro. Revise todos os requisitos de tarifa, hotel, bagagem, alteração, reembolso, visto e viajante antes da compra.",
  ...
  "legal.acceptableUsePolicy.summary": "Regras de comportamento para o uso seguro, justo e legal dos sistemas do Kurioticket.",
  ...
  "legal.acceptableUsePolicy.sections.prohibited.paragraph1": "Você não pode extrair dados do Kurioticket, extrair dados de sites de companhias aéreas por meio do Kurioticket, atacar APIs de provedores, automatizar pesquisas abusivas, criar contas fraudulentas, testar cartões roubados, enviar spam ao suporte ou interferir na confiabilidade da plataforma.",
  ...
  "legal.privacy.sections.data-we-collect.paragraph1": "Coletamos dados de conta, como nome, e-mail, senha com hash, identificadores de provedor de autenticação e preferências opcionais de viagem. Não solicitamos dados de passaporte, documento oficial de identidade ou endereço residencial no cadastro.",
  "legal.privacy.sections.data-we-collect.paragraph2": "Coletamos dados de produto, como pesquisas, voos salvos, hotéis salvos, pesquisas salvas, alertas de preço, redirecionamentos, chamados de suporte, notificações, eventos de análise e uso de recursos.",
  ...
  "legal.privacy.sections.choices.paragraph2": "Retemos apenas dados úteis para operação do produto, segurança, suporte, análises, conformidade ou necessidades comerciais legítimas.",
  ...
  "legal.cookiePolicy.sections.use.paragraph1": "O Kurioticket pode usar cookies para sessões de autenticação, segurança, prevenção de fraudes, armazenamento de preferências, análises, monitoramento de desempenho e experimentos de recursos.",
  "legal.cookiePolicy.sections.use.paragraph2": "Alguns cookies são necessários para login, acesso a painéis, chamados de suporte, recursos de viagem salvos, segurança e preferências.",
  ...
  "legal.cookiePolicy.sections.third-parties.paragraph2": "Sites de provedores externos têm suas próprias práticas de cookies após o redirecionamento.",
  ...
  "legal.affiliateDisclosure.sections.ranking.paragraph1": "O Kurioticket busca classificar resultados por sinais de valor para o usuário, como preço, duração, escalas, confiança, conforto e redução de estresse. Relações de afiliados não devem criar urgência falsa, taxas ocultas ou recomendações enganosas.",
  ...
  "legal.dataDeletionPolicy.summary": "Como usuários podem solicitar a exclusão da conta e quais dados talvez precisem ser retidos.",
  ...
  "legal.dataDeletionPolicy.sections.request.paragraph1": "Você pode solicitar a exclusão da conta nas configurações da conta ou pelo suporte. Processaremos solicitações de exclusão de acordo com a lei aplicável, necessidades de verificação de identidade, prevenção de fraudes, obrigações legais e requisitos de segurança.",
  "legal.dataDeletionPolicy.sections.retention.title": "Registros retidos",
  "legal.dataDeletionPolicy.sections.retention.paragraph1": "Alguns registros podem ser retidos para fins comerciais legítimos, segurança, análises, obrigações legais, prevenção de abuso ou resolução de disputas. Minimizamos os dados pessoais retidos sempre que viável.",
  ...
  "legal.refundBookingDisclaimer.title": "Aviso de reembolso e provedor externo",
  "legal.refundBookingDisclaimer.summary": "Esclarece que compras, emissão de passagens, reembolsos, cancelamentos e pagamentos de inventário de viagem acontecem fora do Kurioticket.",
  ...
  "legal.refundBookingDisclaimer.sections.refunds.paragraph2": "O suporte do Kurioticket pode ajudar você a entender o uso da plataforma e os limites de orientação de viagem, mas não pode substituir políticas de parceiros ou companhias aéreas.",
  ...
  "legal.priceAvailabilityDisclaimer.title": "Aviso de preço e disponibilidade",
  "legal.priceAvailabilityDisclaimer.summary": "Explica por que preços de viagem, regras tarifárias, diárias e disponibilidade podem mudar.",
  ...
  "legal.priceAvailabilityDisclaimer.sections.change.paragraph2": "O Kurioticket busca comparar dados atuais de provedores, mas atrasos de provedores, limites de uso, janelas de cache, conversão de moeda, regras de parceiros e seleções do usuário podem afetar as informações exibidas.",
  "legal.priceAvailabilityDisclaimer.sections.verify.title": "Verifique antes do pagamento",
  "legal.priceAvailabilityDisclaimer.sections.verify.paragraph1": "Sempre revise o site do provedor externo antes da compra. O site do provedor externo é a fonte autorizada para preço final, disponibilidade, condições tarifárias, condições do quarto e termos de compra.",
  ...
  "legal.partnerRedirectDisclaimer.title": "Aviso de redirecionamento para parceiro",
