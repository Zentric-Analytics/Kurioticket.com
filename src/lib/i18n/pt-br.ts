...
export const translations: TranslationDictionary = {
  ...
  loginSubmit: "Entrar",
  loginCheckingDetails: "Verificando detalhes…",
  ...
  forgotPasswordLoginLink: "Voltar para entrar",
  resetPasswordPageTitle: "Redefinir senha",
  resetPasswordNewPasswordTitle: "Criar uma nova senha",
  resetPasswordNewPasswordSubtitle: "Informe sua nova senha abaixo.",
  ...
  resetPasswordSubmitting: "Redefinindo...",
  resetPasswordRememberPrompt: "Lembrou sua senha?",
  resetPasswordLoginLink: "Voltar para entrar",
  resetPasswordRequestNewLink: "Solicitar um novo e-mail de redefinição",
  verifyEmailPageTitle: "Verificar e-mail",
  verifyEmailPageSubtitle:
  ...
  verifyEmailResendSending: "Enviando...",
  verifyEmailResendCode: "Enviar um novo código",
  verifyEmailAlreadyVerifiedPrompt: "Já verificado?",
  verifyEmailLoginLink: "Entrar",
  verifyLoginPageTitle: "Verificar login",
  verifyLoginPageSubtitle:
    "Informe o código de 6 dígitos que enviamos para seu e-mail. Os códigos expiram após 10 minutos.",
  verifyLoginCodeLabel: "Código de login",
  verifyLoginSubmit: "Verificar login",
  verifyLoginSubmitting: "Verificando…",
  verifyLoginNewCodePrompt:
    "Precisa de um novo código? Informe sua senha para que possamos reenviar com segurança.",
  verifyLoginPasswordLabel: "Senha para reenviar",
  verifyLoginSendingCode: "Enviando código…",
  verifyLoginResendIn: "Reenviar em {{seconds}} s",
  verifyLoginResendCode: "Reenviar código",
  verifyLoginStartOverPrompt: "Precisa recomeçar?",
