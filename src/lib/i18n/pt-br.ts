...
export const translations: TranslationDictionary = {
  ...
  "accountDashboard.priceAlerts.description": "Veja registros de alertas baseados em provedores salvos na sua conta Kurioticket.",
  "accountDashboard.priceAlerts.empty.title": "Ainda não há alertas de preço.",
  "accountDashboard.priceAlerts.empty.body": "Salve buscas ou rotas para acompanhar as viagens que são importantes para você.",
  ...
  "accountDashboard.trips.history.empty.cancelled.body": "Suas reservas canceladas aparecerão aqui para referência.",
