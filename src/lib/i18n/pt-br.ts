...
export const translations: TranslationDictionary = {
  ...
  "deals.guidedPreview.description": "Prévia guiada de Ofertas: Complete guided Deals preview: Hotel, Flight and Car selection and confirmation, Review, and final partner handoff.",
  ...
  "deals.guided.error.title": "Prévia guiada de Ofertas: We could not show this guided Deals page",
  "deals.guided.error.body": "Prévia guiada de Ofertas: No booking-partner page was opened. Try again or return safely to Deals.",
  "deals.guided.error.retry": "Prévia guiada de Ofertas: Try again",
  "deals.guided.error.returnDeals": "Prévia guiada de Ofertas: Return to Deals",
