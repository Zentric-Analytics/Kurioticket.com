...
export const translations: TranslationDictionary = {
  ...
  "deals.guidedPreview.description": "Prévia guiada de Ofertas: Complete guided Pacotes preview: Hotel, Flight and Car selection and confirmation, Review, and final partner handoff.",
  "deals.guidedPreview.availableCar": "Prévia guiada de Ofertas: Car results, filters, sorting, details, and confirmation",
  "deals.guidedPreview.availableReview": "Prévia guiada de Ofertas: Trip Review with persisted opened-step progress",
  "deals.guidedPreview.availableHandoff": "Prévia guiada de Ofertas: Final booking-partner handoff for each included product",
  "deals.guidedPreview.previewOnlyTitle": "Prévia guiada de Ofertas: Internal preview limitations",
  "deals.guidedPreview.previewOnlyPublicLaunch": "Prévia guiada de Ofertas: Public activation has not occurred; normal Search remains unchanged.",
  "deals.guidedPreview.previewOnlyBooking": "Prévia guiada de Ofertas: Kurioticket does not complete booking or payment. Complete each provider step separately.",
  "deals.guided.confirmation.readError": "Prévia guiada de Ofertas: Saved preview progress could not be read. Try confirmation again.",
  "deals.guided.confirmation.saveError": "Prévia guiada de Ofertas: Preview progress could not be saved. Try confirmation again.",
  "deals.guided.crossTabUpdated": "Prévia guiada de Ofertas: This trip was updated in another tab.",
  "deals.guided.prerequisiteChanged": "Prévia guiada de Ofertas: An earlier trip choice changed in another tab. Your current saved trip is now shown.",
  "deals.guided.conflict.title": "Prévia guiada de Ofertas: Another guided preview is saved",
  "deals.guided.conflict.body": "Prévia guiada de Ofertas: This page belongs to a different guided search. Its saved progress is protected.",
  "deals.guided.conflict.restart": "Prévia guiada de Ofertas: Start this preview trip again",
  "deals.guided.conflict.restartDisclosure": "Prévia guiada de Ofertas: Starting again replaces the guided-preview progress currently saved in this browser.",
  "deals.guided.error.title": "Prévia guiada de Ofertas: We could not show this guided Pacotes page",
  "deals.guided.error.body": "Prévia guiada de Ofertas: No booking-partner page was opened. Try again or return safely to Pacotes.",
  "deals.guided.error.retry": "Prévia guiada de Ofertas: Try again",
  "deals.guided.error.returnDeals": "Prévia guiada de Ofertas: Return to Pacotes",
  "deals.guided.storageUnavailable.title": "Prévia guiada de Ofertas: Temporary preview storage is unavailable",
  "deals.guided.storageUnavailable.body": "Prévia guiada de Ofertas: This guided stage cannot safely save progress. Restore browser storage and reload.",
  "deals.guided.invalid.title": "Prévia guiada de Ofertas: Saved preview progress is invalid",
  "deals.guided.invalid.body": "Prévia guiada de Ofertas: Return to the first guided stage to choose fresh trip options.",
  "deals.guided.expired.title": "Prévia guiada de Ofertas: Your guided preview has expired",
  "deals.guided.expired.body": "Prévia guiada de Ofertas: Return to the first guided stage and refresh your trip options.",
  "metadata.root.title.default": "Kurioticket | Encontre voos baratos rapidamente",
  "metadata.root.description": "Compare voos e hotéis acessíveis em segundos com uma plataforma de decisão de viagem mais tranquila.",
  destinationsLoadingPage: "Carregando a página de destinos...",
  "brandedLoading.default.title": "Carregando Kurioticket...",
  "brandedLoading.default.preparingExperience": "Preparando sua experiência...",
  ...
  contactMetadataTitle: "Entrar em contato com a Kurioticket",
  ...
  exploreWaysRouteTitle: "Descoberta de rotas",
  exploreWaysRouteText: "Comece por uma rota de voo e depois compare horários, conexões e opções de fornecedores quando houver resultados disponíveis.",
  exploreWaysHotelsTitle: "Ideias de destinos para hotéis",
  exploreWaysHotelsText: "Use buscas de hotéis por destino para comparar opções de estadia, localizações e termos de cancelamento.",
  exploreWaysSavedTitle: "Viagens salvas e buscas recentes",
  exploreWaysSavedText: "Volte para rotas e buscas que você já iniciou para manter o planejamento organizado em várias sessões.",
  exploreWaysBasicsTitle: "Noções básicas de planejamento de viagem",
  exploreWaysBasicsText: "Pense em datas, flexibilidade, bagagem, necessidades de hospedagem e políticas dos fornecedores antes de se comprometer.",
  exploreNeedsTitle: "Planeje por necessidade de viagem",
  exploreNeedsWeekendTitle: "Fins de semana em cidades",
  exploreNeedsWeekendText: "Compare rotas mais curtas, horários simples e localizações de hotéis que caibam em pouco tempo fora.",
  exploreNeedsInternationalTitle: "Viagens internacionais",
  exploreNeedsInternationalText: "Revise itinerários mais longos com cuidado, incluindo tempo total de viagem, conexões, requisitos de entrada e termos do fornecedor.",
  exploreNeedsHotelFirstTitle: "Planejamento começando pelo hotel",
  exploreNeedsHotelFirstText: "Comece pelo lugar onde deseja se hospedar e depois alinhe voos e outras partes da viagem a esse local.",
  exploreNeedsCompleteTitle: "Planejamento completo da viagem",
  exploreNeedsCompleteText: "Use voos, hotéis, viagens salvas e buscas recentes juntos para manter clara a visão completa da viagem.",
  exploreChecklistTitle: "Antes de reservar",
  exploreChecklistTime: "Compare o tempo total de viagem e as conexões",
  exploreChecklistBaggage: "Revise bagagem e flexibilidade",
  exploreChecklistHotel: "Confira a localização do hotel e as regras de cancelamento",
  exploreChecklistProvider: "Confirme preço final e disponibilidade com o fornecedor",
  exploreChecklistSave: "Salve rotas ou buscas para depois",
  explorePrimaryCta: "Buscar voos",
  exploreSecondaryCta: "Buscar hotéis",
  exploreSavedCta: "Ver viagens salvas",
  twoFactorLoadingChallenge: "Carregando desafio de dois fatores…",
  twoFactorEyebrow: "Autenticação de dois fatores",
  twoFactorTitle: "Digite seu código do autenticador",
  twoFactorSubtitle: "Use o código de 6 dígitos do seu aplicativo autenticador ou informe um código de recuperação salvo para concluir o login.",
  twoFactorCodeLabel: "Código do autenticador ou de recuperação",
  twoFactorHelperText: "Abra seu aplicativo autenticador e digite o código atual de 6 dígitos, ou use um código de recuperação.",
  twoFactorInvalidCode: "O código é inválido ou já foi usado.",
  twoFactorVerifying: "Verificando…",
  twoFactorSubmit: "Verificar e continuar",
  twoFactorBackToLogin: "Voltar / sair",
  loginDivider: "OU",
  ...
  "guides.metadata.best-time-to-book-flights.title": "Melhor momento para reservar voos",
  "guides.metadata.best-time-to-book-flights.description": "Saiba quando reservar voos, comparar o timing das tarifas e evitar pagar demais pela sua próxima viagem.",
  "guides.metadata.how-to-avoid-risky-layovers.title": "Como evitar conexões arriscadas",
  "guides.metadata.how-to-avoid-risky-layovers.description": "Saiba como comparar tempos de conexão, mudanças de aeroporto e riscos de conexão antes de reservar.",
  "guides.metadata.how-to-compare-baggage-inclusive-fares.title": "Como comparar tarifas com bagagem incluída",
  "guides.metadata.how-to-compare-baggage-inclusive-fares.description": "Saiba como comparar tarifas com bagagem incluída para que a passagem mais barata não fique mais cara depois.",
  ...
  "accountMenu.recentSearches.label": "Pesquisas recentes",
  ...
  "accountDashboard.trips.lookup.notFoundDescription": "Não conseguimos encontrar uma reserva com esses dados.",
  "accountDashboard.trips.lookup.notFoundTitle": "Reserva não encontrada",
  "accountDashboard.trips.lookup.loading": "Buscando reserva...",
  "accountDashboard.trips.lookup.invalidEmail": "Insira um endereço de e-mail válido",
  "accountDashboard.trips.lookup.emailRequired": "O endereço de e-mail é obrigatório",
  "accountDashboard.trips.lookup.reservationCodeRequired": "O código da reserva é obrigatório",
  ...
  "accountDashboard.priceAlerts.tabs.triggered": "Expirados",
  ...
  "accountDashboard.priceAlerts.features.monitoring.body": "Monitoramos os preços e avisamos quando os alertas forem acionados.",
  ...
  "accountDashboard.trips.lookup.closeAriaLabel": "Fechar",
  ...
  "destinations.country.australia": "Austrália",
  "destinations.country.rwanda": "Ruanda",
  "destinations.country.egypt": "Egito",
  "destinations.country.ethiopia": "Etiópia",
  ...
  savedTripsPageSubtitle: "Seus itinerários escolhidos e rotas em destaque.",
  savedTripsTabsLabel: "Viagens salvas / Histórico de pesquisa",
  savedTripsTabSaved: "Viagens salvas",
  savedTripsTabHistory: "Histórico de pesquisa",
  ...
  recentSearchesPageTitle: "Pesquisas recentes",
  recentSearchesClearAll: "Limpar tudo",
  recentSearchesClearFlights: "Limpar voos",
  recentSearchesClearHotels: "Limpar hotéis",
  recentSearchesPageSubtitle:
    "Jump back to where you left off and search again in one click.",
  recentSearchesEmptyTitle: "Comece uma pesquisa para ganhar impulso",
  ...
  savedTripsRecentSearchesSubtitle:
    "Volte de onde parou e pesquise novamente com um clique.",
  ...
  countryCurrencyDescription: "Escolha o país e a moeda usados para preços e preferências regionais.",
  ...
  countryCurrencyPopularCountryAndCurrency: "Países e moedas populares",
  ...
  flightLandingRouteTemplate: "De {{origin}} para {{destination}}",
  flightLandingRouteConnector: "para",
  "flightLandingCity.New York": "Nova York",
  "flightLandingCity.Tokyo": "Tóquio",
  "flightLandingCity.Singapore": "Singapura",
  ...
  flightSearchAgainCurrentPrices: "Esta cotação de voo não está mais disponível. Pesquise novamente para ver os preços atuais.",
  ...
  flightRouteTemplate: "{{origin}} para {{destination}}",
  layoverTemplate: "Conexão em {{airport}} · {{duration}} · {{connection}}",
  flightNumberLabel: "Voo",
  layoverIn: "Conexão em",
  layoverSummaryTemplate: "Conexão: {{airport}} {{duration}}",
  ...
  "hotelGuests.adultDescription": "A partir de 18 anos",
  "hotelGuests.childDescription": "De 0 a 17 anos",
  "hotelGuests.roomDescription": "Quartos separados",
  ...
  "hotelDestinationKind.city": "Cidade",
  "hotelDestinationKind.district": "Área",
  "hotelDestinationKind.landmark": "Ponto turístico",
  "hotelDestinationKind.airport-area": "Área do aeroporto",
  ...
  "deals.loadingPage": "Carregando página...",
  "deals.decreaseCountAria": "Diminuir {{label}}",
  ...
  "deals.destination.tokyo.imageAlt": "Horizonte de Tóquio com prédios altos e densos à luz do dia",
  "deals.destination.london.city": "Londres",
  "deals.destination.london.country": "Reino Unido",
  "deals.destination.london.imageAlt": "Tower Bridge e o rio Tâmisa em Londres sob um céu azul",
  "deals.destination.paris.city": "Paris",
  "deals.destination.paris.country": "França",
  "deals.destination.paris.imageAlt": "Torre Eiffel e o rio Sena em Paris na hora dourada",
  "deals.destination.dubai.city": "Dubai",
  "deals.destination.dubai.country": "Emirados Árabes Unidos",
  "deals.destination.dubai.imageAlt": "Horizonte de Dubai com o Burj Khalifa acima dos arranha-céus",
  "deals.destination.cancun.city": "Cancún",
  "deals.destination.cancun.country": "México",
  "deals.destination.cancun.imageAlt": "Praia de Cancún com areia branca e água turquesa",
  "deals.destination.rome.city": "Roma",
  "deals.destination.rome.country": "Itália",
  "deals.destination.rome.imageAlt": "O Coliseu em Roma sob um céu azul claro",
  ...
  "legal.index.heroLabel": "Informações legais",
  "legal.index.heroTitle": "Centro jurídico",
  "legal.index.heroDescription": "Os recursos jurídicos da Kurioticket explicam como funcionam nossas práticas de busca de viagens, conta, privacidade, redirecionamento para provedores e conformidade.",
  "legal.index.compliance.eyebrow": "EMPRESA E CONFORMIDADE",
  "legal.index.compliance.sellerOfTravel": "Vendedor de viagens da Califórnia",
  "legal.index.compliance.registrationNumberLabel": "Nº de registro",
  "legal.index.compliance.registrationExpires": "O registro expira em",
  "legal.index.compliance.registrationExpiresDate": "5 de junho de 2027",
  "legal.index.compliance.publicNotice": "O registro como vendedor de viagens não constitui aprovação pelo Estado da Califórnia.",
  "legal.index.contacts.support": "Suporte",
  "legal.index.contacts.legal": "Jurídico",
  "legal.index.contacts.privacy": "Privacidade",
  "legal.index.resourcesEyebrow": "Recursos oficiais",
  "legal.index.resourcesTitle": "Documentos jurídicos",
  "legal.index.documentsCountLabel": "políticas e avisos disponíveis",
  "legal.index.documents.privacyChoices.title": "Opções de privacidade",
  "legal.index.documents.privacyChoices.summary": "Informações localizadas para este documento jurídico da Kurioticket.",
  "legal.index.documents.californiaSellerOfTravelNotice.title": "Aviso de vendedor de viagens da Califórnia",
  "legal.index.documents.californiaSellerOfTravelNotice.summary": "Informações localizadas para este documento jurídico da Kurioticket.",
  "legal.index.documents.legalNoticeCompanyInformation.title": "Aviso legal e informações da empresa",
  "legal.index.documents.legalNoticeCompanyInformation.summary": "Informações localizadas para este documento jurídico da Kurioticket.",
  "legal.index.documents.securityStatement.title": "Declaração de segurança",
  "legal.index.documents.securityStatement.summary": "Informações localizadas para este documento jurídico da Kurioticket.",
  "legal.index.documents.accessibilityStatement.title": "Declaração de acessibilidade",
  "legal.index.documents.accessibilityStatement.summary": "Informações localizadas para este documento jurídico da Kurioticket.",
  ...
  "hotelResults.payAtProperty": "Pague na propriedade",
  "hotelResults.payLater": "Pague depois",
  "hotelResults.noPrepayment": "Sem pré-pagamento",
  "hotelResults.refundable": "Reembolsável",
  ...
  "carsSearch.driverAgeAnyAgeRange": "Qualquer idade 18–70",
  ...
  "carsSearch.error.pickupLocationRequired": "Informe um local de retirada.",
  "carsSearch.error.pickupDateRequired": "Selecione uma data de retirada.",
  "carsSearch.error.pickupDatePast": "A data de retirada não pode estar no passado.",
  "carsSearch.error.pickupTimeRequired": "Selecione um horário de retirada.",
  "carsSearch.error.dropoffDateRequired": "Selecione uma data de devolução.",
  "carsSearch.error.dropoffDatePast": "A data de devolução não pode estar no passado.",
  "carsSearch.error.dropoffTimeRequired": "Selecione um horário de devolução.",
  "carsSearch.error.driverAgeInvalid": "Selecione Qualquer idade 18–70 ou uma idade do motorista de 18 a 70.",
  "carsSearch.error.dropoffLocationRequired": "Informe um local de devolução.",
  "carsSearch.error.dropoffBeforePickup": "A data de devolução não pode ser anterior à data de retirada.",
  "carsSearch.error.sameDayDropoffAfterPickup": "Para devoluções no mesmo dia, o horário de devolução deve ser depois do horário de retirada.",
  ...
  "carsResults.pickupLocationLabel": "Local de retirada",
  "carsResults.returnLocationLabel": "Local de devolução",
  "carsResults.rentalDatesLabel": "Datas da locação",
  "carsResults.pickupReturnTimeLabel": "Horário de retirada / devolução",
  "carsResults.driverAgeLabel": "Idade do motorista",
  ...
  "account.pendingDeletion.eyebrow": "Boas-vindas de volta",
  "account.pendingDeletion.title": "A exclusão da sua conta está pendente.",
  "account.pendingDeletion.scheduledPrefix": "Sua conta está programada para exclusão permanente em",
  "account.pendingDeletion.reactivateNotice": "Você pode reativar sua conta antes dessa data. Até lá, a navegação normal no painel ficará restrita.",
  "account.pendingDeletion.helperBefore": "Boas-vindas de volta. Clicar em Reativar conta cancela a exclusão antes de",
  "account.pendingDeletion.helperAfter": "e restaura o acesso normal ao aplicativo.",
  "account.pendingDeletion.error.reactivate": "Não foi possível reativar a conta.",
  "account.pendingDeletion.error.expired": "A janela de reativação de 7 dias expirou. Entre em contato com o suporte.",
  "account.pendingDeletion.action.reactivating": "Reativando…",
  "account.pendingDeletion.action.reactivate": "Reativar conta",
  "account.pendingDeletion.action.logout": "Sair",
  ...
  "legal.californiaSellerOfTravelNotice.title": "Aviso de vendedor de viagens da Califórnia",
  "legal.californiaSellerOfTravelNotice.summary": "Aviso de registro California Seller of Travel para a plataforma de pesquisa e redirecionamento de viagens da Kurioticket.",
  "legal.californiaSellerOfTravelNotice.lastUpdatedDate": "June 28, 2026",
  "legal.californiaSellerOfTravelNotice.tableOfContents": "SUMÁRIO",
  "legal.californiaSellerOfTravelNotice.sections.registration.title": "Informações de registro",
  "legal.californiaSellerOfTravelNotice.sections.registration.paragraph1": "A Kurioticket LLC está registrada como California Seller of Travel sob o número de registro 2151995-40.",
  "legal.californiaSellerOfTravelNotice.sections.registration.paragraph2": "Registro válido a partir de June 27, 2026. O registro expira em June 30, 2027.",
  "legal.californiaSellerOfTravelNotice.sections.registration.paragraph3": "O registro como vendedor de viagens não constitui aprovação pelo Estado da Califórnia.",
  "legal.californiaSellerOfTravelNotice.sections.platform-model.title": "Modelo de pesquisa e redirecionamento",
  "legal.californiaSellerOfTravelNotice.sections.platform-model.paragraph1": "A Kurioticket LLC opera uma plataforma de pesquisa, comparação e redirecionamento de viagens para flights, hotels, and rental cars. A Kurioticket ajuda os usuários a comparar opções de viagem e seguir para fornecedores externos para as etapas finais da reserva.",
  "legal.californiaSellerOfTravelNotice.sections.platform-model.paragraph2": "A Kurioticket não é companhia aérea, hotel, agência de viagens online, agência de viagens, processadora de pagamentos para compras de viagem nem emissora de passagens.",
  "legal.californiaSellerOfTravelNotice.sections.provider-responsibilities.title": "Responsabilidades de fornecedores externos",
  "legal.californiaSellerOfTravelNotice.sections.provider-responsibilities.paragraph1": "Fornecedores externos tratam da reserva final, pagamento, confirmação, cancelamento, reembolsos, alterações, bagagem, check-in e suporte à reserva depois que você sai da Kurioticket para o site do fornecedor.",
  "legal.californiaSellerOfTravelNotice.sections.provider-responsibilities.paragraph2": "Antes de comprar, confira no site do fornecedor externo o preço final, disponibilidade, regras tarifárias, condições do quarto ou veículo, políticas de cancelamento, políticas de reembolso, regras de bagagem, requisitos de check-in e termos de atendimento ao cliente.",
  "legal.californiaSellerOfTravelNotice.sections.contact.title": "Contato",
  ...
  "legal.californiaSellerOfTravelNotice.sections.contact.paragraph2": "Para suporte da plataforma, contate support@kurioticket.com. Para assuntos jurídicos, contate legal@kurioticket.com. Para assuntos de privacidade, contate privacy@kurioticket.com.",
  "legal.californiaSellerOfTravelNotice.developerNote": "Estes rascunhos de documentos jurídicos são materiais iniciais de trabalho e devem ser revisados por um advogado qualificado antes de um lançamento público em larga escala.",
  ...
  "accountDashboard.personalDetails.description": "Gerencie as informações que a Kurioticket usa para sua conta.",
  ...
  "accountDashboard.personalDetails.section.basicInformation": "Informações básicas",
  ...
  "accountDashboard.personalDetails.section.address": "Endereço",
  ...
  "accountDashboard.personalDetails.changeEmail": "Alterar e-mail",
  "accountDashboard.personalDetails.emailHelper": "Este e-mail é usado para login e confirmações de reserva. Alterações exigem verificação.",
  "accountDashboard.personalDetails.phoneHelper": "Usaremos este número para atualizações de reservas.",
  ...
  "accountDashboard.personalDetails.addressDescription": "Usado para cobrança, registros de reserva e comunicação de viagem.",
  "accountDashboard.personalDetails.countryRegion": "País/região",
  "accountDashboard.personalDetails.selectOne": "Selecione uma opção",
  "accountDashboard.personalDetails.streetAddress": "Endereço",
  "accountDashboard.personalDetails.apartmentSuite": "Apartamento, suíte, unidade, prédio",
  "accountDashboard.personalDetails.townCity": "Cidade",
  "accountDashboard.personalDetails.stateProvinceRegion": "Estado / província / região",
  "accountDashboard.personalDetails.postcodeZip": "CEP / código postal",
  ...
  "hotelsHeroImageAlt": "Mensageiro de hotel recebendo um hóspede com bagagem em um lobby premium",
  "hotelDestination.London.imageAlt": "Tower Bridge e o rio Tâmisa em Londres sob céu azul",
  "hotelDestination.Paris.imageAlt": "Torre Eiffel e rio Sena em Paris na hora dourada",
  "hotelDestination.Rome.imageAlt": "O Coliseu em Roma sob um céu azul claro",
  "hotelDestination.Dubai.imageAlt": "Horizonte de Dubai com o Burj Khalifa acima dos arranha-céus",
  "hotelDestination.Singapore.imageAlt": "Horizonte da Marina Bay em Singapura ao anoitecer",
  "hotelDestination.Barcelona.imageAlt": "Paisagem urbana de Barcelona com a Sagrada Família à luz do dia",
  "hotelDestination.Toronto.imageAlt": "Horizonte de Toronto com a CN Tower ao lado do Lago Ontário",
  "hotelDestination.Amsterdam.imageAlt": "Casas de canal e ponte de Amsterdã junto à água",
  "hotelDestination.Bangkok.imageAlt": "Horizonte de Bangkok e rio Chao Phraya ao pôr do sol",
  "hotelDestination.Cancun.imageAlt": "Praia de Cancún com areia branca e água turquesa",
  "hotelDestination.Istanbul.imageAlt": "Orla de Istambul com cúpulas e minaretes na hora dourada",
  "hotelDestination.Tokyo.imageAlt": "Horizonte de Tóquio com prédios altos densos à luz do dia",
  ...
  "emailUpdates.subscribedStatus": "Você está inscrito.",
  "emailUpdates.subscribedButton": "Inscrito",
  "emailUpdates.stopUpdates": "Parar atualizações",
  "emailUpdates.loadingStatus": "Carregando…",
  "emailUpdates.unsubscribedStatus": "Você não está inscrito.",
  "emailUpdates.notFoundStatus": "Nenhuma assinatura foi encontrada.",
  "emailUpdates.subscribeButton": "Assinar",
  "emailUpdates.restartUpdates": "Reiniciar atualizações",
  "emailUpdates.updatesStopped": "Atualizações interrompidas",
  "emailUpdates.notAvailable": "Não disponível",
  "emailUpdates.invalidLink": "Este link de preferências é inválido ou expirou.",
  "emailUpdates.loadError": "Não foi possível carregar estas preferências agora.",
  "emailUpdates.updateError": "Não foi possível atualizar esta preferência agora.",
  "emailUpdates.preferenceUpdated": "Preferência atualizada.",
  ...
  "legal.legalNoticeCompanyInformation.title": "Aviso legal e informações da empresa",
  "legal.legalNoticeCompanyInformation.summary": "Informações sobre empresa, contato, escopo do produto e limites dos provedores para a Kurioticket.",
  "legal.legalNoticeCompanyInformation.lastUpdatedDate": "28 de junho de 2026",
  "legal.legalNoticeCompanyInformation.tableOfContents": "ÍNDICE",
  "legal.legalNoticeCompanyInformation.sections.company-information.title": "Informações da empresa",
  "legal.legalNoticeCompanyInformation.sections.company-information.paragraph1": "Kurioticket LLC, 801 Tupper St, Suite 812, Santa Rosa, CA 95404. Telefone: 346-383-0325. Suporte: support@kurioticket.com. Jurídico: legal@kurioticket.com. Privacidade: privacy@kurioticket.com.",
  "legal.legalNoticeCompanyInformation.sections.company-information.paragraph2": "Nome legal: Kurioticket LLC. Endereço: 801 Tupper St, Suite 812, Santa Rosa, CA 95404. Telefone comercial: 346-383-0325.",
  "legal.legalNoticeCompanyInformation.sections.contacts.title": "E-mails de contato",
  "legal.legalNoticeCompanyInformation.sections.contacts.paragraph1": "Suporte: support@kurioticket.com. Jurídico: legal@kurioticket.com. Privacidade: privacy@kurioticket.com.",
  "legal.legalNoticeCompanyInformation.sections.product-scope.title": "Escopo do produto e modelo de negócios",
  "legal.legalNoticeCompanyInformation.sections.product-scope.paragraph1": "O escopo do produto da Kurioticket inclui voos, hotéis, carros e ofertas.",
  "legal.legalNoticeCompanyInformation.sections.product-scope.paragraph2": "Modelo de negócios: plataforma de busca, comparação e redirecionamento de viagens. A Kurioticket ajuda os usuários a pesquisar, comparar e prosseguir para provedores de viagem externos.",
  "legal.legalNoticeCompanyInformation.sections.provider-payment-boundary.title": "Limite entre provedor e pagamento",
  "legal.legalNoticeCompanyInformation.sections.provider-payment-boundary.paragraph1": "A Kurioticket não processa pagamentos finais de viagem nem emite documentos finais de viagem; provedores externos gerenciam a reserva final, pagamento, confirmação, cancelamento, reembolsos, alterações, bagagem, check-in e suporte à reserva.",
  "legal.legalNoticeCompanyInformation.sections.provider-payment-boundary.paragraph2": "O provedor externo que aceita o pagamento é responsável pelos termos finais da reserva, preço final, processamento de pagamento, confirmação, cancelamento, reembolsos, alterações, bagagem, check-in e suporte à reserva.",
  "legal.legalNoticeCompanyInformation.sections.california-registration.title": "Referência ao California Seller of Travel",
  "legal.legalNoticeCompanyInformation.sections.california-registration.paragraph1": "California Seller of Travel Registration No. 2172630-70. O registro como vendedor de viagens não constitui aprovação pelo Estado da Califórnia.",
  ...
  "deals.productSelector.minimumTwo": "Pacotes requires at least two products.",
  ...
  "deals.guided.handoffPending.returnDeals": "Return to Pacotes",
  ...
  "deals.guided.handoffPending.missingBody": "Return to Pacotes and confirm your trip options again.",
  ...
  "deals.guided.handoffInvalid.body": "For your safety, no booking partner was opened. Return to Pacotes and try again.",
  "deals.guided.handoffInvalid.returnDeals": "Return to Pacotes",
  ...
  "deals.guided.handoff.storageReadFailedBody": "Não foi possível verificar novamente sua viagem salva, então esta etapa não foi aberta. Tente novamente.",
  ...
  "deals.guided.handoff.returnDeals": "Return to Pacotes",
  "deals.guided.handoff.missingTitle": "We could not load this guided trip",
  "deals.guided.handoff.missingBody": "Return to Pacotes and confirm your trip options again.",
  ...
  "accountDashboard.preferences.booking.sections.flightDefaults.description": "Defina suas preferências de viagem padrão para reservas mais rápidas e relevantes.",
  "accountDashboard.preferences.customization.status.savingShort": "Saving...",
  "accountDashboard.preferences.email.resetShort": "Redefinir",
  "accountDashboard.preferences.email.savePreferences": "Salvar preferências",
  "accountDashboard.preferences.email.savingPreferences": "Saving...",
  "accountDashboard.preferences.email.savingShort": "Saving...",
  "accountDashboard.preferences.email.title": "Preferências de e-mail",
  "accountMenu.savedRecent.label": "Viagens salvas",
  "carDetails.cancellation": "Cancelamento",
  "carDetails.freeCancellation": "Cancelamento grátis",
  "carDetails.nonRefundable": "Não reembolsável",
  "carDetails.return": "Retorno",
  "carDetails.unlimitedMileage": "Quilometragem ilimitada",
  "carsResults.lowestTotal": "Menor preço total",
  "carsResults.passengers": "Passageiros",
  "carsResults.recommended": "Recomendado",
  "carsResults.sortBy": "Ordenar por",
  "carsResults.topRated": "MAIS BEM AVALIADO",
  "carsSearch.returnLocationLabel": "Local de devolução",
  "carsSearch.type.airport": "Aeroporto",
  "carsSearch.type.area": "Área",
  "carsSearch.type.city": "Cidade",
  "deals.guided.hotelDetails.roomInformation": "Room",
  "destinationImageFallback": "Destino",
  "editSearch": "Editar pesquisa",
  "homeRegionalRoutesTitle": "Descubra destinos a partir da sua região",
};
