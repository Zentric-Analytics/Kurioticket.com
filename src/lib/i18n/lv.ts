...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Ceļotāji",
  "mobileDatePicker.start": "Sākums",
  "mobileDatePicker.end": "Beigas",
  deals: "Ceļojumu paketes",
  ...
  fromPrice: "No",
  homeDestinationDubaiCity: "Dubaija",
  homeDestinationDubaiCountry: "Apvienotie Arābu Emirāti",
  homeDestinationDubaiAlt: "Dubaija, Apvienotie Arābu Emirāti",
  homeDestinationLondonCity: "Londona",
  homeDestinationLondonCountry: "Apvienotā Karaliste",
  homeDestinationLondonAlt: "Londona, Apvienotā Karaliste",
  homeDestinationParisCity: "Parīze",
  homeDestinationParisCountry: "Francija",
  homeDestinationParisAlt: "Parīze, Francija",
  homeDestinationBaliCity: "Bali",
  homeDestinationBaliCountry: "Indonēzija",
  homeDestinationBaliAlt: "Bali, Indonēzija",
  homeDestinationNewYorkCity: "Ņujorka",
  homeDestinationNewYorkCountry: "Amerikas Savienotās Valstis",
  homeDestinationNewYorkAlt: "Ņujorka, Amerikas Savienotās Valstis",
  ...
  "deals.results.title": "Coordinated trip results (lv)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (lv)",
  "deals.results.modify": "Modify search · Coordinated trip results (lv)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (lv)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (lv)",
  "deals.results.viewCars": "View car options · Coordinated trip results (lv)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (lv)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (lv)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (lv)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (lv)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (lv)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (lv)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (lv)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (lv)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (lv)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (lv)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (lv)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (lv)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (lv)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (lv)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (lv)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (lv)",
  ...
  flightSearchDestinationPlaceholderShort: 'Uz kurieni?',
};
