...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Rejsende",
  ...
  homeDestinationDubaiCountry: "Forenede Arabiske Emirater",
  homeDestinationDubaiAlt: "Dubai, Forenede Arabiske Emirater",
  homeDestinationLondonCity: "London",
  homeDestinationLondonCountry: "Storbritannien",
  homeDestinationLondonAlt: "London, Storbritannien",
  homeDestinationParisCity: "Paris",
  homeDestinationParisCountry: "Frankrig",
  homeDestinationParisAlt: "Paris, Frankrig",
  ...
  "deals.results.title": "Coordinated trip results (da)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (da)",
  "deals.results.modify": "Modify search · Coordinated trip results (da)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (da)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (da)",
  "deals.results.viewCars": "View car options · Coordinated trip results (da)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (da)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (da)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (da)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (da)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (da)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (da)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (da)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (da)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (da)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (da)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (da)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (da)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (da)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (da)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (da)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (da)",
  ...
  flightSearchDestinationPlaceholderShort: 'Hvorhen?',
};
