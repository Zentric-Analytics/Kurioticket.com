...
export const translations: TranslationDictionary = {
  ...
  moreServiceInfoStepSaveDetails:
    "저장된 여행, 최근 검색, 알림은 검토 중인 옵션으로 더 쉽게 돌아가고 관련 여행 계획 세부 정보를 정리하는 데 도움이 됩니다.",
  moreServiceInfoStepRedirectsTitle: "제공업체 이동 설명",
  ...
  moreServiceInfoStepRedirectsDetails:
    "제공업체 페이지에서는 이동된 상품의 최종 가격, 이용 가능 여부, 규정, 결제 단계, 영수증, 예약 변경, 취소 및 여행 문서가 처리됩니다.",
  moreServiceInfoStepAccountTitle: "계정 및 여행 도구",
  moreServiceInfoStepAccountSummary:
    "계정 도구를 사용해 저장된 검색, 여행, 알림, 환경설정을 하나의 Kurioticket 작업 공간에 정리하세요.",
  moreServiceInfoStepAccountDetails:
    "이 도구는 Kurioticket에서의 여행 계획을 지원하며, 외부에서 예약이 완료된 경우 제공업체별 예약 관리는 해당 제공업체에 남아 있습니다.",
  moreServiceInfoFaqHeading: "자주 묻는 질문",
  moreServiceInfoFaqDescription:
    "여행 검색, 제공업체 이동, 저장된 여행, 계정 도구에 관한 짧은 답변입니다.",
  ...
  moreServiceInfoFaqPaymentsAnswer:
    "제공업체로 이동되는 상품의 경우 Kurioticket은 결제를 처리하지 않습니다. 제공업체 페이지에서 직접 검토하고 결제를 완료하세요.",
  moreServiceInfoFaqSaveQuestion: "여행과 알림을 저장할 수 있나요?",
  moreServiceInfoFaqSaveAnswer:
    "네. 계정 도구를 사용하면 여행을 저장하고, 노선을 추적하고, 알림을 관리하고, 검토 중인 여행 옵션으로 돌아갈 수 있습니다.",
  ...
  moreServiceInfoFaqSupportAnswer:
    "고객 지원 페이지를 이용하고 계정 이메일, 진행하려던 작업, 도움이 될 수 있는 노선, 호텔 또는 제공업체 세부 정보를 함께 알려주세요.",
  moreServiceInfoHelpTitle: "도움이 필요하신가요?",
  moreServiceInfoHelpDescription:
    "계정, 저장된 여행, 알림 또는 제공업체 이동에 대해 궁금한 점이 있으신가요?",
  ...
  serviceGuaranteeFaqResultsDisplayedAnswer:
    "결과는 여행 제공업체에서 제공하는 정보를 바탕으로 표시되며, 가능한 경우 노선, 날짜, 가격, 제공업체 세부 정보가 포함됩니다.",
  serviceGuaranteeFaqRedirectedQuestion: "왜 다른 제공업체로 이동하나요?",
  serviceGuaranteeFaqRedirectedAnswer:
    "일부 결과는 외부 제공업체 사이트에서 완료됩니다. 해당 옵션을 선택하면 예약, 결제, 여행별 서비스를 제공업체가 처리할 수 있도록 Kurioticket이 이동시킵니다.",
  serviceGuaranteeFaqBookDirectlyQuestion: "Kurioticket에서 직접 예약하나요?",
  serviceGuaranteeFaqBookDirectlyAnswer:
    "Kurioticket은 주로 여행 검색 및 비교 플랫폼입니다. 결과가 제공업체로 이동되는 경우 예약은 Kurioticket이 아니라 해당 제공업체에서 완료됩니다.",
  serviceGuaranteeFaqPricesGuaranteedQuestion: "가격은 항상 보장되나요?",
  serviceGuaranteeFaqPricesGuaranteedAnswer:
    "아니요. 가격은 제공업체의 이용 가능 여부, 세금, 수수료, 통화 및 시점에 따라 변경될 수 있습니다. 예약 전에 제공업체 페이지에서 최종 가격을 항상 확인하세요.",
  serviceGuaranteeFaqChooseProvidersQuestion: "Kurioticket은 제공업체를 어떻게 선택하나요?",
  serviceGuaranteeFaqChooseProvidersAnswer:
    "Kurioticket은 관련 검색 결과를 제공할 수 있는 여행 제공업체 및 데이터 소스와 협력합니다. 이용 가능 여부, 가격 및 표시 옵션은 노선, 목적지, 제공업체 범위에 따라 달라질 수 있습니다.",
  serviceGuaranteeFaqEncounterIssueQuestion: "문제가 발생하면 어떻게 해야 하나요?",
  serviceGuaranteeFaqEncounterIssueAnswer:
    "문제가 Kurioticket의 검색, 계정 접근, 저장된 여행, 알림 또는 이동과 관련된 경우 Kurioticket 지원팀에 문의하세요. 이미 제공업체에서 예약했다면 예약 변경, 환불, 취소 또는 여행 문서는 해당 제공업체에 문의하세요.",
  ...
  supportBeforeContactDashboardDescription:
    "Kurioticket 계정 이메일, 도움이 필요한 내용, 문제를 이해하는 데 도움이 되는 예약 또는 노선 세부 정보를 함께 알려주세요.",
  ...
  supportCategoryPartnerRedirect: "제공업체 이동",
  ...
  supportFaqAccountAnswer:
    "Kurioticket은 계정 접근, 로그인 문제, 가입 문제, 프로필 접근 및 플랫폼의 계정 관련 문제를 도와드릴 수 있습니다.",
  ...
  supportFaqSavedTripsQuestion: "저장된 여행 및 알림",
  supportFaqSavedTripsAnswer:
    "Kurioticket은 저장된 여행, 최근 검색, 가격 알림, 알림 문제 및 계정에 연결된 여행 도구를 도와드릴 수 있습니다.",
  supportFaqRedirectQuestion: "예약/제공업체 이동 도움말",
  supportFaqRedirectAnswer:
    "파트너 또는 제공업체로의 이동이 실패하거나, 잘못된 페이지가 열리거나, 선택한 여행 또는 검색 세부 정보가 유지되지 않는 경우 Kurioticket이 도와드릴 수 있습니다.",
  supportFaqAlreadyBookedQuestion: "이미 제공업체에서 예약하셨나요?",
  supportFaqAlreadyBookedAnswer:
    "항공사, 호텔, 여행사 또는 외부 제공업체에서 예약이 완료된 경우 예약 변경, 환불, 취소, 체크인, 탑승, 영수증 및 여행 문서는 해당 제공업체가 책임집니다.",
  supportFaqChangeBookingQuestion: "Kurioticket이 내 예약을 변경할 수 있나요?",
  supportFaqChangeBookingAnswer:
    "직접 예약이 지원되는 경우 Kurioticket을 통해 직접 이루어진 예약에 대해서만 Kurioticket이 도움을 드릴 수 있습니다. 외부 제공업체에서 완료된 예약은 해당 제공업체에 직접 문의하세요.",
  supportFaqWhyRedirectedQuestion: "왜 다른 제공업체로 이동되었나요?",
  supportFaqWhyRedirectedAnswer:
    "Kurioticket은 여행 검색 및 비교 플랫폼이며, 일부 결과는 예약, 결제 및 제공업체별 지원을 완료하는 신뢰할 수 있는 제공업체로 이동됩니다.",
