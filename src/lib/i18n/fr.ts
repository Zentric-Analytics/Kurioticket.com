...
export const translations: TranslationDictionary = {
  ...
  forgotPasswordPageSubtitle: "Enter your email and we'll send instructions to reset your password.",
  ...
  forgotPasswordRememberPrompt: "Remember your password?",
  ...
  resetPasswordRequestNewEmail: "Request a new reset email",
  resetPasswordCreateNewTitle: "Create a new password",
  ...
  resetPasswordSuccessRedirecting: "Password reset successful. Redirecting to sign in...",
  resetPasswordResetting: "Resetting...",
  resetPasswordSubmit: "Reset password",
  verifyEmailPageTitle: "Verify your email",
  verifyEmailSubtitle: "Enter the 6-digit code we sent to your email. Codes expire after 10 minutes.",
  ...
  verifyEmailResent: "If this email needs verification, a new code has been sent.",
  verifyEmailAlreadyVerified: "Already verified?",
  verifyLoginPageTitle: "Verify your login",
  verifyLoginSubtitle: "Enter the 6-digit code we sent to your email. Codes expire after 10 minutes.",
  verifyLoginCodeLabel: "Login code",
  verifyLoginVerifying: "Verifying…",
  verifyLoginSubmit: "Verify login",
  verifyLoginNeedNewCode: "Need a new code? Enter your password so we can safely resend one.",
  verifyLoginPasswordForResend: "Password for resend",
  verifyLoginSendingCode: "Sending code…",
  verifyLoginResendIn: "Resend in {{seconds}}s",
  verifyLoginResendCode: "Resend code",
  verifyLoginStartOverPrompt: "Need to start over?",
  verifyLoginAgain: "Log in again",
  verifyLoginEnterPassword: "Enter your password to request a new login code.",
