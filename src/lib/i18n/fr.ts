...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Voyageurs",
  "mobileTravelerCabin.title": "Voyageurs et cabine",
  "mobileTravelerCabin.adultDescription": "18 ans et plus",
  "mobileTravelerCabin.childDescription": "De 2 à 17 ans",
  "mobileTravelerCabin.infantDescription": "Moins de 2 ans",
  "mobileTravelerCabin.tip": "Conseil",
  "mobileTravelerCabin.baggageTip": "La franchise de bagages peut varier selon la compagnie aérienne. Consultez les détails sur la page du fournisseur.",
  "mobileDatePicker.start": "Début",
  "mobileDatePicker.end": "Fin",
  "deals.guided.confirmation.retry": "Réessayer",
  "deals.guidedPreview.description": "Aperçu guidé des Offres: Complete guided Forfaits preview: Hotel, Flight and Car selection and confirmation, Review, and final partner handoff.",
  "deals.guidedPreview.availableCar": "Aperçu guidé des Offres: Car results, filters, sorting, details, and confirmation",
  "deals.guidedPreview.availableReview": "Aperçu guidé des Offres: Trip Review with persisted opened-step progress",
  "deals.guidedPreview.availableHandoff": "Aperçu guidé des Offres: Final booking-partner handoff for each included product",
  "deals.guidedPreview.previewOnlyTitle": "Aperçu guidé des Offres: Internal preview limitations",
  "deals.guidedPreview.previewOnlyPublicLaunch": "Aperçu guidé des Offres: Public activation has not occurred; normal Search remains unchanged.",
  "deals.guidedPreview.previewOnlyBooking": "Aperçu guidé des Offres: Kurioticket does not complete booking or payment. Complete each provider step separately.",
  "deals.guided.confirmation.readError": "Aperçu guidé des Offres: Saved preview progress could not be read. Try confirmation again.",
  "deals.guided.confirmation.saveError": "Aperçu guidé des Offres: Preview progress could not be saved. Try confirmation again.",
  "deals.guided.crossTabUpdated": "Aperçu guidé des Offres: This trip was updated in another tab.",
  "deals.guided.prerequisiteChanged": "Aperçu guidé des Offres: An earlier trip choice changed in another tab. Your current saved trip is now shown.",
  "deals.guided.conflict.title": "Aperçu guidé des Offres: Another guided preview is saved",
  "deals.guided.conflict.body": "Aperçu guidé des Offres: This page belongs to a different guided search. Its saved progress is protected.",
  "deals.guided.conflict.restart": "Aperçu guidé des Offres: Start this preview trip again",
  "deals.guided.conflict.restartDisclosure": "Aperçu guidé des Offres: Starting again replaces the guided-preview progress currently saved in this browser.",
  "deals.guided.error.title": "Aperçu guidé des Offres: We could not show this guided Forfaits page",
  "deals.guided.error.body": "Aperçu guidé des Offres: No booking-partner page was opened. Try again or return safely to Forfaits.",
  "deals.guided.error.retry": "Aperçu guidé des Offres: Try again",
  "deals.guided.error.returnDeals": "Aperçu guidé des Offres: Return to Forfaits",
  "deals.guided.storageUnavailable.title": "Aperçu guidé des Offres: Temporary preview storage is unavailable",
  "deals.guided.storageUnavailable.body": "Aperçu guidé des Offres: This guided stage cannot safely save progress. Restore browser storage and reload.",
  "deals.guided.invalid.title": "Aperçu guidé des Offres: Saved preview progress is invalid",
  "deals.guided.invalid.body": "Aperçu guidé des Offres: Return to the first guided stage to choose fresh trip options.",
  "deals.guided.expired.title": "Aperçu guidé des Offres: Your guided preview has expired",
  "deals.guided.expired.body": "Aperçu guidé des Offres: Return to the first guided stage and refresh your trip options.",
  "metadata.root.title.default": "Kurioticket | Trouvez vite des vols pas chers",
  "metadata.root.description": "Comparez des vols et des hôtels abordables en quelques secondes avec une plateforme de décision de voyage plus sereine.",
  destinationsLoadingPage: "Chargement de la page des destinations...",
  "brandedLoading.default.title": "Chargement de Kurioticket...",
  "brandedLoading.default.preparingExperience": "Préparation de votre expérience...",
  ...
  contactMetadataTitle: "Contacter Kurioticket",
  ...
  exploreWaysTitle: "Façons d’explorer",
  exploreWaysRouteTitle: "Découverte d’itinéraires",
  exploreWaysRouteText: "Commencez par un itinéraire de vol, puis comparez les horaires, les escales et les options de fournisseurs lorsque les résultats sont disponibles.",
  exploreWaysHotelsTitle: "Idées de destinations hôtelières",
  exploreWaysHotelsText: "Utilisez des recherches d’hôtels axées sur la destination pour comparer les options de séjour, les emplacements et les conditions d’annulation.",
  exploreWaysSavedTitle: "Voyages enregistrés et recherches récentes",
  exploreWaysSavedText: "Revenez aux itinéraires et recherches déjà commencés afin de garder votre planification organisée sur plusieurs sessions.",
  exploreWaysBasicsTitle: "Bases de la planification de voyage",
  exploreWaysBasicsText: "Réfléchissez au calendrier, à la flexibilité, aux bagages, aux besoins d’hébergement et aux politiques des fournisseurs avant de vous engager.",
  exploreNeedsTitle: "Planifier selon le besoin de voyage",
  exploreNeedsWeekendTitle: "Week-ends en ville",
  exploreNeedsWeekendText: "Comparez des itinéraires plus courts, des horaires simples et des emplacements d’hôtels adaptés à un séjour limité.",
  exploreNeedsInternationalTitle: "Voyages internationaux",
  exploreNeedsInternationalText: "Examinez attentivement les itinéraires plus longs, y compris la durée totale, les escales, les conditions d’entrée et les modalités du fournisseur.",
  exploreNeedsHotelFirstTitle: "Planification d’abord par l’hôtel",
  exploreNeedsHotelFirstText: "Commencez par l’endroit où vous souhaitez séjourner, puis organisez les vols et les autres éléments du voyage autour de cet emplacement.",
  exploreNeedsCompleteTitle: "Planification complète du voyage",
  exploreNeedsCompleteText: "Utilisez les vols, hôtels, voyages enregistrés et recherches récentes ensemble pour garder une vue claire du voyage.",
  exploreChecklistTitle: "Avant de réserver",
  exploreChecklistTime: "Comparer la durée totale du voyage et les escales",
  exploreChecklistBaggage: "Examiner les bagages et la flexibilité",
  exploreChecklistHotel: "Vérifier l’emplacement de l’hôtel et les règles d’annulation",
  exploreChecklistProvider: "Confirmer le prix final et la disponibilité auprès du fournisseur",
  exploreChecklistSave: "Enregistrer des itinéraires ou recherches pour plus tard",
  explorePrimaryCta: "Rechercher des vols",
  exploreSecondaryCta: "Rechercher des hôtels",
  exploreSavedCta: "Voir les voyages enregistrés",
  ...
  loginUsePasskey: "Utiliser la clé d’accès",
  loginOpeningPasskey: "Ouverture…",
  loginNotNow: "Pas maintenant",
  selectLanguage: "Choisir la langue",
  suggestedLanguages: "Langues suggérées",
  allLanguages: "Toutes les langues",
  platform: "Plateforme",
  legal: "Mentions légales",
  "recentSearches.title": "Recherches récentes",
  "recentSearches.subtitle": "Itinéraires rapides à partir de vos dernières recherches.",
  "recentSearches.clearAll": "Tout effacer",
  "recentSearches.saveAria": "Enregistrer la recherche récente",
  "recentSearches.unsaveAria": "Retirer la recherche récente des favoris",
  "recentSearches.removeAria": "Supprimer la recherche récente",
  "redirect.title": "Redirection sécurisée vers le partenaire",
  "redirect.description": "Vous quittez Kurioticket pour un fournisseur externe où les prix, les disponibilités, les règles tarifaires et les étapes d’achat sont confirmés.",
  "redirect.missingTarget": "Le lien de redirection est manquant. Veuillez relancer la recherche.",
  "redirect.loading": "Préparation de la redirection...",
  "flightGuide.eyebrow": "Guide de planification d’itinéraire",
  "flightGuide.description": "Comparez les détails de l’itinéraire, les options d’aéroport, le calendrier saisonnier et les notes de planification avant de poursuivre votre recherche.",
  "flightGuide.roadmapTitle": "Feuille de route du contenu",
  "flightGuide.roadmap.bestTimeToBook": "Meilleur moment pour réserver",
  "flightGuide.roadmap.airportLayoverNotes": "Notes sur les aéroports et les escales",
  "flightGuide.roadmap.budgetRangesAlerts": "Fourchettes de budget et alertes",
  "flightGuide.roadmap.hotelCoordinationInsights": "Conseils de coordination avec l’hôtel",
  "hotelGuide.eyebrow": "Guide de destination hôtelière",
  "hotelGuide.titleSuffix": "hôtels",
  "hotelGuide.description": "Examinez les considérations d’hébergement de la destination, la facilité d’arrivée, l’adéquation du quartier, l’accès aux transports et les signaux de qualité des hôtels avant de rechercher des séjours.",
  "hotelGuide.contentSystemTitle": "Système de contenu de destination",
  "hotelGuide.contentSystemBody": "Les éditeurs peuvent ajouter des informations pratiques locales, des notes de transfert depuis l’aéroport et des recommandations de quartiers en phase 2.",
  "guides.title": "Guides de planification de voyage",
  "guides.description": "Explorez des guides d’itinéraires, d’aéroports, de destinations, d’hôtels et de planification de voyage conçus pour faciliter des décisions de voyage confiantes.",
  "guides.metadata.best-time-to-book-flights.title": "Meilleur moment pour réserver des vols",
  "guides.metadata.best-time-to-book-flights.description": "Découvrez quand réserver des vols, comparer le moment des tarifs et éviter de payer trop cher votre prochain voyage.",
  "guides.metadata.how-to-avoid-risky-layovers.title": "Comment éviter les escales risquées",
  "guides.metadata.how-to-avoid-risky-layovers.description": "Découvrez comment comparer les durées d’escale, les changements d’aéroport et les risques de correspondance avant de réserver.",
  "guides.metadata.how-to-compare-baggage-inclusive-fares.title": "Comment comparer les tarifs avec bagages inclus",
  "guides.metadata.how-to-compare-baggage-inclusive-fares.description": "Découvrez comment comparer les tarifs avec bagages inclus afin que le billet le moins cher ne devienne pas plus coûteux plus tard.",
  "guides.articleEyebrow": "Article de planification de voyage",
  ...
  signInSubtitle: "Connectez-vous à votre compte Kurioticket.",
  email: "E-mail",
  ...
  resetPasswordInvalidLink: "Le lien de réinitialisation est invalide ou a expiré.",
  ...
  resetPasswordSuccess: "Votre mot de passe a été réinitialisé. Vous pouvez maintenant vous connecter.",
  verifyEmailTitle: "Vérifiez votre e-mail",
  verifyEmailInstructions: "Saisissez le code de vérification envoyé à votre adresse e-mail.",
  verifyEmailCodeLabel: "Code de vérification",
  verifyEmailInvalidCode: "Le code de vérification est invalide ou a expiré.",
  verifyEmailSubmit: "Vérifier l’e-mail",
  verifyEmailSending: "Envoi...",
  verifyEmailSendNewCode: "Envoyer un nouveau code",
  verifyEmailResendSuccess: "Si cet e-mail doit être vérifié, un nouveau code a été envoyé.",
  verifyEmailAlreadyVerified: "Déjà vérifié ?",
  verifyEmailLoginLink: "Se connecter",
  verifyEmailResend: "Renvoyer le code",
  verifyEmailSuccess: "E-mail vérifié avec succès.",
  verifyEmailVerifying: "Vérification...",
  stayDetails: "Détails du séjour",
  onlyShowStaysThatAllowPets: "Afficher uniquement les séjours acceptant les animaux",

  mobileTravelHeading: "Voyage",
  mobileExploreHeading: "Explorer",
  mobileInfoLegalHeading: "Infos et mentions légales",
  "onboarding.eyebrow": "Configuration intelligente facultative",
  "onboarding.title": "Ajustez vos préférences de voyage",
  "onboarding.description": "Vous pouvez ignorer cette étape maintenant et modifier ces informations à tout moment depuis votre compte.",
  "onboarding.homeAirport": "Aéroport de départ préféré",
  "onboarding.preferredAirlines": "Compagnies aériennes préférées",
  "onboarding.savePreferencesLater": "Enregistrer les préférences plus tard",
  ...
  countryCurrencyDescription: "Choisissez le pays et la devise utilisés pour les prix et les préférences régionales.",
  ...
  noCountriesOrCurrenciesFound: "Aucun pays ni aucune devise trouvés",
  showMoreResults: "Afficher plus de résultats",
  "countryCurrency.country.US": "États-Unis",
  "countryCurrency.country.GB": "Royaume-Uni",
  "countryCurrency.country.CA": "Canada",
  "countryCurrency.country.AU": "Australie",
  "countryCurrency.country.DE": "Allemagne",
  "countryCurrency.country.FR": "France",
  "countryCurrency.country.NL": "Pays-Bas",
  "countryCurrency.country.ES": "Espagne",
  "countryCurrency.country.IT": "Italie",
  "countryCurrency.country.NG": "Nigéria",
  "countryCurrency.country.GH": "Ghana",
  "countryCurrency.country.ZA": "Afrique du Sud",
  "countryCurrency.country.AE": "Émirats arabes unis",
  "countryCurrency.country.SA": "Arabie saoudite",
  "countryCurrency.country.QA": "Qatar",
  "countryCurrency.country.TR": "Turquie",
  "countryCurrency.country.JP": "Japon",
  "countryCurrency.country.KR": "Corée du Sud",
  ...
  "destinations.country.mexico": "Mexique",
  "destinations.country.australia": "Australie",
  "destinations.country.rwanda": "Rwanda",
  "destinations.country.egypt": "Égypte",
  "destinations.country.ethiopia": "Éthiopie",
  ...
  "accountDashboard.trips.lookup.notFoundDescription": "Nous n’avons trouvé aucune réservation avec ces informations.",
  "accountDashboard.trips.lookup.notFoundTitle": "Réservation introuvable",
  "accountDashboard.trips.lookup.loading": "Recherche de la réservation...",
  "accountDashboard.trips.lookup.invalidEmail": "Saisissez une adresse e-mail valide",
  "accountDashboard.trips.lookup.emailRequired": "L’adresse e-mail est obligatoire",
  "accountDashboard.trips.lookup.reservationCodeRequired": "Le code de réservation est obligatoire",
  ...
  "accountDashboard.trips.lookup.closeAriaLabel": "Fermer",
  ...
  "accountDashboard.trips.history.empty.cancelled.title": "Changement de programme ?",
  "accountDashboard.trips.history.empty.cancelled.body": "Vos réservations annulées apparaîtront ici pour référence.",
  ...
  "accountDashboard.trips.summary": "{{total}} voyages au total. {{upcoming}} à venir, {{past}} passés, {{cancelled}} annulés.",
  "accountDashboard.trips.state.loading": "Chargement de vos voyages...",
  "accountDashboard.trips.state.unauthenticated.title": "Connectez-vous pour voir vos voyages",
  "accountDashboard.trips.state.unauthenticated.body": "Vos voyages sont liés à votre compte. Connectez-vous, puis revenez ici pour gérer les réservations à venir, passées et annulées.",
  "accountDashboard.trips.state.error.title": "Impossible de charger les voyages",
  "accountDashboard.trips.state.error.body": "Nous n’avons pas pu charger vos voyages. Réessayez.",
  "accountDashboard.trips.state.error.retry": "Réessayer",
  "accountDashboard.trips.state.error.retryAriaLabel": "Réessayer de charger les voyages",
  "accountDashboard.trips.lookup.unauthenticated": "Connectez-vous pour rechercher une réservation.",
  "accountDashboard.trips.lookup.error": "Nous n’avons pas pu rechercher cette réservation. Réessayez.",
  "accountDashboard.trips.lookup.found": "Réservation trouvée.",
  "accountDashboard.trips.card.bookingReference": "Référence de réservation",
  "accountDashboard.trips.card.departure": "Départ",
  "accountDashboard.trips.card.return": "Retour",
  "accountDashboard.trips.card.passengers": "Passagers",
  "accountDashboard.trips.card.total": "Total",
  "accountDashboard.trips.card.viewDetails": "Voir les détails",
  "accountDashboard.trips.card.unknownDestination": "Destination inconnue",
  "accountDashboard.trips.status.upcoming": "À venir",
  "accountDashboard.priceAlerts.eyebrow": "OUTILS DU COMPTE",
  "accountDashboard.priceAlerts.title": "Alertes de prix",
  "accountDashboard.priceAlerts.description": "Suivez les prix et recevez une notification lorsque les tarifs changent.",
  "accountDashboard.priceAlerts.empty.title": "Aucune alerte de prix pour le moment.",
  "accountDashboard.priceAlerts.empty.body": "Créez une alerte depuis une recherche de vols pour suivre les changements de tarifs et recevoir des notifications.",
  ...
  "accountDashboard.priceAlerts.filtersAriaLabel": "Filtres des alertes de prix",
  "accountDashboard.priceAlerts.featuresAriaLabel": "Fonctionnalités des alertes de prix",
  "accountDashboard.priceAlerts.tabs.active": "Actives",
  "accountDashboard.priceAlerts.tabs.triggered": "Expirées",
  "accountDashboard.priceAlerts.tabs.all": "Toutes",
  "accountDashboard.priceAlerts.sort.label": "Trier par",
  "accountDashboard.priceAlerts.sort.ariaLabel": "Trier les alertes de prix",
  "accountDashboard.priceAlerts.sort.newest": "Les plus récentes",
  "accountDashboard.priceAlerts.sort.oldest": "Plus anciens",
  "accountDashboard.priceAlerts.sort.routeAz": "Itinéraire A-Z",
  "accountDashboard.priceAlerts.features.monitoring.title": "Suivi en temps réel",
  "accountDashboard.priceAlerts.features.monitoring.body": "Nous surveillons les prix et vous prévenons lorsque les alertes se déclenchent.",
  "accountDashboard.priceAlerts.features.email.title": "Notifications par e-mail",
  "accountDashboard.priceAlerts.features.email.body": "Recevez une notification lorsque les tarifs changent.",
  "accountDashboard.priceAlerts.features.trends.title": "Tendances des prix",
  "accountDashboard.priceAlerts.features.trends.body": "Suivez l’évolution des tarifs surveillés au fil du temps.",
  "accountDashboard.priceAlerts.features.management.title": "Gestion facile",
  "accountDashboard.priceAlerts.features.management.body": "Mettez en pause ou supprimez des alertes à tout moment.",
  "accountDashboard.priceAlerts.error.title": "Nous n’avons pas pu charger vos alertes. Veuillez réessayer.",
  "accountDashboard.priceAlerts.error.body": "Les détails de votre compte restent protégés. Actualisez la page ou revenez à votre tableau de bord.",
  "accountDashboard.priceAlerts.error.cta": "Retour au tableau de bord",
  "accountDashboard.priceAlerts.alertType.flight": "Vol",
  "accountDashboard.priceAlerts.alertType.hotel": "Hôtel",
  "accountDashboard.priceAlerts.alert.targetPrice": "Prix cible",
  "accountDashboard.priceAlerts.alert.noTargetPrice": "Aucun prix cible enregistré",
  "accountDashboard.priceAlerts.alert.created": "Créée",
  "accountDashboard.priceAlerts.alert.updated": "Mise à jour",
  ...
  "accountDashboard.preferences.customization.title": "Préférences de personnalisation",
  "accountDashboard.preferences.customization.description": "Choisissez comment Kurioticket personnalise votre expérience.",
  "accountDashboard.preferences.customization.languageRegion.title": "Langue et région",
  "accountDashboard.preferences.customization.languageRegion.description": "Définissez votre langue, votre devise et votre région par défaut.",
  "accountDashboard.preferences.customization.preferredLanguage": "Langue préférée",
  "accountDashboard.preferences.customization.selectPreferredLanguage": "Sélectionner la langue préférée",
  "accountDashboard.preferences.customization.currency": "Devise",
  "accountDashboard.preferences.customization.selectCurrency": "Sélectionner la devise",
  "accountDashboard.preferences.customization.region": "Région",
  "accountDashboard.preferences.customization.selectRegion": "Sélectionner la région",
  "accountDashboard.preferences.customization.personalization.title": "Personnalisation",
  "accountDashboard.preferences.customization.personalization.description": "Contrôlez comment Kurioticket personnalise vos recommandations.",
  "accountDashboard.preferences.customization.personalizeSearches": "Utiliser mes recherches pour personnaliser les recommandations",
  "accountDashboard.preferences.customization.personalizedTravelForfaits": "Afficher des offres de voyage personnalisées",
  "accountDashboard.preferences.customization.rememberRecentSearches": "Mémoriser mes recherches récentes",
  "accountDashboard.preferences.customization.communicationStyle.title": "Style de communication",
  "accountDashboard.preferences.customization.communicationStyle.description": "Choisissez comment Kurioticket doit communiquer avec vous.",
  "accountDashboard.preferences.customization.emailUpdates": "Mises à jour par e-mail",
  "accountDashboard.preferences.customization.priceAlertEmails": "E-mails d’alerte de prix",
  "accountDashboard.preferences.customization.travelInspirationEmails": "E-mails d’inspiration voyage",
  "accountDashboard.preferences.customization.language.english": "Anglais",
  "accountDashboard.preferences.customization.language.spanish": "Espagnol",
  "accountDashboard.preferences.customization.language.french": "Français",
  "accountDashboard.preferences.customization.language.german": "Allemand",
  "accountDashboard.preferences.customization.language.portuguese": "Portugais",
  "accountDashboard.preferences.customization.language.dutch": "Néerlandais",
  "accountDashboard.preferences.customization.currency.usd": "Dollar américain (USD)",
  "accountDashboard.preferences.customization.currency.eur": "Euro (EUR)",
  "accountDashboard.preferences.customization.currency.gbp": "Livre sterling (GBP)",
  "accountDashboard.preferences.customization.currency.cad": "Dollar canadien (CAD)",
  "accountDashboard.preferences.customization.currency.aud": "Dollar australien (AUD)",
  "accountDashboard.preferences.customization.region.unitedStates": "États-Unis",
  "accountDashboard.preferences.customization.region.canada": "Canada",
  "accountDashboard.preferences.customization.region.unitedKingdom": "Royaume-Uni",
  "accountDashboard.preferences.customization.region.europe": "Europe",
  "accountDashboard.preferences.customization.region.australia": "Australie",
  "accountDashboard.preferences.booking.title": "Préférences de réservation",
  "accountDashboard.preferences.booking.description": "Définissez vos préférences de voyage par défaut pour des réservations plus rapides et plus pertinentes.",
  "accountDashboard.preferences.booking.airports.title": "Aéroports",
  "accountDashboard.preferences.booking.airports.description": "Choisissez les aéroports depuis lesquels vous préférez partir.",
  "accountDashboard.preferences.booking.homeAirport": "Aéroport principal",
  "accountDashboard.preferences.booking.searchAirport": "Rechercher un aéroport",
  "accountDashboard.preferences.booking.secondaryAirports": "Aéroports secondaires",
  "accountDashboard.preferences.booking.addAlternativeAirports": "Ajouter des aéroports alternatifs",
  "accountDashboard.preferences.booking.airlines.title": "Compagnies aériennes",
  "accountDashboard.preferences.booking.airlines.description": "Choisissez les compagnies aériennes que vous préférez ou souhaitez éviter.",
  "accountDashboard.preferences.booking.preferredAirlines": "Compagnies aériennes préférées",
  "accountDashboard.preferences.booking.searchAirlines": "Rechercher des compagnies aériennes",
  "accountDashboard.preferences.booking.avoidAirlines": "Compagnies aériennes à éviter",
  "accountDashboard.preferences.booking.stays.title": "Séjours",
  "accountDashboard.preferences.booking.stays.description": "Définissez vos préférences d’hébergement pour les réservations d’hôtel.",
  "accountDashboard.preferences.booking.preferredHotelChains": "Chaînes hôtelières préférées",
  "accountDashboard.preferences.booking.searchHotelChains": "Rechercher des chaînes hôtelières",
  "accountDashboard.preferences.booking.avoidHotelChains": "Chaînes hôtelières à éviter",
  "accountDashboard.preferences.cancel": "Annuler",
  "accountDashboard.preferences.savePreferences": "Enregistrer les préférences",
  "account.pendingDeletion.eyebrow": "Bon retour",
  "account.pendingDeletion.title": "La suppression de votre compte est en attente.",
  "account.pendingDeletion.scheduledPrefix": "Votre compte est programmé pour une suppression définitive le",
  "account.pendingDeletion.reactivateNotice": "Vous pouvez réactiver votre compte avant cette date. D’ici là, la navigation normale dans le tableau de bord est limitée.",
  "account.pendingDeletion.helperBefore": "Bon retour. Cliquer sur Réactiver le compte annule la suppression avant le",
  "account.pendingDeletion.helperAfter": "et rétablit l’accès normal à l’application.",
  "account.pendingDeletion.error.reactivate": "Impossible de réactiver le compte.",
  "account.pendingDeletion.error.expired": "Le délai de réactivation de 7 jours a expiré. Contactez l’assistance.",
  "account.pendingDeletion.action.reactivating": "Réactivation…",
  "account.pendingDeletion.action.reactivate": "Réactiver le compte",
  "account.pendingDeletion.action.logout": "Se déconnecter",
  ...
  "accountDashboard.personalDetails.description": "Gérez les informations que Kurioticket utilise pour votre compte.",
  ...
  "accountDashboard.personalDetails.section.basicInformation": "Informations de base",
  ...
  "accountDashboard.personalDetails.section.address": "Adresse",
  ...
  "accountDashboard.personalDetails.emailVerified": "Vérifié",
  "accountDashboard.personalDetails.changeEmail": "Modifier l’e-mail",
  "accountDashboard.personalDetails.emailHelper": "Cet e-mail est utilisé pour la connexion et les confirmations de réservation. Les modifications nécessitent une vérification.",
  "accountDashboard.personalDetails.phoneHelper": "Nous utiliserons ce numéro pour les mises à jour de réservation.",
  "accountDashboard.personalDetails.dateOfBirthDayPlaceholder": "JJ",
  "accountDashboard.personalDetails.dateOfBirthYearPlaceholder": "AAAA",
  "accountDashboard.personalDetails.addressDescription": "Utilisée pour la facturation, les dossiers de réservation et les communications de voyage.",
  "accountDashboard.personalDetails.countryRegion": "Pays/région",
  "accountDashboard.personalDetails.selectOne": "Sélectionnez une option",
  "accountDashboard.personalDetails.streetAddress": "Adresse",
  "accountDashboard.personalDetails.apartmentSuite": "Appartement, suite, unité, bâtiment",
  "accountDashboard.personalDetails.townCity": "Ville / commune",
  "accountDashboard.personalDetails.stateProvinceRegion": "État / province / région",
  "accountDashboard.personalDetails.postcodeZip": "Code postal",
  ...
  recentSearchesPageTitle: "Recherches récentes",
  recentSearchesClearAll: "Tout effacer",
  recentSearchesClearFlights: "Effacer les vols",
  recentSearchesClearHotels: "Effacer les hôtels",
  recentSearchesPageSubtitle:
    "Jump back to where you left off and search again in one click.",
  recentSearchesEmptyTitle: "Lancez une recherche pour garder l’élan",
  ...
  loginInvalidCredentials:
    "Nous n’avons pas pu vous connecter. Vérifiez votre e-mail et votre mot de passe, puis réessayez.",
  loginRateLimited:
  ...
  forgotPasswordSuccess: "Si un compte existe, nous avons envoyé les instructions de réinitialisation du mot de passe.",
  ...
  resetPasswordCreateTitle: "Créez un nouveau mot de passe",
  resetPasswordSubtitle: "Saisissez votre nouveau mot de passe ci-dessous.",
  resetPasswordRequestNew: "Demander un nouvel e-mail de réinitialisation",
  ...
  resetPasswordValidationError:
    "Saisissez un mot de passe valide et assurez-vous que les deux champs de mot de passe correspondent.",
  resetPasswordUnable: "Impossible de réinitialiser le mot de passe pour le moment.",
  resetPasswordSuccessMessage: "Mot de passe réinitialisé avec succès. Redirection vers la connexion...",
  resetPasswordResetting: "Réinitialisation...",
  resetPasswordRemember: "Vous vous souvenez de votre mot de passe ?",
  resetPasswordLoginLink: "Se connecter",
  verifyLoginTitle: "Vérifiez votre connexion",
  verifyLoginInstructions: "Saisissez le code à 6 chiffres que nous avons envoyé à votre adresse e-mail. Les codes expirent après 10 minutes.",
  verifyLoginCodeLabel: "Code de connexion",
  verifyLoginSubmit: "Vérifier la connexion",
  verifyLoginNeedNewCode: "Besoin d’un nouveau code ? Saisissez votre mot de passe afin que nous puissions en renvoyer un en toute sécurité.",
  verifyLoginPasswordLabel: "Mot de passe pour le renvoi",
  verifyLoginNeedStartOver: "Besoin de recommencer ?",
  verifyLoginAgainLink: "Se reconnecter",
  ...
  "legal.index.heroLabel": "Informations juridiques",
  "legal.index.heroTitle": "Centre juridique",
  "legal.index.heroDescription": "Les ressources juridiques de Kurioticket expliquent le fonctionnement de nos pratiques de recherche de voyage, de compte, de confidentialité, de redirection fournisseur et de conformité.",
  "legal.index.compliance.eyebrow": "ENTREPRISE ET CONFORMITÉ",
  "legal.index.compliance.sellerOfTravel": "Vendeur de voyages de Californie",
  "legal.index.compliance.registrationNumberLabel": "N° d’enregistrement",
  "legal.index.compliance.registrationExpires": "Expiration de l’enregistrement",
  "legal.index.compliance.registrationExpiresDate": "5 juin 2027",
  "legal.index.compliance.publicNotice": "L’enregistrement comme vendeur de voyages ne constitue pas une approbation par l’État de Californie.",
  "legal.index.contacts.support": "Assistance",
  "legal.index.contacts.legal": "Juridique",
  "legal.index.contacts.privacy": "Confidentialité",
  "legal.index.resourcesEyebrow": "Ressources officielles",
  "legal.index.resourcesTitle": "Documents juridiques",
  "legal.index.documentsCountLabel": "politiques et avis disponibles",
  "legal.index.documents.privacyChoices.title": "Choix de confidentialité",
  "legal.index.documents.privacyChoices.summary": "Informations localisées pour ce document juridique de Kurioticket.",
  "legal.index.documents.californiaSellerOfTravelNotice.title": "Avis de vendeur de voyages de Californie",
  "legal.index.documents.californiaSellerOfTravelNotice.summary": "Informations localisées pour ce document juridique de Kurioticket.",
  "legal.index.documents.legalNoticeCompanyInformation.title": "Mentions légales et informations sur l’entreprise",
  "legal.index.documents.legalNoticeCompanyInformation.summary": "Informations localisées pour ce document juridique de Kurioticket.",
  "legal.index.documents.securityStatement.title": "Déclaration de sécurité",
  "legal.index.documents.securityStatement.summary": "Informations localisées pour ce document juridique de Kurioticket.",
  "legal.index.documents.accessibilityStatement.title": "Déclaration d’accessibilité",
  "legal.index.documents.accessibilityStatement.summary": "Informations localisées pour ce document juridique de Kurioticket.",
  ...
  "legal.californiaSellerOfTravelNotice.title": "Avis de vendeur de voyages de Californie",
  "legal.californiaSellerOfTravelNotice.summary": "Avis d’enregistrement California Seller of Travel pour la plateforme de recherche et de redirection de voyages de Kurioticket.",
  "legal.californiaSellerOfTravelNotice.lastUpdatedDate": "28 juin 2026",
  "legal.californiaSellerOfTravelNotice.tableOfContents": "TABLE DES MATIÈRES",
  "legal.californiaSellerOfTravelNotice.sections.registration.title": "Informations d’enregistrement",
  "legal.californiaSellerOfTravelNotice.sections.registration.paragraph1": "Kurioticket LLC est enregistrée comme California Seller of Travel sous le numéro d’enregistrement 2172630-70.",
  "legal.californiaSellerOfTravelNotice.sections.registration.paragraph2": "Enregistrement valable à partir du June 06, 2026. L’enregistrement expire le June 05, 2027.",
  "legal.californiaSellerOfTravelNotice.sections.registration.paragraph3": "L’enregistrement comme vendeur de voyages ne constitue pas une approbation par l’État de Californie.",
  "legal.californiaSellerOfTravelNotice.sections.platform-model.title": "Modèle de recherche et de redirection",
  "legal.californiaSellerOfTravelNotice.sections.platform-model.paragraph1": "Kurioticket LLC exploite une plateforme de recherche, de comparaison et de redirection de voyages pour les vols, hôtels, voitures et offres. Kurioticket aide les utilisateurs à comparer les options de voyage et à poursuivre vers des fournisseurs externes pour les étapes finales de réservation.",
  "legal.californiaSellerOfTravelNotice.sections.platform-model.paragraph2": "Kurioticket ne traite pas les paiements finaux de voyage et n’émet pas les documents de voyage finaux ; les fournisseurs externes gèrent la réservation finale, le paiement, la confirmation, l’annulation, les remboursements, les modifications, les bagages, l’enregistrement et l’assistance aux réservations.",
  "legal.californiaSellerOfTravelNotice.sections.provider-responsibilities.title": "Responsabilités des fournisseurs externes",
  "legal.californiaSellerOfTravelNotice.sections.provider-responsibilities.paragraph1": "Les fournisseurs externes gèrent la réservation finale, le paiement, la confirmation, l’annulation, les remboursements, les modifications, les bagages, l’enregistrement et l’assistance aux réservations après votre passage de Kurioticket au site d’un fournisseur.",
  "legal.californiaSellerOfTravelNotice.sections.provider-responsibilities.paragraph2": "Consultez le prix final, la disponibilité, les règles tarifaires, les conditions de chambre ou de véhicule, la politique d’annulation, la politique de remboursement, les règles relatives aux bagages, les exigences d’enregistrement et les conditions d’assistance client du fournisseur externe avant de finaliser tout achat.",
  "legal.californiaSellerOfTravelNotice.sections.contact.title": "Contact",
  "legal.californiaSellerOfTravelNotice.sections.contact.paragraph1": "Kurioticket LLC, 801 Tupper St, Suite 812, Santa Rosa, CA 95404. Téléphone : 346-383-0325. Support : support@kurioticket.com. Juridique : legal@kurioticket.com. Confidentialité : privacy@kurioticket.com.",
  "legal.californiaSellerOfTravelNotice.sections.contact.paragraph2": "Pour l’assistance de la plateforme, contactez support@kurioticket.com. Pour les questions juridiques, contactez legal@kurioticket.com. Pour les questions de confidentialité, contactez privacy@kurioticket.com.",
  "legal.californiaSellerOfTravelNotice.developerNote": "Ces projets juridiques sont des contenus provisoires de démarrage et doivent être examinés par un conseiller juridique qualifié avant un lancement public à grande échelle.",
  ...
  "legal.dataDeletionPolicy.tableOfContents": "TABLE DES MATIÈRES",
  ...
  "legal.refundBookingDisclaimer.tableOfContents": "TABLE DES MATIÈRES",
  ...
  "legal.priceAvailabilityDisclaimer.tableOfContents": "TABLE DES MATIÈRES",
  ...
  "legal.partnerRedirectDisclaimer.title": "Avis sur les redirections vers les partenaires",
  "legal.partnerRedirectDisclaimer.summary": "Ce qui se passe lorsque Kurioticket redirige les utilisateurs vers des compagnies aériennes, des hôtels, des partenaires affiliés ou des fournisseurs de voyage.",
  "legal.partnerRedirectDisclaimer.lastUpdatedDate": "11 mai 2026",
  "legal.partnerRedirectDisclaimer.tableOfContents": "TABLE DES MATIÈRES",
  "legal.partnerRedirectDisclaimer.lastUpdated": "Dernière mise à jour : 11 mai 2026",
  "legal.partnerRedirectDisclaimer.sections.redirect.title": "Redirections sécurisées",
  "legal.partnerRedirectDisclaimer.sections.redirect.paragraph1": "Lorsque vous continuez vers un fournisseur externe, Kurioticket vous redirige vers une compagnie aérienne, un hôtel, un partenaire affilié ou un fournisseur de voyage. Nous pouvons enregistrer des métadonnées de redirection, comme le fournisseur, l’itinéraire, le prix, l’horodatage, le type d’utilisateur et la page source, à des fins d’analyse, d’assistance, de prévention des abus et de suivi d’affiliation.",
  "legal.partnerRedirectDisclaimer.sections.redirect.paragraph2": "Kurioticket ne remplit pas automatiquement les sites des compagnies aériennes, n’extrait pas de données des sites des compagnies aériennes et n’effectue pas d’achats auprès de partenaires en votre nom.",
  "legal.partnerRedirectDisclaimer.sections.external-terms.title": "Conditions externes",
  "legal.partnerRedirectDisclaimer.sections.external-terms.paragraph1": "Les sites de partenaires externes sont régis par leurs propres conditions, politiques de confidentialité, politiques de remboursement, cookies, pratiques d’accessibilité et processus d’assistance client.",
  "legal.partnerRedirectDisclaimer.developerNote": "Ces versions juridiques sont des documents provisoires pour le lancement initial et doivent être examinées par un conseiller juridique qualifié avant tout lancement public à grande échelle.",
  ...
  "accountMenu.recentSearches.label": "Recherches récentes",
  ...
  "flightLandingCity.Cairo": "Le Caire",
  "flightLandingCity.Doha": "Doha",
  "flightLandingCity.Dubai": "Dubaï",
  "flightLandingCity.Istanbul": "Istanbul",
  "flightLandingCity.Johannesburg": "Johannesbourg",
  ...
  "homePopularDestinationCity.dubai": "Dubaï",
  "homePopularDestinationCity.istanbul": "Istanbul",
  "homePopularDestinationCity.johannesburg": "Johannesbourg",
  ...
  homeHotelDestinationsTitle: "Explorez des séjours dans le monde",
  homeHotelDestinationsSubtitle:
    "Découvrez des destinations hôtelières dans des villes, pays et régions populaires.",
  homeHotelDestinationsExploreStays: "Explorer les séjours",
  homeHotelDestinationsExploreAll: "Explorer tous les séjours",
  homeHotelDestinationsCardAria: "Explorez les séjours à {{city}}, {{country}}.",
  ...
  "homeDiscoveryRoute.ng-los-lhr.title": "Londres affaires et week-end",
  "homeDiscoveryRoute.ng-los-lhr.routeNote": "Ligne long-courrier à haute fréquence, pratique pour combiner déplacements professionnels et loisirs.",
  "homeDiscoveryRoute.ng-los-dxb.title": "Escale shopping à Dubaï",
  "homeDiscoveryRoute.ng-los-dxb.routeNote": "Itinéraire prisé pour les pauses shopping, les voyages en famille et les correspondances.",
  "homeDiscoveryRoute.ng-abv-acc.title": "Court séjour régional à Accra",
  "homeDiscoveryRoute.ng-abv-acc.routeNote": "Route régionale courte avec un accès efficace de ville à ville.",
  "homeDiscoveryRoute.ng-los-nbo.title": "Nairobi, porte d’entrée safari",
  "homeDiscoveryRoute.ng-los-nbo.routeNote": "Accès à l’Afrique de l’Est pour les pôles d’affaires et les extensions safari.",
  "homeDiscoveryRoute.ng-abv-jnb.title": "Escapade urbaine à Johannesburg",
  "homeDiscoveryRoute.ng-abv-jnb.routeNote": "Bonne connectivité vers le sud pour les réunions et les séjours urbains.",
  "homeDiscoveryRoute.ng-los-ist.title": "Route de connexion via Istanbul",
  "homeDiscoveryRoute.ng-los-ist.routeNote": "Excellent hub pour les liaisons européennes avec une escale urbaine animée.",
  "homeDiscoveryRoute.ng-abv-cdg.title": "Échappée style à Paris",
  "homeDiscoveryRoute.ng-abv-cdg.routeNote": "Route européenne classique pour la mode, les musées et les scènes culinaires.",
  "homeDiscoveryRoute.ng-los-doh.title": "Transit premium à Doha",
  "homeDiscoveryRoute.ng-los-doh.routeNote": "Itinéraire axé sur le confort avec des correspondances mondiales fluides.",
  "homeDiscoveryRoute.ng-los-kig.title": "Week-end ville propre à Kigali",
  "homeDiscoveryRoute.ng-los-kig.routeNote": "Hub régional en essor avec collines verdoyantes et déplacements urbains faciles.",
  "homeDiscoveryRoute.ng-abv-cai.title": "Escale patrimoine au Caire",
  "homeDiscoveryRoute.ng-abv-cai.routeNote": "Porte d’entrée vers l’histoire du Nil et les marchés animés de la vieille ville.",
  "homeDiscoveryRoute.ng-los-add.title": "Lien est-africain via Addis-Abeba",
  ...
  homepageFaqViewAll: "Voir toutes les questions fréquentes",
...
flightLandingRouteAriaLabel:
  ...
  flightRouteTemplate: "{{origin}} vers {{destination}}",
  layoverTemplate: "Escale à {{airport}} · {{duration}} · {{connection}}",
  flightNumberLabel: "Vol",
  layoverIn: "Escale à",
  layoverSummaryTemplate: "Escale : {{airport}} {{duration}}",
  ...
  "Live flight results are temporarily unavailable. Please try again shortly.": "Les résultats de vols en direct sont temporairement indisponibles. Veuillez réessayer sous peu.",
  ...
  "hotelResults.cheapest": "LE MOINS CHER",
  ...
  "hotelResults.topRated": "LE MIEUX NOTÉ",
  ...
  "hotelResults.filterBy": "Filtrer par",
  ...
  "hotelResults.fromRating": "À partir de",
  ...
  "hotelResults.payAtProperty": "Paiement sur place",
  "hotelResults.payLater": "Payer plus tard",
  "hotelResults.noPrepayment": "Aucun prépaiement",
  "hotelResults.refundable": "Remboursable",
  ...
  "carsSearch.error.pickupLocationRequired": "Saisissez un lieu de prise en charge.",
  "carsSearch.error.pickupDateRequired": "Sélectionnez une date de prise en charge.",
  "carsSearch.error.pickupDatePast": "La date de prise en charge ne peut pas être dans le passé.",
  "carsSearch.error.pickupTimeRequired": "Sélectionnez une heure de prise en charge.",
  "carsSearch.error.dropoffDateRequired": "Sélectionnez une date de retour.",
  "carsSearch.error.dropoffDatePast": "La date de retour ne peut pas être dans le passé.",
  "carsSearch.error.dropoffTimeRequired": "Sélectionnez une heure de retour.",
  "carsSearch.error.driverAgeInvalid": "Sélectionnez Tout âge 18–70 ou un âge de conducteur de 18 à 70 ans.",
  "carsSearch.error.dropoffLocationRequired": "Saisissez un lieu de retour.",
  "carsSearch.error.dropoffBeforePickup": "La date de retour ne peut pas être antérieure à la date de prise en charge.",
  "carsSearch.error.sameDayDropoffAfterPickup": "Pour les retours le même jour, l’heure de retour doit être après l’heure de prise en charge.",
  ...
  "carsResults.pickupLocationLabel": "Lieu de prise en charge",
  "carsResults.returnLocationLabel": "Lieu de retour",
  "carsResults.rentalDatesLabel": "Dates de location",
  "carsResults.pickupReturnTimeLabel": "Heure de prise en charge / retour",
  "carsResults.driverAgeLabel": "Âge du conducteur",
  ...
  "deals.travelersCarsLabel": "VOYAGEURS / VOITURES",
  "deals.travelersCabinLabel": "VOYAGEURS / CABINE",
  "deals.travelersDetailsLabel": "VOYAGEURS / DÉTAILS",
  "deals.travelersRoomsCarLabel": "VOYAGEURS / CHAMBRES / VOITURE",
  ...
  "deals.loadingPage": "Chargement de la page...",
  "deals.decreaseCountAria": "Diminuer {{label}}",
  "deals.increaseCountAria": "Augmenter {{label}}",
  ...
  "deals.destination.tokyo.imageAlt": "Skyline de Tokyo avec de nombreux immeubles de grande hauteur en journée",
  "deals.destination.london.city": "Londres",
  "deals.destination.london.country": "Royaume-Uni",
  "deals.destination.london.imageAlt": "Tower Bridge et la Tamise à Londres sous un ciel bleu",
  "deals.destination.paris.city": "Paris",
  "deals.destination.paris.country": "France",
  "deals.destination.paris.imageAlt": "Tour Eiffel et Seine à Paris à l’heure dorée",
  "deals.destination.dubai.city": "Dubaï",
  "deals.destination.dubai.country": "Émirats arabes unis",
  "deals.destination.dubai.imageAlt": "Skyline de Dubaï avec le Burj Khalifa dominant les gratte-ciel",
  "deals.destination.cancun.city": "Cancún",
  "deals.destination.cancun.country": "Mexique",
  "deals.destination.cancun.imageAlt": "Plage de Cancún avec sable blanc et eau turquoise",
  "deals.destination.rome.city": "Rome",
  "deals.destination.rome.country": "Italie",
  "deals.destination.rome.imageAlt": "Le Colisée à Rome sous un ciel bleu dégagé",
  ...
  supportBeforeContactDashboardDescription:
    "Indiquez l’e-mail de votre compte Kurioticket, ce pour quoi vous avez besoin d’aide et tout détail de réservation ou d’itinéraire pouvant nous aider à comprendre le problème.",
  ...
  "accountDashboard.hub.travelActivity": "Activité de voyage",
  "accountDashboard.hub.myTrips": "Mes voyages",
  "accountDashboard.hub.savedTrips": "Voyages enregistrés",
  "accountDashboard.hub.recentSearches": "Recherches récentes",
  ...
  "accountDashboard.hub.faq": "Questions fréquentes",
  "accountDashboard.hub.serviceGuarantee": "Garantie de service",
  "hotelResults.filter.doubleBusiness": "Chambre double affaires",
  "hotelResults.filter.bedAndBreakfast": "Chambre avec petit-déjeuner",
  ...
  "emailUpdates.subscribedStatus": "Vous êtes abonné.",
  "emailUpdates.subscribedButton": "Abonné",
  "emailUpdates.stopUpdates": "Arrêter les mises à jour",
  "emailUpdates.loadingStatus": "Chargement…",
  "emailUpdates.unsubscribedStatus": "Vous n’êtes pas abonné.",
  "emailUpdates.notFoundStatus": "Aucun abonnement n’a été trouvé.",
  "emailUpdates.subscribeButton": "S’abonner",
  "emailUpdates.restartUpdates": "Redémarrer les mises à jour",
  "emailUpdates.updatesStopped": "Mises à jour arrêtées",
  "emailUpdates.notAvailable": "Non disponible",
  "emailUpdates.invalidLink": "Ce lien de préférences est invalide ou expiré.",
  "emailUpdates.loadError": "Nous n’avons pas pu charger ces préférences pour le moment.",
  "emailUpdates.updateError": "Nous n’avons pas pu mettre à jour cette préférence pour le moment.",
  "emailUpdates.preferenceUpdated": "Préférence mise à jour.",
  ...
  "legal.legalNoticeCompanyInformation.title": "Mentions légales et informations sur l’entreprise",
  "legal.legalNoticeCompanyInformation.summary": "Informations sur l’entreprise, les contacts, le périmètre du produit et les limites des fournisseurs pour Kurioticket.",
  "legal.legalNoticeCompanyInformation.lastUpdatedDate": "28 juin 2026",
  "legal.legalNoticeCompanyInformation.tableOfContents": "TABLE DES MATIÈRES",
  "legal.legalNoticeCompanyInformation.sections.company-information.title": "Informations sur l’entreprise",
  "legal.legalNoticeCompanyInformation.sections.company-information.paragraph1": "Kurioticket LLC, 801 Tupper St, Suite 812, Santa Rosa, CA 95404. Téléphone : 346-383-0325. Assistance : support@kurioticket.com. Juridique : legal@kurioticket.com. Confidentialité : privacy@kurioticket.com.",
  "legal.legalNoticeCompanyInformation.sections.company-information.paragraph2": "Nom légal : Kurioticket LLC. Adresse : 801 Tupper St, Suite 812, Santa Rosa, CA 95404. Téléphone professionnel : 346-383-0325.",
  "legal.legalNoticeCompanyInformation.sections.contacts.title": "Adresses e-mail de contact",
  "legal.legalNoticeCompanyInformation.sections.contacts.paragraph1": "Assistance : support@kurioticket.com. Juridique : legal@kurioticket.com. Confidentialité : privacy@kurioticket.com.",
  "legal.legalNoticeCompanyInformation.sections.product-scope.title": "Périmètre du produit et modèle économique",
  "legal.legalNoticeCompanyInformation.sections.product-scope.paragraph1": "Le périmètre du produit Kurioticket comprend les vols, les hôtels, les voitures et les offres.",
  "legal.legalNoticeCompanyInformation.sections.product-scope.paragraph2": "Modèle économique : plateforme de recherche, comparaison et redirection de voyages. Kurioticket aide les utilisateurs à rechercher, comparer et poursuivre vers des fournisseurs de voyage externes.",
  "legal.legalNoticeCompanyInformation.sections.provider-payment-boundary.title": "Limite entre fournisseur et paiement",
  "legal.legalNoticeCompanyInformation.sections.provider-payment-boundary.paragraph1": "Kurioticket ne traite pas les paiements finaux de voyage et n’émet pas de documents de voyage finaux ; les fournisseurs externes gèrent la réservation finale, le paiement, la confirmation, l’annulation, les remboursements, les modifications, les bagages, l’enregistrement et l’assistance de réservation.",
  "legal.legalNoticeCompanyInformation.sections.provider-payment-boundary.paragraph2": "Le fournisseur externe qui reçoit le paiement est responsable des conditions finales de réservation, du prix final, du traitement du paiement, de la confirmation, de l’annulation, des remboursements, des modifications, des bagages, de l’enregistrement et de l’assistance de réservation.",
  "legal.legalNoticeCompanyInformation.sections.california-registration.title": "Référence California Seller of Travel",
  "legal.legalNoticeCompanyInformation.sections.california-registration.paragraph1": "California Seller of Travel Registration No. 2172630-70. L’enregistrement comme vendeur de voyages ne constitue pas une approbation par l’État de Californie.",
  ...
  "deals.results.title": "Résultats de voyage coordonnés",
  "deals.results.explanation": "Ces résultats alignent chaque produit sur votre voyage. Les prix restent propres à chaque produit et les sélections se font séparément.",
  "deals.results.modify": "Modifier la recherche",
  "deals.results.viewFlights": "Voir tous les vols",
  "deals.results.viewHotels": "Voir tous les hôtels",
  "deals.results.viewCars": "Voir les voitures",
  "deals.results.invalidTitle": "Vérifiez votre recherche",
  "deals.results.invalidMessage": "Certains détails du voyage sont manquants ou invalides.",
  "deals.results.noResults": "Aucun résultat correspondant.",
  "deals.results.providerUnavailable": "Le fournisseur est temporairement indisponible.",
  "deals.results.rateLimited": "Trop de recherches. Patientez puis réessayez.",
  "deals.results.unsupportedDestination": "Cette destination hôtelière n’est pas prise en charge.",
  "deals.error.flightOriginCode": "Sélectionnez un aéroport de départ valide.",
  "deals.error.flightDestinationCode": "Sélectionnez un aéroport d’arrivée valide.",
  "deals.error.flightPassengers": "Utilisez de 1 à 9 passagers entiers.",
  "deals.error.flightInfants": "Le nombre de bébés ne peut dépasser celui des adultes.",
  "deals.error.flightDates": "Sélectionnez des dates de vol valides.",
  "deals.error.hotelDestination": "Saisissez une destination d’hôtel.",
  "deals.error.hotelGuests": "Utilisez de 1 à 12 voyageurs entiers.",
  "deals.error.hotelRooms": "Sélectionnez de 1 à 6 chambres.",
  "deals.error.hotelDates": "Sélectionnez des dates d’hôtel valides.",
  "deals.results.separateBooking": "Résultats coordonnés, sélections séparées.",
  "deals.productSelector.instruction": "Choose at least two products",
  "deals.productSelector.minimumTwo": "Forfaits requires at least two products.",
  ...
  "deals.journey.step.flight": "Flight",
  "deals.journey.step.car": "Car",
  "deals.journey.step.review": "Review",
  "deals.journey.status.completed": "Completed",
  "deals.journey.status.current": "Current",
  "deals.journey.status.upcoming": "Upcoming",
  "deals.journey.status.needs-attention": "Needs attention",
  ...
  "deals.guided.review.introduction": "Review each confirmed option before continuing to booking partners.",
  ...
  "deals.guided.review.conversionUnavailable": "A converted estimate is currently unavailable.",
  "deals.guided.review.estimatedTotal": "Estimated trip total",
  "deals.guided.review.totalUnavailable": "A combined estimate is currently unavailable. Review the provider prices for each trip option.",
  "deals.guided.review.estimateDisclosure": "Estimated currency conversions may change. Each booking partner sets the final price.",
  "deals.guided.review.fallbackDisclosure": "Estimated using fallback exchange rates. Each booking partner sets the final price.",
  "deals.guided.review.priceNeedsRefresh": "Price needs refreshing",
  "deals.guided.review.expiredBody": "This option is too old to continue safely. Choose a current option before continuing.",
  "deals.guided.review.continue": "Continue to booking partners",
  "deals.guided.review.continueUnavailable": "Refresh every expired option before continuing.",
  "deals.guided.review.bookingDisclosure": "Nothing is booked on this page. Each booking partner will be reviewed separately.",
  ...
  "deals.guided.handoffPending.body": "Your confirmed trip is still saved temporarily. Provider pages remain disabled in this preview milestone.",
  "deals.guided.handoffPending.backReview": "Back to trip review",
  "deals.guided.handoffPending.returnDeals": "Return to Forfaits",
  "deals.guided.handoffPending.loading": "Loading your confirmed trip…",
  "deals.guided.handoffPending.missingTitle": "We could not load this guided trip",
  "deals.guided.handoffPending.missingBody": "Return to Forfaits and confirm your trip options again.",
  "deals.guided.handoffPending.expiredTitle": "Your guided trip has expired",
  "deals.guided.handoffPending.expiredBody": "Return to the guided journey and refresh your trip options.",
  "deals.guided.handoffPending.incompleteTitle": "Your guided trip is incomplete",
  "deals.guided.handoffPending.incompleteBody": "Confirm every included trip option before continuing.",
  "deals.guided.handoffPending.storageTitle": "Temporary trip storage is unavailable",
  "deals.guided.handoffPending.storageBody": "Your browser could not load the guided trip safely.",
  "deals.guided.review.package": "Forfait",
  "deals.guided.review.includedOptions": "Options incluses",
  "deals.guided.review.location": "Lieu",
  "deals.guided.review.checkIn": "Arrivée",
  "deals.guided.review.checkOut": "Départ",
  "deals.guided.review.nightsLabel": "Nuits",
  "deals.guided.review.room": "Chambre",
  "deals.guided.review.flightNumber": "Vol",
  "deals.guided.review.route": "Itinéraire",
  "deals.guided.review.departure": "Départ",
  "deals.guided.review.arrival": "Arrivée",
  "deals.guided.review.duration": "Durée",
  "deals.guided.review.model": "Modèle",
  "deals.guided.review.category": "Catégorie",
  "deals.guided.review.pickup": "Prise en charge",
  "deals.guided.review.return": "Retour",
  "deals.guided.review.rentalDaysLabel": "Jours de location",
  "deals.guided.handoffInvalid.title": "Cette demande de transfert n’est pas valide",
  "deals.guided.handoffInvalid.body": "Pour votre sécurité, aucun partenaire de réservation n’a été ouvert. Revenez aux Offres et réessayez.",
  "deals.guided.handoffInvalid.returnDeals": "Retour aux Offres",
  "deals.guided.handoffPending.useCurrentOptions": "Utiliser les options actuelles du voyage",
  "deals.guided.handoff.title": "Continue with your booking partners",
  "deals.guided.handoff.introduction": "Open each step separately. Kurioticket does not book or take payment on this page.",
  ...
  "deals.guided.handoff.storageReadFailedBody": "Nous n’avons pas pu revérifier votre voyage enregistré, cette étape n’a donc pas été ouverte. Réessayez.",
  ...
  "deals.guided.handoff.selectionChanged": "Your trip changed in another tab. Review the updated step, then open it again.",
  "deals.guided.handoff.planExpiredAtClick": "Your guided trip expired before this step could be opened. Refresh your trip options.",
  "deals.guided.handoff.productExpiredAtClick": "This option expired before it could be opened. Return to Review for fresh results.",
  ...
  "deals.guided.handoff.openedDisclosure": "Opened means the handoff page was launched. It does not mean the booking is complete.",
  "deals.guided.handoff.allOpened": "All booking-partner steps have been opened",
  "deals.guided.handoff.allOpenedBody": "Complete each booking separately with the provider. Kurioticket has not booked or charged for this trip.",
  "deals.guided.handoff.progressUnsaved": "Your progress could not be saved. No new handoff page was opened.",
  ...
  "deals.guided.handoff.storageBody": "Your browser could not load the guided trip safely.",
  "deals.guided.handoff.returnDeals": "Return to Forfaits",
  "deals.guided.handoff.missingTitle": "We could not load this guided trip",
  "deals.guided.handoff.missingBody": "Return to Forfaits and confirm your trip options again.",
  "deals.guided.handoff.expiredTitle": "Your guided trip has expired",
  "deals.guided.handoff.expiredBody": "Return to the guided journey and refresh your trip options.",
  "deals.guided.handoff.incompleteTitle": "Your guided trip is incomplete",
  "deals.guided.handoff.incompleteBody": "Confirm every included trip option before continuing.",
  ...
  flightSearchDestinationPlaceholderShort: 'Où allez-vous ?',
  "accountDashboard.recently": "Récemment",
  // Reused from existing locale glossary entries with identical canonical meaning.
  "accountDashboard.preferences.booking.actions.saving": "Saving...",
  "accountDashboard.preferences.booking.sections.flightDefaults.description": "Définissez vos préférences de voyage par défaut pour des réservations plus rapides et plus pertinentes.",
  "accountDashboard.preferences.customization.status.savingShort": "Saving...",
  "accountDashboard.preferences.email.resetShort": "Réinitialiser",
  "accountDashboard.preferences.email.savePreferences": "Enregistrer les préférences",
  "accountDashboard.preferences.email.savingPreferences": "Saving...",
  "accountDashboard.preferences.email.savingShort": "Saving...",
  "accountDashboard.preferences.email.title": "Préférences e-mail",
  "accountMenu.savedRecent.label": "Voyages enregistrés",
  "carDetails.cancellation": "Annulation",
  "carDetails.freeCancellation": "Annulation gratuite",
  "carDetails.nonRefundable": "Non remboursable",
  "carDetails.pickup": "Prise en charge",
  "carDetails.return": "Retour",
  "carDetails.unlimitedMileage": "Kilométrage illimité",
  "carsResults.lowestTotal": "Prix total le plus bas",
  "carsResults.passengers": "Passagers",
  "carsResults.recommended": "Recommandé",
  "carsResults.sortBy": "Trier par",
  "carsResults.topRated": "LE MIEUX NOTÉ",
  "carsSearch.returnLocationLabel": "Lieu de retour",
  "carsSearch.type.airport": "Aéroport",
  "carsSearch.type.area": "Quartier",
  "carsSearch.type.city": "Ville",
  "deals.guided.hotelDetails.roomInformation": "Chambre",
  "homeRegionalRoutesTitle": "Découvrez des destinations depuis votre région",
