...
export const translations: TranslationDictionary = {
  ...
  "legal.privacy.summary": "Comment Kurioticket LLC (« Kurioticket », « nous », « notre » ou « nos ») collecte, utilise, stocke et protège les données de compte, de recherche, d’alerte, d’assistance et d’e-mail.",
  ...
  "legal.privacy.sections.vendors.paragraph1": "Nous pouvons utiliser des fournisseurs de services tiers pour nous aider à exploiter nos services, envoyer des communications, protéger la plateforme, mesurer les performances et soutenir les fonctionnalités du produit.",
  "legal.privacy.sections.vendors.paragraph2": "Kurioticket ne demande ni ne stocke les numéros de carte de crédit pour les réservations de voyage. Kurioticket ne stocke pas les données de passeport.",
  ...
  "legal.privacy.sections.choices.paragraph2": "Nous ne conservons que les données utiles au fonctionnement du produit, à la sécurité, à l’assistance, à l’analyse, à la conformité ou aux besoins commerciaux légitimes.",
