...
flightLandingRouteAriaLabel:
  ...
  "deals.results.heading": "Plan your trip",
  "deals.results.modify": "Modify search",
  "deals.results.tripSummary": "Trip summary",
  "deals.results.route": "Route",
  "deals.results.travelers": "Travelers",
  "deals.results.included": "Included products",
  "deals.results.flightTitle": "Live Flight results",
  "deals.results.flightLoading": "Searching live Flight options…",
  "deals.results.flightEmpty": "No live Flight options were found for this search.",
  "deals.results.flightError": "Live Flight results are temporarily unavailable. Please try again.",
  "deals.results.viewAllFlights": "View all Flights",
  "deals.results.flightPriceNotice": "Prices shown here apply to Flights only, not the complete trip.",
  "deals.results.hotelTitle": "Hotel",
  "deals.results.carTitle": "Car",
  "deals.results.hotelUnavailable": "Live Hotel rates are not currently available for this Deals search.",
  "deals.results.carUnavailable": "Live Car rates are not currently available for this Deals search.",
  "deals.results.customHotelDates": "Use different Hotel dates",
  "deals.results.hotelDates": "Hotel dates",
  "deals.results.hotelCheckIn": "Hotel check-in",
  "deals.results.hotelCheckOut": "Hotel check-out",
  "deals.results.carDetails": "Car details",
  "deals.results.customizeCar": "Customize Car details",
  "deals.results.carPickup": "Pickup location",
  "deals.results.carDropoff": "Return location",
  "deals.results.pickupDate": "Pickup date",
  "deals.results.dropoffDate": "Return date",
  "deals.results.pickupTime": "Pickup time",
  "deals.results.dropoffTime": "Return time",
  "deals.results.adults": "Adults",
  "deals.results.children": "Children",
  "deals.results.summary.destination": "Destination",
  "deals.results.summary.checkIn": "Check-in",
  "deals.results.summary.checkOut": "Check-out",
  "deals.results.summary.travelers": "Travelers",
  "deals.results.summary.rooms": "Rooms",
  "deals.results.summary.pickupLocation": "Pickup location",
  "deals.results.summary.dropoffLocation": "Return location",
  "deals.results.summary.pickupDate": "Pickup date",
  "deals.results.summary.dropoffDate": "Return date",
  "deals.results.summary.pickupTime": "Pickup time",
  "deals.results.summary.dropoffTime": "Return time",
  "deals.results.summary.driverAge": "Driver age",
  "deals.error.cabinClass": "Choose a valid cabin class.",
  "deals.error.hotelDates": "Choose a valid Hotel check-in date.",
  "deals.error.hotelDateOrder": "Hotel check-out must be after check-in.",
  "deals.error.hotelBoundary": "Hotel dates must remain within the Flight trip.",
  "deals.error.carPickup": "Enter a Car pickup location.",
  "deals.error.carDropoff": "Enter a Car return location.",
  "deals.error.carDates": "Choose a valid Car pickup date.",
  "deals.error.carDateOrder": "Car return cannot be before pickup.",
  "deals.error.carTime": "Choose a valid Car pickup time.",
  "deals.error.carTimeOrder": "Car return must be after pickup.",
  "deals.error.driverAge": "Choose a valid driver age.",
};
