...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Podróżni",
  ...
  "deals.guidedPreview.description": "Podgląd ofert z przewodnikiem: Complete guided Pakiety preview: Hotel, Flight and Car selection and confirmation, Review, and final partner handoff.",
  "deals.guidedPreview.availableCar": "Podgląd ofert z przewodnikiem: Car results, filters, sorting, details, and confirmation",
  "deals.guidedPreview.availableReview": "Podgląd ofert z przewodnikiem: Trip Review with persisted opened-step progress",
  "deals.guidedPreview.availableHandoff": "Podgląd ofert z przewodnikiem: Final booking-partner handoff for each included product",
  "deals.guidedPreview.previewOnlyTitle": "Podgląd ofert z przewodnikiem: Internal preview limitations",
  "deals.guidedPreview.previewOnlyPublicLaunch": "Podgląd ofert z przewodnikiem: Public activation has not occurred; normal Search remains unchanged.",
  "deals.guidedPreview.previewOnlyBooking": "Podgląd ofert z przewodnikiem: Kurioticket does not complete booking or payment. Complete each provider step separately.",
  "deals.guided.confirmation.readError": "Podgląd ofert z przewodnikiem: Saved preview progress could not be read. Try confirmation again.",
  "deals.guided.confirmation.saveError": "Podgląd ofert z przewodnikiem: Preview progress could not be saved. Try confirmation again.",
  "deals.guided.crossTabUpdated": "Podgląd ofert z przewodnikiem: This trip was updated in another tab.",
  "deals.guided.prerequisiteChanged": "Podgląd ofert z przewodnikiem: An earlier trip choice changed in another tab. Your current saved trip is now shown.",
  "deals.guided.conflict.title": "Podgląd ofert z przewodnikiem: Another guided preview is saved",
  "deals.guided.conflict.body": "Podgląd ofert z przewodnikiem: This page belongs to a different guided search. Its saved progress is protected.",
  "deals.guided.conflict.restart": "Podgląd ofert z przewodnikiem: Start this preview trip again",
  "deals.guided.conflict.restartDisclosure": "Podgląd ofert z przewodnikiem: Starting again replaces the guided-preview progress currently saved in this browser.",
  "deals.guided.error.title": "Podgląd ofert z przewodnikiem: We could not show this guided Pakiety page",
  "deals.guided.error.body": "Podgląd ofert z przewodnikiem: No booking-partner page was opened. Try again or return safely to Pakiety.",
  "deals.guided.error.retry": "Podgląd ofert z przewodnikiem: Try again",
  "deals.guided.error.returnDeals": "Podgląd ofert z przewodnikiem: Return to Pakiety",
  "deals.guided.storageUnavailable.title": "Podgląd ofert z przewodnikiem: Temporary preview storage is unavailable",
  "deals.guided.storageUnavailable.body": "Podgląd ofert z przewodnikiem: This guided stage cannot safely save progress. Restore browser storage and reload.",
  "deals.guided.invalid.title": "Podgląd ofert z przewodnikiem: Saved preview progress is invalid",
  "deals.guided.invalid.body": "Podgląd ofert z przewodnikiem: Return to the first guided stage to choose fresh trip options.",
  "deals.guided.expired.title": "Podgląd ofert z przewodnikiem: Your guided preview has expired",
  "deals.guided.expired.body": "Podgląd ofert z przewodnikiem: Return to the first guided stage and refresh your trip options.",
  ...
  "brandedLoading.default.title": "Ładowanie Kurioticket...",
  "brandedLoading.default.preparingExperience": "Przygotowujemy Twoje doświadczenie...",
  ...
  contactMetadataTitle: "Skontaktuj się z Kurioticket",
  ...
  exploreWaysTitle: "Sposoby odkrywania",
  exploreWaysRouteTitle: "Odkrywanie tras",
  exploreWaysRouteText: "Zacznij od trasy lotu, a potem porównaj rozkłady, przesiadki i opcje dostawców, gdy wyniki będą dostępne.",
  exploreWaysHotelsTitle: "Pomysły na kierunki hotelowe",
  exploreWaysHotelsText: "Użyj wyszukiwania hoteli według kierunku, aby porównać opcje pobytu, lokalizacje i warunki anulowania.",
  exploreWaysSavedTitle: "Zapisane podróże i ostatnie wyszukiwania",
  exploreWaysSavedText: "Wróć do rozpoczętych tras i wyszukiwań, aby planowanie pozostało uporządkowane w wielu sesjach.",
  exploreWaysBasicsTitle: "Podstawy planowania podróży",
  exploreWaysBasicsText: "Przed decyzją przemyśl terminy, elastyczność, bagaż, potrzeby noclegowe i zasady dostawców.",
  exploreNeedsTitle: "Planuj według potrzeby podróży",
  exploreNeedsWeekendTitle: "Weekendowe wypady do miasta",
  exploreNeedsWeekendText: "Porównaj krótsze trasy, proste rozkłady i lokalizacje hoteli pasujące do ograniczonego czasu wyjazdu.",
  exploreNeedsInternationalTitle: "Podróże międzynarodowe",
  exploreNeedsInternationalText: "Uważnie sprawdź dłuższe plany podróży, w tym całkowity czas, przesiadki, wymagania wjazdowe i warunki dostawcy.",
  exploreNeedsHotelFirstTitle: "Planowanie od hotelu",
  exploreNeedsHotelFirstText: "Zacznij od miejsca pobytu, a następnie dopasuj loty i inne elementy podróży do tej lokalizacji.",
  exploreNeedsCompleteTitle: "Pełne planowanie podróży",
  exploreNeedsCompleteText: "Używaj razem lotów, hoteli, zapisanych podróży i ostatnich wyszukiwań, aby zachować jasny obraz całej podróży.",
  exploreChecklistTitle: "Przed rezerwacją",
  exploreChecklistTime: "Porównaj całkowity czas podróży i przesiadki",
  exploreChecklistBaggage: "Sprawdź bagaż i elastyczność",
  exploreChecklistHotel: "Sprawdź lokalizację hotelu i zasady anulowania",
  exploreChecklistProvider: "Potwierdź końcową cenę i dostępność u dostawcy",
  exploreChecklistSave: "Zapisz trasy lub wyszukiwania na później",
  explorePrimaryCta: "Szukaj lotów",
  exploreSecondaryCta: "Szukaj hoteli",
  exploreSavedCta: "Zobacz zapisane podróże",
  ...
  loginProcessing: "Sprawdzamy Twoje dane i wysyłamy kod weryfikacyjny…",
  loginResendSuccess: "Wysłaliśmy nowy kod, jeśli to konto może się zalogować.",
  loginEnterCode: "Wpisz 6-cyfrowy kod logowania.",
  loginVerifiedRedirecting: "Zweryfikowano. Przekierowywanie…",
  loginStartOverError: "Zacznij od nowa, abyśmy mogli sprawdzić Twoje dane przed wysłaniem nowego kodu.",
  loginSendingNewCode: "Wysyłamy nowy kod weryfikacyjny…",
  loginUnableSendNewCode: "Nie można teraz wysłać nowego kodu. Spróbuj ponownie.",
  loginErrorAccountUnavailable: "To konto jest niedostępne. Skontaktuj się z pomocą techniczną.",
  loginUnableSendLoginCode: "Nie można teraz wysłać kodu logowania. Spróbuj ponownie.",
  signupVerificationRequiredRedirecting: "Wymagana weryfikacja. Przekierowywanie...",
  signupErrorUnableCreate: "Nie udało się utworzyć konta. Spróbuj ponownie.",
  signupErrorRateLimited: "Zbyt wiele prób rejestracji. Poczekaj i spróbuj ponownie.",
  signupErrorDuplicateEmail: "Konto z tym adresem e-mail już istnieje.",
  signupErrorUnableSendVerification: "Nie można teraz wysłać kodu weryfikacyjnego. Spróbuj ponownie.",
  ...
  mobilePreferencesHeading: "Preferencje",
  ...
  "accountDashboard.preferences.customization.personalizedTravelPakiety":
  ...
  "accountDashboard.personalDetails.emailVerified": "Zweryfikowano",
  "accountDashboard.personalDetails.changeEmail": "Zmień e-mail",
  "accountDashboard.personalDetails.emailHelper": "Ten adres e-mail jest używany do logowania i potwierdzeń rezerwacji. Zmiany wymagają weryfikacji.",
  "accountDashboard.personalDetails.phoneHelper": "Użyjemy tego numeru do aktualizacji dotyczących rezerwacji.",
  "accountDashboard.personalDetails.dateOfBirthDayPlaceholder": "DD",
  "accountDashboard.personalDetails.monthPlaceholder": "Miesiąc",
  "accountDashboard.personalDetails.dateOfBirthYearPlaceholder": "RRRR",
  "accountDashboard.personalDetails.section.basicInformation": "Podstawowe informacje",
  "accountDashboard.personalDetails.section.address": "Adres",
  "accountDashboard.personalDetails.addressDescription": "Używany do rozliczeń, zapisów rezerwacji i komunikacji dotyczącej podróży.",
  "accountDashboard.personalDetails.countryRegion": "Kraj/region",
  "accountDashboard.personalDetails.selectOne": "Wybierz jedną opcję",
  "accountDashboard.personalDetails.streetAddress": "Adres ulicy",
  "accountDashboard.personalDetails.apartmentSuite": "Mieszkanie, apartament, lokal, budynek",
  "accountDashboard.personalDetails.townCity": "Miejscowość / miasto",
  "accountDashboard.personalDetails.stateProvinceRegion": "Stan / prowincja / region",
  "accountDashboard.personalDetails.postcodeZip": "Kod pocztowy",
  "accountDashboard.personalDetails.cancel": "Anuluj",
  "accountDashboard.personalDetails.saveChanges": "Zapisz zmiany",
  logout: "Wyloguj się",
  ...
  "accountMenu.recentSearches.label": "Ostatnie wyszukiwania",
  ...
  signupErrorFullNameRequired: "Wpisz swoje imię i nazwisko.",
  signupErrorInvalidEmail: "Wpisz prawidłowy adres e-mail.",
  signupErrorPasswordRequirements: "Hasło musi mieć co najmniej 8 znaków.",
  ...
  "accountDashboard.trips.summary": "{{total}} Reisen insgesamt. {{upcoming}} bevorstehend, {{past}} vergangen, {{cancelled}} storniert.",
  "accountDashboard.trips.state.loading": "Deine Reisen werden geladen...",
  "accountDashboard.trips.state.unauthenticated.title": "Melde dich an, um deine Reisen anzusehen",
  "accountDashboard.trips.state.unauthenticated.body": "Deine Reisen sind mit deinem Konto verbunden. Melde dich an und kehre dann hierher zurück, um bevorstehende, vergangene und stornierte Buchungen zu verwalten.",
  "accountDashboard.trips.state.error.title": "Reisen können nicht geladen werden",
  "accountDashboard.trips.state.error.body": "Wir konnten deine Reisen nicht laden. Bitte versuche es erneut.",
  "accountDashboard.trips.state.error.retry": "Erneut versuchen",
  "accountDashboard.trips.state.error.retryAriaLabel": "Reisen erneut laden",
  "accountDashboard.trips.lookup.unauthenticated": "Melde dich an, um eine Reservierung zu suchen.",
  "accountDashboard.trips.lookup.error": "Wir konnten diese Reservierung nicht suchen. Bitte versuche es erneut.",
  "accountDashboard.trips.lookup.found": "Reservierung gefunden.",
  "accountDashboard.trips.card.bookingReference": "Buchungsreferenz",
  "accountDashboard.trips.card.departure": "Abflug",
  "accountDashboard.trips.card.return": "Rückkehr",
  "accountDashboard.trips.card.passengers": "Passagiere",
  "accountDashboard.trips.card.total": "Gesamt",
  "accountDashboard.trips.card.viewDetails": "Details anzeigen",
  "accountDashboard.trips.card.unknownDestination": "Unbekanntes Reiseziel",
  "accountDashboard.trips.status.upcoming": "Bevorstehend",
  savedTripsPageTitle: "Zapisane podróże",
  savedTripsPageSubtitle: "Wybrane przez Ciebie plany podróży i popularne trasy.",
  savedTripsTabsLabel: "Zapisane podróże / Historia wyszukiwania",
  savedTripsTabSaved: "Zapisane podróże",
  savedTripsTabHistory: "Historia wyszukiwania",
  ...
  recentSearchesPageTitle: "Ostatnie wyszukiwania",
  recentSearchesClearAll: "Wyczyść wszystko",
  recentSearchesClearFlights: "Wyczyść loty",
  recentSearchesClearHotels: "Wyczyść hotele",
  ...
  "deals.loadingPage": "Ładowanie strony...",
  "deals.decreaseCountAria": "Zmniejsz {{label}}",
  "deals.increaseCountAria": "Zwiększ {{label}}",
  ...
  "deals.destination.tokyo.imageAlt": "Panorama Tokio z gęstą zabudową wysokościowców w świetle dnia",
  "deals.destination.london.city": "Londyn",
  "deals.destination.london.country": "Wielka Brytania",
  "deals.destination.london.imageAlt": "Tower Bridge i Tamiza w Londynie pod błękitnym niebem",
  "deals.destination.paris.city": "Paryż",
  "deals.destination.paris.country": "Francja",
  "deals.destination.paris.imageAlt": "Wieża Eiffla i Sekwana w Paryżu podczas złotej godziny",
  "deals.destination.dubai.city": "Dubaj",
  "deals.destination.dubai.country": "Zjednoczone Emiraty Arabskie",
  "deals.destination.dubai.imageAlt": "Panorama Dubaju z Burdż Chalifa górującym nad wieżowcami",
  "deals.destination.cancun.city": "Cancun",
  "deals.destination.cancun.country": "Meksyk",
  "deals.destination.cancun.imageAlt": "Plaża w Cancun z białym piaskiem i turkusową wodą",
  "deals.destination.rome.city": "Rzym",
  "deals.destination.rome.country": "Włochy",
  "deals.destination.rome.imageAlt": "Koloseum w Rzymie pod czystym błękitnym niebem",
  ...
  "hotelResults.unableToOpenProvider": "Nie można teraz otworzyć dostawcy. Spróbuj ponownie.",
  ...
  "hotelResults.payAtProperty": "Zapłać w obiekcie",
  "hotelResults.payLater": "Zapłać później",
  "hotelResults.noPrepayment": "Bez przedpłaty",
  "hotelResults.refundable": "Zwrotne",
  ...
  "hotelGuests.adultDescription": "18 lat i więcej",
  "hotelGuests.childDescription": "Od 0 do 17 lat",
  "hotelGuests.roomDescription": "Oddzielne pokoje",
  ...
  "hotelDestination.Rome.imageAlt": "Koloseum w Rzymie pod czystym błękitnym niebem",
  "hotelDestination.Dubai.imageAlt": "Panorama Dubaju z Burdż Chalifa górującym nad wieżowcami",
  "hotelDestination.Singapore.imageAlt": "Panorama Marina Bay w Singapurze o zmierzchu",
  "hotelDestination.Barcelona.imageAlt": "Panorama Barcelony z Sagradą Famílią za dnia",
  "hotelDestination.Toronto.imageAlt": "Panorama Toronto z CN Tower nad jeziorem Ontario",
  "hotelDestination.Amsterdam.imageAlt": "Amsterdamskie kamienice nad kanałem i most przy wodzie",
  "hotelDestination.Bangkok.imageAlt": "Panorama Bangkoku i rzeka Chao Phraya o zachodzie słońca",
  "hotelDestination.Cancun.imageAlt": "Plaża w Cancun z białym piaskiem i turkusową wodą",
  "hotelDestination.Istanbul.imageAlt": "Nabrzeże Stambułu z kopułami i minaretami podczas złotej godziny",
  business: "Biznes",
  first: "Pierwsza",
  fromPrice: "Od",
  ...
  verifyLoginTitle: "Zweryfikuj swoje logowanie",
  verifyLoginInstructions: "Wpisz 6-cyfrowy kod wysłany na Twój adres e-mail. Kody wygasają po 10 minutach.",
  verifyLoginCodeLabel: "Kod logowania",
  verifyLoginSubmit: "Zweryfikuj logowanie",
  verifyLoginNeedNewCode: "Potrzebujesz nowego kodu? Wpisz hasło, abyśmy mogli bezpiecznie wysłać kolejny.",
  verifyLoginPasswordLabel: "Hasło do ponownej wysyłki",
  verifyLoginNeedStartOver: "Chcesz zacząć od nowa?",
  ...
  forgotPasswordInvalidEmail: "Wpisz prawidłowy adres e-mail.",
  forgotPasswordUnableRequest: "Nie można teraz poprosić o zresetowanie hasła.",
  ...
  "carsSearch.driverAgeAnyAgeRange": "Dowolny wiek 18–70",
  ...
  "carsSearch.error.pickupLocationRequired": "Wpisz miejsce odbioru.",
  "carsSearch.error.pickupDateRequired": "Wybierz datę odbioru.",
  "carsSearch.error.pickupDatePast": "Data odbioru nie może być w przeszłości.",
  "carsSearch.error.pickupTimeRequired": "Wybierz godzinę odbioru.",
  "carsSearch.error.dropoffDateRequired": "Wybierz datę zwrotu.",
  "carsSearch.error.dropoffDatePast": "Data zwrotu nie może być w przeszłości.",
  "carsSearch.error.dropoffTimeRequired": "Wybierz godzinę zwrotu.",
  "carsSearch.error.driverAgeInvalid": "Wybierz Dowolny wiek 18–70 lub wiek kierowcy od 18 do 70.",
  "carsSearch.error.dropoffLocationRequired": "Wpisz miejsce zwrotu.",
  "carsSearch.error.dropoffBeforePickup": "Data zwrotu nie może być wcześniejsza niż data odbioru.",
  "carsSearch.error.sameDayDropoffAfterPickup": "Przy zwrocie tego samego dnia godzina zwrotu musi być późniejsza niż godzina odbioru.",
  carsSearchPreparing: "Przygotowujemy wyszukiwanie samochodów...",
  searchingCars: "Szukamy samochodów...",
  ...
  "carsResults.pickupLocationLabel": "Miejsce odbioru",
  "carsResults.returnLocationLabel": "Miejsce zwrotu",
  "carsResults.rentalDatesLabel": "Daty wynajmu",
  "carsResults.pickupReturnTimeLabel": "Godzina odbioru / zwrotu",
  "carsResults.driverAgeLabel": "Wiek kierowcy",
  ...
  "emailUpdates.subscribedStatus": "Masz aktywną subskrypcję.",
  "emailUpdates.subscribedButton": "Subskrybowano",
  "emailUpdates.stopUpdates": "Zatrzymaj aktualizacje",
  "emailUpdates.loadingStatus": "Ładowanie…",
  "emailUpdates.unsubscribedStatus": "Nie masz aktywnej subskrypcji.",
  "emailUpdates.notFoundStatus": "Nie znaleziono subskrypcji.",
  "emailUpdates.subscribeButton": "Subskrybuj",
  "emailUpdates.restartUpdates": "Wznów aktualizacje",
  "emailUpdates.updatesStopped": "Aktualizacje zatrzymane",
  "emailUpdates.notAvailable": "Niedostępne",
  "emailUpdates.invalidLink": "Ten link preferencji jest nieprawidłowy lub wygasł.",
  "emailUpdates.loadError": "Nie mogliśmy teraz załadować tych preferencji.",
  "emailUpdates.updateError": "Nie mogliśmy teraz zaktualizować tej preferencji.",
  "emailUpdates.preferenceUpdated": "Preferencja zaktualizowana.",
  resetPasswordCreateTitle: "Utwórz nowe hasło",
  resetPasswordSubtitle: "Wpisz poniżej nowe hasło.",
  resetPasswordInvalidLink: "Ten link resetowania jest nieprawidłowy lub wygasł. Poproś o nową wiadomość e-mail do resetowania hasła.",
  resetPasswordRequestNew: "Poproś o nową wiadomość resetującą",
  resetPasswordNewPasswordLabel: "Nowe hasło",
  resetPasswordConfirmPasswordLabel: "Potwierdź nowe hasło",
  resetPasswordValidationError: "Wpisz prawidłowe hasło i upewnij się, że oba pola hasła są zgodne.",
  resetPasswordUnable: "Nie można teraz zresetować hasła.",
  ...
  "deals.results.title": "Skoordynowane wyniki podróży",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Skoordynowane wyniki podróży",
  "deals.results.modify": "Modify search · Skoordynowane wyniki podróży",
  "deals.results.viewFlights": "View all flights · Skoordynowane wyniki podróży",
  "deals.results.viewHotels": "View all hotels · Skoordynowane wyniki podróży",
  "deals.results.viewCars": "View car options · Skoordynowane wyniki podróży",
  "deals.results.invalidTitle": "Review your search · Skoordynowane wyniki podróży",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Skoordynowane wyniki podróży",
  "deals.results.noResults": "No matching results were found. · Skoordynowane wyniki podróży",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Skoordynowane wyniki podróży",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Skoordynowane wyniki podróży",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Skoordynowane wyniki podróży",
  "deals.error.flightOriginCode": "Airport selection is required. · Skoordynowane wyniki podróży",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Skoordynowane wyniki podróży",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Skoordynowane wyniki podróży",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Skoordynowane wyniki podróży",
  "deals.error.flightDates": "Select valid flight dates. · Skoordynowane wyniki podróży",
  "deals.error.hotelDestination": "Enter a hotel destination. · Skoordynowane wyniki podróży",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Skoordynowane wyniki podróży",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Skoordynowane wyniki podróży",
  "deals.error.hotelDates": "Select valid hotel dates. · Skoordynowane wyniki podróży",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Skoordynowane wyniki podróży",
  "deals.productSelector.instruction": "Choose at least two products",
  "deals.productSelector.minimumTwo": "Pakiety requires at least two products.",
  ...
  "deals.guided.handoffPending.returnDeals": "Return to Pakiety",
  ...
  "deals.guided.handoffPending.missingBody": "Return to Pakiety and confirm your trip options again.",
  ...
  "deals.guided.handoffInvalid.body": "For your safety, no booking partner was opened. Return to Pakiety and try again.",
  "deals.guided.handoffInvalid.returnDeals": "Return to Pakiety",
  ...
  "deals.guided.handoff.storageReadFailedBody": "Nie udało się ponownie sprawdzić zapisanej podróży, dlatego ten krok nie został otwarty. Spróbuj ponownie.",
  ...
  "deals.guided.handoff.returnDeals": "Return to Pakiety",
  "deals.guided.handoff.missingTitle": "We could not load this guided trip",
  "deals.guided.handoff.missingBody": "Return to Pakiety and confirm your trip options again.",
  ...
  flightSearchDestinationPlaceholderShort: 'Dokąd?',
  "accountDashboard.recently": "Ostatnio",
  // Reused from existing locale glossary entries with identical canonical meaning.
  "accountDashboard.mobile.manageAccount": "Zarządzaj kontem",
  "accountDashboard.personalDetails.saving": "Saving...",
  "accountDashboard.preferences.booking.actions.saving": "Saving...",
  "accountDashboard.preferences.booking.sections.flightDefaults.description": "Ustaw domyślne preferencje podróży, aby rezerwacje były szybsze i trafniejsze.",
  "accountDashboard.preferences.customization.status.savingShort": "Saving...",
  "accountDashboard.preferences.email.resetShort": "Resetuj",
  "accountDashboard.preferences.email.savePreferences": "Zapisz preferencje",
  "accountDashboard.preferences.email.savingPreferences": "Saving...",
  "accountDashboard.preferences.email.savingShort": "Saving...",
  "accountDashboard.preferences.email.title": "Preferencje e-mail",
  "accountDashboard.preferences.personalDetails.title": "Dane osobowe",
  "accountDashboard.preferences.title": "Preferencje",
  "accountDashboard.preferences.travel.title": "Preferencje rezerwacji",
  "accountDashboard.support.contact.title": "Skontaktuj się z pomocą",
  "accountDashboard.support.title": "Pomoc",
  "accountMenu.savedRecent.label": "Zapisane podróże",
  "cancel": "Anuluj",
  "carDetails.cancellation": "Anulowanie",
  "carDetails.freeCancellation": "Bezpłatne anulowanie",
  "carDetails.nonRefundable": "Bezzwrotne",
  "carDetails.return": "Rückkehr",
  "carDetails.unlimitedMileage": "Nielimitowany przebieg",
  "carsResults.lowestTotal": "Najniższa cena całkowita",
  "carsResults.passengers": "Passagiere",
  "carsResults.recommended": "Polecane",
  "carsResults.sortBy": "Sortuj według",
  "carsResults.topRated": "NAJWYŻEJ OCENIANE",
  "carsSearch.returnLocationLabel": "MIEJSCE ZWROTU",
  "carsSearch.type.airport": "Lotnisko",
  "carsSearch.type.area": "Lokalizacja / obszar",
  "deals.guided.hotelDetails.roomInformation": "Room",
  "destinationImageFallback": "CEL PODRÓŻY",
  "from": "Od",
  "homeRegionalRoutesTitle": "Odkrywaj kierunki z Twojego regionu",
  "legalCenter.heroTitle": "Centrum prawne",
  "loginVerifying": "Weryfikowanie…",
  "onboarding.preferredAirlines": "Preferowane linie lotnicze",
  "openFilters": "Otwórz filtry",
  "recentSearches.clearAll": "Wyczyść wszystko",
  "recentSearches.title": "Ostatnie wyszukiwania",
