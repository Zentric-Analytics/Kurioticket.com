...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Путници",
  "mobileDatePicker.start": "Početak",
  "mobileDatePicker.end": "Kraj",
  deals: "Пакети путовања",
  ...
  homeDestinationDubaiCountry: "Ujedinjeni Arapski Emirati",
  homeDestinationDubaiAlt: "Dubai, Ujedinjeni Arapski Emirati",
  homeDestinationLondonCity: "London",
  homeDestinationLondonCountry: "Ujedinjeno Kraljevstvo",
  homeDestinationLondonAlt: "London, Ujedinjeno Kraljevstvo",
  homeDestinationParisCity: "Pariz",
  homeDestinationParisCountry: "Francuska",
  homeDestinationParisAlt: "Pariz, Francuska",
  homeDestinationBaliCity: "Bali",
  homeDestinationBaliCountry: "Indonezija",
  homeDestinationBaliAlt: "Bali, Indonezija",
  homeDestinationNewYorkCity: "Njujork",
  homeDestinationNewYorkCountry: "Sjedinjene Američke Države",
  homeDestinationNewYorkAlt: "Njujork, Sjedinjene Američke Države",
  ...
  "deals.results.title": "Coordinated trip results (sr)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (sr)",
  "deals.results.modify": "Modify search · Coordinated trip results (sr)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (sr)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (sr)",
  "deals.results.viewCars": "View car options · Coordinated trip results (sr)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (sr)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (sr)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (sr)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (sr)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (sr)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (sr)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (sr)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (sr)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (sr)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (sr)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (sr)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (sr)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (sr)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (sr)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (sr)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (sr)",
