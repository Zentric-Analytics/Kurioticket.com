...
export const translations: TranslationDictionary = {
  ...
  "deals.guidedPreview.description": "ตัวอย่างดีลแบบแนะนำ: Complete guided Deals preview: Hotel, Flight and Car selection and confirmation, Review, and final partner handoff.",
  ...
  "deals.guided.error.title": "ตัวอย่างดีลแบบแนะนำ: We could not show this guided Deals page",
  "deals.guided.error.body": "ตัวอย่างดีลแบบแนะนำ: No booking-partner page was opened. Try again or return safely to Deals.",
  "deals.guided.error.retry": "ตัวอย่างดีลแบบแนะนำ: Try again",
  "deals.guided.error.returnDeals": "ตัวอย่างดีลแบบแนะนำ: Return to Deals",
