...
export const translations: TranslationDictionary = {
  ...
  "deals.guidedPreview.description": "ตัวอย่างดีลแบบแนะนำ: Complete guided แพ็กเกจท่องเที่ยว preview: Hotel, Flight and Car selection and confirmation, Review, and final partner handoff.",
  "deals.guidedPreview.availableCar": "ตัวอย่างดีลแบบแนะนำ: Car results, filters, sorting, details, and confirmation",
  "deals.guidedPreview.availableReview": "ตัวอย่างดีลแบบแนะนำ: Trip Review with persisted opened-step progress",
  "deals.guidedPreview.availableHandoff": "ตัวอย่างดีลแบบแนะนำ: Final booking-partner handoff for each included product",
  "deals.guidedPreview.previewOnlyTitle": "ตัวอย่างดีลแบบแนะนำ: Internal preview limitations",
  "deals.guidedPreview.previewOnlyPublicLaunch": "ตัวอย่างดีลแบบแนะนำ: Public activation has not occurred; normal Search remains unchanged.",
  "deals.guidedPreview.previewOnlyBooking": "ตัวอย่างดีลแบบแนะนำ: Kurioticket does not complete booking or payment. Complete each provider step separately.",
  "deals.guided.confirmation.readError": "ตัวอย่างดีลแบบแนะนำ: Saved preview progress could not be read. Try confirmation again.",
  "deals.guided.confirmation.saveError": "ตัวอย่างดีลแบบแนะนำ: Preview progress could not be saved. Try confirmation again.",
  "deals.guided.crossTabUpdated": "ตัวอย่างดีลแบบแนะนำ: This trip was updated in another tab.",
  "deals.guided.prerequisiteChanged": "ตัวอย่างดีลแบบแนะนำ: An earlier trip choice changed in another tab. Your current saved trip is now shown.",
  "deals.guided.conflict.title": "ตัวอย่างดีลแบบแนะนำ: Another guided preview is saved",
  "deals.guided.conflict.body": "ตัวอย่างดีลแบบแนะนำ: This page belongs to a different guided search. Its saved progress is protected.",
  "deals.guided.conflict.restart": "ตัวอย่างดีลแบบแนะนำ: Start this preview trip again",
  "deals.guided.conflict.restartDisclosure": "ตัวอย่างดีลแบบแนะนำ: Starting again replaces the guided-preview progress currently saved in this browser.",
  "deals.guided.error.title": "ตัวอย่างดีลแบบแนะนำ: We could not show this guided แพ็กเกจท่องเที่ยว page",
  "deals.guided.error.body": "ตัวอย่างดีลแบบแนะนำ: No booking-partner page was opened. Try again or return safely to แพ็กเกจท่องเที่ยว.",
  "deals.guided.error.retry": "ตัวอย่างดีลแบบแนะนำ: Try again",
  "deals.guided.error.returnDeals": "ตัวอย่างดีลแบบแนะนำ: Return to แพ็กเกจท่องเที่ยว",
  "deals.guided.storageUnavailable.title": "ตัวอย่างดีลแบบแนะนำ: Temporary preview storage is unavailable",
  "deals.guided.storageUnavailable.body": "ตัวอย่างดีลแบบแนะนำ: This guided stage cannot safely save progress. Restore browser storage and reload.",
  "deals.guided.invalid.title": "ตัวอย่างดีลแบบแนะนำ: Saved preview progress is invalid",
  "deals.guided.invalid.body": "ตัวอย่างดีลแบบแนะนำ: Return to the first guided stage to choose fresh trip options.",
  "deals.guided.expired.title": "ตัวอย่างดีลแบบแนะนำ: Your guided preview has expired",
  "deals.guided.expired.body": "ตัวอย่างดีลแบบแนะนำ: Return to the first guided stage and refresh your trip options.",
  ...
  "hotelResults.filter.freeWifi": "Wi‑Fi ฟรี",
  "hotelResults.filter.parking": "ที่จอดรถ",
  "hotelResults.filter.pool": "สระว่ายน้ำ",
  "hotelResults.filter.airportShuttle": "รถรับส่งสนามบิน",
  "hotelResults.filter.spa": "สปา",
  "hotelResults.filter.fitnessCenter": "ฟิตเนสเซ็นเตอร์",
  "hotelResults.filter.workspace": "พื้นที่ทำงาน",
  ...
  contactMetadataTitle: "ติดต่อ Kurioticket",
  ...
  loginProcessing: "กำลังตรวจสอบรายละเอียดของคุณและส่งรหัสยืนยัน…",
  loginResendSuccess: "เราได้ส่งรหัสใหม่แล้ว หากบัญชีนี้สามารถเข้าสู่ระบบได้",
  loginEnterCode: "ป้อนรหัสเข้าสู่ระบบ 6 หลัก",
  loginVerifiedRedirecting: "ยืนยันแล้ว กำลังเปลี่ยนเส้นทาง…",
  loginStartOverError: "เริ่มใหม่เพื่อให้เราตรวจสอบรายละเอียดของคุณก่อนส่งรหัสใหม่",
  loginSendingNewCode: "กำลังส่งรหัสยืนยันใหม่…",
  loginUnableSendNewCode: "ไม่สามารถส่งรหัสใหม่ได้ในขณะนี้ โปรดลองอีกครั้ง",
  loginErrorAccountUnavailable: "บัญชีนี้ไม่พร้อมใช้งาน โปรดติดต่อฝ่ายสนับสนุน",
  loginUnableSendLoginCode: "ไม่สามารถส่งรหัสเข้าสู่ระบบได้ในขณะนี้ โปรดลองอีกครั้ง",
  signupVerificationRequiredRedirecting: "ต้องมีการยืนยัน กำลังเปลี่ยนเส้นทาง...",
  signupErrorUnableCreate: "เราไม่สามารถสร้างบัญชีของคุณได้ โปรดลองอีกครั้ง",
  signupErrorRateLimited: "พยายามสมัครมากเกินไป โปรดรอแล้วลองอีกครั้ง",
  signupErrorDuplicateEmail: "มีบัญชีที่ใช้อีเมลนี้อยู่แล้ว",
  signupErrorUnableSendVerification: "ไม่สามารถส่งรหัสยืนยันได้ในขณะนี้ โปรดลองอีกครั้ง",
  ...
  filters: "ตัวกรอง",
  filtersWithCount: "ตัวกรอง · {{count}}",
  done: "เสร็จสิ้น",
  ...
  "hotelGuests.adultDescription": "อายุ 18 ปีขึ้นไป",
  "hotelGuests.childDescription": "อายุ 0–17 ปี",
  "hotelGuests.roomDescription": "ห้องแยกกัน",
  ...
  "hotelDestination.Rome.imageAlt": "โคลอสเซียมในกรุงโรมใต้ท้องฟ้าสีฟ้าใส",
  "hotelDestination.Dubai.imageAlt": "เส้นขอบฟ้าดูไบพร้อมเบิร์จคาลิฟาที่สูงเหนืออาคารระฟ้า",
  "hotelDestination.Singapore.imageAlt": "เส้นขอบฟ้ามารีนาเบย์ในสิงคโปร์ยามพลบค่ำ",
  "hotelDestination.Barcelona.imageAlt": "ทิวทัศน์เมืองบาร์เซโลนาพร้อมซากราดาฟามีเลียในเวลากลางวัน",
  "hotelDestination.Toronto.imageAlt": "เส้นขอบฟ้าโตรอนโตพร้อม CN Tower ข้างทะเลสาบออนแทรีโอ",
  "hotelDestination.Amsterdam.imageAlt": "บ้านริมคลองและสะพานของอัมสเตอร์ดัมเลียบผืนน้ำ",
  "hotelDestination.Bangkok.imageAlt": "เส้นขอบฟ้าเมืองกรุงเทพฯ และแม่น้ำเจ้าพระยายามพระอาทิตย์ตก",
  "hotelDestination.Cancun.imageAlt": "ชายหาดแคนคูนที่มีทรายขาวและน้ำทะเลสีเทอร์ควอยซ์",
  "hotelDestination.Istanbul.imageAlt": "ริมน้ำอิสตันบูลพร้อมโดมและหอคอยสุเหร่าในช่วงแสงสีทอง",
  ...
  "deals.countSummary.travelers": "{{label}} {{count}} คน",
  "deals.countSummary.rooms": "{{label}} {{count}}",
  ...
  "deals.loadingPage": "กำลังโหลดหน้า...",
  "deals.decreaseCountAria": "ลด {{label}}",
  "deals.increaseCountAria": "เพิ่ม {{label}}",
  ...
  "carsSearch.error.pickupLocationRequired": "ป้อนสถานที่รับรถ",
  "carsSearch.error.pickupDateRequired": "เลือกวันที่รับรถ",
  "carsSearch.error.pickupDatePast": "วันที่รับรถต้องไม่เป็นวันที่ผ่านมาแล้ว",
  "carsSearch.error.pickupTimeRequired": "เลือกเวลารับรถ",
  "carsSearch.error.dropoffDateRequired": "เลือกวันที่คืนรถ",
  "carsSearch.error.dropoffDatePast": "วันที่คืนรถต้องไม่เป็นวันที่ผ่านมาแล้ว",
  "carsSearch.error.dropoffTimeRequired": "เลือกเวลาคืนรถ",
  "carsSearch.error.driverAgeInvalid": "เลือกอายุใดก็ได้ 18–70 หรืออายุผู้ขับขี่ตั้งแต่ 18 ถึง 70",
  "carsSearch.error.dropoffLocationRequired": "ป้อนสถานที่คืนรถ",
  "carsSearch.error.dropoffBeforePickup": "วันที่คืนรถต้องไม่อยู่ก่อนวันที่รับรถ",
  "carsSearch.error.sameDayDropoffAfterPickup": "สำหรับการคืนรถในวันเดียวกัน เวลาคืนรถต้องอยู่หลังเวลารับรถ",
  carsSearchPreparing: "กำลังเตรียมการค้นหารถ...",
  searchingCars: "กำลังค้นหารถ...",
  ...
  "carsResults.pickupLocationLabel": "สถานที่รับรถ",
  "carsResults.returnLocationLabel": "สถานที่คืนรถ",
  "carsResults.rentalDatesLabel": "วันที่เช่ารถ",
  "carsResults.pickupReturnTimeLabel": "เวลารับ / คืนรถ",
  "carsResults.driverAgeLabel": "อายุผู้ขับ",
  ...
  supportFaqChangeBookingAnswer:
    "Kurioticket ไม่ได้จัดการหรือเปลี่ยนแปลงการจองการเดินทาง ผู้ให้บริการภายนอกเป็นผู้ดูแลการเปลี่ยนแปลง การยกเลิก การคืนเงิน การเช็กอิน ใบเสร็จ และเอกสารการเดินทาง",
  ...
  "flightResults.duration.minutesOnly": "{{minutes}} นาที",
  ...
  "accountDashboard.hub.customizationPreferences": "การตั้งค่าการปรับแต่ง",
  "accountDashboard.preferences.customization.subtitle": "การตั้งค่าที่ทำให้แอปรู้สึกเป็นส่วนตัวสำหรับคุณ",
  "accountDashboard.preferences.customization.sections.display": "การแสดงผล",
  "accountDashboard.preferences.customization.sections.regionalDefaults": "ค่าเริ่มต้นตามภูมิภาค",
  "accountDashboard.preferences.customization.sections.personalization": "การปรับแต่งส่วนบุคคล",
  "accountDashboard.preferences.customization.fields.theme.label": "ธีมที่ต้องการ",
  "accountDashboard.preferences.customization.fields.theme.description": "เลือกหน้าตาของ Kurioticket ขณะใช้งาน",
  "accountDashboard.preferences.customization.fields.density.label": "ความหนาแน่นการแสดงผล",
  ...
  "accountDashboard.preferences.customization.options.density.comfortable": "สบายตา",
  "accountDashboard.preferences.customization.options.density.compact": "กะทัดรัด",
  "accountDashboard.preferences.customization.options.language.english": "อังกฤษ",
  ...
  "accountDashboard.preferences.customization.options.region.nigeria": "ไนจีเรีย",
  "accountDashboard.preferences.customization.options.region.unitedKingdom": "สหราชอาณาจักร",
  "accountDashboard.preferences.customization.options.region.unitedStates": "สหรัฐอเมริกา",
  "accountDashboard.preferences.customization.options.region.europe": "ยุโรป",
  ...
  "deals.results.title": "ผลการเดินทางที่ประสานกัน",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · ผลการเดินทางที่ประสานกัน",
  "deals.results.modify": "Modify search · ผลการเดินทางที่ประสานกัน",
  "deals.results.viewFlights": "View all flights · ผลการเดินทางที่ประสานกัน",
  "deals.results.viewHotels": "View all hotels · ผลการเดินทางที่ประสานกัน",
  "deals.results.viewCars": "View car options · ผลการเดินทางที่ประสานกัน",
  "deals.results.invalidTitle": "Review your search · ผลการเดินทางที่ประสานกัน",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · ผลการเดินทางที่ประสานกัน",
  "deals.results.noResults": "No matching results were found. · ผลการเดินทางที่ประสานกัน",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · ผลการเดินทางที่ประสานกัน",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · ผลการเดินทางที่ประสานกัน",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · ผลการเดินทางที่ประสานกัน",
  "deals.error.flightOriginCode": "Airport selection is required. · ผลการเดินทางที่ประสานกัน",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · ผลการเดินทางที่ประสานกัน",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · ผลการเดินทางที่ประสานกัน",
  "deals.error.flightInfants": "Infants cannot exceed adults. · ผลการเดินทางที่ประสานกัน",
  "deals.error.flightDates": "Select valid flight dates. · ผลการเดินทางที่ประสานกัน",
  "deals.error.hotelDestination": "Enter a hotel destination. · ผลการเดินทางที่ประสานกัน",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · ผลการเดินทางที่ประสานกัน",
  "deals.error.hotelRooms": "Select 1–6 rooms. · ผลการเดินทางที่ประสานกัน",
  "deals.error.hotelDates": "Select valid hotel dates. · ผลการเดินทางที่ประสานกัน",
  "deals.results.separateBooking": "Coordinated results, separate selections. · ผลการเดินทางที่ประสานกัน",
  "deals.productSelector.instruction": "Choose at least two products",
  "deals.productSelector.minimumTwo": "แพ็กเกจท่องเที่ยว requires at least two products.",
  ...
  "deals.guided.handoffPending.returnDeals": "Return to แพ็กเกจท่องเที่ยว",
  ...
  "deals.guided.handoffPending.missingBody": "Return to แพ็กเกจท่องเที่ยว and confirm your trip options again.",
  ...
  "deals.guided.handoffInvalid.body": "For your safety, no booking partner was opened. Return to แพ็กเกจท่องเที่ยว and try again.",
  "deals.guided.handoffInvalid.returnDeals": "Return to แพ็กเกจท่องเที่ยว",
  ...
  "deals.guided.handoff.storageReadFailedBody": "เราไม่สามารถตรวจสอบทริปที่บันทึกไว้อีกครั้งได้ จึงไม่ได้เปิดขั้นตอนนี้ โปรดลองอีกครั้ง",
  ...
  "deals.guided.handoff.returnDeals": "Return to แพ็กเกจท่องเที่ยว",
  "deals.guided.handoff.missingTitle": "We could not load this guided trip",
  "deals.guided.handoff.missingBody": "Return to แพ็กเกจท่องเที่ยว and confirm your trip options again.",
  ...
  flightSearchDestinationPlaceholderShort: 'ไปที่ไหน?',
  "accountDashboard.recently": "เมื่อเร็ว ๆ นี้",
  // Reused from existing locale glossary entries with identical canonical meaning.
  "accountDashboard.personalDetails.saving": "กำลังบันทึก...",
  "accountDashboard.preferences.booking.actions.saving": "กำลังบันทึก...",
  "accountDashboard.preferences.booking.sections.flightDefaults.description": "ตั้งค่าการเดินทางเริ่มต้นของคุณเพื่อให้การจองรวดเร็วและตรงความต้องการมากขึ้น",
  "accountDashboard.preferences.customization.status.savingShort": "กำลังบันทึก...",
  "accountDashboard.preferences.email.resetShort": "รีเซ็ต",
  "accountDashboard.preferences.email.savePreferences": "บันทึกการตั้งค่า",
  "accountDashboard.preferences.email.saveShort": "บันทึก",
  "accountDashboard.preferences.email.savingPreferences": "กำลังบันทึก...",
  "accountDashboard.preferences.email.savingShort": "กำลังบันทึก...",
  "accountDashboard.preferences.email.title": "การตั้งค่าอีเมล",
  "accountDashboard.preferences.personalDetails.title": "รายละเอียดส่วนตัว",
  "accountDashboard.preferences.title": "การตั้งค่า",
  "accountDashboard.preferences.travel.title": "การตั้งค่าการจอง",
  "accountDashboard.support.contact.title": "ติดต่อฝ่ายสนับสนุน",
  "accountDashboard.support.title": "ฝ่ายสนับสนุน",
  "accountMenu.savedRecent.label": "ทริปที่บันทึกไว้",
  "cancel": "ยกเลิก",
  "carDetails.cancellation": "การยกเลิก",
  "carDetails.freeCancellation": "ยกเลิกฟรี",
  "carDetails.nonRefundable": "ไม่สามารถคืนเงินได้",
  "carDetails.return": "返回",
  "carDetails.unlimitedMileage": "ไม่จำกัดระยะทาง",
  "carsResults.lowestTotal": "ราคารวมต่ำที่สุด",
  "carsResults.passengers": "乘客",
  "carsResults.sortBy": "เรียงตาม",
  "carsResults.topRated": "คะแนนสูงสุด",
  "carsSearch.returnLocationLabel": "สถานที่คืนรถ",
  "carsSearch.type.airport": "สนามบิน",
  "deals.guided.hotelDetails.roomInformation": "Room",
  "edit": "แก้ไข",
  "editSearch": "แก้ไขการค้นหา",
  "emailUpdates.subscribeButton": "สมัครรับข่าวสาร",
  "from": "เริ่มต้นที่",
  "homeRegionalRoutesTitle": "ค้นพบจุดหมายปลายทางจากภูมิภาคของคุณ",
  "loginVerifying": "กำลังยืนยัน…",
  "onboarding.preferredAirlines": "สายการบินที่ต้องการ",
  "openFilters": "เปิดตัวกรอง",
  "recentSearches.clearAll": "ล้างทั้งหมด",
  "recentSearches.removeAria": "ลบการค้นหาล่าสุด",
  "recentSearches.title": "การค้นหาล่าสุด",
  "searchCars": "ค้นหารถ",
  "verifyEmailCodeLabel": "รหัสยืนยัน",
  "verifyEmailInstructions": "ป้อนรหัส 6 หลักที่เราส่งไปยังอีเมลของคุณ รหัสจะหมดอายุหลังจาก 10 นาที",
};
