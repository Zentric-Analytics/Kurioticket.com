...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "مسافر",
  "mobileDatePicker.start": "آغاز",
  "mobileDatePicker.end": "اختتام",
  deals: "سفری پیکیجز",
  ...
  fromPrice: "سے",
  homeDestinationDubaiCity: "دبئی",
  homeDestinationDubaiCountry: "متحدہ عرب امارات",
  homeDestinationDubaiAlt: "دبئی, متحدہ عرب امارات",
  homeDestinationLondonCity: "لندن",
  homeDestinationLondonCountry: "برطانیہ",
  homeDestinationLondonAlt: "لندن, برطانیہ",
  homeDestinationParisCity: "پیرس",
  homeDestinationParisCountry: "فرانس",
  homeDestinationParisAlt: "پیرس, فرانس",
  homeDestinationBaliCity: "بالی",
  homeDestinationBaliCountry: "انڈونیشیا",
  homeDestinationBaliAlt: "بالی, انڈونیشیا",
  homeDestinationNewYorkCity: "نیویارک",
  homeDestinationNewYorkCountry: "امریکہ",
  homeDestinationNewYorkAlt: "نیویارک, امریکہ",
  ...
  "deals.results.title": "Coordinated trip results (ur)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (ur)",
  "deals.results.modify": "Modify search · Coordinated trip results (ur)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (ur)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (ur)",
  "deals.results.viewCars": "View car options · Coordinated trip results (ur)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (ur)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (ur)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (ur)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (ur)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (ur)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (ur)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (ur)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (ur)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (ur)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (ur)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (ur)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (ur)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (ur)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (ur)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (ur)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (ur)",
  ...
  flightSearchDestinationPlaceholderShort: 'کہاں؟',
};
