...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Ταξιδιώτες",
  "mobileDatePicker.start": "Έναρξη",
  "mobileDatePicker.end": "Λήξη",
  deals: "Ταξιδιωτικά πακέτα",
  ...
  fromPrice: "Από",
  homeDestinationDubaiCity: "Ντουμπάι",
  homeDestinationDubaiCountry: "Ηνωμένα Αραβικά Εμιράτα",
  homeDestinationDubaiAlt: "Ντουμπάι, Ηνωμένα Αραβικά Εμιράτα",
  homeDestinationLondonCity: "Λονδίνο",
  homeDestinationLondonCountry: "Ηνωμένο Βασίλειο",
  homeDestinationLondonAlt: "Λονδίνο, Ηνωμένο Βασίλειο",
  homeDestinationParisCity: "Παρίσι",
  homeDestinationParisCountry: "Γαλλία",
  homeDestinationParisAlt: "Παρίσι, Γαλλία",
  homeDestinationBaliCity: "Μπαλί",
  homeDestinationBaliCountry: "Ινδονησία",
  homeDestinationBaliAlt: "Μπαλί, Ινδονησία",
  homeDestinationNewYorkCity: "Νέα Υόρκη",
  homeDestinationNewYorkCountry: "Ηνωμένες Πολιτείες",
  homeDestinationNewYorkAlt: "Νέα Υόρκη, Ηνωμένες Πολιτείες",
  ...
  "deals.results.title": "Coordinated trip results (el)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (el)",
  "deals.results.modify": "Modify search · Coordinated trip results (el)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (el)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (el)",
  "deals.results.viewCars": "View car options · Coordinated trip results (el)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (el)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (el)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (el)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (el)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (el)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (el)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (el)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (el)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (el)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (el)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (el)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (el)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (el)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (el)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (el)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (el)",
  ...
  flightSearchDestinationPlaceholderShort: 'Προς τα πού;',
};
