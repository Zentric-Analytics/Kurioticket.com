...
export const translations: TranslationDictionary = {
  ...
  "destinations.region.northAmerica.summary":
    "यादगार क्षितिज, तटीय प्रतीक, मनोरंजन राजधानियाँ और सिनेमाई शहर-विराम जिन्हें योजना में शामिल करना बनता है।",
  "destinations.region.asia.summary":
    "नीऑन शहरों, द्वीपीय आराम, स्ट्रीट फ़ूड दिग्गजों, मंदिरों, समुद्र तटों और प्रीमियम शॉपिंग गेटवे का संग्रह।",
  "destinations.region.africa.summary":
    "समुद्री नज़ारों, सफारी पहुँच, रचनात्मक राजधानियों और समृद्ध सांस्कृतिक रंगों वाले प्रभावशाली यात्रा पसंदीदा।",
  "destinations.region.middleEast.summary":
    "लक्ज़री क्षितिज, गर्म तट, रेगिस्तानी दृश्य, विरासत वाले इलाके और आधुनिक आतिथ्य केंद्र।",
  ...
  "destinations.tag.desertDrama": "रेगिस्तानी दृश्य",
  ...
  "destinations.city.florence": "फ़्लोरेंस",
  ...
  "destinations.city.marrakech": "माराकेच",
  ...
  "destinations.country.turkey": "तुर्की",
  ...
  faqQuestionPriceChanges:
    "ऑफ़र पर क्लिक करने के बाद कीमतें क्यों बदल सकती हैं?",
  ...
  faqQuestionCompareProviders:
    "क्या मैं एक ही यात्रा के लिए कई प्रदाताओं की तुलना कर सकता/सकती हूँ?",
  ...
  faqQuestionPreferences:
    "क्या मैं मुद्रा और भाषा प्राथमिकताएँ सेट कर सकता/सकती हूँ?",
  ...
  signupAgreementAfterPrivacy:
    " और पार्टनर रीडायरेक्ट खुलासों से सहमत होते हैं।",
  ...
  loginResendSuccess:
    "यदि यह खाता साइन इन कर सकता है, तो हमने नया कोड भेजा है।",
  ...
  serviceGuaranteeFaqResultsDisplayedQuestion:
    "यात्रा परिणाम कैसे दिखाए जाते हैं?",
  ...
  serviceGuaranteeFaqRedirectedQuestion:
    "मुझे किसी दूसरे प्रदाता के पास क्यों भेजा जाता है?",
  ...
  serviceGuaranteeFaqBookDirectlyQuestion:
    "क्या मैं सीधे Kurioticket पर बुक करता हूँ?",
  ...
  serviceGuaranteeFaqPricesGuaranteedQuestion:
    "क्या कीमतें हमेशा गारंटीड होती हैं?",
  ...
  serviceGuaranteeFaqChooseProvidersQuestion:
    "Kurioticket प्रदाताओं का चयन कैसे करता है?",
  ...
  serviceGuaranteeFaqEncounterIssueQuestion:
    "अगर मुझे कोई समस्या आती है तो मुझे क्या करना चाहिए?",
  ...
  moreServiceInfoContextCompare:
    "कई यात्रा प्रदाताओं के विकल्पों की तुलना करें।",
  moreServiceInfoContextSave:
    "साइन इन होने पर यात्राएँ, अलर्ट और पसंदें सहेजें।",
  ...
  moreServiceInfoFaqPaymentsQuestion:
    "क्या Kurioticket भुगतान संसाधित करता है?",
  ...
  onlyShowPetFriendlyStays:
    "केवल वे ठहराव दिखाएँ जहाँ पालतू जानवरों की अनुमति है",
  ...
  savedTripFallbackTitle: "सहेजी गई यात्रा",
  savedTripFallbackRoute: "गंतव्य विवरण उपलब्ध नहीं है",
  savedTripFallbackNote:
    "यह यात्रा इस डिवाइस पर सहेजी गई थी और इसे कभी भी हटाया जा सकता है।",
  ...
  savedTripsNoRecentDescription:
    "हम आपके नवीनतम मार्ग और ठहराव यहाँ रखेंगे ताकि हर बार लौटने पर योजना तेज़ लगे।",
  ...
  savedTripsGuestCountOne: "1 अतिथि",
  savedTripsGuestCountOther: "{{count}} अतिथि",
  ...
  supportFaqAccountAnswer:
    "Kurioticket खाता एक्सेस, साइन-इन समस्याओं, साइन-अप समस्याओं, प्रोफ़ाइल एक्सेस और खाते से जुड़ी प्लेटफ़ॉर्म समस्याओं में मदद कर सकता है।",
  supportFaqSearchQuestion: "खोज और परिणाम सहायता",
  supportFaqSearchAnswer:
    "जब उड़ान या होटल खोज काम नहीं कर रही हो, परिणाम लोड न हो रहे हों, फ़िल्टर भ्रमित कर रहे हों, या कीमतें और प्रदाता अपेक्षित रूप से न दिख रहे हों, तब Kurioticket मदद कर सकता है।",
  supportFaqSavedTripsQuestion: "सहेजी गई यात्राएँ और अलर्ट",
  supportFaqSavedTripsAnswer:
    "Kurioticket सहेजी गई यात्राओं, हाल की खोजों, कीमत अलर्ट, सूचना समस्याओं और खाते से जुड़े यात्रा टूल में मदद कर सकता है।",
  supportFaqRedirectQuestion: "बुकिंग/प्रदाता रीडायरेक्ट सहायता",
  supportFaqRedirectAnswer:
    "यदि किसी पार्टनर या प्रदाता पर रीडायरेक्ट विफल हो जाता है, गलत पेज खुलता है, या चुनी गई यात्रा या खोज विवरण सुरक्षित नहीं रहते, तो Kurioticket मदद कर सकता है।",
  supportFaqAlreadyBookedQuestion:
    "क्या आपने पहले ही किसी प्रदाता के साथ बुकिंग कर ली है?",
  supportFaqAlreadyBookedAnswer:
    "यदि आपकी बुकिंग किसी एयरलाइन, होटल, यात्रा एजेंसी या बाहरी प्रदाता के साथ पूरी हुई है, तो बुकिंग बदलाव, रिफंड, रद्दीकरण, चेक-इन, बोर्डिंग, रसीदों और यात्रा दस्तावेज़ों के लिए वही प्रदाता ज़िम्मेदार है।",
  supportFaqChangeBookingQuestion: "क्या Kurioticket मेरी बुकिंग बदल सकता है?",
  supportFaqChangeBookingAnswer:
    "Kurioticket केवल उन बुकिंग में मदद कर सकता है जो सीधे Kurioticket के माध्यम से की गई हों, यदि और जब सीधी बुकिंग समर्थित हो। बाहरी प्रदाताओं के साथ पूरी हुई बुकिंग के लिए सीधे उसी प्रदाता से संपर्क करें।",
  supportFaqWhyRedirectedQuestion:
    "मुझे किसी दूसरे प्रदाता के पास क्यों भेजा गया?",
  supportFaqWhyRedirectedAnswer:
    "Kurioticket एक यात्रा खोज और तुलना प्लेटफ़ॉर्म है, और कुछ परिणाम आपको विश्वसनीय प्रदाताओं पर भेजते हैं जहाँ आप बुकिंग, भुगतान और प्रदाता-विशिष्ट सहायता पूरी करते हैं।",
  ...
  footerConfidenceTagline:
    "उड़ानें, होटल और यात्रा डील्स आत्मविश्वास के साथ खोजें।",
