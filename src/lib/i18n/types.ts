export type TranslationDictionary = {
  ...
  signupAgreementBeforeTerms: string;
  signupTermsLink: string;
  signupAgreementBetweenLinks: string;
  signupPrivacyPolicyLink: string;
  signupAgreementAfterPrivacy: string;
  signupSubmit: string;
  signupCreatingAccount: string;
  signupGoogle: string;
  ...
  signupErrorRateLimited: string;
  signupErrorDuplicateEmail: string;
  signupErrorUnableSendVerification: string;
  signupVerificationRequiredRedirecting: string;
  signupAutomaticLoginFailed: string;
  signupAccountCreatedRedirecting: string;
  menu: string;
