...
export const translations: TranslationDictionary = {
  ...
  "destinations.tag.desertDrama": "Cảnh quan sa mạc ấn tượng",
  ...
  savedTripsClearAllSaved: "Xóa tất cả chuyến đi đã lưu",
  ...
  savedTripsSavedBadge: "Đã lưu",
  savedTripsTrendingBadge: "Đang thịnh hành",
  savedTripsProviderFare: "Giá từ nhà cung cấp",
  savedTripsCurrentOptions: "Lựa chọn hiện tại",
  savedTripsCompareCurrentOptions: "So sánh lựa chọn hiện tại",
  savedTripsViewFare: "Xem giá vé",
  savedTripsSearchRoute: "Tìm tuyến đường",
  ...
  savedTripsSearchNewTrips: "Tìm chuyến đi mới",
  savedTripsRemoveRecentSearch: "Xóa tìm kiếm gần đây",
