...
export const translations: TranslationDictionary = {
  ...en,
  "deals.mobileTravelersTitle": "Utazók",
  "mobileDatePicker.start": "Kezdés",
  "mobileDatePicker.end": "Befejezés",
  deals: "Utazási csomagok",
  ...
  homeDestinationDubaiCountry: "Egyesült Arab Emírségek",
  homeDestinationDubaiAlt: "Dubaj, Egyesült Arab Emírségek",
  homeDestinationLondonCity: "London",
  homeDestinationLondonCountry: "Egyesült Királyság",
  homeDestinationLondonAlt: "London, Egyesült Királyság",
  homeDestinationParisCity: "Párizs",
  homeDestinationParisCountry: "Franciaország",
  homeDestinationParisAlt: "Párizs, Franciaország",
  homeDestinationBaliCity: "Bali",
  homeDestinationBaliCountry: "Indonézia",
  homeDestinationBaliAlt: "Bali, Indonézia",
  homeDestinationNewYorkCity: "New York",
  homeDestinationNewYorkCountry: "Egyesült Államok",
  homeDestinationNewYorkAlt: "New York, Egyesült Államok",
  ...
  "deals.results.title": "Coordinated trip results (hu)",
  "deals.results.explanation": "These results align each included product with your trip. Prices stay product-specific and selections are completed separately. · Coordinated trip results (hu)",
  "deals.results.modify": "Modify search · Coordinated trip results (hu)",
  "deals.results.viewFlights": "View all flights · Coordinated trip results (hu)",
  "deals.results.viewHotels": "View all hotels · Coordinated trip results (hu)",
  "deals.results.viewCars": "View car options · Coordinated trip results (hu)",
  "deals.results.invalidTitle": "Review your search · Coordinated trip results (hu)",
  "deals.results.invalidMessage": "Some trip details are missing or invalid. · Coordinated trip results (hu)",
  "deals.results.noResults": "No matching results were found. · Coordinated trip results (hu)",
  "deals.results.providerUnavailable": "The provider is temporarily unavailable. · Coordinated trip results (hu)",
  "deals.results.rateLimited": "Too many searches. Please wait and try again. · Coordinated trip results (hu)",
  "deals.results.unsupportedDestination": "This hotel destination is not supported. · Coordinated trip results (hu)",
  "deals.error.flightOriginCode": "Airport selection is required. · Coordinated trip results (hu)",
  "deals.error.flightDestinationCode": "Select a valid arrival airport. · Coordinated trip results (hu)",
  "deals.error.flightPassengers": "Use 1–9 whole-number passengers. · Coordinated trip results (hu)",
  "deals.error.flightInfants": "Infants cannot exceed adults. · Coordinated trip results (hu)",
  "deals.error.flightDates": "Select valid flight dates. · Coordinated trip results (hu)",
  "deals.error.hotelDestination": "Enter a hotel destination. · Coordinated trip results (hu)",
  "deals.error.hotelGuests": "Use 1–12 whole-number guests. · Coordinated trip results (hu)",
  "deals.error.hotelRooms": "Select 1–6 rooms. · Coordinated trip results (hu)",
  "deals.error.hotelDates": "Select valid hotel dates. · Coordinated trip results (hu)",
  "deals.results.separateBooking": "Coordinated results, separate selections. · Coordinated trip results (hu)",
