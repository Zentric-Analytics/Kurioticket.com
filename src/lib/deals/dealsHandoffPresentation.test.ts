...
const plan: DealsTripPlan = {
  ...
  flight: { id: "f1", provider: "Duffel", airline: "Brussels Airlines", flightNumber: "SN7261", origin: "LOS", destination: "LAX", departure: "2026-08-01T23:35:00", arrival: "2026-08-02T06:15:00", duration: "10h 40m", sourcePrice: 6400.33, sourceCurrency: "USD", resultReceivedAt: now },
  hotel: { id: "h1", provider: "Hotelbeds", name: "Parkwest Bicycle Casino", location: "Los Angeles - CA", checkIn: "2026-08-01", checkOut: "2026-08-03", roomType: "DELUXE KING ROOM", sourcePrice: 500, sourceCurrency: "USD", resultReceivedAt: now },
