...
export const travelApi = {
  ...
  requestCurrentEmailCode: () => request<{ cooldownSeconds: number }>("/api/mobile/v1/email-change/current-request", { method: "POST", body: JSON.stringify({}) }),
  ...
  requestEmailChange: (newEmail: string, ownershipProof: string) => request<{ cooldownSeconds: number }>("/api/mobile/v1/email-change/request", { method: "POST", body: JSON.stringify({ newEmail, ownershipProof }) }),
