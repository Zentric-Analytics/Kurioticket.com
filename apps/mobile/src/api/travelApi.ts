...
export const travelApi = {
  ...
  requestEmailChange: (newEmail: string) => request<{ cooldownSeconds: number }>("/api/mobile/v1/email-change/request", { method: "POST", body: JSON.stringify({ newEmail }) }),
  confirmEmailChange: (newEmail: string, code: string) => request<{ email: string; userId: string }>("/api/mobile/v1/email-change/confirm", { method: "POST", body: JSON.stringify({ newEmail, code }) }),
