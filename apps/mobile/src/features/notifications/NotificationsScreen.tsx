...
export function NotificationsScreen() {
  ...
  return <SafeAreaView style={flowStyles.safe} edges={["top"]}>
    ...
    {!state.loading || state.items.length ? <ScrollView refreshControl={<RefreshControl refreshing={state.refreshing} onRefresh={() => void loadFirstPage(true)} />} contentContainerStyle={styles.list}>
