export const protectedRoutes = ["/saved", "/price-alerts", "/notifications", "/personal-information", "/email-preferences", "/travel-preferences", "/(tabs)/trips", "/(tabs)/profile"] as const;
