...
const styles = StyleSheet.create({ safe: { flex: 1 }, scroll: { paddingHorizontal: 18, paddingBottom: 28 }, header: { minHeight: 70, flexDirection: "row", alignItems: "center" }, title: { fontSize: 30, lineHeight: 38, fontWeight: "800" }, illustration: { height: 192, marginHorizontal: -18, marginTop: -5 }, heroTitle: { textAlign: "center", fontSize: 22, lineHeight: 28, fontWeight: "800", marginTop: -2 }, heroBody: { textAlign: "center", fontSize: 13, lineHeight: 19, marginTop: 7 }, signIn: { height: 54, marginTop: 16, borderRadius: 10, backgroundColor: BLUE, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 12, paddingHorizontal: 18 }, signInText: { color: "white", fontSize: 16, fontWeight: "700" }, signInArrow: { position: "absolute", right: 17 }, sections: { gap: 16, marginTop: 16 }, pressed: { opacity: .7 } });
