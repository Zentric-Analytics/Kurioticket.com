...
export function SecurityScreen() {
  ...
  const reactivate = async () => { if(submitting)return;setSubmitting(true);setError("");try{await travelApi.reactivateDeletion();setDeletion(null);setMessage(c.reactivated);}catch(e){if(!await unauth(e))setError(e instanceof TravelApiError?e.message:c.deletionError);}finally{setSubmitting(false);} };
