...
export function SecurityScreen() {
  ...
  return <SafeAreaView style={[styles.safe, { backgroundColor: theme.background }]} edges={["top"]}>
    ...
    <ScreenModal visible={devicesOpen} title={c.activeSessions} closeLabel={c.close} onClose={closeDevices} overlay={sessionSheet}>
