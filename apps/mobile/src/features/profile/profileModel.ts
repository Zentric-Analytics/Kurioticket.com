...
export type ProfileDestination =
  ...
  | { kind: "preview-browser"; path: "/mobile/legal/terms-of-service" | "/mobile/legal/privacy-policy"; productionHref: "/(tabs)/profile/terms-of-service" | "/(tabs)/profile/privacy-policy" };
