...
const resetNavigationCopy: Record<MobileLocale, ResetNavigationCopy> = {
  "en-us": { title: "Reset password", entry: "Reset password another way", entryHelp: "Verify your account by email and choose a new password.", submit: "Reset password", buttonSuccess: "Password reset successfully", success: "Password reset. Other devices were signed out." },
  "es-es": { title: "Restablecer contraseña", entry: "Restablecer contraseña de otra forma", entryHelp: "Verifica tu cuenta por correo electrónico y elige una nueva contraseña.", submit: "Restablecer contraseña", buttonSuccess: "Contraseña restablecida correctamente", success: "Contraseña restablecida. Se cerraron las otras sesiones." },
  fr: { title: "Réinitialiser le mot de passe", entry: "Réinitialiser le mot de passe autrement", entryHelp: "Vérifiez votre compte par e-mail et choisissez un nouveau mot de passe.", submit: "Réinitialiser le mot de passe", buttonSuccess: "Mot de passe réinitialisé", success: "Mot de passe réinitialisé. Les autres appareils ont été déconnectés." },
  "de-de": { title: "Passwort zurücksetzen", entry: "Passwort auf andere Weise zurücksetzen", entryHelp: "Bestätige dein Konto per E-Mail und wähle ein neues Passwort.", submit: "Passwort zurücksetzen", buttonSuccess: "Passwort erfolgreich zurückgesetzt", success: "Passwort zurückgesetzt. Andere Geräte wurden abgemeldet." },
  "it-it": { title: "Reimposta password", entry: "Reimposta password in un altro modo", entryHelp: "Verifica il tuo account via email e scegli una nuova password.", submit: "Reimposta password", buttonSuccess: "Password reimpostata correttamente", success: "Password reimpostata. Gli altri dispositivi sono stati disconnessi." },
  "pt-br": { title: "Redefinir senha", entry: "Redefinir senha de outra forma", entryHelp: "Verifique sua conta por e-mail e escolha uma nova senha.", submit: "Redefinir senha", buttonSuccess: "Senha redefinida com sucesso", success: "Senha redefinida. Outros dispositivos foram desconectados." },
  nl: { title: "Wachtwoord opnieuw instellen", entry: "Wachtwoord op een andere manier opnieuw instellen", entryHelp: "Verifieer je account via e-mail en kies een nieuw wachtwoord.", submit: "Wachtwoord opnieuw instellen", buttonSuccess: "Wachtwoord opnieuw ingesteld", success: "Wachtwoord opnieuw ingesteld. Andere apparaten zijn afgemeld." },
  ar: { title: "إعادة تعيين كلمة المرور", entry: "إعادة تعيين كلمة المرور بطريقة أخرى", entryHelp: "تحقق من حسابك عبر البريد الإلكتروني واختر كلمة مرور جديدة.", submit: "إعادة تعيين كلمة المرور", buttonSuccess: "تمت إعادة تعيين كلمة المرور بنجاح", success: "تمت إعادة تعيين كلمة المرور وتسجيل خروج الأجهزة الأخرى." },
  "zh-cn": { title: "重置密码", entry: "通过其他方式重置密码", entryHelp: "通过电子邮箱验证账户并设置新密码。", submit: "重置密码", buttonSuccess: "密码重置成功", success: "密码已重置，其他设备已退出登录。" },
  ja: { title: "パスワードをリセット", entry: "別の方法でパスワードをリセット", entryHelp: "メールでアカウントを確認し、新しいパスワードを設定します。", submit: "パスワードをリセット", buttonSuccess: "パスワードをリセットしました", success: "パスワードをリセットしました。他のデバイスはサインアウトされました。" },
  ko: { title: "비밀번호 재설정", entry: "다른 방법으로 비밀번호 재설정", entryHelp: "이메일로 계정을 확인하고 새 비밀번호를 설정하세요.", submit: "비밀번호 재설정", buttonSuccess: "비밀번호가 재설정되었습니다", success: "비밀번호가 재설정되었습니다. 다른 기기에서 로그아웃되었습니다." },
  hi: { title: "पासवर्ड रीसेट करें", entry: "दूसरे तरीके से पासवर्ड रीसेट करें", entryHelp: "ईमेल से अपने खाते की पुष्टि करें और नया पासवर्ड चुनें।", submit: "पासवर्ड रीसेट करें", buttonSuccess: "पासवर्ड सफलतापूर्वक रीसेट हुआ", success: "पासवर्ड रीसेट हो गया। अन्य डिवाइस साइन आउट कर दिए गए।" },
  tr: { title: "Parolayı sıfırla", entry: "Parolayı başka bir yolla sıfırla", entryHelp: "Hesabınızı e-postayla doğrulayın ve yeni bir parola seçin.", submit: "Parolayı sıfırla", buttonSuccess: "Parola başarıyla sıfırlandı", success: "Parola sıfırlandı. Diğer cihazların oturumu kapatıldı." },
  pl: { title: "Zresetuj hasło", entry: "Zresetuj hasło w inny sposób", entryHelp: "Zweryfikuj konto przez e-mail i wybierz nowe hasło.", submit: "Zresetuj hasło", buttonSuccess: "Hasło zresetowano pomyślnie", success: "Hasło zresetowano. Inne urządzenia zostały wylogowane." },
  sv: { title: "Återställ lösenord", entry: "Återställ lösenord på ett annat sätt", entryHelp: "Verifiera ditt konto via e-post och välj ett nytt lösenord.", submit: "Återställ lösenord", buttonSuccess: "Lösenordet har återställts", success: "Lösenordet har återställts. Andra enheter har loggats ut." },
  id: { title: "Atur ulang kata sandi", entry: "Atur ulang kata sandi dengan cara lain", entryHelp: "Verifikasi akun melalui email dan pilih kata sandi baru.", submit: "Atur ulang kata sandi", buttonSuccess: "Kata sandi berhasil diatur ulang", success: "Kata sandi diatur ulang. Perangkat lain telah keluar." },
  th: { title: "รีเซ็ตรหัสผ่าน", entry: "รีเซ็ตรหัสผ่านด้วยวิธีอื่น", entryHelp: "ยืนยันบัญชีผ่านอีเมลและเลือกรหัสผ่านใหม่", submit: "รีเซ็ตรหัสผ่าน", buttonSuccess: "รีเซ็ตรหัสผ่านสำเร็จ", success: "รีเซ็ตรหัสผ่านแล้ว อุปกรณ์อื่นถูกออกจากระบบ" },
  vi: { title: "Đặt lại mật khẩu", entry: "Đặt lại mật khẩu theo cách khác", entryHelp: "Xác minh tài khoản qua email và chọn mật khẩu mới.", submit: "Đặt lại mật khẩu", buttonSuccess: "Đặt lại mật khẩu thành công", success: "Đã đặt lại mật khẩu. Các thiết bị khác đã đăng xuất." },
};
...
function Button({ label, onPress, loading, succeeded = false }: { label: string; onPress: () => void; loading: boolean; succeeded?: boolean }) {
  const inactive = loading || succeeded;
  return <Pressable accessibilityRole="button" accessibilityState={{ disabled: inactive, busy: loading }} disabled={inactive} onPress={onPress} style={({ pressed }) => [styles.button, pressed && !inactive && styles.pressed]}><View style={styles.buttonContent}><Text accessibilityLiveRegion={succeeded ? "polite" : undefined} style={styles.buttonText}>{label}</Text>{loading ? <ActivityIndicator size="small" color="white" /> : null}</View></Pressable>;
}
...
export function PasswordResetFlow({ active, copy: c, intro, onUnauthorized, onSuccess }: Props) {
  ...
  const [stage, setStage] = useState<"sending" | "verify" | "create">("sending"); const [challenge, setChallenge] = useState<PasswordResetChallenge | null>(null); const [code, setCode] = useState(""); const [codeError, setCodeError] = useState(""); const [recoveryToken, setRecoveryToken] = useState(""); const [newPassword, setNewPassword] = useState(""); const [confirmPassword, setConfirmPassword] = useState(""); const [newError, setNewError] = useState(""); const [confirmError, setConfirmError] = useState(""); const [generalError, setGeneralError] = useState(""); const [message, setMessage] = useState(""); const [submitting, setSubmitting] = useState(false); const [succeeded, setSucceeded] = useState(false); const [hidden, setHidden] = useState({ newPassword: true, confirmPassword: true }); const [resendUntil, setResendUntil] = useState(0); const [resendRemaining, setResendRemaining] = useState(0); const activeRef = useRef(active); const generationRef = useRef(0); const inFlightRef = useRef(false);

  const clearAll = () => { generationRef.current += 1; inFlightRef.current = false; setStage("sending"); setChallenge(null); setCode(""); setCodeError(""); setRecoveryToken(""); setNewPassword(""); setConfirmPassword(""); setNewError(""); setConfirmError(""); setGeneralError(""); setMessage(""); setSubmitting(false); setSucceeded(false); setHidden({ newPassword: true, confirmPassword: true }); setResendUntil(0); setResendRemaining(0); };
  ...
  useEffect(() => { activeRef.current = active; if (!active) { clearAll(); return; } generationRef.current += 1; setStage("sending"); setGeneralError(""); setCodeError(""); setMessage(""); setSucceeded(false); void sendCode(); return () => { generationRef.current += 1; }; }, [active]);
  ...
  const resetPassword = async () => {
    ...
    const generation = generationRef.current; let restartVerification = false; inFlightRef.current = true; setSubmitting(true); setSucceeded(false); setGeneralError("");
    try {
