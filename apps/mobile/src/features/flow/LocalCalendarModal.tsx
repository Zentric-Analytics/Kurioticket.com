...
export function LocalCalendarModal({ visible, title, selected, minimum, onChoose, onClose, dismissOnBackdropPress = false }: LocalCalendarModalProps) {
  ...
  return <Modal visible transparent animationType="none" onRequestClose={onClose}><SafeAreaView edges={["top"]} pointerEvents={motion.pointerEvents} style={styles.overlay}>
