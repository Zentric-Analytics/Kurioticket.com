...
export function LocalCalendarModal({ visible, title, selected, minimum, onChoose, onClose }: { visible: boolean; title: string; selected: string; minimum: string; onChoose: (iso: string) => void; onClose: () => void }) {
  ...
  return <Modal visible transparent animationType="slide" onRequestClose={onClose}><SafeAreaView style={styles.overlay}><View accessibilityViewIsModal style={styles.modal}>
