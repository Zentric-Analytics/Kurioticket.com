...
export function HotelDestinationSheet({ visible, value, onDone, onCancel, suggestionIcons = ["hotel"] }: { visible: boolean; value: string; onDone: (destination: string) => void; onCancel: () => void; suggestionIcons?: readonly SearchResultProductIconName[] }) {
  const ft = useFlowTheme();
