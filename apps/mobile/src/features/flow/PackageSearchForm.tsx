...
export function PackageSearchForm({ presentation }: { presentation: "home" | "standalone" }) {
  ...
  return <>
    ...
    <HotelDestinationSheet visible={hotelDestinationOpen} value={search.destination} suggestionIcons={PACKAGE_SUGGESTION_ICONS[search.mode]} onDone={destination => { setSearch(current => applyPackageDestination(current, destination)); setHotelDestinationOpen(false); }} onCancel={() => setHotelDestinationOpen(false)}/>
