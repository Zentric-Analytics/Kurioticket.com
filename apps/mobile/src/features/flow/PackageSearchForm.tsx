...
export function PackageSearchForm({ presentation }: { presentation: "home" | "standalone" }) {
  ...
  return <>
    ...
    <HotelDestinationSheet visible={hotelDestinationOpen} value={search.destination} onChoose={destination => { setSearch(current => applyPackageDestination(current, destination)); setHotelDestinationOpen(false); }} onCancel={() => setHotelDestinationOpen(false)}/>
