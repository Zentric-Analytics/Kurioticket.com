...
const styles = StyleSheet.create({screen:{flex:1},header:{minHeight:68,paddingHorizontal:16,flexDirection:"row",alignItems:"center"},headerCopy:{flex:1,minWidth:0},title:{fontSize:18,lineHeight:24,fontWeight:"700",fontFamily:appFonts.bold},subtitle:{fontSize:12,lineHeight:16,fontWeight:"500",fontFamily:appFonts.medium},close:{width:44,height:44,alignItems:"center",justifyContent:"center"},scroll:{flex:1},content:{paddingTop:4,paddingBottom:24},section:{paddingHorizontal:16,paddingVertical:14},sectionTitle:{fontSize:15,lineHeight:20,fontWeight:"700",fontFamily:appFonts.bold},options:{marginTop:12},row:{minHeight:44,flexDirection:"row",alignItems:"center",gap:11},rtlRow:{flexDirection:"row-reverse"},box:{width:21,height:21,borderWidth:1.5,borderRadius:4,alignItems:"center",justifyContent:"center"},rowLabel:{flex:1,fontSize:14,lineHeight:19,fontWeight:"500",fontFamily:appFonts.medium},count:{fontSize:13,minWidth:28,textAlign:"right",fontFamily:appFonts.medium},footer:{borderTopWidth:StyleSheet.hairlineWidth,paddingHorizontal:16,paddingTop:12},footerActions:{flexDirection:"row",alignItems:"center",gap:14},reset:{minWidth:116,height:49,borderWidth:1,borderRadius:12,alignItems:"center",justifyContent:"center"},resetText:{fontSize:15,fontWeight:"700",fontFamily:appFonts.bold},view:{width:"100%",minHeight:50,borderRadius:10,backgroundColor:ui.blue,alignItems:"center",justifyContent:"center"},flex:{width:"auto",flex:1},updating:{flexDirection:"row",alignItems:"center",gap:8},viewText:{color:"white",fontSize:16,lineHeight:22,fontWeight:"700",fontFamily:appFonts.bold}});
