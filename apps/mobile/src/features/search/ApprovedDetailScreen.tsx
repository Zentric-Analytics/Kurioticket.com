...
const d = StyleSheet.create({
  ...
  hotelAboutSubheading: { marginTop: 28, fontSize: 16, lineHeight: 24, fontWeight: "600", fontFamily: appFonts.semibold },
  ...
  hotelAboutHighlight: { width: "48%", minHeight: 56, paddingHorizontal: 12, paddingVertical: 10, borderWidth: 1, borderRadius: 12, flexDirection: "row", alignItems: "center", gap: 8 },
  hotelAboutHighlightText: { flex: 1, minWidth: 0, fontSize: 14, lineHeight: 20, fontWeight: "500", fontFamily: appFonts.medium },
