        ...
        <View style={d.hotelIdentity}>
          <View style={d.hotelIdentityTopRow}>
            ...
            <View style={d.hotelHeaderActions}>
              ...
              >
                <Heart size={20} strokeWidth={2} color={androidFavoriteColors.stroke} fill={saved ? androidFavoriteColors.savedFill : androidFavoriteColors.unsavedFill} />
              </Pressable>
...
const d = StyleSheet.create({
  ...
  hotelOfferBrandLogo: { width: 120, height: 26, flexShrink: 0 },
  hotelOfferProvider: { fontSize: 15, lineHeight: 21, fontWeight: "900" },
  selectionControl: { width: 18, height: 18, borderRadius: 9, borderWidth: 1.5, alignItems: "center", justifyContent: "center" },
  selectionControlDot: { width: 8, height: 8, borderRadius: 4 },
  ...
  hotelNightly: { fontSize: 20, lineHeight: 24, fontWeight: "700", fontFamily: appFonts.bold, textAlign: "right" },
