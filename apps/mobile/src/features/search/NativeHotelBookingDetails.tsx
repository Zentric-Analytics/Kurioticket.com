...
const s = StyleSheet.create({
  ...
  description: { marginTop: 10, fontSize: 13, lineHeight: 22, fontWeight: "400", fontFamily: appFonts.regular },
  fallback: { marginTop: 8, fontSize: 13, lineHeight: 20, fontWeight: "400", fontFamily: appFonts.regular },
  divider: { height: StyleSheet.hairlineWidth, marginVertical: 14 },
  rowList: { marginTop: 10, gap: 13 },
  amenityRow: { minHeight: 28, flexDirection: "row", alignItems: "center", gap: 11 },
  infoRow: { minHeight: 26, flexDirection: "row", alignItems: "flex-start", gap: 10 },
  rowText: { flex: 1, minWidth: 0, fontSize: 13, lineHeight: 20, fontWeight: "400", fontFamily: appFonts.regular },
  seeAllRow: { minHeight: 48, marginTop: 10, borderTopWidth: StyleSheet.hairlineWidth, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  seeAllText: { fontSize: 14, lineHeight: 20, fontWeight: "600", fontFamily: appFonts.semibold },
  pressed: { opacity: 0.58 },
  accessibilityList: { marginTop: 10, gap: 7 },
  ...
  sheetScroll: { paddingHorizontal: 18, paddingTop: 18, paddingBottom: 28 },
  amenityGroupSpaced: { marginTop: 24 },
  groupTitle: { fontSize: 15, lineHeight: 21, fontWeight: "700", fontFamily: appFonts.bold },
  groupRows: { marginTop: 10, gap: 13 },
  sheetAmenityRow: { minHeight: 28, flexDirection: "row", alignItems: "center", gap: 11 },
