...
const s = StyleSheet.create({
  ...
  description: { marginTop: 4, fontSize: 14, lineHeight: 21, fontWeight: "400", fontFamily: appFonts.regular },
  fallback: { marginTop: 4, fontSize: 14, lineHeight: 20, fontWeight: "400", fontFamily: appFonts.regular },
  ...
  bullet: { width: 20, fontSize: 14, lineHeight: 21 },
