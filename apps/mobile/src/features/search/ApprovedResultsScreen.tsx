...
import { useSearchPickerKeyboardPresentation } from "../flow/searchPickerKeyboardPresentation";
...
const s0 = StyleSheet.create({
  ...
  hotelAlertMotionBackdrop: { backgroundColor: "transparent" },
  hotelAlertMotionScrim: { backgroundColor: "rgba(0,0,0,.45)" },
