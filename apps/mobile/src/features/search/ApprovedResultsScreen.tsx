...
const s0 = StyleSheet.create({
  ...
  flightHeader: { paddingHorizontal: 12, paddingTop: 12, paddingBottom: 8 },
  flightHeaderMainRow: { width: "100%", flexDirection: "row", alignItems: "center" },
  ...
  hotelTitleRow: { position: "relative", zIndex: 1, flexDirection: "row", alignItems: "flex-start", minWidth: 0 },
  hotelActions: { position: "absolute", zIndex: 2, top: -8, right: -8, flexDirection: "row", flexShrink: 0, gap: 0 },
