...
const s0 = StyleSheet.create({
  ...
  flightResultCount: { paddingHorizontal: 14, paddingTop: 7, fontSize: 16, lineHeight: 21, fontWeight: "700" },
  card: {
    width: "100%",
    borderWidth: 1,
    borderRadius: 16,
  ...
  airlineName: { fontSize: 14, lineHeight: 18, color: ui.navy, fontWeight: "700" },
  flightNumber: { marginTop: 1, fontSize: 11, lineHeight: 14, fontWeight: "500" },
  ...
  journeyLabel: { fontSize: 10, lineHeight: 12, fontWeight: "700", letterSpacing: 0.8 },
  ...
  time: { fontSize: 15, lineHeight: 19, fontWeight: "800", color: ui.navy },
  airportCode: { fontSize: 11, lineHeight: 14, fontWeight: "700" },
  timelineColumn: { flex: 1, minWidth: 46, alignItems: "center" },
  journeyDuration: { maxWidth: "100%", fontSize: 11, lineHeight: 14, fontWeight: "600", textAlign: "center" },
  stopLabel: { maxWidth: "100%", fontSize: 10, lineHeight: 13, fontWeight: "500", textAlign: "center" },
