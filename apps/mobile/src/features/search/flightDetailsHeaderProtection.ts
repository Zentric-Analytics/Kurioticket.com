const FLIGHT_DETAILS_HERO_HEIGHT = 318;
...
export function flightDetailsHeaderProtectionGeometry(topInset: number) {
  ...
  return {
    protectedHeight,
    threshold: Math.max(0, FLIGHT_DETAILS_HERO_HEIGHT - FLIGHT_DETAILS_ITINERARY_OVERLAP - protectedHeight),
  };
}
