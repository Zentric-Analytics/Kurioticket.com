...
test("connection polish stays compact and uses restrained theme-aware surfaces",()=>{
  ...
  assert.match(source,/const FLIGHT_DETAILS_DARK_CONNECTION_BORDER = "#31445D"/);
  ...
  assert.match(itinerary,/const connectionBorder=theme\.dark\?FLIGHT_DETAILS_DARK_CONNECTION_BORDER:FLIGHT_DETAILS_LIGHT_CONNECTION_BORDER/);
  ...
  assert.doesNotMatch(itinerary,/theme\.dark&&\{borderColor:theme\.border\}/);
