...
const styles = StyleSheet.create({
  ...
  scrim: { backgroundColor: "rgba(8, 18, 35, 0.52)" }, sheet: { maxHeight: "88%", marginHorizontal: FLIGHT_QUICK_SHEET_HORIZONTAL_INSET, borderTopLeftRadius: 24, borderTopRightRadius: 24, borderBottomLeftRadius: 24, borderBottomRightRadius: 24, overflow: "hidden" },
  header: { minHeight: 52, flexDirection: "row", alignItems: "center", paddingLeft: 16, paddingRight: 8 },
  close: { width: 44, height: 44, alignItems: "center", justifyContent: "center" }, title: { flex: 1, textAlign: "left", fontSize: 19, lineHeight: 24, fontWeight: "600" },
