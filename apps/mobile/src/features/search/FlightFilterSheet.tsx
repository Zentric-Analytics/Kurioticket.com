...
export function FlightFilterSheet({visible,section,filters,options,results,priceValue,currency,priceFilteringReady,onChange,onClose}:Props){
 ...
 const compactFrame:FlightResultsCompactMenuFrame|undefined=full?undefined:section==="airlines"?{left:164,width:244}:section==="stops"?{left:224,width:220}:{left:244,width:268};
