...
function Choice({label,count,selected,onPress,accessibilityRole="checkbox"}:{label:string;count?:number;selected:boolean;onPress:()=>void;accessibilityRole?:"checkbox"|"radio"}){const {theme}=useAppTheme();return <Pressable accessibilityRole={accessibilityRole} accessibilityState={accessibilityRole==="radio"?{selected}:{checked:selected}} onPress={onPress} style={[styles.choice,{backgroundColor:selected?"rgba(37, 99, 235, 0.05)":"transparent",borderColor:selected?ui.blue:theme.border,borderWidth:selected?1:StyleSheet.hairlineWidth}]}><Text style={[styles.choiceLabel,{color:selected?ui.blue:theme.textPrimary}]}>{label}</Text>{count!==undefined?<Text style={[styles.count,{color:theme.textSecondary}]}>{count}</Text>:null}{selected?<Check size={18} color={ui.blue}/>:null}</Pressable>}
const styles=StyleSheet.create({overlay:{flex:1,justifyContent:"flex-end"},backdropScrim:{backgroundColor:"rgba(15, 23, 42, 0.35)"},bottom:{justifyContent:"flex-end"},sheet:{width:"100%",borderTopLeftRadius:24,borderTopRightRadius:24,overflow:"hidden",shadowColor:"#0F172A",shadowOpacity:.2,shadowRadius:18,elevation:16},header:{minHeight:76,paddingLeft:20,paddingRight:10,flexDirection:"row",alignItems:"center",borderBottomWidth:StyleSheet.hairlineWidth},copy:{flex:1},title:{fontSize:18,fontFamily:appFonts.bold,fontWeight:"700"},subtitle:{fontSize:12,lineHeight:18,fontFamily:appFonts.medium},close:{width:44,height:44,alignItems:"center",justifyContent:"center"},body:{flexShrink:1},content:{padding:16,gap:8},sortChoices:{gap:8},priceCard:{paddingVertical:4},help:{fontSize:13,marginBottom:14,fontFamily:appFonts.medium},inputs:{flexDirection:"row",gap:10,marginBottom:12},inputColumn:{flex:1},inputLabel:{fontSize:12,fontFamily:appFonts.semibold,marginBottom:5},input:{height:44,borderWidth:1,borderRadius:8,paddingHorizontal:10,fontFamily:appFonts.medium},endpoints:{flexDirection:"row",justifyContent:"space-between"},choice:{minHeight:50,borderRadius:10,paddingHorizontal:14,flexDirection:"row",alignItems:"center",gap:10},choiceLabel:{flex:1,fontSize:14,lineHeight:20,fontWeight:"500",fontFamily:appFonts.medium},count:{fontSize:13,fontFamily:appFonts.medium},empty:{paddingVertical:20,textAlign:"center",fontFamily:appFonts.medium},footer:{flexDirection:"row",gap:10,paddingHorizontal:16,paddingTop:12,borderTopWidth:StyleSheet.hairlineWidth},reset:{minWidth:116,height:49,borderWidth:1,borderRadius:12,alignItems:"center",justifyContent:"center"},apply:{flex:1,height:49,borderRadius:12,backgroundColor:ui.blue,alignItems:"center",justifyContent:"center"},updating:{flexDirection:"row",alignItems:"center",gap:8},buttonText:{fontSize:15,fontFamily:appFonts.bold,fontWeight:"700"}});
