...
function FareBenefitRow({semantic,text,textColor}:{semantic:"positive"|"negative"|"informational";text:string;textColor:string}){return <View style={s.fareBenefitRow}><View style={s.fareStatusColumn}><View style={[s.fareStatus,semantic==="positive"?s.fareStatusPositive:s.fareStatusNeutral]}>{semantic==="positive"?<FlowIcon name="check" size={11} color={ui.green}/>:semantic==="negative"?<View style={s.fareStatusMinus}/>:<View style={s.fareStatusDot}/>}</View></View><Text style={[s.fareBenefitText,{color:textColor}]}>{text}</Text></View>}
