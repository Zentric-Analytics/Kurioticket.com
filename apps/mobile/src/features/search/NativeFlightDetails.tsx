...
export function NativeFlightDetails({ params }: { params: Params }) {
  ...
  if (state === "loading") return <FlightDetailsLoadingSkeleton theme={theme} topInset={inset.top} bottomInset={inset.bottom} fareCardWidth={fareCardWidth} contentWidth={windowWidth}/>;
...
function FlightDetailsLoadingSkeleton({theme,topInset,bottomInset,fareCardWidth,contentWidth}:{theme:ReturnType<typeof useAppTheme>["theme"];topInset:number;bottomInset:number;fareCardWidth:number;contentWidth:number}) {
  ...
  return <SafeAreaView edges={[]} style={[s.safe,{backgroundColor:contentCanvasColor}]}>
    ...
    <ScrollView testID="flight-details-loading-scroll" style={{backgroundColor:contentCanvasColor}} contentContainerStyle={[s.content,{width:contentWidth,paddingBottom:120+bottomInset}]}>
