...
import { arrivalDayOffsetAccessibility, flightArrivalDayOffset, providerLocalFlightDateLong } from "./flightArrivalDayOffset";
  ...
  return <View style={[s.itineraryCard,{backgroundColor:theme.surface,borderColor:theme.border}]}>
    ...
    <View style={s.journeySummary}>
      ...
      <View style={[s.journeyEndpoint,s.arrivalEndpoint]}>
        ...
        {arrivalDayOffset?<Text accessible accessibilityLabel={arrivalDayOffsetAccessibility(arrivalDayOffset)??undefined} style={s.arrivalDayOffset}>+{arrivalDayOffset} {arrivalDayOffset===1?"day":"days"}</Text>:null}
      </View>
    </View>
