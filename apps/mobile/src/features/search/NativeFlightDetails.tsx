...
export function NativeFlightDetails({ params }: { params: Params }) {
  ...
  const fareTabActiveTextColor=theme.dark?"#8FB5FF":"#004BB8";
  const fareTabInactiveTextColor=theme.dark?theme.textPrimary:"#1A1A1A";
