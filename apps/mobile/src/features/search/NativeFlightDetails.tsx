      ...
      <Animated.View pointerEvents="none" style={[s.loadingBody,{opacity}]}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={s.loadingFares}>
          {[0,1].map(key=><View key={key} style={[s.loadingFareCard,{width:fareCardWidth,backgroundColor:theme.surface,borderColor:theme.border}]}>
            <View style={s.loadingFareIdentity}><View style={s.loadingFareNameRow}><View style={[s.loadingFareIcon,placeholder]}/><View style={[s.loadingLine,s.loadingFareName,placeholder]}/></View></View>
            ...
            <View style={s.loadingFarePriceBlock}><View style={[s.loadingLine,s.loadingFarePriceLabel,placeholder]}/><View style={[s.loadingLine,s.loadingFarePrice,placeholder]}/></View>
          </View>)}
        </ScrollView>
