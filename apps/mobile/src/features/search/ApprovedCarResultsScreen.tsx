...
import { ArrowLeft, ArrowUp, ChevronDown, SlidersHorizontal, SquarePen } from "lucide-react-native";
...
export function ApprovedCarResultsScreen() {
  ...
  return <SafeAreaView style={[r.safe,{backgroundColor:carCanvasColor}]} edges={["top"]}>
    ...
    <ScrollView ref={carScrollRef} style={{backgroundColor:carCanvasColor}} alwaysBounceVertical={false} bounces={false} overScrollMode="never" scrollEventThrottle={16} onScroll={handleCarScroll} contentContainerStyle={[r.body,{paddingBottom:Math.max(insets.bottom + 16,16)}]}>
