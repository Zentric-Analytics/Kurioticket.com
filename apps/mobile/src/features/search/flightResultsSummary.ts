...
const resultUiCopy: Record<MobileLocale, Record<UiKey, string>> = {
  ...
  hi:ui("कोई उड़ान आपके फ़िल्टर से मेल नहीं खाती","उड़ानें लोड नहीं हो सकीं","कोई उड़ान नहीं मिली","अपने फ़िल्टर समायोजित करें या साफ़ करें।","नतीजे लोड करते समय कुछ गड़बड़ हुई।","इस खोज के लिए हमें कोई उड़ान नहीं मिली।","फ़िल्टर साफ़ करें","फिर कोशिश करें","खोज संपादित करें","फ़िल्टर समायोजित करें","उड़ानें क्रमबद्ध करें","नतीजों का क्रम चुनें","सर्वश्रेष्ठ","सबसे सस्ता","सबसे तेज़","कीमत और यात्रा समय का सर्वोत्तम संतुलन","सबसे कम कुल कीमत","सबसे कम यात्रा समय","रीसेट करें","लागू करें","फ़िल्टर","उड़ानों को फ़िल्टर करें","कीमत","अधिकतम कीमत","अधिकतम","उड़ान समय","जाने वाली उड़ान","वापसी की उड़ान","उड़ान","उड़ान भरना","लैंडिंग","अवधि","अधिकतम यात्रा समय","स्टॉप","नॉनस्टॉप","1 स्टॉप","2+ स्टॉप","एयरलाइंस","एयरलाइंस खोजें","और दिखाएँ","कम दिखाएँ","हवाई अड्डे","से","तक","किराया प्राथमिकताएँ","सामान शामिल","लचीला / वापसी योग्य","सब साफ़ करें","सभी उड़ानें दिखाई गई हैं","एक या अधिक एयरलाइंस चुनें","अनुमत स्टॉप की संख्या चुनें","प्रस्थान या आगमन हवाई अड्डे चुनें","क्रम विकल्प बंद करें","उड़ान फ़िल्टर बंद करें","चयनित","सक्रिय"),
  tr:ui("Filtrelerinizle eşleşen uçuş yok","Uçuşlar yüklenemedi","Uçuş bulunamadı","Filtrelerinizi ayarlamayı veya temizlemeyi deneyin.","Sonuçlar yüklenirken bir sorun oluştu.","Bu arama için uçuş bulamadık.","Filtreleri temizle","Tekrar dene","Aramayı düzenle","Filtreleri ayarla","Uçuşları sırala","Sonuçların sıralama şeklini seçin","En iyi","En ucuz","En hızlı","Fiyat ve yolculuk süresi açısından en iyi denge","En düşük toplam fiyat","En kısa yolculuk süresi","Sıfırla","Uygula","Filtreler","Uçuşları filtrele","Fiyat","Maksimum fiyat","En fazla","Uçuş saatleri","Gidiş uçuşu","Dönüş uçuşu","Uçuş","Kalkış","İniş","Süre","Maksimum seyahat süresi","Duraklar","Direkt","1 durak","2+ durak","Havayolları","Havayolu ara","Daha fazla göster","Daha az göster","Havalimanları","KALKIŞ","VARIŞ","Ücret tercihleri","Bagaj dahil","Esnek / iade edilebilir","Tümünü temizle","Tüm uçuşlar gösteriliyor","Bir veya daha fazla havayolu seçin","İzin verilen durak sayılarını seçin","Kalkış veya varış havalimanlarını seçin","Sıralama seçeneklerini kapat","Uçuş filtrelerini kapat","seçili","etkin"),
  pl:ui("Żadne loty nie pasują do filtrów","Nie udało się wczytać lotów","Nie znaleziono lotów","Spróbuj zmienić lub wyczyścić filtry.","Wystąpił problem podczas ładowania wyników.","Nie znaleźliśmy lotów dla tego wyszukiwania.","Wyczyść filtry","Spróbuj ponownie","Edytuj wyszukiwanie","Dostosuj filtry","Sortuj loty","Wybierz sposób sortowania wyników","Najlepsze","Najtańsze","Najszybsze","Najlepszy balans ceny i czasu podróży","Najniższa cena całkowita","Najkrótszy czas podróży","Resetuj","Zastosuj","Filtry","Filtruj loty","Cena","Cena maksymalna","Do","Godziny lotów","Lot wylotowy","Lot powrotny","Lot","Start","Lądowanie","Czas trwania","Maksymalny czas podróży","Przesiadki","Bezpośredni","1 przesiadka","2+ przesiadki","Linie lotnicze","Szukaj linii lotniczych","Pokaż więcej","Pokaż mniej","Lotniska","Z","DO","Preferencje taryfy","Bagaż w cenie","Elastyczny / zwrotny","Wyczyść wszystko","Wyświetlane są wszystkie loty","Wybierz co najmniej jedną linię lotniczą","Wybierz dozwoloną liczbę przesiadek","Wybierz lotniska wylotu lub przylotu","Zamknij opcje sortowania","Zamknij filtry lotów","wybrano","aktywne"),
  sv:ui("Inga flyg matchar dina filter","Flygen kunde inte läsas in","Inga flyg hittades","Prova att justera eller rensa filtren.","Något gick fel när resultaten lästes in.","Vi hittade inga flyg för den här sökningen.","Rensa filter","Försök igen","Redigera sökning","Justera filter","Sortera flyg","Välj hur resultaten ska sorteras","Bäst","Billigast","Snabbast","Bäst balans mellan pris och restid","Lägsta totalpris","Kortaste restid","Återställ","Tillämpa","Filter","Filtrera flyg","Pris","Maxpris","Upp till","Flygtider","Utresa","Returflyg","Flyg","Avgång","Ankomst","Varaktighet","Maximal restid","Stopp","Direkt","1 stopp","2+ stopp","Flygbolag","Sök flygbolag","Visa mer","Visa mindre","Flygplatser","FRÅN","TILL","Prisvillkor","Bagage ingår","Flexibel / återbetalningsbar","Rensa allt","Alla flyg visas","Välj ett eller flera flygbolag","Välj tillåtet antal stopp","Välj avgångs- eller ankomstflygplatser","Stäng sorteringsalternativ","Stäng flygfilter","vald","aktiv"),
  id:ui("Tidak ada penerbangan yang cocok dengan filter Anda","Penerbangan tidak dapat dimuat","Penerbangan tidak ditemukan","Coba sesuaikan atau hapus filter Anda.","Terjadi masalah saat memuat hasil.","Kami tidak menemukan penerbangan untuk pencarian ini.","Hapus filter","Coba lagi","Edit pencarian","Sesuaikan filter","Urutkan penerbangan","Pilih urutan hasil","Terbaik","Termurah","Tercepat","Keseimbangan terbaik antara harga dan waktu perjalanan","Harga total terendah","Waktu perjalanan tersingkat","Atur ulang","Terapkan","Filter","Filter penerbangan","Harga","Harga maksimum","Hingga","Waktu penerbangan","Penerbangan berangkat","Penerbangan pulang","Penerbangan","Lepas landas","Mendarat","Durasi","Waktu perjalanan maksimum","Transit","Langsung","1 transit","2+ transit","Maskapai","Cari maskapai","Tampilkan lebih banyak","Tampilkan lebih sedikit","Bandara","DARI","KE","Preferensi tarif","Bagasi termasuk","Fleksibel / dapat dikembalikan","Hapus semua","Semua penerbangan ditampilkan","Pilih satu atau beberapa maskapai","Pilih jumlah transit yang diizinkan","Pilih bandara keberangkatan atau kedatangan","Tutup opsi urutan","Tutup filter penerbangan","dipilih","aktif"),
  th:ui("ไม่มีเที่ยวบินที่ตรงกับตัวกรองของคุณ","โหลดเที่ยวบินไม่ได้","ไม่พบเที่ยวบิน","ลองปรับหรือล้างตัวกรองของคุณ","เกิดข้อผิดพลาดขณะโหลดผลลัพธ์","เราไม่พบเที่ยวบินสำหรับการค้นหานี้","ล้างตัวกรอง","ลองอีกครั้ง","แก้ไขการค้นหา","ปรับตัวกรอง","เรียงเที่ยวบิน","เลือกวิธีเรียงผลลัพธ์","ดีที่สุด","ถูกที่สุด","เร็วที่สุด","สมดุลที่สุดระหว่างราคาและเวลาเดินทาง","ราคารวมต่ำสุด","เวลาเดินทางสั้นที่สุด","รีเซ็ต","ใช้","ตัวกรอง","กรองเที่ยวบิน","ราคา","ราคาสูงสุด","ไม่เกิน","เวลาเที่ยวบิน","เที่ยวบินขาไป","เที่ยวบินขากลับ","เที่ยวบิน","ออกเดินทาง","ถึงที่หมาย","ระยะเวลา","เวลาเดินทางสูงสุด","จุดแวะ","บินตรง","1 จุดแวะ","2+ จุดแวะ","สายการบิน","ค้นหาสายการบิน","แสดงเพิ่มเติม","แสดงน้อยลง","สนามบิน","จาก","ถึง","การตั้งค่าค่าโดยสาร","รวมสัมภาระ","ยืดหยุ่น / คืนเงินได้","ล้างทั้งหมด","แสดงเที่ยวบินทั้งหมด","เลือกสายการบินอย่างน้อยหนึ่งสาย","เลือกจำนวนจุดแวะที่อนุญาต","เลือกสนามบินต้นทางหรือปลายทาง","ปิดตัวเลือกการเรียง","ปิดตัวกรองเที่ยวบิน","เลือกแล้ว","ใช้งาน"),
  vi:ui("Không có chuyến bay phù hợp với bộ lọc của bạn","Không thể tải chuyến bay","Không tìm thấy chuyến bay","Hãy thử điều chỉnh hoặc xóa bộ lọc.","Đã xảy ra lỗi khi tải kết quả.","Chúng tôi không tìm thấy chuyến bay cho tìm kiếm này.","Xóa bộ lọc","Thử lại","Chỉnh sửa tìm kiếm","Điều chỉnh bộ lọc","Sắp xếp chuyến bay","Chọn cách sắp xếp kết quả","Tốt nhất","Rẻ nhất","Nhanh nhất","Cân bằng tốt nhất giữa giá và thời gian hành trình","Tổng giá thấp nhất","Thời gian hành trình ngắn nhất","Đặt lại","Áp dụng","Bộ lọc","Lọc chuyến bay","Giá","Giá tối đa","Tối đa","Giờ bay","Chuyến bay đi","Chuyến bay về","Chuyến bay","Cất cánh","Hạ cánh","Thời lượng","Thời gian di chuyển tối đa","Điểm dừng","Bay thẳng","1 điểm dừng","2+ điểm dừng","Hãng hàng không","Tìm hãng hàng không","Hiển thị thêm","Hiển thị ít hơn","Sân bay","TỪ","ĐẾN","Tùy chọn giá vé","Bao gồm hành lý","Linh hoạt / hoàn tiền","Xóa tất cả","Đang hiển thị tất cả chuyến bay","Chọn một hoặc nhiều hãng hàng không","Chọn số điểm dừng cho phép","Chọn sân bay khởi hành hoặc đến","Đóng tùy chọn sắp xếp","Đóng bộ lọc chuyến bay","đã chọn","đang hoạt động"),
};
...
const countTemplates: Record<MobileLocale, CountTemplates> = {
  ...
  fr: { one:"{count} vol", other:"{count} vols" },
  "de-de": { one:"{count} Flug", other:"{count} Flüge" },
  "it-it": { one:"{count} volo", other:"{count} voli" },
  "pt-br": { one:"{count} voo", other:"{count} voos" },
  nl: { one:"{count} vlucht", other:"{count} vluchten" },
  ar: { zero:"{count} رحلات", one:"{count} رحلة", two:"{count} رحلتان", few:"{count} رحلات", many:"{count} رحلة", other:"{count} رحلة" },
  "zh-cn": { other:"{count} 个航班" },
  ja: { other:"{count}便" },
  ko: { other:"{count}개 항공편" },
  hi: { one:"{count} उड़ान", other:"{count} उड़ानें" },
  tr: { one:"{count} uçuş", other:"{count} uçuş" },
  pl: { one:"{count} lot", few:"{count} loty", many:"{count} lotów", other:"{count} lotów" },
  sv: { one:"{count} flyg", other:"{count} flyg" },
  id: { other:"{count} penerbangan" },
  th: { other:"{count} เที่ยวบิน" },
  vi: { other:"{count} chuyến bay" },
};

const uiForms: Record<MobileLocale, { view: string; applied: string; priceFrom: string }> = {
  "en-us":{view:"View",applied:"applied",priceFrom:"From"},
  "es-es":{view:"Ver",applied:"aplicados",priceFrom:"Desde"},
  fr:{view:"Voir",applied:"appliqués",priceFrom:"Dès"},
  "de-de":{view:"Anzeigen",applied:"angewendet",priceFrom:"Ab"},
  "it-it":{view:"Vedi",applied:"applicati",priceFrom:"Da"},
  "pt-br":{view:"Ver",applied:"aplicados",priceFrom:"A partir de"},
  nl:{view:"Bekijk",applied:"toegepast",priceFrom:"Vanaf"},
  ar:{view:"عرض",applied:"مطبّق",priceFrom:"من"},
  "zh-cn":{view:"查看",applied:"项已应用",priceFrom:"起价"},
  ja:{view:"表示",applied:"件適用",priceFrom:"最低"},
  ko:{view:"보기",applied:"개 적용됨",priceFrom:"최저"},
  hi:{view:"देखें",applied:"लागू",priceFrom:"से"},
  tr:{view:"Görüntüle",applied:"uygulandı",priceFrom:"Başlangıç"},
  pl:{view:"Pokaż",applied:"zastosowano",priceFrom:"Od"},
  sv:{view:"Visa",applied:"tillämpade",priceFrom:"Från"},
  id:{view:"Lihat",applied:"diterapkan",priceFrom:"Mulai"},
  th:{view:"ดู",applied:"รายการที่ใช้",priceFrom:"เริ่มต้น"},
  vi:{view:"Xem",applied:"đã áp dụng",priceFrom:"Từ"},
};
...
export const flightResultsUiCopy = (locale: MobileLocale) => {
  ...
  return {
    ...labels,
    flightCount: countLabel,
    viewFlights: (value: number) => `${uiForms[locale].view} ${countLabel(value)}`,
    appliedCount: (value: number) => `${value} ${uiForms[locale].applied}`,
    ...
    fromPrice: (price: string) => `${uiForms[locale].priceFrom} ${price}`,
  };
};
