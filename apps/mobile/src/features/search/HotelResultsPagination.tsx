...
const styles=StyleSheet.create({row:{flexDirection:"row",flexWrap:"nowrap",justifyContent:"center",alignItems:"center",gap:6,paddingHorizontal:8,paddingVertical:12},target:{minWidth:40,height:40,borderWidth:1,borderRadius:9,alignItems:"center",justifyContent:"center",paddingHorizontal:8},targetText:{fontSize:13,lineHeight:17,fontWeight:"500",fontFamily:appFonts.medium},currentText:{fontWeight:"700",fontFamily:appFonts.bold}});
