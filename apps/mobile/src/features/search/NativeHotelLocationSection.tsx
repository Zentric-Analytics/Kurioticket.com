...
const styles = StyleSheet.create({
  ...
  streetViewLoadingText: { fontSize: 13, lineHeight: 20, fontWeight: "500" },
  mapFallback: { flex: 1, alignItems: "center", justifyContent: "center", gap: 6 },
  subheading: { marginTop: 10, fontSize: 15, lineHeight: 20, fontWeight: "700" },
  ...
  fallbackText: { marginTop: 4, fontSize: 14, lineHeight: 20, fontWeight: "400" },
});
