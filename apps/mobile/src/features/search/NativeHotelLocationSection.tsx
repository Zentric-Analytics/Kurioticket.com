...
import { NativeHotelFullLookAroundModal } from "./NativeHotelFullLookAroundModal";
import {
...
export function NativeHotelLocationSection({ hotelId, hotelName, propertyDetails, theme }: {
  ...
  const [fullLookAroundOpen, setFullLookAroundOpen] = useState(false);
  ...
  return <View style={styles.locationSection}>
    ...
    <NativeHotelFullLookAroundModal visible={fullLookAroundOpen} hotelId={hotelId} hotelName={hotelName} propertyDetails={propertyDetails} theme={theme} onClose={() => setFullLookAroundOpen(false)} />
