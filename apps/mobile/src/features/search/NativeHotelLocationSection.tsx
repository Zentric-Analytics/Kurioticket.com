...
const styles = StyleSheet.create({
  ...
  accessibilityHeading: { marginTop: 28, fontSize: 15, lineHeight: 22, fontWeight: "600", fontFamily: appFonts.semibold },
  ...
  fallbackText: { marginTop: 12, fontSize: 13, lineHeight: 22, fontWeight: "400", fontFamily: appFonts.regular },
});
