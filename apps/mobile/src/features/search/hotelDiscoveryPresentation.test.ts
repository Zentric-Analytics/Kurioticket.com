...
test("active native Hotel continuation distinguishes planning rooms and provider truth", () => {
...
test("active Hotel details do not fabricate classification, reviews, rooms, or price", () => {
