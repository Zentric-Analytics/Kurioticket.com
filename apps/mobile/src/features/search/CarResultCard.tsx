...
export function CarResultCard({ result, rank, imageUri, searchParams, onViewDeal }: {
  ...
  return <View style={[c.card,{backgroundColor:theme.surface,borderColor:theme.dark?theme.border:"#D8E1EC",shadowColor:theme.dark?"#000000":"#18305B"}]}>
    {hasTopBadge ? <View style={c.topMetaShell}>
...
const c = StyleSheet.create({
  card:{borderWidth:1,borderRadius:13,overflow:"hidden",shadowOpacity:0.08,shadowRadius:10,shadowOffset:{width:0,height:2},elevation:2},topMetaShell:{flexDirection:"row"},topMetaVisualSpacer:{width:"40%"},topMetaContent:{flex:1,minWidth:0,paddingHorizontal:10,paddingTop:9,paddingBottom:4},topMetaRow:{minWidth:0,flexDirection:"row",alignItems:"center",justifyContent:"flex-end",gap:6},main:{minHeight:168,flexDirection:"row",alignItems:"stretch"},visualColumn:{width:"40%",minHeight:168,paddingLeft:6,paddingRight:6,paddingBottom:8},visualColumnWithoutTopMeta:{paddingTop:9},visual:{flex:1,backgroundColor:"#F8FAFC",overflow:"hidden",borderRadius:10},image:{...StyleSheet.absoluteFillObject},imageFallback:{flex:1,alignItems:"center",justifyContent:"center",gap:7,padding:8},fallbackText:{fontSize:10,fontWeight:"600",color:"#315A7D",textAlign:"center"},
  contentColumn:{flex:1,minWidth:0},actionRow:{flexDirection:"row"},actionVisualSpacer:{width:"40%"},actionContent:{flex:1,minWidth:0,paddingLeft:10,paddingRight:10,paddingBottom:8},
  information:{flex:1,minWidth:0,paddingHorizontal:10,paddingBottom:9},informationWithoutTopMeta:{paddingTop:9},freeCancellation:{minWidth:0,flexShrink:1,flexDirection:"row",alignItems:"center",alignSelf:"flex-end",gap:3,marginTop:3},freeCancellationText:{fontSize:11,lineHeight:15,fontWeight:"700"},headerRow:{flexDirection:"row",alignItems:"flex-start",gap:6},identityColumn:{flex:1,minWidth:0},name:{fontSize:15,fontWeight:"800",lineHeight:18,color:ui.navy},identityLine:{minWidth:0,lineHeight:18},secondaryModel:{fontSize:15,fontWeight:"800",lineHeight:18},similar:{fontSize:11,fontWeight:"500",lineHeight:16,color:"#536B92"},category:{fontSize:10,fontWeight:"800",letterSpacing:1.1,lineHeight:16,textTransform:"uppercase",color:"#004BB8"},utilityColumn:{flexShrink:0,alignItems:"flex-end"},badge:{flexShrink:0,flexDirection:"row",alignItems:"center",gap:3,borderRadius:5,backgroundColor:"#ECFDF5",paddingHorizontal:5,paddingVertical:2},badgeText:{fontSize:9,fontWeight:"700",color:"#15803D"},actions:{flexDirection:"row",alignItems:"center"},action:{width:28,height:44,justifyContent:"flex-start"},saveAction:{alignItems:"flex-end",paddingRight:2},shareAction:{alignItems:"flex-start",paddingLeft:2},detailColumn:{minWidth:0,marginTop:7},location:{flexDirection:"row",alignItems:"flex-start",gap:4},meta:{flex:1,minWidth:0,fontSize:11,fontWeight:"500",lineHeight:15,color:"#536B92"},
  specs:{marginTop:7,flexDirection:"column",gap:7},spec:{minWidth:0,flexDirection:"row",alignItems:"flex-start",gap:4},specText:{flex:1,minWidth:0,fontSize:11,fontWeight:"500",lineHeight:14,color:"#536B92"},priceColumn:{flexShrink:0,minWidth:108,maxWidth:"100%",alignItems:"flex-end",justifyContent:"flex-end"},unavailablePrice:{maxWidth:"100%",textAlign:"right",fontSize:11,fontWeight:"500",lineHeight:15},total:{maxWidth:"100%",fontSize:21,fontWeight:"700",lineHeight:24,letterSpacing:-0.4,color:ui.navy},taxDisclosure:{maxWidth:"100%",marginTop:1,fontSize:10,fontWeight:"500",lineHeight:13,textAlign:"right"},perDay:{maxWidth:"100%",marginTop:2,fontSize:11,fontWeight:"700",lineHeight:14,textAlign:"right"},viewDeal:{minHeight:36,flexDirection:"row",alignItems:"center",justifyContent:"flex-end",gap:4},viewDealText:{fontSize:13,lineHeight:15,fontWeight:"600"},conversion:{flexDirection:"row",alignItems:"flex-end",justifyContent:"flex-end",paddingLeft:10,paddingRight:10,paddingTop:7,paddingBottom:4},
});
