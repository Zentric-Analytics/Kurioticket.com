  ...
  return <View style={[c.card,{backgroundColor:theme.surface,borderColor:theme.dark?theme.border:"#D8E1EC",shadowColor:theme.dark?"#000000":"#18305B"}]}>
    ...
    <View style={[c.conversion,{backgroundColor:theme.surface}]}>
      <View style={c.rentalBenefits}>
        {offer?.freeCancellation ? <View style={c.rentalBenefit}><ShieldCheck accessible={false} size={12} strokeWidth={2} color={theme.icon} /><Text style={[c.rentalBenefitText,{color:theme.textSecondary}]}>Free cancellation</Text></View> : null}
        <View style={c.rentalBenefit}><Fuel accessible={false} size={12} strokeWidth={2} color={theme.icon} /><Text style={[c.rentalBenefitText,{color:theme.textSecondary}]}>{fuelPolicyLabel}</Text></View>
        <View style={c.rentalBenefit}><Gauge accessible={false} size={12} strokeWidth={2} color={theme.icon} /><Text style={[c.rentalBenefitText,{color:theme.textSecondary}]}>{mileageLabel}</Text></View>
      </View>
...
const c = StyleSheet.create({
  ...
  specs:{marginTop:7,flexDirection:"column",gap:5},spec:{minWidth:0,flexDirection:"row",alignItems:"flex-start",gap:4},specText:{flex:1,minWidth:0,fontSize:11,fontWeight:"500",lineHeight:14,color:"#536B92"},priceColumn:{flexShrink:0,minWidth:108,maxWidth:"46%",alignItems:"flex-end",justifyContent:"flex-end"},unavailablePrice:{maxWidth:"100%",textAlign:"right",fontSize:11,fontWeight:"500",lineHeight:15},total:{maxWidth:"100%",fontSize:21,fontWeight:"700",lineHeight:24,letterSpacing:-0.4,color:ui.navy},taxDisclosure:{maxWidth:"100%",marginTop:1,fontSize:10,fontWeight:"500",lineHeight:13,textAlign:"right"},perDay:{maxWidth:"100%",marginTop:2,fontSize:11,fontWeight:"700",lineHeight:14,textAlign:"right"},viewDeal:{minHeight:36,flexDirection:"row",alignItems:"center",justifyContent:"flex-end",gap:4,marginTop:2},viewDealText:{fontSize:13,lineHeight:15,fontWeight:"600"},conversion:{flexDirection:"row",alignItems:"flex-end",gap:10,paddingLeft:10,paddingRight:10,paddingTop:7,paddingBottom:8},rentalBenefits:{flex:1,minWidth:0,flexDirection:"row",flexWrap:"wrap",alignItems:"center",alignContent:"flex-end",columnGap:8,rowGap:4},rentalBenefit:{maxWidth:"100%",flexDirection:"row",alignItems:"center",gap:3},rentalBenefitText:{fontSize:10,fontWeight:"500",lineHeight:14},
});
