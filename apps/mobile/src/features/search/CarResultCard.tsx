...
const c = StyleSheet.create({
  ...
  lowerBand:{flexDirection:"row",alignItems:"stretch",borderTopWidth:StyleSheet.hairlineWidth},specColumn:{flex:1,minWidth:0,gap:8,paddingHorizontal:8,paddingVertical:10},spec:{minWidth:0,flexDirection:"row",alignItems:"flex-start",gap:4},specText:{flex:1,minWidth:0,fontSize:11,fontWeight:"500",lineHeight:14,color:"#536B92"},commerceColumn:{flex:1.35,minWidth:0,borderLeftWidth:StyleSheet.hairlineWidth,paddingLeft:8,paddingRight:9,paddingTop:8,paddingBottom:5},priceColumn:{minWidth:0,maxWidth:"100%",alignItems:"flex-end"},unavailablePrice:{maxWidth:"100%",textAlign:"right",fontSize:11,fontWeight:"500",lineHeight:15},dailyPrice:{maxWidth:"100%",fontSize:19,fontWeight:"600",lineHeight:22,letterSpacing:-0.35,color:ui.navy},perDayLabel:{maxWidth:"100%",marginTop:1,fontSize:10,fontWeight:"500",lineHeight:13,textAlign:"right"},viewDeal:{minHeight:36,flexDirection:"row",alignItems:"center",justifyContent:"flex-end",gap:4},viewDealText:{fontSize:14,lineHeight:18,fontWeight:"600"},
});
