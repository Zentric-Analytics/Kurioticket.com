...
const en = {
  ...
  emailCurrentEntry: "Enter your current email address",
  emailCurrentHelp: "Enter the email address linked to your account, then request a verification code.",
  emailCurrentMismatch: "Enter the email address currently linked to your account.",
  emailSendInitial: "Send code",
...
const es: typeof en = {
  ...
  emailNewLabel: "Nuevo correo",
  emailCurrentEntry: "Introduce tu correo electrónico actual",
  emailCurrentHelp: "Introduce el correo de tu cuenta y solicita un código de verificación.",
  emailCurrentMismatch: "Introduce el correo electrónico vinculado actualmente a tu cuenta.",
  emailSendInitial: "Enviar código",
  ...
  emailSendingShort: "Enviando",
  emailSentShort: "Código enviado",
  emailMaxResends: "Has alcanzado el máximo de reenvíos. Inténtalo de nuevo en un minuto.",
  emailTryLater: "Inténtalo luego",
