...
const EXPECTED = Object.freeze({ projectId: '89f6fd88-c0d7-495a-9e2b-8301b09f407d', package: 'com.kurioticket.app', profile: 'production', runtime: 'production-0.3.3', channel: 'production', api: 'https://kurioticket.com' });
